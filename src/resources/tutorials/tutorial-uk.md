...
- Logseq — це платформа з [відкритим кодом](https://github.com/logseq/og) для керування _знаннями_ та співпраці, орієнтована на _конфіденційності_.
...
- Ви також можете завантажити наш настільний додаток за адресою https://github.com/logseq/og/releases
