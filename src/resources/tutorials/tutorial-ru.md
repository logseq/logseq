...
- Logseq - это платформа с [открытым исходным кодом](https://github.com/logseq/og), _ориентированная на конфиденциальность_, для управления _знаниями_ и совместной работы.
...
по адресу https://github.com/logseq/og/releases
