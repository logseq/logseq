  ...
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
   ...
   {:on-boarding/title "Olá, bem-vindo ao Logseq!"
    ...
    :ru {:on-boarding/title "Привет, добро пожаловать в Logseq!"
        ...
        :settings-page/custom-date-format "Пердпочтительный формат дат"
        :settings-page/preferred-file-format "Пердпочтительный формат файлов"
        :settings-page/preferred-workflow "Пердпочтительный рабочий процесс"
