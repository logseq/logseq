...
(def dicts
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
        ...
        :settings-page/git-confirm "You need to restart the app after updating the settings."
   ...
   {:on-boarding/title "Olá, bem-vindo ao Logseq!"
    ...
    :ru {:on-boarding/title "Привет, добро пожаловать в Logseq!"
        ...
        :settings-page/git-confirm "Необходимо перезапустить приложение после изменения настроек."
