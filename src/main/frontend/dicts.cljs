...
"
        ...
        :content/copy-current-block-ref "Copy current block ref"
   ...
   :de {:help/about "Über Logseq"
        ...
        :content/copy-current-block-ref "Aktuelle Blockreferenz kopieren"
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :content/copy-current-block-ref "Copier la référence de bloc actuelle"
   ...
   :zh-CN {:on-boarding/title "你好，欢迎使用 Logseq！"
           ...
           :content/copy-current-block-ref "复制当前块引用"
   ...
   :zh-Hant {:on-boarding/title "你好，歡迎使用 Logseq！"
             ...
             :content/copy-current-block-ref "復制當前塊引用"
