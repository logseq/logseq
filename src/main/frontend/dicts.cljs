...
(def dicts
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
   ...
   :es {:on-boarding/title "Hola, bienvenido a Logseq!"
        ...
        :on-boarding/privacy "El servidor nunca almacenará ni analizará sus notas privadas. Sus datos son archivos de texto plano, admitimos tanto Markdown como el modo Org de Emacs por ahora. Incluso si el sitio web no funciona o no puede mantener, los datos siempre serán suyos."
        ...
        :on-boarding/features-block-embed "Inserción de bloques"
        :on-boarding/features-page-embed "Inserción de páginas"
        ...
        :on-boarding/clojure-desc " - Un lenguaje de programación dinámico, funcional y de propósito general"
        ...
        :help/privacy "Politica de privacidad"
        :help/terms "Términos"
        ...
        :right-side-bar/page "Gráfico de las páginas"
        ...
        :git/a-force-push "Envio (push) forzado"
        ...
        :page/cancel-publishing "Cancelar la publicación e Logseq"
        ...
        :journal/multiple-files-with-different-formats "Parece que tiene varios archivos de diario (con diferentes formatos) para el mismo mes, por favor guarde sólo un archivo de diario para cada mes."
        :journal/go-to "Ir a Archivos"
        :file/name "Nombre del archivo"
        :file/file "Archivos: "
        :file/last-modified-at "Fecha de modificación"
        :file/no-data "No hay datos"
        :file/format-not-supported "Formato .{1} no es soportado."
        ...
        :content/open-in-sidebar "Abrir en la barra lateral"
        ...
        :settings-page/show-brackets "Mostar paréntesis"
        ...
        :settings-page/dont-use-other-peoples-proxy-servers "No use servidores proxy de otras personas. Es muy peligroso, le pueden  robar su token y consecuentemente sus notass. Logseq no se hace responsable por la pérdida si utiliza servidores proxy ajenos. Es posible configurar un servidor proxy propio, consulte."
