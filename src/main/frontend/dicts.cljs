...
"
        ...
        :insert-line-above "Insert Line Above The Block"
        :insert-line-below "Insert Line Below The Block"
        :general "General"
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :insert-line-above "Insérer une ligne au-dessus du bloc"
        :insert-line-below "Insérer une ligne sous le bloc"
        :general "Général"
   ...
   :zh-CN {:on-boarding/title "你好，欢迎使用 Logseq！"
           ...
           :insert-line-above "在块上方插入行"
           :insert-line-below "在块下方插入行"
           :general "常规​​​​​"
           :help/toggle "显示/关闭帮助"
   ...
   :zh-Hant {:on-boarding/title "你好，歡迎使用 Logseq！"
             ...
             :insert-line-above "在塊上方插入行"
             :insert-line-below "在塊下方插入行"
             :general "常規​​​​​"
             :help/toggle "顯示/關閉幫助"
             :help/git-commit-message "提交消息"
             :help/full-text-search "全文搜索"
   ...
   :af {:on-boarding/title "Hi, welcome to Logseq!"
        ...
        :insert-line-above "Plaas reël bo die blok"
        :insert-line-below "Voeg 'n reël onder die blok in"
        :general "Algemeen"
