...
"
        ...
        :insert-block-above "Insert New Block Above"
        :insert-block-below "Insert New Block Below"
        :general "General"
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :insert-block-above "Insérer un nouveau bloc au-dessus"
        :insert-block-below "Insérer un nouveau bloc ci-dessous"
        :general "Général"
   ...
   :zh-Hant {:on-boarding/title "你好，歡迎使用 Logseq！"
             ...
             :insert-block-above "在上方插入塊"
             :insert-block-below "在下方插入塊"
             :general "常規​​​​​"
             :help/toggle "顯示/關閉幫助"
             :help/git-commit-message "提交消息"
             :help/full-text-search "全文搜索"
   ...
   :af {:on-boarding/title "Hi, welcome to Logseq!"
        ...
        :insert-block-above "Voeg 'n nuwe blok hierbo in"
        :insert-block-below "Voeg 'n nuwe blok hieronder in"
        :general "Algemeen"
