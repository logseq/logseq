...
(def dicts
  {:en {:tutorial/text (rc/inline "tutorial-en.md")
        ...
        :right-side-bar/custom-configuration "Custom configuration"
        :right-side-bar/custom-theme "Custom theme"
   ...
   :de {:help/about "Über Logseq"
        ...
        :right-side-bar/custom-configuration "Benutzerdefinierte Konfiguration"
        :right-side-bar/custom-theme "Benutzerdefiniertes Thema"
   ...
   :fr {:help/about "A propos de Logseq"
        ...
        :right-side-bar/custom-configuration "Configuration personnalisée"
        :right-side-bar/custom-theme "Thème personnalisé"
   ...
   :zh-CN {:on-boarding/title "你好，欢迎使用 Logseq！"
           ...
           :right-side-bar/custom-configuration "自定义配置"
           :right-side-bar/custom-theme "自定义主题"
           ...
           :settings-page/edit-custom-css "编辑 custom.css"
           :settings-page/git-desc "is used for pages version control, you can click the vertical three dots menu to check the page's history."
           :settings-page/git-confirm "You need to restart the app after updating the Git settings."
           :settings-page/git-switcher-label "Enable Git auto commit"
           :settings-page/git-commit-delay "Git auto commit seconds"
   ...
   :zh-Hant {:on-boarding/title "你好，歡迎使用 Logseq！"
             ...
             :right-side-bar/custom-configuration "自定義配置"
             :right-side-bar/custom-theme "自定義主題"
   ...
   :af {:on-boarding/title "Hi, welcome to Logseq!"
        ...
        :right-side-bar/custom-configuration "Pasgemaakte konfigurasie"
        :right-side-bar/custom-theme "pasgemaakte tema"
   ...
   :es {:on-boarding/title "¡Hola, bienvenido a Logseq!"
        ...
        :right-side-bar/custom-configuration "Configuración personalizada"
        :right-side-bar/custom-theme "tema personalizado"
   ...
   :nb-NO {:on-boarding/title "Hei, og velkommen til Logseq!"
           ...
           :right-side-bar/custom-configuration "Egendefinert konfigurasjon"
           :right-side-bar/custom-theme "tilpasset tema"
           :right-side-bar/theme "{1} tema"
   ...
   {:on-boarding/title "Olá, bem-vindo ao Logseq!"
    ...
    :right-side-bar/help "Ajuda"
    :right-side-bar/switch-theme "Temas"
    :right-side-bar/custom-configuration "Configuração personalizada"
    :right-side-bar/custom-theme "Tema personalizado"
    :right-side-bar/theme "Tema {1}"
    :right-side-bar/page "Grafo da página"
    :right-side-bar/recent "Recente"
   ...
   :ru {:on-boarding/title "Привет, добро пожаловать в Logseq!"
        ...
        :right-side-bar/custom-configuration "Индивидуальная конфигурация"
        :right-side-bar/custom-theme "Пользовательская тема"
