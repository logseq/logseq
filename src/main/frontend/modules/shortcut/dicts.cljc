...
(def ^:large-vars/data-var all-default-keyboard-shortcuts
  {:date-picker/complete         "Date picker: Choose selected day"
   ...
   :whiteboard/select              "Activate select tool"
   :whiteboard/pan                 "Activate pan tool"
   :whiteboard/portal              "Activate portal tool"
   :whiteboard/pencil              "Activate pencil tool"
   :whiteboard/highlighter         "Activate highlighter tool"
   :whiteboard/eraser              "Activate eraser tool"
   :whiteboard/connector           "Activate connector tool"
   :whiteboard/text                "Activate text tool"
   :whiteboard/rectangle           "Activate rectangle tool"
   :whiteboard/ellipse             "Activate ellipse tool"
