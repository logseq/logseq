...
(def ^:large-vars/data-var dicts
  {:en {:accessibility/skip-to-main-content "Skip to main content"
   ...
   :ru {:accessibility/skip-to-main-content "Перейти к основному содержимому"
        ...
        :dev/show-page-data "(Dev) Показать данные о странице"
        :dev/show-block-data "(Dev) Показать данные о блоке"
        :dev/show-block-ast "(Dev) Показать AST блока"
        :dev/show-page-ast "(Dev) Показать AST страницы"
        :content/copy-export-as "Cкопировать / Экспортировать как.."
        :content/copy-block-url "Скопировать URL блока"
        :content/copy-block-ref "Скопировать ссылку блока"
        :content/copy-block-emebed "Копировать встроенный блок"
        :content/copy-ref "Скопировать эту ссылку Copy this reference"
        :content/delete-ref "Удалить эту ссылку Delete this reference"
        :content/replace-with-text "Заменить на текст Replace with text"
        :content/replace-with-embed "Заменить на встроенный"
