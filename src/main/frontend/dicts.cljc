...
(def ^:large-vars/data-var dicts
  {:en {:accessibility/skip-to-main-content "Skip to main content"
   ...
   :fr {:tutorial/text #?(:cljs (rc/inline "tutorial-fr.md")
        ...
        :relaunch-confirm-to-work "Il est nécessaire de relancer l'application pour que ça fonctionne. Voules-vous..."
        ...
        :sync-from-local-changes-detected "Raffraîchissement des modifications détectées sur vos..."
