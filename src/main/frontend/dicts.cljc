...
(def ^:large-vars/data-var dicts
  {:en {:tutorial/text #?(:cljs (rc/inline "tutorial-en.md")
        ...
        :file-rn/need-action "File rename actions are suggested to match up with the format"
        ...
        :file-rn/select-format "(Developer Option) Select the desired filename format"
        ...
        :file-rn/format-deprecated "You are currently using an outdated format! May update to the latest format."
        :file-rn/filename-format "Filename Format"
