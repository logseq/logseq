...
(def ^:large-vars/data-var dicts
  {:en {:tutorial/text #?(:cljs (rc/inline "tutorial-en.md")
        ...
        :file-rn/or-select-actions ", or manually rename the files below, then "
        :file-rn/or-select-actions-2 ". You can't re-do the actions once you closed the panel."
        :file-rn/legend "🟢 Optional actions; 🟡 Rename required to avoid title change; 🔴 Breaking change."
        ...
        :file-rn/instruct-1 "It's a 2-stage process to update filename format:"
