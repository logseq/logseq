...
(defn build-db-initial-data
  ...
  (let [initial-data (cond->
        ...
        bootstrap-class? (fn [c] (contains? #{:logseq.class/Root :logseq.class/Property :logseq.class/Tag :logseq.class/Template :logseq.class/Agent :logseq.class/Project :logseq.class/Code-block} (:db/ident c)))
