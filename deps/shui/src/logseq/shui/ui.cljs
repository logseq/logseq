...
(def button-group (util/ui-wrap "ButtonGroup"))
(def toolbar (util/ui-wrap "Toolbar"))
(def toolbar-group (util/ui-wrap "ToolbarGroup"))
(def toolbar-button (util/ui-wrap "ToolbarButton"))
(def toolbar-input (util/ui-wrap "ToolbarInput"))
(def toolbar-link (util/ui-wrap "ToolbarLink"))
(def toolbar-separator (util/ui-wrap "ToolbarSeparator"))
...
(def alert (util/ui-wrap "Alert"))
(def alert-title (util/ui-wrap "AlertTitle"))
(def alert-description (util/ui-wrap "AlertDescription"))
(def slider (util/ui-wrap "Slider"))
(def slider-track (util/ui-wrap "SliderTrack"))
(def slider-range (util/ui-wrap "SliderRange"))
(def slider-thumb (util/ui-wrap "SliderThumb"))
(def separator (util/ui-wrap "Separator"))
(def badge (util/ui-wrap "Badge"))
(def skeleton (util/ui-wrap "Skeleton"))
(def calendar (util/ui-wrap "Calendar"))
(def avatar (util/ui-wrap "Avatar"))
(def avatar-image (util/ui-wrap "AvatarImage"))
(def avatar-fallback (util/ui-wrap "AvatarFallback"))
...
(def tooltip (util/ui-wrap "Tooltip"))
(def tooltip-trigger (util/ui-wrap "TooltipTrigger"))
(def tooltip-portal (util/ui-wrap "TooltipPortal"))
(def tooltip-content (util/ui-wrap "TooltipContent"))
(def tooltip-provider (util/ui-wrap "TooltipProvider"))
(def tooltip-arrow (util/ui-wrap "TooltipArrow"))

(def card (util/ui-wrap "Card"))
(def card-header (util/ui-wrap "CardHeader"))
(def card-title (util/ui-wrap "CardTitle"))
(def card-description (util/ui-wrap "CardDescription"))
(def card-content (util/ui-wrap "CardContent"))
(def card-footer (util/ui-wrap "CardFooter"))
...
(def context-menu (util/ui-wrap "ContextMenu"))
(def context-menu-trigger (util/ui-wrap "ContextMenuTrigger"))
(def context-menu-content (util/ui-wrap "ContextMenuContent"))
(def context-menu-item (util/ui-wrap "ContextMenuItem"))
(def context-menu-checkbox-item (util/ui-wrap "ContextMenuCheckboxItem"))
(def context-menu-radio-item (util/ui-wrap "ContextMenuRadioItem"))
(def context-menu-label (util/ui-wrap "ContextMenuLabel"))
(def context-menu-separator (util/ui-wrap "ContextMenuSeparator"))
(def context-menu-shortcut (util/ui-wrap "ContextMenuShortcut"))
(def context-menu-group (util/ui-wrap "ContextMenuGroup"))
(def context-menu-portal (util/ui-wrap "ContextMenuPortal"))
(def context-menu-sub (util/ui-wrap "ContextMenuSub"))
(def context-menu-sub-content (util/ui-wrap "ContextMenuSubContent"))
(def context-menu-sub-trigger (util/ui-wrap "ContextMenuSubTrigger"))
(def context-menu-radio-group (util/ui-wrap "ContextMenuRadioGroup"))
...
(def dialog-get dialog-core/get-dialog)
