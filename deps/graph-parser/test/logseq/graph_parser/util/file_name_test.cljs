...
(deftest page-name-parsing-tests
  (is (string? (gp-util/title-parsing  "___-_-_-_---___----")))
  (is (string? (gp-util/title-parsing  "_____///____---___----")))
  (is (string? (gp-util/title-parsing  "/_/////---/_----")))
  (is (string? (gp-util/title-parsing  "/\\#*%lasdf\\//__--dsll_____----....-._0x2B")))
  (is (string? (gp-util/title-parsing  "/\\#*%l;;&&;&\\//__--dsll_____----....-._0x2B")))
  (is (string? (gp-util/title-parsing  multiplatform-reserved-chars)))
  (is (string? (gp-util/title-parsing  "dsa&amp&semi;l dsalfjk jkl"))))
...
(deftest page-name-sanitization-backward-tests
  ...
  (is (= multiplatform-reserved-chars (gp-util/title-parsing multiplatform-reserved-chars))))
