(* cljs shadow.resource/inline "templates/config.edn" — the default
   graph config seeded into logseq/config.edn. Vendored from
   deps/common/resources/templates/config.edn; keep in sync. *)
let config_edn = {|{:meta/version 1
...
;; {:journals []}
 ...
 ;; - prettify-url?   Whether urls to YouTube or X should be wrapped with {{video ...}} or {{twitter ...}}
 ;; :quick-capture-options
 ;; {:insert-today? false           ;; Default value: true
 ;;  :redirect-page? false          ;; Default value: false
 ;;  :default-page "quick capture"  ;; Default page: "quick capture"
 ;;  :prettify-url? true}           ;; Default value: true
