...
cljs.core.reset_BANG_(frontend.mobile.flows._STAR_mobile_app_state,state.isActive);
...
module$node_modules$$capacitor$app$dist$plugin_cjs.App.addListener("appStateChange",frontend.mobile.core.app_state_change_handler);

return module$node_modules$$capacitor$network$dist$plugin_cjs.Network.addListener("networkStatusChange",(function (p1__89087_SHARP_){
return cljs.core.reset_BANG_(frontend.mobile.flows._STAR_mobile_network_status,p1__89087_SHARP_);
}));
});
...
frontend.mobile.core.keyboard_hide = (function frontend$mobile$core$keyboard_hide(){
return module$node_modules$$capacitor$keyboard$dist$plugin_cjs.Keyboard.hide();
});
frontend.mobile.core.keyboard_show = (function frontend$mobile$core$keyboard_show(){
return module$node_modules$$capacitor$keyboard$dist$plugin_cjs.Keyboard.show();
});
