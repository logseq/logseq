...
var target_block__$1 = (function (){var G__72769 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(target_block);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__72769) : frontend.db.entity.call(null,G__72769));
})();
var blocks_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__72765_SHARP_){
var G__72770 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__72765_SHARP_);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__72770) : frontend.db.entity.call(null,G__72770));
}),blocks);
...
var _STAR_outliner_ops_STAR__orig_val__72846 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__72847 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__72847);

try{frontend.handler.editor.save_current_block_BANG_.cljs$core$IFn$_invoke$arity$0();

if(top_QMARK_){
var first_child_QMARK__72889 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(target_block__$2)),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(logseq.db.get_left_sibling(target_block__$2)));
if(first_child_QMARK__72889){
var temp__5804__auto___72890 = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(target_block__$2);
if(cljs.core.truth_(temp__5804__auto___72890)){
var parent_72891 = temp__5804__auto___72890;
frontend.modules.outliner.op.move_blocks_BANG_(blocks_SINGLEQUOTE___$1,parent_72891,false);
} else {
}
} else {
var temp__5802__auto___72892 = logseq.db.get_left_sibling(target_block__$2);
if(cljs.core.truth_(temp__5802__auto___72892)){
var before_node_72894 = temp__5802__auto___72892;
frontend.modules.outliner.op.move_blocks_BANG_(blocks_SINGLEQUOTE___$1,before_node_72894,true);
} else {
var temp__5804__auto___72896 = new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1(target_block__$2);
if(cljs.core.truth_(temp__5804__auto___72896)){
var parent_72897 = temp__5804__auto___72896;
frontend.modules.outliner.op.move_blocks_BANG_(blocks_SINGLEQUOTE___$1,parent_72897,false);
} else {
}
}
}
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__72846);
}}
} else {
return null;
