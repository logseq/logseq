...
var self__ = this;
var self__ = this;
var G__57672 = (arguments.length - (1));
switch (G__57672) {
case (1):
...
(missionary.impl.Mailbox.Port.prototype.apply = (function (self__,args57671){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57671)));
}));
...
var vec__57677 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57677,(0),null);
...
var _BANG_ = (function (p1__57670_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__57670_SHARP_) : s_BANG_.call(null,p1__57670_SHARP_));
});
...
var G__57691 = (new missionary.Cancelled("Mailbox fetch cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__57691) : f_BANG_.call(null,G__57691));
} else {
return null;
}
});
...
var G__57697_57751 = tmp.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__57697_57751) : s_BANG_.call(null,G__57697_57751));

return missionary.impl.Mailbox.nop;
}
} else {
var G__57702_57752 = self__.dequeue.pop();
(s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(G__57702_57752) : s_BANG_.call(null,G__57702_57752));
