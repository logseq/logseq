...
var G__67734 = string;
var G__67734__$1 = (((G__67734 == null))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67734));
if((G__67734__$1 == null)){
return null;
} else {
return logseq.common.util.safe_decode_uri_component(G__67734__$1);
}
} else {
return string;
}
...
var G__67735 = file_name;
var G__67735__$1 = (((G__67735 == null))?null:logseq.graph_parser.extract.decode_namespace_underlines(G__67735));
var G__67735__$2 = (((G__67735__$1 == null))?null:clojure.string.replace(G__67735__$1,logseq.common.util.url_encoded_pattern,logseq.graph_parser.extract.safe_url_decode));
if((G__67735__$2 == null)){
return null;
} else {
return logseq.graph_parser.extract.make_valid_namespaces(G__67735__$2);
}
});
...
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.seq(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__67737_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_name,logseq.common.util.page_name_sanity_lc(p1__67737_SHARP_))) || (clojure.string.blank_QMARK_(p1__67737_SHARP_)));
}),alias_SINGLEQUOTE_));
} else {
return and__5000__auto__;
}
...
var result = (function (){var G__67739 = page_m;
var G__67739__$1 = ((cljs.core.seq(aliases_SINGLEQUOTE_))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67739,new cljs.core.Keyword("block","alias","block/alias",-2112644699),aliases_SINGLEQUOTE_):G__67739);
if(cljs.core.truth_(new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67739__$1,new cljs.core.Keyword("block","tags","block/tags",1814948340),(function (){var tags = new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(properties);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(result,new cljs.core.Keyword("block","properties","block/properties",708347145),(function (p1__67738_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__67738_SHARP_,logseq.graph_parser.property.editable_linkable_built_in_properties);
}));
});
logseq.graph_parser.extract.build_page_map = (function logseq$graph_parser$extract$build_page_map(properties,invalid_properties,properties_text_values,file,page,page_name,p__67740){
var map__67741 = p__67740;
var map__67741__$1 = cljs.core.__destructure_map(map__67741);
var date_formatter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67741__$1,new cljs.core.Keyword(null,"date-formatter","date-formatter",-223324709));
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67741__$1,new cljs.core.Keyword(null,"db","db",993250759));
var from_page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67741__$1,new cljs.core.Keyword(null,"from-page","from-page",75165656));
var vec__67742 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.filter,cljs.core.remove)((function (p__67745){
var vec__67746 = p__67745;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67746,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67746,(1),null);
return logseq.graph_parser.property.valid_property_name_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(k));
}),properties);
var _STAR_valid_properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67742,(0),null);
var _STAR_invalid_properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67742,(1),null);
...
var G__67749 = page_m;
var G__67749__$1 = ((cljs.core.seq(valid_properties))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__67749,new cljs.core.Keyword("block","properties","block/properties",708347145),valid_properties,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","properties-text-values","block/properties-text-values",1271244708),cljs.core.select_keys(properties_text_values,cljs.core.keys(valid_properties))], 0)):G__67749);
if(cljs.core.seq(invalid_properties__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67749__$1,new cljs.core.Keyword("block","invalid-properties","block/invalid-properties",1509592872),invalid_properties__$1);
} else {
return G__67749__$1;
}
});
 ...
 */
logseq.graph_parser.extract.extract_pages_and_blocks = (function logseq$graph_parser$extract$extract_pages_and_blocks(format,ast,properties,file,content,p__67771){
var map__67772 = p__67771;
var map__67772__$1 = cljs.core.__destructure_map(map__67772);
var options = map__67772__$1;
var date_formatter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67772__$1,new cljs.core.Keyword(null,"date-formatter","date-formatter",-223324709));
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67772__$1,new cljs.core.Keyword(null,"db","db",993250759));
var filename_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67772__$1,new cljs.core.Keyword(null,"filename-format","filename-format",-1193264412));
var resolve_uuid_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67772__$1,new cljs.core.Keyword(null,"resolve-uuid-fn","resolve-uuid-fn",-1951054525),cljs.core.constantly(null));
...
var vec__67775 = logseq.graph_parser.block.convert_page_if_journal(page,date_formatter);
var page__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67775,(0),null);
var page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67775,(1),null);
var _journal_day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67775,(2),null);
...
var blocks = cljs.core.vec(logseq.graph_parser.block.with_parent_and_order(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","name","block/name",1619760316),page_name], null),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__67769_SHARP_){
return logseq.graph_parser.block.fix_block_id_if_duplicated_BANG_(db,page_name,_STAR_extracted_block_ids,p1__67769_SHARP_);
 ...
 */
logseq.graph_parser.extract.extract = (function logseq$graph_parser$extract$extract(file_path,content,p__67790){
var map__67791 = p__67790;
var map__67791__$1 = cljs.core.__destructure_map(map__67791);
var options = map__67791__$1;
var user_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67791__$1,new cljs.core.Keyword(null,"user-config","user-config",-1138679827));
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67791__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
...
return clojure.walk.keywordize_keys(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__67801){
var vec__67805 = p__67801;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67805,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67805,(1),null);
var mldoc_ast = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67805,(2),null);
...
var vec__67792 = logseq.graph_parser.extract.extract_pages_and_blocks(format,ast,properties,file_path,content,options);
var pages = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67792,(0),null);
var blocks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67792,(1),null);
 ...
 */
logseq.graph_parser.extract.extract_whiteboard_edn = (function logseq$graph_parser$extract$extract_whiteboard_edn(file,content,p__67827){
var map__67828 = p__67827;
var map__67828__$1 = cljs.core.__destructure_map(map__67828);
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67828__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
...
var map__67829 = logseq.common.util.safe_read_map_string.cljs$core$IFn$_invoke$arity$1(content);
var map__67829__$1 = cljs.core.__destructure_map(map__67829);
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67829__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67829__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
var blocks__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (block){
...
var blocks__$2 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67810_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__67810_SHARP_,logseq.graph_parser.whiteboard.with_whiteboard_block_props(p1__67810_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page_block__$1)], null))], 0));
