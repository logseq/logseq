...
var vec__90896 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90896,(0),null);
var block = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90896,(1),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90896,(2),null);
var sidebar_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90896,(3),null);
var preview_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90896,(4),null);
...
}),'tabIndex':(0),'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ls-block","block-add-button","flex-1","flex-col","rounded-sm","cursor-text","transition-opacity","ease-in","duration-100","!py-0",(cljs.core.truth_(has_children_QMARK_)?"opacity-0":"opacity-50")], null))},[daiquiri.core.create_element("div",{'className':"flex flex-row"},[daiquiri.core.create_element("div",{'style':{'height':(28),'marginLeft':(cljs.core.truth_(frontend.util.mobile_QMARK_())?(0):(22))},'className':"flex items-center"},[daiquiri.core.create_element("span",{'className':"bullet-container cursor opacity-0 transition-opacity ease-in duration-100"},[daiquiri.core.create_element("span",{'className':"bullet"},null)])])])]);
}),null,"frontend.components.page/add-button");
frontend.components.page.page_blocks_cp = rum.core.lazy_build(rum.core.build_defcs,(function (state,block_STAR_,p__90901){
var map__90902 = p__90901;
var map__90902__$1 = cljs.core.__destructure_map(map__90902);
var config = map__90902__$1;
var sidebar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90902__$1,new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672));
var whiteboard_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90902__$1,new cljs.core.Keyword(null,"whiteboard?","whiteboard?",-1968190788));
...
var page_e_91110 = cljs.core.first(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
var page_name_91111 = new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(page_e_91110);
if(cljs.core.truth_((function (){var and__5000__auto__ = page_name_91111;
if(cljs.core.truth_(and__5000__auto__)){
var and__5000__auto____$1 = (frontend.db.journal_page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? frontend.db.journal_page_QMARK_.cljs$core$IFn$_invoke$arity$1(page_name_91111) : frontend.db.journal_page_QMARK_.call(null,page_name_91111));
if(cljs.core.truth_(and__5000__auto____$1)){
return (frontend.date.journal_title__GT_int(page_name_91111) >= frontend.date.journal_title__GT_int(frontend.date.today()));
} else {
return and__5000__auto____$1;
}
} else {
...
frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("journal","insert-template","journal/insert-template",-1273735332),page_name_91111], null));
} else {
}
}
...
return daiquiri.core.create_element("div",{'id':"today-queries"},[cljs.core.into_array.cljs$core$IFn$_invoke$arity$1((function (){var iter__5480__auto__ = (function frontend$components$page$iter__90903(s__90904){
return (new cljs.core.LazySeq(null,(function (){
var s__90904__$1 = s__90904;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__90904__$1);
if(temp__5804__auto__){
var s__90904__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__90904__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__90904__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__90906 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__90905 = (0);
while(true){
if((i__90905 < size__5479__auto__)){
var query = cljs.core._nth(c__5478__auto__,i__90905);
cljs.core.chunk_append(b__90906,(function (){var query_SINGLEQUOTE_ = (cljs.core.truth_(frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$0())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(query,new cljs.core.Keyword(null,"collapsed?","collapsed?",-1661420674),true):query);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__90906),frontend$components$page$iter__90903(cljs.core.chunk_rest(s__90904__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__90906),null);
}
} else {
var query = cljs.core.first(s__90904__$2);
...
return rum.core.with_key(frontend.ui.catch_error(frontend.ui.component_error("Failed default query:",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"content","content",15833224),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([query_SINGLEQUOTE_], 0))], null)),frontend.components.query.custom_query(frontend.components.block.wrap_query_components(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mt-10"], null),new cljs.core.Keyword(null,"editor-box","editor-box",708759870),frontend.components.editor.box,new cljs.core.Keyword(null,"page","page",849072397),frontend.components.page.page_cp], null)),query_SINGLEQUOTE_)),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(repo),"-custom-query-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(query_SINGLEQUOTE_))].join(''));
})(),frontend$components$page$iter__90903(cljs.core.rest(s__90904__$2)));
}
} else {
return null;
}
...
var vec__90907 = rum.core.use_state(null);
var pages = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90907,(0),null);
var set_pages_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90907,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__90925),frontend$components$page$iter__90922(cljs.core.chunk_rest(s__90923__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__90925),null);
}
} else {
var page = cljs.core.first(s__90923__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["tagged-page-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page))].join('')], null),frontend.components.block.page_cp(cljs.core.PersistentArrayMap.EMPTY,page)], null),frontend$components$page$iter__90922(cljs.core.rest(s__90923__$2)));
}
} else {
return null;
}
...
frontend.components.page.page_title_editor = rum.core.lazy_build(rum.core.build_defc,(function (page,p__90926){
var map__90927 = p__90926;
var map__90927__$1 = cljs.core.__destructure_map(map__90927);
var _STAR_input_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"*input-value","*input-value",1906486090));
var _STAR_title_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"*title-value","*title-value",1930859070));
var _STAR_edit_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"*edit?","*edit?",1879943992));
var untitled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"untitled?","untitled?",1662295877));
var page_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"page-name","page-name",974981762));
var old_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"old-name","old-name",1289683869));
var whiteboard_page_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90927__$1,new cljs.core.Keyword(null,"whiteboard-page?","whiteboard-page?",1626270426));
...
var and__5000__auto__ = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(page_name) : frontend.util.page_name_sanity_lc.call(null,page_name)),(function (){var G__90928 = cljs.core.deref(_STAR_title_value);
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__90928) : frontend.util.page_name_sanity_lc.call(null,G__90928));
})());
if(and__5000__auto__){
...
if(cljs.core.truth_(and__5000__auto____$1)){
var G__90929 = cljs.core.deref(_STAR_title_value);
var G__90930 = tag_idents;
return (frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2 ? frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(G__90929,G__90930) : frontend.db.page_exists_QMARK_.call(null,G__90929,G__90930));
} else {
return and__5000__auto____$1;
}
} else {
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.page.rename_BANG_(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page),cljs.core.deref(_STAR_title_value))),(function (___40947__auto__){
...
frontend.components.page.page_title_cp = rum.core.lazy_build(rum.core.build_defcs,(function (state,page,p__90931){
var map__90932 = p__90931;
var map__90932__$1 = cljs.core.__destructure_map(map__90932);
var fmt_journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90932__$1,new cljs.core.Keyword(null,"fmt-journal?","fmt-journal?",-134242319));
var preview_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90932__$1,new cljs.core.Keyword(null,"preview?","preview?",590561578));
if(cljs.core.truth_(page)){
var page__$1 = (function (){var G__90933 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1 ? frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1(G__90933) : frontend.db.sub_block.call(null,G__90933));
})();
...
if(cljs.core.truth_(untitled_QMARK_)){
var attrs90934 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"untitled","untitled",301293696)], 0));
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs90934))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["opacity-50"], null)], null),attrs90934], 0))):{'className':"opacity-50"}),((cljs.core.map_QMARK_(attrs90934))?null:[daiquiri.interpreter.interpret(attrs90934)]));
} else {
if(nested_QMARK_){
...
return daiquiri.core.create_element("div",{'className':"ls-page-title-actions"},[(function (){var attrs90941 = (cljs.core.truth_(new cljs.core.Keyword("logseq.property","icon","logseq.property/icon",589123285).cljs$core$IFn$_invoke$arity$1((function (){var G__90942 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__90942) : frontend.db.entity.call(null,G__90942));
})()))?null:(function (){var G__90943 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"ghost","ghost",-1531157576),new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.Keyword(null,"sm","sm",-1402575065),new cljs.core.Keyword(null,"class","class",-2030961996),"px-2 py-0 h-6 text-xs text-muted-foreground",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
...
var G__90944 = "Add icon";
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__90943,G__90944) : logseq.shui.ui.button.call(null,G__90943,G__90944));
})());
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs90941))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center","gap-2"], null)], null),attrs90941], 0))):{'className':"flex flex-row items-center gap-2"}),((cljs.core.map_QMARK_(attrs90941))?[daiquiri.interpreter.interpret((function (){var G__90951 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"ghost","ghost",-1531157576),new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.Keyword(null,"sm","sm",-1402575065),new cljs.core.Keyword(null,"class","class",-2030961996),"px-2 py-0 h-6 text-xs text-muted-foreground",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
...
var G__90953 = e.target;
var G__90954 = (function (){
...
var G__90955 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (logseq.shui.ui.popup_show_BANG_.cljs$core$IFn$_invoke$arity$3 ? logseq.shui.ui.popup_show_BANG_.cljs$core$IFn$_invoke$arity$3(G__90953,G__90954,G__90955) : logseq.shui.ui.popup_show_BANG_.call(null,G__90953,G__90954,G__90955));
} else {
var opts = (function (){var G__90956 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"block","block",664686210),page,new cljs.core.Keyword(null,"target","target",253001721),e.target], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__90956,new cljs.core.Keyword(null,"class-schema?","class-schema?",508813900),true);
} else {
return G__90956;
}
})();
...
var G__90952 = (cljs.core.truth_((logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.class_QMARK_.call(null,page)))?"Add tag property":(cljs.core.truth_((logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.property_QMARK_.call(null,page)))?"Configure":"Set property"
));
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__90951,G__90952) : logseq.shui.ui.button.call(null,G__90951,G__90952));
})())]:[daiquiri.interpreter.interpret(attrs90941),daiquiri.interpreter.interpret((function (){var G__90963 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"ghost","ghost",-1531157576),new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.Keyword(null,"sm","sm",-1402575065),new cljs.core.Keyword(null,"class","class",-2030961996),"px-2 py-0 h-6 text-xs text-muted-foreground",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
if(cljs.core.truth_((logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.property_QMARK_.call(null,page)))){
var G__90965 = e.target;
var G__90966 = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ls-property-dropdown","div.ls-property-dropdown",-263769697),frontend.components.property.config.property_dropdown(page,null,cljs.core.PersistentArrayMap.EMPTY)], null);
});
var G__90967 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (logseq.shui.ui.popup_show_BANG_.cljs$core$IFn$_invoke$arity$3 ? logseq.shui.ui.popup_show_BANG_.cljs$core$IFn$_invoke$arity$3(G__90965,G__90966,G__90967) : logseq.shui.ui.popup_show_BANG_.call(null,G__90965,G__90966,G__90967));
} else {
var opts = (function (){var G__90968 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"block","block",664686210),page,new cljs.core.Keyword(null,"target","target",253001721),e.target], null);
if(cljs.core.truth_((logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.class_QMARK_.call(null,page)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__90968,new cljs.core.Keyword(null,"class-schema?","class-schema?",508813900),true);
} else {
return G__90968;
}
})();
...
var G__90964 = (cljs.core.truth_((logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.class_QMARK_.call(null,page)))?"Add tag property":(cljs.core.truth_((logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.property_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.property_QMARK_.call(null,page)))?"Configure":"Set property"
));
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__90963,G__90964) : logseq.shui.ui.button.call(null,G__90963,G__90964));
})())]));
})()]);
...
if(cljs.core.truth_((function (){var G__90969 = e;
var G__90969__$1 = (((G__90969 == null))?null:G__90969.target);
if((G__90969__$1 == null)){
return null;
} else {
return G__90969__$1.closest(".ls-properties-area");
}
})())){
return null;
} else {
...
var G__90970 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_name], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__90970) : frontend.db.entity.call(null,G__90970));
} else {
if(logseq.common.util.uuid_string_QMARK_(page_name)){
var G__90971 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.uuid(page_name)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__90971) : frontend.db.entity.call(null,G__90971));
} else {
...
var attrs91004 = (function (){var G__91005 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),default_tab,new cljs.core.Keyword(null,"class","class",-2030961996),"w-full"], null);
var G__91006 = (cljs.core.truth_(both_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.gap-1.items-center","div.flex.flex-row.gap-1.items-center",1211135204),(function (){var G__91009 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-8"], null);
var G__91010 = (cljs.core.truth_(class_QMARK_)?(function (){var G__91013 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"tag",new cljs.core.Keyword(null,"class","class",-2030961996),"py-1 text-xs"], null);
var G__91014 = "Tagged nodes";
return (logseq.shui.ui.tabs_trigger.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.tabs_trigger.cljs$core$IFn$_invoke$arity$2(G__91013,G__91014) : logseq.shui.ui.tabs_trigger.call(null,G__91013,G__91014));
})():null);
var G__91011 = (cljs.core.truth_(property_QMARK_)?(function (){var G__91015 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),"property",new cljs.core.Keyword(null,"class","class",-2030961996),"py-1 text-xs"], null);
var G__91016 = "Nodes with property";
return (logseq.shui.ui.tabs_trigger.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.tabs_trigger.cljs$core$IFn$_invoke$arity$2(G__91015,G__91016) : logseq.shui.ui.tabs_trigger.call(null,G__91015,G__91016));
})():null);
var G__91012 = (cljs.core.truth_(property_QMARK_)?frontend.components.db_based.page.configure_property(page):null);
return (logseq.shui.ui.tabs_list.cljs$core$IFn$_invoke$arity$4 ? logseq.shui.ui.tabs_list.cljs$core$IFn$_invoke$arity$4(G__91009,G__91010,G__91011,G__91012) : logseq.shui.ui.tabs_list.call(null,G__91009,G__91010,G__91011,G__91012));
})()], null):null);
var G__91007 = (cljs.core.truth_(class_QMARK_)?(function (){var G__91017 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"tag"], null);
var G__91018 = frontend.components.objects.class_objects(page,opts);
return (logseq.shui.ui.tabs_content.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.tabs_content.cljs$core$IFn$_invoke$arity$2(G__91017,G__91018) : logseq.shui.ui.tabs_content.call(null,G__91017,G__91018));
})():null);
var G__91008 = (cljs.core.truth_(property_QMARK_)?(function (){var G__91019 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),"property"], null);
var G__91020 = frontend.components.objects.property_related_objects(page,new cljs.core.Keyword(null,"current-page?","current-page?",-1491305079).cljs$core$IFn$_invoke$arity$1(opts));
return (logseq.shui.ui.tabs_content.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.tabs_content.cljs$core$IFn$_invoke$arity$2(G__91019,G__91020) : logseq.shui.ui.tabs_content.call(null,G__91019,G__91020));
})():null);
return (logseq.shui.ui.tabs.cljs$core$IFn$_invoke$arity$4 ? logseq.shui.ui.tabs.cljs$core$IFn$_invoke$arity$4(G__91005,G__91006,G__91007,G__91008) : logseq.shui.ui.tabs.call(null,G__91005,G__91006,G__91007,G__91008));
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91004))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["page-tabs"], null)], null),attrs91004], 0))):{'className':"page-tabs"}),((cljs.core.map_QMARK_(attrs91004))?null:[daiquiri.interpreter.interpret(attrs91004)]));
...
var vec__91021 = rum.core.use_state(cljs.core.not((logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.class_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.class_QMARK_.call(null,page))));
var collapsed_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91021,(0),null);
var set_collapsed_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91021,(1),null);
return daiquiri.core.create_element("div",{'className':"ls-sidebar-page-properties flex flex-col gap-2 mt-2"},[(function (){var attrs91030 = (function (){var G__91031 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),new cljs.core.Keyword(null,"ghost","ghost",-1531157576),new cljs.core.Keyword(null,"size","size",1098693007),new cljs.core.Keyword(null,"sm","sm",-1402575065),new cljs.core.Keyword(null,"class","class",-2030961996),"px-1 text-muted-foreground",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__91033 = cljs.core.not(collapsed_QMARK_);
return (set_collapsed_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_collapsed_BANG_.cljs$core$IFn$_invoke$arity$1(G__91033) : set_collapsed_BANG_.call(null,G__91033));
})], null);
var G__91032 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-xs","span.text-xs",63518557),(cljs.core.truth_(collapsed_QMARK_)?"Open":"Hide")," properties"], null);
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__91031,G__91032) : logseq.shui.ui.button.call(null,G__91031,G__91032));
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91030))?daiquiri.interpreter.element_attributes(attrs91030):null),((cljs.core.map_QMARK_(attrs91030))?null:[daiquiri.interpreter.interpret(attrs91030)]));
...
frontend.components.page.page_inner = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__91036){
var map__91037 = p__91036;
var map__91037__$1 = cljs.core.__destructure_map(map__91037);
var option = map__91037__$1;
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"page","page",849072397));
var preview_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"preview?","preview?",590561578));
var sidebar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672));
var linked_refs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"linked-refs?","linked-refs?",-119740497));
var unlinked_refs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"unlinked-refs?","unlinked-refs?",-1047663389));
var config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91037__$1,new cljs.core.Keyword(null,"config","config",994861415));
...
var attrs91038 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((cljs.core.seq(new cljs.core.Keyword("block","tags","block/tags",1814948340).cljs$core$IFn$_invoke$arity$1(page)))?(function (){var page_names = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","title","block/title",710445684),new cljs.core.Keyword("block","tags","block/tags",1814948340).cljs$core$IFn$_invoke$arity$1(page));
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91038))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex-1","page","relative","cp__page-inner-wrap"], null)], null),attrs91038], 0))):{'className':"flex-1 page relative cp__page-inner-wrap"}),((cljs.core.map_QMARK_(attrs91038))?[(cljs.core.truth_((function (){var and__5000__auto__ = whiteboard_page_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not(sidebar_QMARK_);
} else {
return and__5000__auto__;
}
})())?(function (){var attrs91047 = (function (){var G__91050 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page);
var fexpr__91049 = frontend.state.get_component(new cljs.core.Keyword("whiteboard","tldraw-preview","whiteboard/tldraw-preview",663400157));
return (fexpr__91049.cljs$core$IFn$_invoke$arity$1 ? fexpr__91049.cljs$core$IFn$_invoke$arity$1(G__91050) : fexpr__91049.call(null,G__91050));
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91047))?daiquiri.interpreter.element_attributes(attrs91047):null),((cljs.core.map_QMARK_(attrs91047))?null:[daiquiri.interpreter.interpret(attrs91047)]));
})():(function (){var attrs91048 = (cljs.core.truth_((function (){var or__5002__auto__ = block_QMARK_;
if(or__5002__auto__){
return or__5002__auto__;
} else {
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91048))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative","grid","gap-4","sm:gap-8","page-inner"], null)], null),attrs91048], 0))):{'className':"relative grid gap-4 sm:gap-8 page-inner"}),((cljs.core.map_QMARK_(attrs91048))?[(cljs.core.truth_((function (){var and__5000__auto__ = db_based_QMARK_;
if(and__5000__auto__){
...
})())?daiquiri.core.create_element("div",{'style':{'marginLeft':(cljs.core.truth_((function (){var or__5002__auto__ = whiteboard_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return frontend.util.mobile_QMARK_();
}
})())?(0):(-20))},'className':"ls-page-blocks"},[frontend.components.page.page_blocks_cp(page,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([option,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672),sidebar_QMARK_,new cljs.core.Keyword(null,"container-id","container-id",1274665684),new cljs.core.Keyword(null,"container-id","container-id",1274665684).cljs$core$IFn$_invoke$arity$1(state),new cljs.core.Keyword(null,"whiteboard?","whiteboard?",-1968190788),whiteboard_QMARK_], null)], 0)))]):null)]:[daiquiri.interpreter.interpret(attrs91048),(cljs.core.truth_((function (){var and__5000__auto__ = db_based_QMARK_;
if(and__5000__auto__){
var and__5000__auto____$1 = sidebar_QMARK_;
if(cljs.core.truth_(and__5000__auto____$1)){
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
...
})())?(function (){var attrs91039 = (cljs.core.truth_(today_QMARK_)?frontend.components.page.today_queries(repo__$1,today_QMARK_,sidebar_QMARK_):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91039))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-1","flex","flex-col","gap-4"], null)], null),attrs91039], 0))):{'className':"ml-1 flex flex-col gap-4"}),((cljs.core.map_QMARK_(attrs91039))?[(cljs.core.truth_(today_QMARK_)?frontend.components.scheduled_deadlines.scheduled_and_deadlines(title):null),(((((!(block_QMARK_))) && ((!(db_based_QMARK_)))))?frontend.components.page.tagged_pages(repo__$1,page,title):null),(cljs.core.truth_((function (){var and__5000__auto__ = (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
if(cljs.core.truth_(and__5000__auto__)){
...
})():null)]:[daiquiri.interpreter.interpret(attrs91038),(cljs.core.truth_((function (){var and__5000__auto__ = whiteboard_page_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not(sidebar_QMARK_);
} else {
return and__5000__auto__;
}
})())?(function (){var attrs91055 = (function (){var G__91058 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page);
var fexpr__91057 = frontend.state.get_component(new cljs.core.Keyword("whiteboard","tldraw-preview","whiteboard/tldraw-preview",663400157));
return (fexpr__91057.cljs$core$IFn$_invoke$arity$1 ? fexpr__91057.cljs$core$IFn$_invoke$arity$1(G__91058) : fexpr__91057.call(null,G__91058));
})();
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91055))?daiquiri.interpreter.element_attributes(attrs91055):null),((cljs.core.map_QMARK_(attrs91055))?null:[daiquiri.interpreter.interpret(attrs91055)]));
})():(function (){var attrs91056 = (cljs.core.truth_((function (){var or__5002__auto__ = block_QMARK_;
if(or__5002__auto__){
return or__5002__auto__;
} else {
return sidebar_QMARK_;
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91056))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["relative","grid","gap-4","sm:gap-8","page-inner"], null)], null),attrs91056], 0))):{'className':"relative grid gap-4 sm:gap-8 page-inner"}),((cljs.core.map_QMARK_(attrs91056))?[(cljs.core.truth_((function (){var and__5000__auto__ = db_based_QMARK_;
if(and__5000__auto__){
var and__5000__auto____$1 = sidebar_QMARK_;
if(cljs.core.truth_(and__5000__auto____$1)){
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
...
})())?(0):(-20))},'className':"ls-page-blocks"},[frontend.components.page.page_blocks_cp(page,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([option,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672),sidebar_QMARK_,new cljs.core.Keyword(null,"container-id","container-id",1274665684),new cljs.core.Keyword(null,"container-id","container-id",1274665684).cljs$core$IFn$_invoke$arity$1(state),new cljs.core.Keyword(null,"whiteboard?","whiteboard?",-1968190788),whiteboard_QMARK_], null)], 0)))]):null)]:[daiquiri.interpreter.interpret(attrs91056),(cljs.core.truth_((function (){var and__5000__auto__ = db_based_QMARK_;
if(and__5000__auto__){
var and__5000__auto____$1 = sidebar_QMARK_;
if(cljs.core.truth_(and__5000__auto____$1)){
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
...
})())?(function (){var attrs91040 = (cljs.core.truth_(today_QMARK_)?frontend.components.page.today_queries(repo__$1,today_QMARK_,sidebar_QMARK_):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91040))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-1","flex","flex-col","gap-4"], null)], null),attrs91040], 0))):{'className':"ml-1 flex flex-col gap-4"}),((cljs.core.map_QMARK_(attrs91040))?[(cljs.core.truth_(today_QMARK_)?frontend.components.scheduled_deadlines.scheduled_and_deadlines(title):null),(((((!(block_QMARK_))) && ((!(db_based_QMARK_)))))?frontend.components.page.tagged_pages(repo__$1,page,title):null),(cljs.core.truth_((function (){var and__5000__auto__ = (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
if(cljs.core.truth_(and__5000__auto__)){
return new cljs.core.Keyword("logseq.property","_parent","logseq.property/_parent",444328035).cljs$core$IFn$_invoke$arity$1(page);
} else {
return and__5000__auto__;
...
})())?null:daiquiri.core.create_element("div",{'key':"page-unlinked-references"},[frontend.components.reference.unlinked_references(page,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672),sidebar_QMARK_], null))]))]:[daiquiri.interpreter.interpret(attrs91040),(cljs.core.truth_(today_QMARK_)?frontend.components.scheduled_deadlines.scheduled_and_deadlines(title):null),(((((!(block_QMARK_))) && ((!(db_based_QMARK_)))))?frontend.components.page.tagged_pages(repo__$1,page,title):null),(cljs.core.truth_((function (){var and__5000__auto__ = (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(page) : logseq.db.page_QMARK_.call(null,page));
if(cljs.core.truth_(and__5000__auto__)){
return new cljs.core.Keyword("logseq.property","_parent","logseq.property/_parent",444328035).cljs$core$IFn$_invoke$arity$1(page);
} else {
return and__5000__auto__;
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.reset_BANG_(_STAR_loading_QMARK_,false)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.reset_BANG_(_STAR_page,(function (){var G__91059 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_block);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__91059) : frontend.db.entity.call(null,G__91059));
...
frontend.components.page.graph_filter_section = rum.core.lazy_build(rum.core.build_defcs,(function (state,title,content,p__91060){
var map__91061 = p__91060;
var map__91061__$1 = cljs.core.__destructure_map(map__91061);
var search_filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91061__$1,new cljs.core.Keyword(null,"search-filters","search-filters",-2121899355));
...
}),'className':"w-full px-4 py-2 text-left focus:outline-none"},[(function (){var attrs91062 = title;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91062))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","items-center","justify-between"], null)], null),attrs91062], 0))):{'className':"flex items-center justify-between"}),((cljs.core.map_QMARK_(attrs91062))?[(cljs.core.truth_(cljs.core.deref(open_QMARK_))?frontend.components.svg.caret_down():frontend.components.svg.caret_right())]:[daiquiri.interpreter.interpret(attrs91062),(cljs.core.truth_(cljs.core.deref(open_QMARK_))?frontend.components.svg.caret_down():frontend.components.svg.caret_right())]));
...
var map__91070 = settings;
var map__91070__$1 = cljs.core.__destructure_map(map__91070);
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91070__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__91070__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206),true);
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91070__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
var excluded_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91070__$1,new cljs.core.Keyword(null,"excluded-pages?","excluded-pages?",1527958391));
var map__91071 = forcesettings;
var map__91071__$1 = cljs.core.__destructure_map(map__91071);
var link_dist = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91071__$1,new cljs.core.Keyword(null,"link-dist","link-dist",48179915));
var charge_strength = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91071__$1,new cljs.core.Keyword(null,"charge-strength","charge-strength",1642158883));
var charge_range = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91071__$1,new cljs.core.Keyword(null,"charge-range","charge-range",509183775));
...
})(),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"min","min",444991522),(1),new cljs.core.Keyword(null,"max","max",61366548),(10),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__91066_SHARP_){
return cljs.core.reset_BANG_(frontend.components.page._STAR_n_hops,(p1__91066_SHARP_ | (0)));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__91083),frontend$components$page$iter__91080(cljs.core.chunk_rest(s__91081__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__91083),null);
}
} else {
var q = cljs.core.first(s__91081__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.flex-row.justify-between.items-center.mb-2","div.flex.flex-row.justify-between.items-center.mb-2",14359473),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-medium","span.font-medium",1169799421),q], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a.search-filter-close.opacity-70.opacity-100","a.search-filter-close.opacity-70.opacity-100",820760152),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (q,s__91081__$2,temp__5804__auto__,map__91070,map__91070__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,excluded_pages_QMARK_,map__91071,map__91071__$1,link_dist,charge_strength,charge_range,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,excluded_pages_QMARK__SINGLEQUOTE_,link_dist_SINGLEQUOTE_,charge_strength_SINGLEQUOTE_,charge_range_SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,excluded_pages_QMARK___$1,created_at_filter,link_dist__$1,charge_strength__$1,charge_range__$1,set_setting_BANG_,set_forcesetting_BANG_,search_graph_filters,focus_nodes){
return (function (){
return frontend.state.remove_search_filter_BANG_(q);
});})(q,s__91081__$2,temp__5804__auto__,map__91070,map__91070__$1,journal_QMARK_,orphan_pages_QMARK_,builtin_pages_QMARK_,excluded_pages_QMARK_,map__91071,map__91071__$1,link_dist,charge_strength,charge_range,journal_QMARK__SINGLEQUOTE_,orphan_pages_QMARK__SINGLEQUOTE_,builtin_pages_QMARK__SINGLEQUOTE_,excluded_pages_QMARK__SINGLEQUOTE_,link_dist_SINGLEQUOTE_,charge_strength_SINGLEQUOTE_,charge_range_SINGLEQUOTE_,journal_QMARK___$1,orphan_pages_QMARK___$1,builtin_pages_QMARK___$1,excluded_pages_QMARK___$1,created_at_filter,link_dist__$1,charge_strength__$1,charge_range__$1,set_setting_BANG_,set_forcesetting_BANG_,search_graph_filters,focus_nodes))
], null),frontend.components.svg.close], null)], null),frontend$components$page$iter__91080(cljs.core.rest(s__91081__$2)));
}
} else {
return null;
}
...
var x = event.x;
var y = event.y;
var drag_QMARK_ = (!((function (){var vec__91084 = cljs.core.deref(frontend.components.page.last_node_position);
var last_node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91084,(0),null);
var last_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91084,(1),null);
var last_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91084,(2),null);
var threshold = (5);
...
var vec__91087 = rum.core.react(frontend.components.page.layout);
var width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91087,(0),null);
var height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91087,(1),null);
...
var filter_patterns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__91090_SHARP_){
return cljs.core.re_pattern(["(?i)",frontend.util.regex_escape(p1__91090_SHARP_)].join(''));
}),filters);
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (node){
return cljs.core.some((function (p1__91091_SHARP_){
return cljs.core.re_find(p1__91091_SHARP_,new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(node));
}),filter_patterns);
}),nodes);
} else {
return nodes;
...
var vec__91093 = (logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1 ? logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1(null) : logseq.shui.hooks.use_state.call(null,null));
var graph = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91093,(0),null);
var set_graph_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91093,(1),null);
logseq.shui.hooks.use_effect_BANG_((function (){
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
var graph_SINGLEQUOTE_ = cljs.core.update.cljs$core$IFn$_invoke$arity$3(graph,new cljs.core.Keyword(null,"nodes","nodes",-2099585805),(function (p1__91092_SHARP_){
return frontend.components.page.filter_graph_nodes(p1__91092_SHARP_,search_graph_filters);
}));
...
return daiquiri.core.create_element("div",{'className':"sidebar-item flex-col"},[daiquiri.core.create_element("div",{'className':"flex items-center justify-between mb-0"},[(function (){var attrs91096 = frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("right-side-bar","show-journals","right-side-bar/show-journals",-1717841874)], 0));
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs91096))?daiquiri.interpreter.element_attributes(attrs91096):null),((cljs.core.map_QMARK_(attrs91096))?null:[daiquiri.interpreter.interpret(attrs91096)]));
})(),(function (){var attrs91097 = frontend.ui.toggle.cljs$core$IFn$_invoke$arity$3(show_journals_in_page_graph_QMARK_,(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs91097))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["mt-1"], null)], null),attrs91097], 0))):{'className':"mt-1"}),((cljs.core.map_QMARK_(attrs91097))?null:[daiquiri.interpreter.interpret(attrs91097)]));
...
var vec__91098 = (logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1 ? logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1(null) : logseq.shui.hooks.use_state.call(null,null));
var graph = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91098,(0),null);
var set_graph_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91098,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__91106),frontend$components$page$batch_delete_dialog_$_iter__91103(cljs.core.chunk_rest(s__91104__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__91106),null);
}
} else {
var page = cljs.core.first(s__91104__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),reitit.frontend.easy.href.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page)], null))], null),frontend.components.block.page_cp(cljs.core.PersistentArrayMap.EMPTY,page)], null)], null),frontend$components$page$batch_delete_dialog_$_iter__91103(cljs.core.rest(s__91104__$2)));
}
} else {
return null;
}
...
var failed_pages_91116 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentVector.EMPTY);
promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
var G__91107 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page);
var G__91108 = null;
var G__91109 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(failed_pages_91116,cljs.core.conj,new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(page));
})], null);
return (frontend.handler.page._LT_delete_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.page._LT_delete_BANG_.cljs$core$IFn$_invoke$arity$3(G__91107,G__91108,G__91109) : frontend.handler.page._LT_delete_BANG_.call(null,G__91107,G__91108,G__91109));
}),pages))),(function (_){
return promesa.protocols._promise(((cljs.core.seq(cljs.core.deref(failed_pages_91116)))?frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("all-pages","failed-to-delete-pages","all-pages/failed-to-delete-pages",-1349728505),clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str,cljs.core.deref(failed_pages_91116)))], 0)),new cljs.core.Keyword(null,"warning","warning",-1685650671),false):frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$2(frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("tips","all-done","tips/all-done",-433291957)], 0)),new cljs.core.Keyword(null,"success","success",1890645906))));
}));
}));
