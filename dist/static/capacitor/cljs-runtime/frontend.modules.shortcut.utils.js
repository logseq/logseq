...
}catch (e62225){if((e62225 instanceof Error)){
var e = e62225;
...
return clojure.string.lower_case(frontend.modules.shortcut.utils.mod_key(clojure.string.replace(clojure.string.replace(binding,/[;=-\[\]'\(\)\~\→\←\⇧]/,(function (p1__62240_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(keynames,p1__62240_SHARP_);
})),/\s+/," ")));
} else {
return null;
}
