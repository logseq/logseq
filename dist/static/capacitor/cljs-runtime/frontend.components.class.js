...
frontend.components.class$.class_children_aux = (function frontend$components$class$class_children_aux(class$,p__89330){
var map__89331 = p__89330;
var map__89331__$1 = cljs.core.__destructure_map(map__89331);
var opts = map__89331__$1;
var default_collapsed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89331__$1,new cljs.core.Keyword(null,"default-collapsed?","default-collapsed?",-1350393823));
var children = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__89328_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(class$),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__89328_SHARP_));
}),new cljs.core.Keyword("logseq.property","_parent","logseq.property/_parent",444328035).cljs$core$IFn$_invoke$arity$1(class$));
if(cljs.core.seq(children)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__5480__auto__ = (function frontend$components$class$class_children_aux_$_iter__89333(s__89334){
return (new cljs.core.LazySeq(null,(function (){
var s__89334__$1 = s__89334;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__89334__$1);
if(temp__5804__auto__){
var s__89334__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__89334__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__89334__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__89336 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__89335 = (0);
while(true){
if((i__89335 < size__5479__auto__)){
var child = cljs.core._nth(c__5478__auto__,i__89335);
cljs.core.chunk_append(b__89336,(function (){var title = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.ml-2","li.ml-2",540554485),frontend.components.block.page_reference(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"show-brackets?","show-brackets?",659769842),false], null),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(child),null)], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__89336),frontend$components$class$class_children_aux_$_iter__89333(cljs.core.chunk_rest(s__89334__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__89336),null);
}
} else {
var child = cljs.core.first(s__89334__$2);
...
})(),frontend$components$class$class_children_aux_$_iter__89333(cljs.core.rest(s__89334__$2)));
}
} else {
return null;
}
