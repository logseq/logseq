...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__72166 = cljs.core.get_global_hierarchy;
return (fexpr__72166.cljs$core$IFn$_invoke$arity$0 ? fexpr__72166.cljs$core$IFn$_invoke$arity$0() : fexpr__72166.call(null));
})());
...
var page_title = (function (){var G__72226 = frontend.extensions.zotero.extractor.item_type(item);
switch (G__72226) {
case "case":
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__72231){
var map__72232 = p__72231;
var map__72232__$1 = cljs.core.__destructure_map(map__72232);
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72232__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72232__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72232__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var tags = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__72236_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__72236_SHARP_,/,\s?/);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__72239){
var map__72240 = p__72239;
var map__72240__$1 = cljs.core.__destructure_map(map__72240);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72240__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__72250){
var vec__72251 = p__72250;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72251,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72251,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__72274){
var vec__72276 = p__72274;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72276,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72276,(1),null);
...
var G__72298 = "{{zotero-imported-file %s, %s}}";
var G__72299 = item_key;
var G__72300 = cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([filename], 0));
return (frontend.util.format.cljs$core$IFn$_invoke$arity$3 ? frontend.util.format.cljs$core$IFn$_invoke$arity$3(G__72298,G__72299,G__72300) : frontend.util.format.call(null,G__72298,G__72299,G__72300));
});
...
var G__72301 = "{{zotero-linked-file %s}}";
var G__72302 = cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.replace_first(path,"attachments:","")], 0));
return (frontend.util.format.cljs$core$IFn$_invoke$arity$2 ? frontend.util.format.cljs$core$IFn$_invoke$arity$2(G__72301,G__72302) : frontend.util.format.call(null,G__72301,G__72302));
});
frontend.extensions.zotero.extractor.extract.cljs$core$IMultiFn$_add_method$arity$3(null,"attachment",(function (item){
var map__72303 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(item);
var map__72303__$1 = cljs.core.__destructure_map(map__72303);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72303__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72303__$1,new cljs.core.Keyword(null,"url","url",276297046));
var link_mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72303__$1,new cljs.core.Keyword(null,"link-mode","link-mode",-960686913));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72303__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var filename = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72303__$1,new cljs.core.Keyword(null,"filename","filename",-1428840783));
var G__72304 = link_mode;
switch (G__72304) {
case "imported_file":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__72304)].join('')));
