...
var G__64739 = state;
var G__64739__$1 = (((G__64739 == null))?null:new cljs.core.Keyword("frontend.mixins","event-handler","frontend.mixins/event-handler",1780579383).cljs$core$IFn$_invoke$arity$1(G__64739));
if((G__64739__$1 == null)){
return null;
} else {
return G__64739__$1.removeAll();
}
});
/**
...
var len__5726__auto___64780 = arguments.length;
var i__5727__auto___64781 = (0);
while(true){
if((i__5727__auto___64781 < len__5726__auto___64780)){
args__5732__auto__.push((arguments[i__5727__auto___64781]));

var G__64782 = (i__5727__auto___64781 + (1));
i__5727__auto___64781 = G__64782;
continue;
} else {
}
break;
...
(frontend.mixins.listen.cljs$core$IFn$_invoke$arity$variadic = (function (state,target,type,handler,p__64752){
var vec__64753 = p__64752;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64753,(0),null);
...
/** @this {Function} */
(frontend.mixins.listen.cljs$lang$applyTo = (function (seq64744){
var G__64745 = cljs.core.first(seq64744);
var seq64744__$1 = cljs.core.next(seq64744);
var G__64746 = cljs.core.first(seq64744__$1);
var seq64744__$2 = cljs.core.next(seq64744__$1);
var G__64747 = cljs.core.first(seq64744__$2);
var seq64744__$3 = cljs.core.next(seq64744__$2);
var G__64748 = cljs.core.first(seq64744__$3);
var seq64744__$4 = cljs.core.next(seq64744__$3);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64745,G__64746,G__64747,G__64748,seq64744__$4);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___64783 = arguments.length;
var i__5727__auto___64784 = (0);
while(true){
if((i__5727__auto___64784 < len__5726__auto___64783)){
args__5732__auto__.push((arguments[i__5727__auto___64784]));

var G__64785 = (i__5727__auto___64784 + (1));
i__5727__auto___64784 = G__64785;
continue;
} else {
}
break;
...
(frontend.mixins.hide_when_esc_or_outside.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__64764){
var map__64765 = p__64764;
var map__64765__$1 = cljs.core.__destructure_map(map__64765);
var on_hide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64765__$1,new cljs.core.Keyword(null,"on-hide","on-hide",1263105709));
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64765__$1,new cljs.core.Keyword(null,"node","node",581201198));
var visibilitychange_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64765__$1,new cljs.core.Keyword(null,"visibilitychange?","visibilitychange?",994612206));
var outside_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64765__$1,new cljs.core.Keyword(null,"outside?","outside?",-1930213908));
var opts = cljs.core.last(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
var outside_QMARK___$1 = (function (){var G__64766 = opts;
if((outside_QMARK_ == null)){
return new cljs.core.Keyword(null,"outside?","outside?",-1930213908).cljs$core$IFn$_invoke$arity$1(G__64766);
} else {
return G__64766;
}
})();
...
frontend.mixins.listen(state,window,"mousedown",click_fn_64786);
}

frontend.mixins.listen(state,window,"keydown",(function (e){
var G__64768 = e.keyCode;
switch (G__64768) {
case (27):
...
/** @this {Function} */
(frontend.mixins.hide_when_esc_or_outside.cljs$lang$applyTo = (function (seq64762){
var G__64763 = cljs.core.first(seq64762);
var seq64762__$1 = cljs.core.next(seq64762);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64763,seq64762__$1);
}));

frontend.mixins.on_enter = (function frontend$mixins$on_enter(var_args){
var args__5732__auto__ = [];
var len__5726__auto___64788 = arguments.length;
var i__5727__auto___64789 = (0);
while(true){
if((i__5727__auto___64789 < len__5726__auto___64788)){
args__5732__auto__.push((arguments[i__5727__auto___64789]));

var G__64790 = (i__5727__auto___64789 + (1));
i__5727__auto___64789 = G__64790;
continue;
} else {
}
break;
...
(frontend.mixins.on_enter.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__64771){
var map__64772 = p__64771;
var map__64772__$1 = cljs.core.__destructure_map(map__64772);
var on_enter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64772__$1,new cljs.core.Keyword(null,"on-enter","on-enter",-928988216));
var node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64772__$1,new cljs.core.Keyword(null,"node","node",581201198));
...
/** @this {Function} */
(frontend.mixins.on_enter.cljs$lang$applyTo = (function (seq64769){
var G__64770 = cljs.core.first(seq64769);
var seq64769__$1 = cljs.core.next(seq64769);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64770,seq64769__$1);
}));
...
var temp__5804__auto___64792 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(keycode_map,key_code);
if(cljs.core.truth_(temp__5804__auto___64792)){
var f_64793 = temp__5804__auto___64792;
(f_64793.cljs$core$IFn$_invoke$arity$2 ? f_64793.cljs$core$IFn$_invoke$arity$2(state,e) : f_64793.call(null,state,e));
} else {
}
...
(frontend.mixins.on_key_down.cljs$core$IFn$_invoke$arity$3 = (function (state,keycode_map,p__64776){
var map__64777 = p__64776;
var map__64777__$1 = cljs.core.__destructure_map(map__64777);
var not_matched_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64777__$1,new cljs.core.Keyword(null,"not-matched-handler","not-matched-handler",1162926887));
var all_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64777__$1,new cljs.core.Keyword(null,"all-handler","all-handler",396726950));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64777__$1,new cljs.core.Keyword(null,"target","target",253001721));
var keycode_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64777__$1,new cljs.core.Keyword(null,"keycode?","keycode?",1611892012),true);
...
var temp__5802__auto___64795 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(keycode_map,key);
if(cljs.core.truth_(temp__5802__auto___64795)){
var f_64796 = temp__5802__auto___64795;
(f_64796.cljs$core$IFn$_invoke$arity$2 ? f_64796.cljs$core$IFn$_invoke$arity$2(state,e) : f_64796.call(null,state,e));
} else {
...
var k__50701__auto__ = ["Render ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(desc)].join('');
console.time(k__50701__auto__);

var res__50702__auto__ = (render_fn.cljs$core$IFn$_invoke$arity$1 ? render_fn.cljs$core$IFn$_invoke$arity$1(state) : render_fn.call(null,state));
