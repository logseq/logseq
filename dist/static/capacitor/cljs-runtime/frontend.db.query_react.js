...
var page_ref_QMARK_ = (function (p1__64158_SHARP_){
return ((typeof p1__64158_SHARP_ === 'string') && (logseq.common.util.page_ref.page_ref_QMARK_(p1__64158_SHARP_)));
});
...
var vec__64172 = cljs.core.rest(f);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64172,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64172,(1),null);
var vec__64175 = ((page_ref_QMARK_(x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [y,x], null));
var page_ref = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64175,(0),null);
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64175,(1),null);
...
frontend.db.query_react.react_query = (function frontend$db$query_react$react_query(repo,p__64189,query_opts){
var map__64207 = p__64189;
var map__64207__$1 = cljs.core.__destructure_map(map__64207);
var query_SINGLEQUOTE_ = map__64207__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64207__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64207__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64207__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var pprint = (cljs.core.truth_(frontend.config.dev_QMARK_)?(function() { 
var G__64221__delegate = function (rest__64185_SHARP_){
if(cljs.core.truth_(frontend.state.developer_mode_QMARK_())){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.prn,rest__64185_SHARP_);
} else {
return null;
}
};
var G__64221 = function (var_args){
var rest__64185_SHARP_ = null;
if (arguments.length > 0) {
var G__64222__i = 0, G__64222__a = new Array(arguments.length -  0);
while (G__64222__i < G__64222__a.length) {G__64222__a[G__64222__i] = arguments[G__64222__i + 0]; ++G__64222__i;}
  rest__64185_SHARP_ = new cljs.core.IndexedSeq(G__64222__a,0,null);
} 
return G__64221__delegate.call(this,rest__64185_SHARP_);};
G__64221.cljs$lang$maxFixedArity = 0;
G__64221.cljs$lang$applyTo = (function (arglist__64223){
var rest__64185_SHARP_ = cljs.core.seq(arglist__64223);
return G__64221__delegate(rest__64185_SHARP_);
});
G__64221.cljs$core$IFn$_invoke$arity$variadic = G__64221__delegate;
return G__64221;
})()
:(function (_){
return null;
...
var resolved_inputs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__64186_SHARP_){
return frontend.db.query_react.resolve_input.cljs$core$IFn$_invoke$arity$3(db,p1__64186_SHARP_,resolve_with);
}),inputs);
var inputs__$1 = (function (){var G__64211 = resolved_inputs;
if(cljs.core.truth_(rules)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__64211,rules);
} else {
return G__64211;
}
})();
