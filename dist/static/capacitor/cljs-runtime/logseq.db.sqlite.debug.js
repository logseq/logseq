...
var schema = (function (){var G__135247 = db.exec(({"sql": "select content from kvs where addr = 0", "rowMode": "array"}));
var G__135247__$1 = (((G__135247 == null))?null:cljs_bean.core.__GT_clj(G__135247));
var G__135247__$2 = (((G__135247__$1 == null))?null:cljs.core.ffirst(G__135247__$1));
if((G__135247__$2 == null)){
return null;
} else {
return logseq.db.sqlite.util.transit_read(G__135247__$2);
}
})();
var result = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__135260){
var vec__135263 = p__135260;
var addr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__135263,(0),null);
var addresses = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__135263,(1),null);
...
var result = cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__135275){
var map__135279 = p__135275;
var map__135279__$1 = cljs.core.__destructure_map(map__135279);
var addr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__135279__$1,new cljs.core.Keyword(null,"addr","addr",-1597650737));
var addresses = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__135279__$1,new cljs.core.Keyword(null,"addresses","addresses",-559529694));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [addr,cljs_bean.core.__GT_clj(JSON.parse(addresses))], null);
