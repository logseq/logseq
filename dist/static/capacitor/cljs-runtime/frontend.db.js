...
if(cljs.core.truth_((function (){var or__5002__auto__ = (function (){var G__60785 = new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450).cljs$core$IFn$_invoke$arity$1(tx_meta);
var fexpr__60784 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"collapse-expand-blocks","collapse-expand-blocks",-868833367),null,new cljs.core.Keyword(null,"save-block","save-block",591532560),null], null), null);
return (fexpr__60784.cljs$core$IFn$_invoke$arity$1 ? fexpr__60784.cljs$core$IFn$_invoke$arity$1(G__60785) : fexpr__60784.call(null,G__60785));
})();
...
var _STAR_outliner_ops_STAR__orig_val__60786 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__60787 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__60787);
...
return logseq.outliner.op.apply_ops_BANG_(frontend.state.get_current_repo(),frontend.db.conn.get_db.cljs$core$IFn$_invoke$arity$1(false),r__60296__auto__,frontend.state.get_date_formatter(),tx_meta);
} else {
return null;
}
} else {
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__60786);
}}
}
}));
