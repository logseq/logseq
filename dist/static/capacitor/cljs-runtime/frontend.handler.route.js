 ...
 */
frontend.handler.route.redirect_BANG_ = (function frontend$handler$route$redirect_BANG_(p__64798){
var map__64799 = p__64798;
var map__64799__$1 = cljs.core.__destructure_map(map__64799);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64799__$1,new cljs.core.Keyword(null,"to","to",192099007));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64799__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64799__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
var push = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64799__$1,new cljs.core.Keyword(null,"push","push",799791267),true);
...
var route_fn_64825 = (cljs.core.truth_(push)?reitit.frontend.easy.push_state:reitit.frontend.easy.replace_state);
(route_fn_64825.cljs$core$IFn$_invoke$arity$3 ? route_fn_64825.cljs$core$IFn$_invoke$arity$3(to,path_params,query_params) : route_fn_64825.call(null,to,path_params,query_params));
...
(frontend.handler.route.redirect_to_page_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (page_name,p__64806){
var map__64807 = p__64806;
var map__64807__$1 = cljs.core.__destructure_map(map__64807);
var opts = map__64807__$1;
var anchor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64807__$1,new cljs.core.Keyword(null,"anchor","anchor",1549638489));
var push = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64807__$1,new cljs.core.Keyword(null,"push","push",799791267));
var click_from_recent_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64807__$1,new cljs.core.Keyword(null,"click-from-recent?","click-from-recent?",-1191845464),false);
var block_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64807__$1,new cljs.core.Keyword(null,"block-id","block-id",-70582834));
var new_whiteboard_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64807__$1,new cljs.core.Keyword(null,"new-whiteboard?","new-whiteboard?",-360865129));
var ignore_alias_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64807__$1,new cljs.core.Keyword(null,"ignore-alias?","ignore-alias?",1336725364));
...
if(and__5000__auto__){
var G__64812 = frontend.state.get_current_repo();
var G__64813 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.get_alias_source_page.cljs$core$IFn$_invoke$arity$2 ? frontend.db.get_alias_source_page.cljs$core$IFn$_invoke$arity$2(G__64812,G__64813) : frontend.db.get_alias_source_page.call(null,G__64812,G__64813));
} else {
return and__5000__auto__;
}
})();
...
var temp__5804__auto___64828 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
if(cljs.core.truth_(temp__5804__auto___64828)){
var db_id_64829 = temp__5804__auto___64828;
frontend.handler.recent.add_page_to_recent_BANG_(db_id_64829,click_from_recent_QMARK_);
} else {
}
...
var m = (function (){var G__64814 = frontend.handler.route.default_page_route(cljs.core.str.cljs$core$IFn$_invoke$arity$1(page_name));
var G__64814__$1 = (cljs.core.truth_(block_id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64814,new cljs.core.Keyword(null,"query-params","query-params",900640534),(cljs.core.truth_(whiteboard_QMARK_)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"block-id","block-id",-70582834),block_id], null):new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"anchor","anchor",1549638489),["ls-block-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_id)].join('')], null))):G__64814);
var G__64814__$2 = (cljs.core.truth_(anchor)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64814__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"anchor","anchor",1549638489),anchor], null)):G__64814__$1);
if(cljs.core.boolean_QMARK_(push)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64814__$2,new cljs.core.Keyword(null,"push","push",799791267),push);
} else {
return G__64814__$2;
}
})();
...
})())?(function (){var temp__5804__auto__ = (function (){var G__64819 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.uuid(name__$1)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__64819) : frontend.db.entity.call(null,G__64819));
})();
...
var map__64820 = route;
var map__64820__$1 = cljs.core.__destructure_map(map__64820);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64820__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var path_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64820__$1,new cljs.core.Keyword(null,"path-params","path-params",-48130597));
...
var map__64821 = route;
var map__64821__$1 = cljs.core.__destructure_map(map__64821);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64821__$1,new cljs.core.Keyword(null,"data","data",-232669377));
...
return frontend.state.sidebar_add_block_BANG_(frontend.state.get_current_repo(),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((function (){var G__64824 = frontend.date.today();
return (frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(G__64824) : frontend.db.get_page.call(null,G__64824));
...
var route_64832 = ((frontend.state.custom_home_page_QMARK_())?new cljs.core.Keyword(null,"all-journals","all-journals",-347015095):new cljs.core.Keyword(null,"home","home",-74557309));
frontend.handler.route.redirect_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"to","to",192099007),route_64832], null));
