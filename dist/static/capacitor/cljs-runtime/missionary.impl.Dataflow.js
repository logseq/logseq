...
var self__ = this;
var self__ = this;
var G__57581 = (arguments.length - (1));
switch (G__57581) {
case (1):
...
(missionary.impl.Dataflow.Port.prototype.apply = (function (self__,args57580){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57580)));
}));
...
var _BANG_ = (function (p1__57578_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__57578_SHARP_) : s_BANG_.call(null,p1__57578_SHARP_));
});
...
var G__57606 = (new missionary.Cancelled("Dataflow variable dereference cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__57606) : f_BANG_.call(null,G__57606));
} else {
return null;
}
}
