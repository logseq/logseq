...
var G__45819 = executor;
var G__45819__$1 = (((G__45819 instanceof cljs.core.Keyword))?G__45819.fqn:null);
switch (G__45819__$1) {
case "default":
return cljs.core.deref(promesa.exec.default_executor);
...
*/
promesa.exec.t_promesa$exec45836 = (function (meta45837){
this.meta45837 = meta45837;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec45836.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45838,meta45837__$1){
var self__ = this;
var _45838__$1 = this;
return (new promesa.exec.t_promesa$exec45836(meta45837__$1));
}));

(promesa.exec.t_promesa$exec45836.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45838){
var self__ = this;
var _45838__$1 = this;
return self__.meta45837;
}));

(promesa.exec.t_promesa$exec45836.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec45836.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{(f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));

return null;
}catch (e45839){var _ = e45839;
return null;
}}));

(promesa.exec.t_promesa$exec45836.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(promesa.exec.noop,f));
}catch (e45840){var cause = e45840;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec45836.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
try{return promesa.protocols._promise((f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null)));
}catch (e45841){var cause = e45841;
return promesa.protocols._promise(cause);
}}));

(promesa.exec.t_promesa$exec45836.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta45837","meta45837",1742365872,null)], null);
}));

(promesa.exec.t_promesa$exec45836.cljs$lang$type = true);

(promesa.exec.t_promesa$exec45836.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec45836");

(promesa.exec.t_promesa$exec45836.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"promesa.exec/t_promesa$exec45836");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec45836.
 */
promesa.exec.__GT_t_promesa$exec45836 = (function promesa$exec$__GT_t_promesa$exec45836(meta45837){
return (new promesa.exec.t_promesa$exec45836(meta45837));
});
...
return (new promesa.exec.t_promesa$exec45836(cljs.core.PersistentArrayMap.EMPTY));
});
 ...
 * @implements {cljs.core.IWithMeta}
*/
promesa.exec.t_promesa$exec45842 = (function (meta45843){
this.meta45843 = meta45843;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(promesa.exec.t_promesa$exec45842.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45844,meta45843__$1){
var self__ = this;
var _45844__$1 = this;
return (new promesa.exec.t_promesa$exec45842(meta45843__$1));
}));

(promesa.exec.t_promesa$exec45842.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45844){
var self__ = this;
var _45844__$1 = this;
return self__.meta45843;
}));

(promesa.exec.t_promesa$exec45842.prototype.promesa$protocols$IExecutor$ = cljs.core.PROTOCOL_SENTINEL);

(promesa.exec.t_promesa$exec45842.prototype.promesa$protocols$IExecutor$_exec_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.impl.promise.nextTick(f);
}));

(promesa.exec.t_promesa$exec45842.prototype.promesa$protocols$IExecutor$_run_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
return promesa.protocols._fmap(promesa.protocols._fmap(promesa.protocols._promise(null),(function (_){
try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}catch (e45846){var ___$1 = e45846;
return null;
}})),promesa.exec.noop);
}));

(promesa.exec.t_promesa$exec45842.prototype.promesa$protocols$IExecutor$_submit_BANG_$arity$2 = (function (this$,f){
var self__ = this;
var this$__$1 = this;
...
(promesa.exec.t_promesa$exec45842.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta45843","meta45843",-551011841,null)], null);
}));

(promesa.exec.t_promesa$exec45842.cljs$lang$type = true);

(promesa.exec.t_promesa$exec45842.cljs$lang$ctorStr = "promesa.exec/t_promesa$exec45842");

(promesa.exec.t_promesa$exec45842.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"promesa.exec/t_promesa$exec45842");
}));

/**
 * Positional factory function for promesa.exec/t_promesa$exec45842.
 */
promesa.exec.__GT_t_promesa$exec45842 = (function promesa$exec$__GT_t_promesa$exec45842(meta45843){
return (new promesa.exec.t_promesa$exec45842(meta45843));
});
...
return (new promesa.exec.t_promesa$exec45842(cljs.core.PersistentArrayMap.EMPTY));
});
...
var len__5726__auto___45878 = arguments.length;
var i__5727__auto___45879 = (0);
while(true){
if((i__5727__auto___45879 < len__5726__auto___45878)){
args__5732__auto__.push((arguments[i__5727__auto___45879]));

var G__45880 = (i__5727__auto___45879 + (1));
i__5727__auto___45879 = G__45880;
continue;
} else {
}
break;
...
(promesa.exec.scheduled_executor.cljs$core$IFn$_invoke$arity$variadic = (function (p__45857){
var map__45858 = p__45857;
var map__45858__$1 = cljs.core.__destructure_map(map__45858);
var parallelism = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45858__$1,new cljs.core.Keyword(null,"parallelism","parallelism",-930922333),(1));
var factory = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45858__$1,new cljs.core.Keyword(null,"factory","factory",63933746));
...
/** @this {Function} */
(promesa.exec.scheduled_executor.cljs$lang$applyTo = (function (seq45855){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45855));
}));
