...
(frontend.search.browser.Browser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k62745,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__62753 = k62745;
var G__62753__$1 = (((G__62753 instanceof cljs.core.Keyword))?G__62753.fqn:null);
switch (G__62753__$1) {
case "repo":
return self__.repo;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k62745,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__62755){
var vec__62756 = p__62755;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62756,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62756,(1),null);
...
(frontend.search.browser.Browser.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__62744){
var self__ = this;
var G__62744__$1 = this;
return (new cljs.core.RecordIter((0),G__62744__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"repo","repo",-1999060679)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.search.browser.Browser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this62747,other62748){
var self__ = this;
var this62747__$1 = this;
return (((!((other62748 == null)))) && ((((this62747__$1.constructor === other62748.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this62747__$1.repo,other62748.repo)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this62747__$1.__extmap,other62748.__extmap)))))));
}));
...
(frontend.search.browser.Browser.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k62745){
var self__ = this;
var this__5307__auto____$1 = this;
var G__62767 = k62745;
var G__62767__$1 = (((G__62767 instanceof cljs.core.Keyword))?G__62767.fqn:null);
switch (G__62767__$1) {
case "repo":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k62745);

}
}));

(frontend.search.browser.Browser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__62744){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__62770 = cljs.core.keyword_identical_QMARK_;
var expr__62771 = k__5309__auto__;
if(cljs.core.truth_((pred__62770.cljs$core$IFn$_invoke$arity$2 ? pred__62770.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"repo","repo",-1999060679),expr__62771) : pred__62770.call(null,new cljs.core.Keyword(null,"repo","repo",-1999060679),expr__62771)))){
return (new frontend.search.browser.Browser(G__62744,self__.__meta,self__.__extmap,null));
} else {
return (new frontend.search.browser.Browser(self__.repo,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__62744),null));
}
}));
...
(frontend.search.browser.Browser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__62744){
var self__ = this;
var this__5299__auto____$1 = this;
return (new frontend.search.browser.Browser(self__.repo,G__62744,self__.__extmap,self__.__hash));
}));
...
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(file_based_QMARK_)?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62743_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__62743_SHARP_,new cljs.core.Keyword(null,"content","content",15833224),(function (content){
return frontend.handler.file_based.property.util.remove_built_in_properties(cljs.core.get.cljs$core$IFn$_invoke$arity$3(p1__62743_SHARP_,new cljs.core.Keyword(null,"format","format",-1306924766),new cljs.core.Keyword(null,"markdown","markdown",1227225089)),content);
}));
...
(frontend.search.browser.Browser.prototype.frontend$search$protocol$Engine$transact_blocks_BANG_$arity$2 = (function (_this,p__62778){
var self__ = this;
var map__62779 = p__62778;
var map__62779__$1 = cljs.core.__destructure_map(map__62779);
var blocks_to_remove_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62779__$1,new cljs.core.Keyword(null,"blocks-to-remove-set","blocks-to-remove-set",266406009));
var blocks_to_add = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62779__$1,new cljs.core.Keyword(null,"blocks-to-add","blocks-to-add",-814061792));
var _this__$1 = this;
 ...
 */
frontend.search.browser.map__GT_Browser = (function frontend$search$browser$map__GT_Browser(G__62750){
var extmap__5342__auto__ = (function (){var G__62782 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__62750,new cljs.core.Keyword(null,"repo","repo",-1999060679));
if(cljs.core.record_QMARK_(G__62750)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__62782);
} else {
return G__62782;
}
})();
return (new frontend.search.browser.Browser(new cljs.core.Keyword(null,"repo","repo",-1999060679).cljs$core$IFn$_invoke$arity$1(G__62750),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
