...
var entity = (function (){var or__5002__auto__ = (function (){var G__69799 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(b)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__69799) : frontend.db.entity.call(null,G__69799));
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
}catch (e69797){var e = e69797;
return cljs.core.reset_BANG_(_STAR_query_error,e);
}});
frontend.components.query.result.get_group_by_page = (function frontend$components$query$result$get_group_by_page(p__69800,p__69801){
var map__69802 = p__69800;
var map__69802__$1 = cljs.core.__destructure_map(map__69802);
var query_m = map__69802__$1;
var result_transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69802__$1,new cljs.core.Keyword(null,"result-transform","result-transform",1904908186));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69802__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var map__69803 = p__69801;
var map__69803__$1 = cljs.core.__destructure_map(map__69803);
var table_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69803__$1,new cljs.core.Keyword(null,"table?","table?",-1064705406));
var db_graph_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69803__$1,new cljs.core.Keyword(null,"db-graph?","db-graph?",-533494876));
 ...
 */
frontend.components.query.result.transform_query_result = (function frontend$components$query$result$transform_query_result(p__69804,query_m,query_result){
var map__69805 = p__69804;
var map__69805__$1 = cljs.core.__destructure_map(map__69805);
var config = map__69805__$1;
var current_block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69805__$1,new cljs.core.Keyword(null,"current-block-uuid","current-block-uuid",-559721957));
...
return (frontend.modules.outliner.tree.filter_top_level_blocks.cljs$core$IFn$_invoke$arity$1 ? frontend.modules.outliner.tree.filter_top_level_blocks.cljs$core$IFn$_invoke$arity$1(G__69806) : frontend.modules.outliner.tree.filter_top_level_blocks.call(null,G__69806));
} else {
return G__69806;
}
} else {
...
var temp__5804__auto___69818 = new cljs.core.Keyword(null,"query-result","query-result",-833644142).cljs$core$IFn$_invoke$arity$1(config);
if(cljs.core.truth_(temp__5804__auto___69818)){
var query_result_69819__$1 = temp__5804__auto___69818;
cljs.core.reset_BANG_(query_result_69819__$1,result);
} else {
}
