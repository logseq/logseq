...
var line = cur.line;
var pos = cur.ch;
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__95217_SHARP_){
return cm.getLineTokens(p1__95217_SHARP_);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.range.cljs$core$IFn$_invoke$arity$1(line)], 0)),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__95218_SHARP_){
return (p1__95218_SHARP_.end <= pos);
...
return (function (p1__95219_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"vector","vector",1902966158),null,new cljs.core.Keyword(null,"list","list",765357683),null], null), null),p1__95219_SHARP_);
...
var G__95267 = next_state;
var G__95268 = cljs.core.rest(tokens__$1);
state = G__95267;
tokens__$1 = G__95268;
continue;
}
...
var map__95220 = frontend.extensions.code.tokens__GT_doc_state(tokens);
var map__95220__$1 = cljs.core.__destructure_map(map__95220);
var current_config_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95220__$1,new cljs.core.Keyword(null,"current-config-path","current-config-path",387759454));
var state_stack = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95220__$1,new cljs.core.Keyword(null,"state-stack","state-stack",489104326));
...
var G__95221 = type;
var G__95221__$1 = (((G__95221 instanceof cljs.core.Keyword))?G__95221.fqn:null);
switch (G__95221__$1) {
case "string":
return "\"\"";
...
var G__95222 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),malli.core.type.cljs$core$IFn$_invoke$arity$1(schema)], null);
var G__95222__$1 = ((cljs.core.seq(properties__$1))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__95222,new cljs.core.Keyword(null,"properties","properties",685819552),properties__$1):G__95222);
if(cljs.core.seq(children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__95222__$1,new cljs.core.Keyword(null,"children","children",-940561982),children);
} else {
return G__95222__$1;
}
});
frontend.extensions.code.malli_to_map_syntax = (function frontend$extensions$code$malli_to_map_syntax(var_args){
var G__95224 = arguments.length;
switch (G__95224) {
case 1:
...
var vec__95225 = frontend.extensions.code.doc_state_at_cursor(cm);
var config_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95225,(0),null);
var doc_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95225,(1),null);
...
var schema_path_95271 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.str,properties);
if(cljs.core.empty_QMARK_(schema_path_95271)){
} else {
if(cljs.core.empty_QMARK_(config_path)){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(result,cljs.core.assoc,cljs.core.first(schema_path_95271),malli.core.type.cljs$core$IFn$_invoke$arity$1(schema));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(config_path),(1))){
if(clojure.string.starts_with_QMARK_(cljs.core.first(schema_path_95271),cljs.core.first(config_path))){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(result,cljs.core.assoc,cljs.core.first(schema_path_95271),malli.core.type.cljs$core$IFn$_invoke$arity$1(schema));
} else {
}
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(config_path),(2))){
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(schema_path_95271),(2))) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(schema_path_95271),cljs.core.first(config_path))) && (clojure.string.starts_with_QMARK_(cljs.core.second(schema_path_95271),cljs.core.second(config_path))))))){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(result,cljs.core.assoc,cljs.core.second(schema_path_95271),malli.core.type.cljs$core$IFn$_invoke$arity$1(schema));
} else {
}
} else {
}
...
var G__95228_95272 = malli.core.type.cljs$core$IFn$_invoke$arity$1(schema);
var G__95228_95273__$1 = (((G__95228_95272 instanceof cljs.core.Keyword))?G__95228_95272.fqn:null);
switch (G__95228_95273__$1) {
case "boolean":
...
break;
case "enum":
var map__95229_95275 = frontend.extensions.code.malli_to_map_syntax.cljs$core$IFn$_invoke$arity$1(schema);
var map__95229_95276__$1 = cljs.core.__destructure_map(map__95229_95275);
var children_95277 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95229_95276__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var seq__95230_95278 = cljs.core.seq(children_95277);
var chunk__95231_95279 = null;
var count__95232_95280 = (0);
var i__95233_95281 = (0);
while(true){
if((i__95233_95281 < count__95232_95280)){
var child_95282 = chunk__95231_95279.cljs$core$IIndexed$_nth$arity$2(null,i__95233_95281);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(result,cljs.core.assoc,cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_95282),null);


var G__95283 = seq__95230_95278;
var G__95284 = chunk__95231_95279;
var G__95285 = count__95232_95280;
var G__95286 = (i__95233_95281 + (1));
seq__95230_95278 = G__95283;
chunk__95231_95279 = G__95284;
count__95232_95280 = G__95285;
i__95233_95281 = G__95286;
continue;
} else {
var temp__5804__auto___95287 = cljs.core.seq(seq__95230_95278);
if(temp__5804__auto___95287){
var seq__95230_95288__$1 = temp__5804__auto___95287;
if(cljs.core.chunked_seq_QMARK_(seq__95230_95288__$1)){
var c__5525__auto___95289 = cljs.core.chunk_first(seq__95230_95288__$1);
var G__95290 = cljs.core.chunk_rest(seq__95230_95288__$1);
var G__95291 = c__5525__auto___95289;
var G__95292 = cljs.core.count(c__5525__auto___95289);
var G__95293 = (0);
seq__95230_95278 = G__95290;
chunk__95231_95279 = G__95291;
count__95232_95280 = G__95292;
i__95233_95281 = G__95293;
continue;
} else {
var child_95294 = cljs.core.first(seq__95230_95288__$1);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(result,cljs.core.assoc,cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_95294),null);


var G__95295 = cljs.core.next(seq__95230_95288__$1);
var G__95296 = null;
var G__95297 = (0);
var G__95298 = (0);
seq__95230_95278 = G__95295;
chunk__95231_95279 = G__95296;
count__95232_95280 = G__95297;
i__95233_95281 = G__95298;
continue;
}
} else {
}
...
var find_fn_name = (function (){var G__95236 = by;
var G__95236__$1 = (((G__95236 instanceof cljs.core.Keyword))?G__95236.fqn:null);
switch (G__95236__$1) {
case "name":
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.code.save_code_editor_BANG_()),(function (___40947__auto__){
...
var block__$1 = (function (){var G__95237 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__95237) : frontend.db.entity.call(null,G__95237));
})();
frontend.state.set_state_BANG_(new cljs.core.Keyword("editor","raw-mode-block","editor/raw-mode-block",-1788505944),block__$1);

var G__95238 = block__$1;
var G__95239 = new cljs.core.Keyword(null,"max","max",61366548);
var G__95240 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"save-code-editor?","save-code-editor?",-419078411),false], null);
return (frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(G__95238,G__95239,G__95240) : frontend.handler.editor.edit_block_BANG_.call(null,G__95238,G__95239,G__95240));
} else {
return null;
}
})());
...
var vec__95241 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var config = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(1),null);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(2),null);
var _code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(3),null);
var theme = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(4),null);
var user_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95241,(5),null);
...
var cm_options = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([default_cm_options,(function (){var G__95244 = frontend.extensions.code.extra_codemirror_options();
if(config_file_QMARK_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__95244,new cljs.core.Keyword(null,"readOnly","readOnly",-1749118317));
} else {
return G__95244;
}
...
var editor = (cljs.core.truth_(textarea)?(function (){var G__95245 = textarea;
var G__95246 = cljs.core.clj__GT_js(cm_options);
return (frontend.extensions.code.from_textarea.cljs$core$IFn$_invoke$arity$2 ? frontend.extensions.code.from_textarea.cljs$core$IFn$_invoke$arity$2(G__95245,G__95246) : frontend.extensions.code.from_textarea.call(null,G__95245,G__95246));
})():null);
...
var textarea_ref_95301 = rum.core.ref_node(state,frontend.extensions.code.textarea_ref_name);
var element_95302 = editor.getWrapperElement();
var _STAR_cursor_prev_95303 = cljs.core.volatile_BANG_(null);
var _STAR_cursor_curr_95304 = cljs.core.volatile_BANG_(null);
var update_cursor_state_BANG__95305 = (function (){
...
if(cljs.core.not(cljs.core.deref(_STAR_cursor_prev_95303))){
cljs.core.vreset_BANG_(_STAR_cursor_prev_95303,range);
} else {
cljs.core.vreset_BANG_(_STAR_cursor_prev_95303,cljs.core.deref(_STAR_cursor_curr_95304));
}

return cljs.core.vreset_BANG_(_STAR_cursor_curr_95304,range);
});
frontend.extensions.code.goog$module$goog$object.set(textarea_ref_95301,frontend.extensions.code.codemirror_ref_name,editor);
...
cljs.core.vreset_BANG_(_STAR_cursor_curr_95304,null);

return cljs.core.vreset_BANG_(_STAR_cursor_prev_95303,null);
}));
...
var G__95247_95306 = (function (){var or__5002__auto__ = code_block;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return edit_block;
...
var G__95248_95307 = new cljs.core.Keyword(null,"max","max",61366548);
var G__95249_95308 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"container-id","container-id",1274665684),new cljs.core.Keyword(null,"container-id","container-id",1274665684).cljs$core$IFn$_invoke$arity$1(config)], null);
(frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(G__95247_95306,G__95248_95307,G__95249_95308) : frontend.handler.editor.edit_block_BANG_.call(null,G__95247_95306,G__95248_95307,G__95249_95308));
} else {
}
...
editor.on("cursorActivity",update_cursor_state_BANG__95305);

element_95302.addEventListener("keydown",(function (e){
var key_code = e.code;
...
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_cursor_prev_95303),cljs.core.deref(_STAR_cursor_curr_95304));
if(and__5000__auto__){
var or__5002__auto__ = (function (){var and__5000__auto____$1 = direction;
if(cljs.core.truth_(and__5000__auto____$1)){
return (cljs.core.deref(_STAR_cursor_curr_95304) == null);
} else {
return and__5000__auto____$1;
}
})();
...
var G__95250 = direction;
var G__95250__$1 = (((G__95250 instanceof cljs.core.Keyword))?G__95250.fqn:null);
switch (G__95250__$1) {
case "left":
return (((new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))) === (0))) && ((new cljs.core.Keyword(null,"ch","ch",-554717905).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))) === (0))));

break;
case "right":
var line = (function (){var temp__5804__auto__ = new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"end","end",-268185958).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304)));
if(cljs.core.truth_(temp__5804__auto__)){
...
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"end","end",-268185958).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))),editor.lastLine())) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"ch","ch",-554717905).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"end","end",-268185958).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))),cljs.core.count(line))));
...
return update_cursor_state_BANG__95305();
} else {
...
var G__95251 = direction;
var G__95251__$1 = (((G__95251 instanceof cljs.core.Keyword))?G__95251.fqn:null);
switch (G__95251__$1) {
case "up":
return (((new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))) === (0))) && ((new cljs.core.Keyword(null,"ch","ch",-554717905).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_cursor_curr_95304))) === (0))));
...
var G__95253 = key_code;
switch (G__95253) {
case "Enter":
frontend.util.stop(e);

var temp__5804__auto__ = (function (){var G__95254 = e.target;
var G__95254__$1 = (((G__95254 == null))?null:G__95254.closest("[blockid]"));
if((G__95254__$1 == null)){
return null;
} else {
return G__95254__$1.getAttribute("blockid");
}
})();
if(cljs.core.truth_(temp__5804__auto__)){
...
return (frontend.util.schedule.cljs$core$IFn$_invoke$arity$1 ? frontend.util.schedule.cljs$core$IFn$_invoke$arity$1(G__95255) : frontend.util.schedule.call(null,G__95255));
} else {
return null;
}
...
element_95302.addEventListener("pointerdown",(function (e){
e.stopPropagation();

return frontend.state.clear_selection_BANG_();
}));

element_95302.addEventListener("touchstart",(function (e){
...
var attrs95256 = (function (){var temp__5804__auto__ = new cljs.core.Keyword(null,"data-lang","data-lang",969460304).cljs$core$IFn$_invoke$arity$1(attr);
if(cljs.core.truth_(temp__5804__auto__)){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs95256))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["extensions__code","flex","flex-1"], null)], null),attrs95256], 0))):{'className':"extensions__code flex flex-1"}),((cljs.core.map_QMARK_(attrs95256))?[daiquiri.core.create_element("div",{'className':"code-editor flex flex-1 flex-row w-full"},[(function (){var attrs95257 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"ref","ref",1289896967),frontend.extensions.code.textarea_ref_name,new cljs.core.Keyword(null,"default-value","default-value",232220170),code], null),attr], 0));
return daiquiri.core.create_element("textarea",((cljs.core.map_QMARK_(attrs95257))?daiquiri.interpreter.element_attributes(attrs95257):null),((cljs.core.map_QMARK_(attrs95257))?null:[daiquiri.interpreter.interpret(attrs95257)]));
})(),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"data-lang","data-lang",969460304).cljs$core$IFn$_invoke$arity$1(attr),"calc"))?frontend.extensions.calc.results(new cljs.core.Keyword(null,"calc-atom","calc-atom",202304533).cljs$core$IFn$_invoke$arity$1(state)):null)])]:[daiquiri.interpreter.interpret(attrs95256),daiquiri.core.create_element("div",{'className':"code-editor flex flex-1 flex-row w-full"},[(function (){var attrs95258 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"ref","ref",1289896967),frontend.extensions.code.textarea_ref_name,new cljs.core.Keyword(null,"default-value","default-value",232220170),code], null),attr], 0));
return daiquiri.core.create_element("textarea",((cljs.core.map_QMARK_(attrs95258))?daiquiri.interpreter.element_attributes(attrs95258):null),((cljs.core.map_QMARK_(attrs95258))?null:[daiquiri.interpreter.interpret(attrs95258)]));
...
var vec__95259 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(1),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(2),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(3),null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(4),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95259,(5),null);
...
var next_theme_95313 = frontend.extensions.code.get_theme_BANG_();
var last_theme_95314 = cljs.core.deref(new cljs.core.Keyword(null,"last-theme","last-theme",-1086226741).cljs$core$IFn$_invoke$arity$1(state));
var editor_SINGLEQUOTE__95315 = (function (){var G__95262 = state;
var G__95262__$1 = (((G__95262 == null))?null:new cljs.core.Keyword(null,"editor-atom","editor-atom",1409591060).cljs$core$IFn$_invoke$arity$1(G__95262));
if((G__95262__$1 == null)){
return null;
} else {
return cljs.core.deref(G__95262__$1);
}
})();
if(cljs.core.truth_((function (){var and__5000__auto__ = editor_SINGLEQUOTE__95315;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(next_theme_95313,last_theme_95314);
} else {
return and__5000__auto__;
}
})())){
cljs.core.reset_BANG_(new cljs.core.Keyword(null,"last-theme","last-theme",-1086226741).cljs$core$IFn$_invoke$arity$1(state),next_theme_95313);

editor_SINGLEQUOTE__95315.setOption("theme",next_theme_95313);
} else {
}
...
var code_95316 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state),(3));
var editor_SINGLEQUOTE__95317 = cljs.core.deref(new cljs.core.Keyword(null,"editor-atom","editor-atom",1409591060).cljs$core$IFn$_invoke$arity$1(state));
if(cljs.core.truth_((function (){var and__5000__auto__ = editor_SINGLEQUOTE__95317;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(editor_SINGLEQUOTE__95317.getValue(),code_95316);
} else {
return and__5000__auto__;
}
})())){
editor_SINGLEQUOTE__95317.setValue(code_95316);
} else {
}
}
...
frontend.commands.handle_step.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("codemirror","focus","codemirror/focus",-19393885),(function (p__95263){
var vec__95264 = p__95263;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95264,(0),null);
