...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__62670){
var vec__62671 = p__62670;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62671,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62671,(1),null);
if(cljs.core.set_QMARK_(v)){
return null;
} else {
var prop_val = (function (){var G__62674 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(v);
var G__62674__$1 = (((G__62674 == null))?null:(datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(db,G__62674) : datascript.core.entity.call(null,db,G__62674)));
if((G__62674__$1 == null)){
return null;
} else {
return logseq.db.frontend.property.property_value_content(G__62674__$1);
}
})();
...
var vals = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62675_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__62675_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","properties","block/properties",708347145),f], null));
}),result);
...
var query_result_SINGLEQUOTE_ = ((frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(repo))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62692_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("block","properties","block/properties",708347145)],[frontend.components.block.macros.properties_by_name(db,p1__62692_SHARP_)]);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62691_SHARP_){
var G__62694 = db;
var G__62695 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__62691_SHARP_);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__62694,G__62695) : datascript.core.entity.call(null,G__62694,G__62695));
