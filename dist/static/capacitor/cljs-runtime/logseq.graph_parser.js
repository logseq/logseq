...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__68857){
var map__68858 = p__68857;
var map__68858__$1 = cljs.core.__destructure_map(map__68858);
var uuid_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68858__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68858__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.ffirst((function (){var G__68863 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?page","?page",-1343187612,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?path","?path",385070032,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?file","?file",-1121006094,null),new cljs.core.Keyword("file","path","file/path",-191335748),new cljs.core.Symbol(null,"?path","?path",385070032,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?page","?page",-1343187612,null),new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.Symbol(null,"?file","?file",-1121006094,null)], null)], null);
var G__68864 = db;
var G__68865 = file_path;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__68863,G__68864,G__68865) : datascript.core.q.call(null,G__68863,G__68864,G__68865));
})());
});
/**
...
(logseq.graph_parser.parse_file.cljs$core$IFn$_invoke$arity$4 = (function (conn,file_path,content,p__68895){
var map__68896 = p__68895;
var map__68896__$1 = cljs.core.__destructure_map(map__68896);
var options = map__68896__$1;
var delete_blocks_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__68896__$1,new cljs.core.Keyword(null,"delete-blocks-fn","delete-blocks-fn",586451366),cljs.core.constantly(cljs.core.PersistentVector.EMPTY));
var extract_options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68896__$1,new cljs.core.Keyword(null,"extract-options","extract-options",-572164844));
var ctime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68896__$1,new cljs.core.Keyword(null,"ctime","ctime",1459030131));
var mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68896__$1,new cljs.core.Keyword(null,"mtime","mtime",963165087));
...
var map__68904 = (function (){var extract_options_SINGLEQUOTE_ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"block-pattern","block-pattern",297259959),logseq.common.config.get_block_pattern(format),new cljs.core.Keyword(null,"date-formatter","date-formatter",-223324709),"MMM do, yyyy",new cljs.core.Keyword(null,"uri-encoded?","uri-encoded?",663370134),false,new cljs.core.Keyword(null,"filename-format","filename-format",-1193264412),new cljs.core.Keyword(null,"legacy","legacy",1434943289)], null),extract_options,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.deref(conn)], null)], 0));
var map__68910 = ((cljs.core.contains_QMARK_(logseq.common.config.mldoc_support_formats,format))?logseq.graph_parser.extract.extract(file_path,content,extract_options_SINGLEQUOTE_):(cljs.core.truth_(logseq.common.config.whiteboard_QMARK_(file_path))?logseq.graph_parser.extract.extract_whiteboard_edn(file_path,content,extract_options_SINGLEQUOTE_):null
));
var map__68910__$1 = cljs.core.__destructure_map(map__68910);
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__68910__$1,new cljs.core.Keyword(null,"pages","pages",-285406513),cljs.core.PersistentVector.EMPTY);
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__68910__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153),cljs.core.PersistentVector.EMPTY);
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__68910__$1,new cljs.core.Keyword(null,"ast","ast",-860334068),cljs.core.PersistentVector.EMPTY);
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68910__$1,new cljs.core.Keyword(null,"refs","refs",-1560051448));
...
var delete_blocks = (function (){var G__68921 = cljs.core.first(pages);
var G__68923 = file_path;
var G__68925 = block_ids;
return (delete_blocks_fn.cljs$core$IFn$_invoke$arity$3 ? delete_blocks_fn.cljs$core$IFn$_invoke$arity$3(G__68921,G__68923,G__68925) : delete_blocks_fn.call(null,G__68921,G__68923,G__68925));
})();
...
var pages_index = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__68884_SHARP_){
return cljs.core.select_keys(p1__68884_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","name","block/name",1619760316)], null));
}),pages__$1);
...
var tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68904__$1,new cljs.core.Keyword(null,"tx","tx",466630418));
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68904__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var file_entity = (function (){var G__68944 = cljs.core.deref(conn);
var G__68945 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","path","file/path",-191335748),file_path], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__68944,G__68945) : datascript.core.entity.call(null,G__68944,G__68945));
})();
var tx__$1 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(tx,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__68948 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("file","path","file/path",-191335748),file_path,new cljs.core.Keyword("file","content","file/content",12680964),content], null);
var G__68948__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = ctime;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return (file_entity == null);
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68948,new cljs.core.Keyword("file","created-at","file/created-at",-92397056),(function (){var or__5002__auto__ = ctime;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return (new Date());
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__68948__$1,new cljs.core.Keyword("file","last-modified-at","file/last-modified-at",473527310),mtime);
} else {
return G__68948__$1;
}
})()], null));
...
var map__68957 = cljs.core.group_by((function (file){
...
var journals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68957__$1,true);
var non_journals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68957__$1,false);
var map__68958 = cljs.core.group_by((function (file){
...
var built_in = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68958__$1,true);
var others = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68958__$1,false);
