...
frontend.components.file_based.query.query_refresh_button = rum.core.lazy_build(rum.core.build_defc,(function (query_time,p__70133){
var map__70134 = p__70133;
var map__70134__$1 = cljs.core.__destructure_map(map__70134);
var on_pointer_down = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70134__$1,new cljs.core.Keyword(null,"on-pointer-down","on-pointer-down",573334138));
var full_text_search_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70134__$1,new cljs.core.Keyword(null,"full-text-search?","full-text-search?",-1837750206));
...
frontend.components.file_based.query.custom_query_header = rum.core.lazy_build(rum.core.build_defc,(function (p__70138,p__70139,p__70140){
var map__70141 = p__70138;
var map__70141__$1 = cljs.core.__destructure_map(map__70141);
var config = map__70141__$1;
var dsl_query_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70141__$1,new cljs.core.Keyword(null,"dsl-query?","dsl-query?",-1061528662));
var map__70142 = p__70139;
var map__70142__$1 = cljs.core.__destructure_map(map__70142);
var q = map__70142__$1;
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70142__$1,new cljs.core.Keyword(null,"title","title",636505583));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70142__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var map__70143 = p__70140;
var map__70143__$1 = cljs.core.__destructure_map(map__70143);
var collapsed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"collapsed?","collapsed?",-1661420674));
var _STAR_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"*result","*result",-1157548516));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var table_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"table?","table?",-1064705406));
var current_block = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"current-block","current-block",1027687970));
var view_f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"view-f","view-f",314082005));
var page_list_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"page-list?","page-list?",-466504566));
var query_error_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70143__$1,new cljs.core.Keyword(null,"query-error-atom","query-error-atom",-2138638607));
...
return daiquiri.core.create_element("div",{'title':["Query: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(query)].join(''),'className':"th"},[(cljs.core.truth_(dsl_query_QMARK_)?(function (){var attrs70180 = frontend.ui.icon("search",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"size","size",1098693007),(14)], null));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70180))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-1","flex-row"], null)], null),attrs70180], 0))):{'className':"flex flex-1 flex-row"}),((cljs.core.map_QMARK_(attrs70180))?[daiquiri.core.create_element("div",{'className':"ml-1"},[["Live query",(cljs.core.truth_(dsl_page_query_QMARK_)?" for pages":null)].join('')])]:[daiquiri.interpreter.interpret(attrs70180),daiquiri.core.create_element("div",{'className':"ml-1"},[["Live query",(cljs.core.truth_(dsl_page_query_QMARK_)?" for pages":null)].join('')])]));
})():daiquiri.core.create_element("div",{'style':{'fontSize':"initial"}},[daiquiri.interpreter.interpret(title)])),((((cljs.core.not(dsl_query_QMARK_)) || (cljs.core.not(collapsed_QMARK_))))?(function (){var attrs70151 = (((cljs.core.count(result) > (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.results-count.pl-2","span.results-count.pl-2",47815345),(function (){var result_count = ((((cljs.core.not(table_QMARK_)) && (cljs.core.map_QMARK_(result))))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.count,cljs.core.val),result)):cljs.core.count(result));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(result_count),(((result_count > (1)))?" results":" result")].join('');
})()], null):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70151))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center","fade-in"], null)], null),attrs70151], 0))):{'className':"flex flex-row items-center fade-in"}),((cljs.core.map_QMARK_(attrs70151))?[(cljs.core.truth_((function (){var and__5000__auto__ = current_block;
if(cljs.core.truth_(and__5000__auto__)){
...
}),'className':"flex ml-1 fade-link"},[daiquiri.interpreter.interpret(frontend.ui.icon("settings",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(20)], null)], null)))]),(function (){var attrs70156 = (cljs.core.truth_((function (){var or__5002__auto__ = full_text_search_QMARK_;
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70156))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-1"], null)], null),attrs70156], 0))):{'className':"ml-1"}),((cljs.core.map_QMARK_(attrs70156))?null:[daiquiri.interpreter.interpret(attrs70156)]));
})()]:[daiquiri.interpreter.interpret(attrs70151),(cljs.core.truth_((function (){var and__5000__auto__ = current_block;
if(cljs.core.truth_(and__5000__auto__)){
return ((cljs.core.not(view_f)) && (cljs.core.not(page_list_QMARK_)));
} else {
return and__5000__auto__;
...
var all_keys = frontend.components.file_based.query_table.get_all_columns_for_result(result,page_list_QMARK_);
return frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("modal","set-query-properties","modal/set-query-properties",-724632293),current_block,all_keys], null));
}),'className':"flex ml-1 fade-link"},[daiquiri.interpreter.interpret(frontend.ui.icon("settings",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(20)], null)], null)))]),(function (){var attrs70176 = (cljs.core.truth_((function (){var or__5002__auto__ = full_text_search_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var and__5000__auto__ = query_time;
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs70176))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-1"], null)], null),attrs70176], 0))):{'className':"ml-1"}),((cljs.core.map_QMARK_(attrs70176))?null:[daiquiri.interpreter.interpret(attrs70176)]));
})()]));
})():null)]);
