...
var G__129994 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__129994)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__129994)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__129994)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__129994)].join('')));
...
var G__130223 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__130224 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__130223;
v = G__130224;
continue;
} else {
var G__130225 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__130226 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__130225;
v = G__130226;
continue;
}
...
break;
case "\"":
var G__130233 = cljs.core.next(sq);
var G__130234 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__130233;
v = G__130234;
continue;
...
break;
default:
var G__130235 = cljs.core.next(sq);
var G__130236 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__130235;
v = G__130236;
continue;
...
while(true){
var G__130049 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__130049__$1 = (((G__130049 instanceof cljs.core.Keyword))?G__130049.fqn:null);
switch (G__130049__$1) {
case "rule":
var vec__130050 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130050,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130050,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__130053 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__130053) : instaparse.cfg.content.call(null,G__130053));
...
break;
case "paren":
var G__130244 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__130244;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__130056 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130056) : instaparse.cfg.build_rule.call(null,G__130056));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__130057 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130057) : instaparse.cfg.build_rule.call(null,G__130057));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__130058 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130058) : instaparse.cfg.build_rule.call(null,G__130058));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__130059 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130059) : instaparse.cfg.build_rule.call(null,G__130059));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__130064 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130064) : instaparse.cfg.build_rule.call(null,G__130064));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__130065 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__130065) : instaparse.cfg.build_rule.call(null,G__130065));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__130049__$1)].join('')));
...
while(true){
var G__130072 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__130072__$1 = (((G__130072 instanceof cljs.core.Keyword))?G__130072.fqn:null);
switch (G__130072__$1) {
case "nt":
...
case "neg":
case "rep":
var G__130247 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__130247;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__130072__$1)].join('')));
...
var valid_nts_130249 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__130076_130250 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__130077_130251 = null;
var count__130078_130252 = (0);
var i__130079_130253 = (0);
while(true){
if((i__130079_130253 < count__130078_130252)){
var nt_130254 = chunk__130077_130251.cljs$core$IIndexed$_nth$arity$2(null,i__130079_130253);
if(cljs.core.truth_((valid_nts_130249.cljs$core$IFn$_invoke$arity$1 ? valid_nts_130249.cljs$core$IFn$_invoke$arity$1(nt_130254) : valid_nts_130249.call(null,nt_130254)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_130254),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__130255 = seq__130076_130250;
var G__130256 = chunk__130077_130251;
var G__130257 = count__130078_130252;
var G__130258 = (i__130079_130253 + (1));
seq__130076_130250 = G__130255;
chunk__130077_130251 = G__130256;
count__130078_130252 = G__130257;
i__130079_130253 = G__130258;
continue;
} else {
var temp__5804__auto___130263 = cljs.core.seq(seq__130076_130250);
if(temp__5804__auto___130263){
var seq__130076_130264__$1 = temp__5804__auto___130263;
if(cljs.core.chunked_seq_QMARK_(seq__130076_130264__$1)){
var c__5525__auto___130265 = cljs.core.chunk_first(seq__130076_130264__$1);
var G__130266 = cljs.core.chunk_rest(seq__130076_130264__$1);
var G__130267 = c__5525__auto___130265;
var G__130268 = cljs.core.count(c__5525__auto___130265);
var G__130269 = (0);
seq__130076_130250 = G__130266;
chunk__130077_130251 = G__130267;
count__130078_130252 = G__130268;
i__130079_130253 = G__130269;
continue;
} else {
var nt_130274 = cljs.core.first(seq__130076_130264__$1);
if(cljs.core.truth_((valid_nts_130249.cljs$core$IFn$_invoke$arity$1 ? valid_nts_130249.cljs$core$IFn$_invoke$arity$1(nt_130274) : valid_nts_130249.call(null,nt_130274)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_130274),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__130275 = cljs.core.next(seq__130076_130264__$1);
var G__130276 = null;
var G__130277 = (0);
var G__130278 = (0);
seq__130076_130250 = G__130275;
chunk__130077_130251 = G__130276;
count__130078_130252 = G__130277;
i__130079_130253 = G__130278;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__130093_130283 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__130094_130284 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__130095_130285 = true;
var _STAR_print_fn_STAR__temp_val__130096_130286 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__130095_130285);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__130096_130286);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__130094_130284);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__130093_130283);
}
...
var len__5726__auto___130299 = arguments.length;
var i__5727__auto___130300 = (0);
while(true){
if((i__5727__auto___130300 < len__5726__auto___130299)){
args__5732__auto__.push((arguments[i__5727__auto___130300]));

var G__130301 = (i__5727__auto___130300 + (1));
i__5727__auto___130300 = G__130301;
continue;
} else {
}
break;
...
return instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5733__auto__);
});

(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__130167){
var map__130168 = p__130167;
var map__130168__$1 = cljs.core.__destructure_map(map__130168);
var opts = map__130168__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__130170 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__130171 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__130171);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5647__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__130205_130302 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__130206_130303 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__130207_130304 = true;
var _STAR_print_fn_STAR__temp_val__130208_130305 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__130207_130304);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__130208_130305);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__130206_130303);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__130205_130302);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__130170);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq130144){
var G__130145 = cljs.core.first(seq130144);
var seq130144__$1 = cljs.core.next(seq130144);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__130145,seq130144__$1);
}));
