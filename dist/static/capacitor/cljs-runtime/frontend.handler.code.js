...
var map__91425 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(frontend.state.state),new cljs.core.Keyword("editor","code-block-context","editor/code-block-context",-1384305346));
var map__91425__$1 = cljs.core.__destructure_map(map__91425);
var config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91425__$1,new cljs.core.Keyword(null,"config","config",994861415));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91425__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var editor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91425__$1,new cljs.core.Keyword(null,"editor","editor",-989377770));
...
var block__$1 = (function (){var G__91427 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(config)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__91427) : frontend.db.entity.call(null,G__91427));
})();
var content = new cljs.core.Keyword("block","raw-title","block/raw-title",1833669090).cljs$core$IFn$_invoke$arity$1(block__$1);
var map__91426 = new cljs.core.Keyword(null,"pos_meta","pos_meta",1041099485).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(new cljs.core.Keyword(null,"code-options","code-options",1113362965).cljs$core$IFn$_invoke$arity$1(state)));
var map__91426__$1 = cljs.core.__destructure_map(map__91426);
var start_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91426__$1,new cljs.core.Keyword(null,"start_pos","start_pos",272375959));
var end_pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91426__$1,new cljs.core.Keyword(null,"end_pos","end_pos",-1418940));
