 ...
 */
logseq.db.frontend.property.build.build_closed_value_block = (function logseq$db$frontend$property$build$build_closed_value_block(block_uuid,block_type,block_value,property,p__61380){
var map__61381 = p__61380;
var map__61381__$1 = cljs.core.__destructure_map(map__61381);
var db_ident = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61381__$1,new cljs.core.Keyword(null,"db-ident","db-ident",-992686073));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61381__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
var G__61387 = logseq.db.frontend.property.build.closed_value_new_block(block_uuid,block_type,block_value,property);
var G__61387__$1 = (cljs.core.truth_((function (){var and__5000__auto__ = db_ident;
if(cljs.core.truth_(and__5000__auto__)){
return (db_ident instanceof cljs.core.Keyword);
} else {
return and__5000__auto__;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61387,new cljs.core.Keyword("db","ident","db/ident",-737096),db_ident):G__61387);
var G__61387__$2 = (cljs.core.truth_(icon)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61387__$1,new cljs.core.Keyword("logseq.property","icon","logseq.property/icon",589123285),icon):G__61387__$1);
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__61387__$2) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__61387__$2));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61405){
var map__61406 = p__61405;
var map__61406__$1 = cljs.core.__destructure_map(map__61406);
var uuid_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"uuid","uuid",-2145095719));
var db_ident = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"db-ident","db-ident",-992686073));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"value","value",305978217));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61406__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var G__61409 = logseq.db.frontend.property.build.build_closed_value_block(uuid_SINGLEQUOTE_,new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(schema),value,property,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db-ident","db-ident",-992686073),db_ident,new cljs.core.Keyword(null,"icon","icon",1679606541),icon], null));
var G__61409__$1 = ((cljs.core.seq(properties))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__61409,properties], 0)):G__61409);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61409__$1,new cljs.core.Keyword("block","order","block/order",-1429282437),logseq.db.common.order.gen_key.cljs$core$IFn$_invoke$arity$0());
 ...
 */
logseq.db.frontend.property.build.build_closed_values = (function logseq$db$frontend$property$build$build_closed_values(db_ident,prop_name,property,p__61421){
var map__61425 = p__61421;
var map__61425__$1 = cljs.core.__destructure_map(map__61425);
var property_attributes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61425__$1,new cljs.core.Keyword(null,"property-attributes","property-attributes",-1673390672));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61425__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var len__5726__auto___61734 = arguments.length;
var i__5727__auto___61735 = (0);
while(true){
if((i__5727__auto___61735 < len__5726__auto___61734)){
args__5732__auto__.push((arguments[i__5727__auto___61735]));

var G__61737 = (i__5727__auto___61735 + (1));
i__5727__auto___61735 = G__61737;
continue;
} else {
}
break;
...
(logseq.db.frontend.property.build.build_property_value_block.cljs$core$IFn$_invoke$arity$variadic = (function (block,property,value,p__61513){
var map__61514 = p__61513;
var map__61514__$1 = cljs.core.__destructure_map(map__61514);
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61514__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61514__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var G__61526 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),(function (){var or__5002__auto__ = block_uuid;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var G__61526__$1 = logseq.common.util.block_with_timestamps(G__61526)
;
if(cljs.core.truth_(properties)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__61526__$1,properties], 0));
} else {
return G__61526__$1;
}
}));
...
/** @this {Function} */
(logseq.db.frontend.property.build.build_property_value_block.cljs$lang$applyTo = (function (seq61466){
var G__61467 = cljs.core.first(seq61466);
var seq61466__$1 = cljs.core.next(seq61466);
var G__61468 = cljs.core.first(seq61466__$1);
var seq61466__$2 = cljs.core.next(seq61466__$1);
var G__61469 = cljs.core.first(seq61466__$2);
var seq61466__$3 = cljs.core.next(seq61466__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61467,G__61468,G__61469,seq61466__$3);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___61757 = arguments.length;
var i__5727__auto___61758 = (0);
while(true){
if((i__5727__auto___61758 < len__5726__auto___61757)){
args__5732__auto__.push((arguments[i__5727__auto___61758]));

var G__61761 = (i__5727__auto___61758 + (1));
i__5727__auto___61758 = G__61761;
continue;
} else {
}
break;
...
(logseq.db.frontend.property.build.build_property_values_tx_m.cljs$core$IFn$_invoke$arity$variadic = (function (block,properties,p__61605){
var map__61606 = p__61605;
var map__61606__$1 = cljs.core.__destructure_map(map__61606);
var pure_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61606__$1,new cljs.core.Keyword(null,"pure?","pure?",350862691));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__61621){
var vec__61622 = p__61621;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(1),null);
var map__61628 = ((cljs.core.map_QMARK_(k))?k:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","ident","db/ident",-737096),k], null));
var map__61628__$1 = cljs.core.__destructure_map(map__61628);
var property_map = map__61628__$1;
var property_value_properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61628__$1,new cljs.core.Keyword(null,"property-value-properties","property-value-properties",339042228));
...
})(),((cljs.core.set_QMARK_(v))?cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61567_SHARP_){
return logseq.db.frontend.property.build.build_property_value_block.cljs$core$IFn$_invoke$arity$variadic(block_SINGLEQUOTE_,property_map,p1__61567_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__61657 = cljs.core.PersistentArrayMap.EMPTY;
var G__61657__$1 = (cljs.core.truth_(property_value_properties)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61657,new cljs.core.Keyword(null,"properties","properties",685819552),property_value_properties):G__61657);
if(cljs.core.truth_(pure_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61657__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"builtin-block-uuid","builtin-block-uuid",-652923992),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(gen_uuid_value_prefix),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__61567_SHARP_)].join('')));
} else {
return G__61657__$1;
}
})()], 0));
}),v)):logseq.db.frontend.property.build.build_property_value_block.cljs$core$IFn$_invoke$arity$variadic(block_SINGLEQUOTE_,property_map,v,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__61665 = cljs.core.PersistentArrayMap.EMPTY;
var G__61665__$1 = (cljs.core.truth_(property_value_properties)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61665,new cljs.core.Keyword(null,"properties","properties",685819552),property_value_properties):G__61665);
if(cljs.core.truth_(pure_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61665__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"builtin-block-uuid","builtin-block-uuid",-652923992),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(gen_uuid_value_prefix),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v)].join('')));
} else {
return G__61665__$1;
}
})()], 0)))], null);
...
/** @this {Function} */
(logseq.db.frontend.property.build.build_property_values_tx_m.cljs$lang$applyTo = (function (seq61577){
...
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61578,G__61579,seq61577__$2);
}));
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61673_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(p1__61673_SHARP_)],null));
}),v));
} else {
