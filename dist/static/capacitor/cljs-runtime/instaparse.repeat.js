...
var G__129996 = arguments.length;
switch (G__129996) {
case 1:
...
var vec__129997 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__129997,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__129997,(1),null);
...
var vec__130000 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130000,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130000,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__130004 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130004,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130004,(1),null);
...
var G__130215 = cljs.core.next(parses__$1);
parses__$1 = G__130215;
continue;
}
...
var G__130008 = arguments.length;
switch (G__130008) {
case 5:
...
var G__130012 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__130013 = G__130012;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130013,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130013,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130013,(2),null);
var selection = vec__130013;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__130012__$1 = G__130012;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__130021 = G__130012__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130021,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130021,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130021,(2),null);
var selection__$1 = vec__130021;
...
var G__130217 = cljs.core.long$(end__$1);
var G__130218 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__130219 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__130217;
parses__$1 = G__130218;
G__130012__$1 = G__130219;
continue;
...
var G__130027 = arguments.length;
switch (G__130027) {
case 5:
...
var G__130037 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__130038 = G__130037;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130038,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130038,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130038,(2),null);
var selection = vec__130038;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__130037__$1 = G__130037;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__130045 = G__130037__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130045,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130045,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130045,(2),null);
var selection__$1 = vec__130045;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__130229 = cljs.core.long$(end__$1);
var G__130231 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__130232 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__130229;
parses__$1 = G__130231;
G__130037__$1 = G__130232;
continue;
...
var G__130055 = arguments.length;
switch (G__130055) {
case 4:
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__130063 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__130066 = G__130063;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130066,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130066,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130066,(2),null);
var selection = vec__130066;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__130063__$1 = G__130063;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__130073 = G__130063__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130073,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130073,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__130073,(2),null);
var selection__$1 = vec__130073;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__130240 = cljs.core.long$(end__$1);
var G__130241 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__130242 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__130240;
parses__$1 = G__130241;
G__130063__$1 = G__130242;
continue;
...
var G__130081 = arguments.length;
switch (G__130081) {
case 4:
...
if(cljs.core.truth_((function (){var fexpr__130184 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__130184.cljs$core$IFn$_invoke$arity$1 ? fexpr__130184.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__130184.call(null,output_format));
})())){
} else {
...
var G__130195 = output_format;
var G__130195__$1 = (((G__130195 instanceof cljs.core.Keyword))?G__130195.fqn:null);
switch (G__130195__$1) {
case "enlive":
...
var and__5000__auto____$1 = (function (){var G__130199 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__130198 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__130198.cljs$core$IFn$_invoke$arity$1 ? fexpr__130198.cljs$core$IFn$_invoke$arity$1(G__130199) : fexpr__130198.call(null,G__130199));
})();
