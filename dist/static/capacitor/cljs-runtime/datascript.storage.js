...
var datascript$storage$IStorage$_store$dyn_50062 = (function (_,addr_PLUS_data_seq,delete_addrs){
...
return datascript$storage$IStorage$_store$dyn_50062(_,addr_PLUS_data_seq,delete_addrs);
}
});

var datascript$storage$IStorage$_restore$dyn_50075 = (function (_,addr){
var x__5350__auto__ = (((_ == null))?null:_);
...
return datascript$storage$IStorage$_restore$dyn_50075(_,addr);
}
});
...
(datascript.storage.StorageAdapter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k49836,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49836,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__49856){
var vec__49858 = p__49856;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49858,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49858,(1),null);
...
(datascript.storage.StorageAdapter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49835){
var self__ = this;
var G__49835__$1 = this;
return (new cljs.core.RecordIter((0),G__49835__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"storage","storage",1867247511)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(datascript.storage.StorageAdapter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49837,other49838){
var self__ = this;
var this49837__$1 = this;
return (((!((other49838 == null)))) && ((((this49837__$1.constructor === other49838.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49837__$1.storage,other49838.storage)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49837__$1.__extmap,other49838.__extmap)))))));
}));
...
(datascript.storage.StorageAdapter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k49836){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k49836);

}
}));

(datascript.storage.StorageAdapter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__49835){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__49898 = cljs.core.keyword_identical_QMARK_;
var expr__49899 = k__5309__auto__;
if(cljs.core.truth_((pred__49898.cljs$core$IFn$_invoke$arity$2 ? pred__49898.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"storage","storage",1867247511),expr__49899) : pred__49898.call(null,new cljs.core.Keyword(null,"storage","storage",1867247511),expr__49899)))){
return (new datascript.storage.StorageAdapter(G__49835,self__.__meta,self__.__extmap,null));
} else {
return (new datascript.storage.StorageAdapter(self__.storage,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__49835),null));
}
}));
...
(datascript.storage.StorageAdapter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__49835){
var self__ = this;
var this__5299__auto____$1 = this;
return (new datascript.storage.StorageAdapter(self__.storage,G__49835,self__.__extmap,self__.__hash));
}));
...
var data = (function (){var G__49933 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"keys","keys",1068423698),keys], null);
if((node instanceof me.tonsky.persistent_sorted_set.Node)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49933,new cljs.core.Keyword(null,"addresses","addresses",-559529694),node._addresses);
} else {
return G__49933;
}
})();
...
var map__49946 = datascript.storage._restore(self__.storage,addr);
var map__49946__$1 = cljs.core.__destructure_map(map__49946);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49946__$1,new cljs.core.Keyword(null,"keys","keys",1068423698));
var addresses = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49946__$1,new cljs.core.Keyword(null,"addresses","addresses",-559529694));
if(cljs.core.truth_(keys)){
var keys_SINGLEQUOTE_ = me.tonsky.persistent_sorted_set.arrays.into_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__49948){
var vec__49949 = p__49948;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49949,(0),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49949,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49949,(2),null);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49949,(3),null);
 ...
 */
datascript.storage.map__GT_StorageAdapter = (function datascript$storage$map__GT_StorageAdapter(G__49839){
var extmap__5342__auto__ = (function (){var G__49959 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49839,new cljs.core.Keyword(null,"storage","storage",1867247511));
if(cljs.core.record_QMARK_(G__49839)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49959);
} else {
return G__49959;
}
})();
return (new datascript.storage.StorageAdapter(new cljs.core.Keyword(null,"storage","storage",1867247511).cljs$core$IFn$_invoke$arity$1(G__49839),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
var _STAR_store_buffer_STAR__orig_val__49970 = datascript.storage._STAR_store_buffer_STAR_;
var _STAR_store_buffer_STAR__temp_val__49971 = cljs.core.volatile_BANG_(cljs.core.transient$(cljs.core.PersistentVector.EMPTY));
(datascript.storage._STAR_store_buffer_STAR_ = _STAR_store_buffer_STAR__temp_val__49971);
...
var storage_50126 = new cljs.core.Keyword(null,"storage","storage",1867247511).cljs$core$IFn$_invoke$arity$1(adapter);
var delete_addrs_50127 = cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(datascript.storage._STAR_delete_buffer),storage_50126));
var __50128 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(datascript.storage._STAR_delete_buffer,cljs.core.assoc,storage_50126,null);
datascript.storage._store(storage_50126,cljs.core.persistent_BANG_(cljs.core.deref(datascript.storage._STAR_store_buffer_STAR_)),delete_addrs_50127);
} else {
}

return db;
}finally {(datascript.storage._STAR_store_buffer_STAR_ = _STAR_store_buffer_STAR__orig_val__49970);
}});
...
return datascript.storage._store(datascript.storage.storage(db),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [datascript.storage.tail_addr,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49996_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(datascript.storage.serializable_datom,p1__49996_SHARP_);
}),tail)], null)], null),null);
});
...
var avet_metadata = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"avet-metadata","avet-metadata",1556019837));
var eavt_metadata = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"eavt-metadata","eavt-metadata",-1384819842));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var max_tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"max-tx","max-tx",1119558339));
var aevt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"aevt","aevt",-585148059));
var max_addr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"max-addr","max-addr",1373100454));
var avet = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"avet","avet",1383857032));
var max_eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"max-eid","max-eid",2134868075));
var eavt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"eavt","eavt",-666437073));
var aevt_metadata = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50004__$1,new cljs.core.Keyword(null,"aevt-metadata","aevt-metadata",-1844063817));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [db,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50003_SHARP_){
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__50009){
var vec__50010 = p__50009;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50010,(0),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50010,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50010,(2),null);
var tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50010,(3),null);
...
var vec__50020 = datascript.storage.restore_impl(storage,opts);
var db = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50020,(0),null);
var tail = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50020,(1),null);
