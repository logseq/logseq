...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.assets.get_asset_path(filename)),(function (_image_path){
return promesa.protocols._mcat(promesa.protocols._promise(photo.base64String),(function (base64string){
return promesa.protocols._mcat(promesa.protocols._promise((new File([(frontend.util.base64string_to_unit8array.cljs$core$IFn$_invoke$arity$1 ? frontend.util.base64string_to_unit8array.cljs$core$IFn$_invoke$arity$1(base64string) : frontend.util.base64string_to_unit8array.call(null,base64string))],filename,({"type": "image/jpeg"})))),(function (file){
return promesa.protocols._promise(file);
}));
}));
}));
}));
...
frontend.mobile.camera.embed_photo = (function frontend$mobile$camera$embed_photo(_id){
var id = frontend.state.get_edit_input_id();
var block = frontend.state.get_edit_block();
var input = frontend.state.get_input();
var _content = frontend.mobile.camera.goog$module$goog$object.get(input,"value");
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.mobile.camera.take_or_choose_photo()),(function (file){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.editor.upload_asset_BANG_(id,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [file], null),format,frontend.handler.editor._STAR_asset_uploading_QMARK_,true)),(function (_ret){
