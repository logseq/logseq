...
var len__5726__auto___90860 = arguments.length;
var i__5727__auto___90861 = (0);
while(true){
if((i__5727__auto___90861 < len__5726__auto___90860)){
args__5732__auto__.push((arguments[i__5727__auto___90861]));

var G__90862 = (i__5727__auto___90861 + (1));
i__5727__auto___90861 = G__90862;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq90806){
var G__90807 = cljs.core.first(seq90806);
var seq90806__$1 = cljs.core.next(seq90806);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__90807,seq90806__$1);
}));
...
var G__90863 = null;
var G__90863__1 = (function (msg){
return (new Error(msg));
});
var G__90863__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__90863__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__90863 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__90863__1.call(this,msg);
case 2:
return G__90863__2.call(this,msg,filename);
case 3:
return G__90863__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__90863.cljs$core$IFn$_invoke$arity$1 = G__90863__1;
G__90863.cljs$core$IFn$_invoke$arity$2 = G__90863__2;
G__90863.cljs$core$IFn$_invoke$arity$3 = G__90863__3;
return G__90863;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__90814_SHARP_){
return (new cljs.core.Delay(p1__90814_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__90815_SHARP_){
return (new goog.string.StringBuffer(p1__90815_SHARP_));
})], null)], null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__90830 = temp__5802__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90830,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90830,(1),null);
var G__90869 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__90870 = cljs.core.rest(kvs);
class__GT_opts = G__90869;
kvs = G__90870;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__90840){
var map__90841 = p__90840;
var map__90841__$1 = cljs.core.__destructure_map(map__90841);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90841__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var map__90849 = opts;
var map__90849__$1 = cljs.core.__destructure_map(map__90849);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90849__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
