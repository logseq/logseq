...
var i_37434 = (0);
while(true){
if((i_37434 < arr.length)){
(arr[i_37434] = null);

var G__37435 = (i_37434 + (1));
i_37434 = G__37435;
continue;
} else {
}
...
var i_37457 = (self__.level + (1));
while(true){
if((i_37457 <= (new_level + (1)))){
(update[i_37457] = self__.header);

var G__37458 = (i_37457 + (1));
i_37457 = G__37458;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_37460 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_37460[i]));
} else {
x__$2.forward.push((((i < links_37460.length))?(links_37460[i]):null));
}

if((i < links_37460.length)){
(links_37460[i] = x__$2);
} else {
links_37460.push(x__$2);
}
...
var i_37468 = (0);
while(true){
if((i_37468 <= self__.level)){
var links_37470 = (update[i_37468]).forward;
if((x__$1 === (((i_37468 < links_37470.length))?(links_37470[i_37468]):null))){
(links_37470[i_37468] = (x__$1.forward[i_37468]));

var G__37472 = (i_37468 + (1));
i_37468 = G__37472;
continue;
} else {
var G__37474 = (i_37468 + (1));
i_37468 = G__37474;
continue;
}
} else {
...
var G__37483 = nx;
var G__37484 = (level__$1 - (1));
x = G__37483;
level__$1 = G__37484;
continue;
} else {
var G__37485 = x;
var G__37486 = (level__$1 - (1));
x = G__37485;
level__$1 = G__37486;
continue;
}
