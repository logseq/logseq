...
return logseq.db.frontend.property.build.build_property_values_tx_m.cljs$core$IFn$_invoke$arity$variadic(new_block,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__61885){
var vec__61893 = p__61885;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61893,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61893,(1),null);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__61957){
var vec__61969 = p__61957;
var db_ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61969,(0),null);
var map__61972 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61969,(1),null);
var map__61972__$1 = cljs.core.__destructure_map(map__61972);
var attribute = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61972__$1,new cljs.core.Keyword(null,"attribute","attribute",-2074029119));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61972__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61972__$1,new cljs.core.Keyword(null,"title","title",636505583));
var closed_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61972__$1,new cljs.core.Keyword(null,"closed-values","closed-values",364658811));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61972__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var property = first__61989;
var others = seq__61988__$1;
var pvalue_tx_m = logseq.db.sqlite.create_graph.__GT_property_value_tx_m(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([property,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("build","properties-ref-types","build/properties-ref-types",-1991321370),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"entity","entity",-450970276),new cljs.core.Keyword(null,"number","number",1570378438)], null)], null)], 0)),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__62009){
var vec__62010 = p__62009;
var _k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62010,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62010,(1),null);
return (((v instanceof cljs.core.Keyword)) && (logseq.db.frontend.malli_schema.internal_ident_QMARK_(v)));
}),properties)));
var tx = (function (){var G__62016 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [property], null);
var G__62016__$1 = ((cljs.core.seq(others))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__62016,others):G__62016);
var G__62016__$2 = ((cljs.core.seq(pvalue_tx_m))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__62016__$1,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__61942_SHARP_){
if(cljs.core.set_QMARK_(p1__61942_SHARP_)){
return p1__61942_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__61942_SHARP_], null);
}
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(pvalue_tx_m)], 0))):G__62016__$1);
if(cljs.core.seq(properties)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__62016__$2,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(property)], null),properties,logseq.db.frontend.property.build.build_properties_with_ref_values(pvalue_tx_m)], 0)));
} else {
return G__62016__$2;
}
})();
...
var bootstrap_properties_tx = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62041_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__62041_SHARP_,bootstrap_idents);
}),bootstrap_properties),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__62042_SHARP_){
return cljs.core.select_keys(p1__62042_SHARP_,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)], null),bootstrap_idents));
...
var seq__62088_62301 = cljs.core.seq(tx);
var chunk__62089_62302 = null;
var count__62090_62303 = (0);
var i__62091_62304 = (0);
while(true){
if((i__62091_62304 < count__62090_62303)){
var m_62305 = chunk__62089_62302.cljs$core$IIndexed$_nth$arity$2(null,i__62091_62304);
var temp__5804__auto___62306 = (function (){var and__5000__auto__ = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(m_62305);
if(cljs.core.truth_(and__5000__auto__)){
return new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(m_62305);
} else {
return and__5000__auto__;
}
})();
if(cljs.core.truth_(temp__5804__auto___62306)){
var block_uuid_62310 = temp__5804__auto___62306;
if(clojure.string.starts_with_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_uuid_62310),"00000002")){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m_62305),"\n","(string/starts-with? (str block-uuid) \"00000002\")"].join('')));
}
} else {
}


var G__62311 = seq__62088_62301;
var G__62312 = chunk__62089_62302;
var G__62313 = count__62090_62303;
var G__62314 = (i__62091_62304 + (1));
seq__62088_62301 = G__62311;
chunk__62089_62302 = G__62312;
count__62090_62303 = G__62313;
i__62091_62304 = G__62314;
continue;
} else {
var temp__5804__auto___62316 = cljs.core.seq(seq__62088_62301);
if(temp__5804__auto___62316){
var seq__62088_62318__$1 = temp__5804__auto___62316;
if(cljs.core.chunked_seq_QMARK_(seq__62088_62318__$1)){
var c__5525__auto___62322 = cljs.core.chunk_first(seq__62088_62318__$1);
var G__62324 = cljs.core.chunk_rest(seq__62088_62318__$1);
var G__62325 = c__5525__auto___62322;
var G__62326 = cljs.core.count(c__5525__auto___62322);
var G__62327 = (0);
seq__62088_62301 = G__62324;
chunk__62089_62302 = G__62325;
count__62090_62303 = G__62326;
i__62091_62304 = G__62327;
continue;
} else {
var m_62328 = cljs.core.first(seq__62088_62318__$1);
var temp__5804__auto___62329__$1 = (function (){var and__5000__auto__ = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(m_62328);
if(cljs.core.truth_(and__5000__auto__)){
return new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(m_62328);
} else {
return and__5000__auto__;
}
})();
if(cljs.core.truth_(temp__5804__auto___62329__$1)){
var block_uuid_62330 = temp__5804__auto___62329__$1;
if(clojure.string.starts_with_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(block_uuid_62330),"00000002")){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m_62328),"\n","(string/starts-with? (str block-uuid) \"00000002\")"].join('')));
}
} else {
}


var G__62331 = cljs.core.next(seq__62088_62318__$1);
var G__62332 = null;
var G__62333 = (0);
var G__62334 = (0);
seq__62088_62301 = G__62331;
chunk__62089_62302 = G__62332;
count__62090_62303 = G__62333;
i__62091_62304 = G__62334;
continue;
}
} else {
}
...
var temp__5804__auto__ = cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__62167){
var vec__62168 = p__62167;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62168,(1),null);
if((v > (1))){
return k;
} else {
return null;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__62188){
var vec__62192 = p__62188;
var db_ident = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62192,(0),null);
var map__62195 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62192,(1),null);
var map__62195__$1 = cljs.core.__destructure_map(map__62195);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62195__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62195__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62195__$1,new cljs.core.Keyword(null,"title","title",636505583));
...
var G__62204 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("block","title","block/title",710445684),title_SINGLEQUOTE_,new cljs.core.Keyword("block","name","block/name",1619760316),logseq.common.util.page_name_sanity_lc(title_SINGLEQUOTE_),new cljs.core.Keyword("db","ident","db/ident",-737096),db_ident,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"db-ident-block-uuid","db-ident-block-uuid",-2020167291),db_ident)], null);
var G__62204__$1 = ((cljs.core.seq(class_properties))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__62204,new cljs.core.Keyword("logseq.property.class","properties","logseq.property.class/properties",-2123712050),class_properties):G__62204);
if(cljs.core.seq(properties)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__62204__$1,properties], 0));
} else {
return G__62204__$1;
}
})()));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__62209 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_id,new cljs.core.Keyword("block","name","block/name",1619760316),logseq.common.config.views_page_name,new cljs.core.Keyword("block","title","block/title",710445684),logseq.common.config.views_page_name,new cljs.core.Keyword("block","tags","block/tags",1814948340),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("logseq.class","Page","logseq.class/Page",1484340329)], null),new cljs.core.Keyword("logseq.property","hide?","logseq.property/hide?",68365746),true,new cljs.core.Keyword("logseq.property","built-in?","logseq.property/built-in?",-1125958160),true], null);
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__62209) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__62209));
})()], null);
});
logseq.db.sqlite.create_graph.build_favorites_page = (function logseq$db$sqlite$create_graph$build_favorites_page(){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__62211 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"builtin-block-uuid","builtin-block-uuid",-652923992),logseq.common.config.favorites_page_name),new cljs.core.Keyword("block","name","block/name",1619760316),logseq.common.config.favorites_page_name,new cljs.core.Keyword("block","title","block/title",710445684),logseq.common.config.favorites_page_name,new cljs.core.Keyword("block","tags","block/tags",1814948340),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("logseq.class","Page","logseq.class/Page",1484340329)], null),new cljs.core.Keyword("logseq.property","hide?","logseq.property/hide?",68365746),true,new cljs.core.Keyword("logseq.property","built-in?","logseq.property/built-in?",-1125958160),true], null);
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__62211) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__62211));
})()], null);
});
...
var len__5726__auto___62367 = arguments.length;
var i__5727__auto___62368 = (0);
while(true){
if((i__5727__auto___62368 < len__5726__auto___62367)){
args__5732__auto__.push((arguments[i__5727__auto___62368]));

var G__62371 = (i__5727__auto___62368 + (1));
i__5727__auto___62368 = G__62371;
continue;
} else {
}
break;
...
(logseq.db.sqlite.create_graph.build_db_initial_data.cljs$core$IFn$_invoke$arity$variadic = (function (config_content,p__62232){
var map__62233 = p__62232;
var map__62233__$1 = cljs.core.__destructure_map(map__62233);
var import_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62233__$1,new cljs.core.Keyword(null,"import-type","import-type",-499283032));
var graph_git_sha = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62233__$1,new cljs.core.Keyword(null,"graph-git-sha","graph-git-sha",-266655130));
if(typeof config_content === 'string'){
} else {
throw (new Error("Assert failed: (string? config-content)"));
}

var initial_data = (function (){var G__62242 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [logseq.db.sqlite.util.kv(new cljs.core.Keyword("logseq.kv","db-type","logseq.kv/db-type",1106888767),"db"),logseq.db.sqlite.util.kv(new cljs.core.Keyword("logseq.kv","schema-version","logseq.kv/schema-version",-1467606676),logseq.db.frontend.schema.version),logseq.db.sqlite.util.kv(new cljs.core.Keyword("logseq.kv","graph-initial-schema-version","logseq.kv/graph-initial-schema-version",91284097),logseq.db.frontend.schema.version),logseq.db.sqlite.util.kv(new cljs.core.Keyword("logseq.kv","graph-created-at","logseq.kv/graph-created-at",1108266678),logseq.common.util.time_ms()),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("db","ident","db/ident",-737096),new cljs.core.Keyword("logseq.property","empty-placeholder","logseq.property/empty-placeholder",-1595021837),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"builtin-block-uuid","builtin-block-uuid",-652923992),new cljs.core.Keyword("logseq.property","empty-placeholder","logseq.property/empty-placeholder",-1595021837))], null)], null);
var G__62242__$1 = (cljs.core.truth_(import_type)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__62242,logseq.db.sqlite.util.import_tx(import_type)):G__62242);
if(cljs.core.truth_(graph_git_sha)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__62242__$1,logseq.db.sqlite.util.kv(new cljs.core.Keyword("logseq.kv","graph-git-sha","logseq.kv/graph-git-sha",-1509491768),graph_git_sha));
} else {
return G__62242__$1;
}
})();
var initial_files = logseq.db.sqlite.create_graph.build_initial_files(config_content);
var map__62241 = logseq.db.sqlite.create_graph.build_initial_properties();
var map__62241__$1 = cljs.core.__destructure_map(map__62241);
var properties_tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62241__$1,new cljs.core.Keyword(null,"tx","tx",466630418));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62241__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var bootstrap_class_ids = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62224_SHARP_){
return cljs.core.select_keys(p1__62224_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","ident","db/ident",-737096),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)], null));
}),bootstrap_classes);
var classes_tx = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62225_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__62225_SHARP_,new cljs.core.Keyword("db","ident","db/ident",-737096));
...
/** @this {Function} */
(logseq.db.sqlite.create_graph.build_db_initial_data.cljs$lang$applyTo = (function (seq62226){
var G__62227 = cljs.core.first(seq62226);
var seq62226__$1 = cljs.core.next(seq62226);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62227,seq62226__$1);
}));
