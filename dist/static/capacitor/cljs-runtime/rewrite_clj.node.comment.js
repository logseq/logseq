...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k63698,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63698,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__63742){
var vec__63743 = p__63742;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63743,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63743,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63697){
var self__ = this;
var G__63697__$1 = this;
return (new cljs.core.RecordIter((0),G__63697__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63699,other63700){
var self__ = this;
var this63699__$1 = this;
return (((!((other63700 == null)))) && ((((this63699__$1.constructor === other63700.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63699__$1.prefix,other63700.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63699__$1.s,other63700.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63699__$1.__extmap,other63700.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k63698){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k63698);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__63697){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__63835 = cljs.core.keyword_identical_QMARK_;
var expr__63836 = k__5309__auto__;
if(cljs.core.truth_((pred__63835.cljs$core$IFn$_invoke$arity$2 ? pred__63835.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__63836) : pred__63835.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__63836)))){
return (new rewrite_clj.node.comment.CommentNode(G__63697,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__63835.cljs$core$IFn$_invoke$arity$2 ? pred__63835.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__63836) : pred__63835.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__63836)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__63697,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__63697),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__63697){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__63697,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__63708){
var extmap__5342__auto__ = (function (){var G__63858 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__63708,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__63708)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__63858);
} else {
return G__63858;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__63708),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__63708),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
