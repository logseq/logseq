...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__87320 = (function (){var G__87323 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__87323) : frontend.db.entity.call(null,G__87323));
})();
var G__87321 = (0);
var G__87322 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"container-id","container-id",1274665684),new cljs.core.Keyword(null,"unknown-container","unknown-container",1739831473)], null);
return (frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(G__87320,G__87321,G__87322) : frontend.handler.editor.edit_block_BANG_.call(null,G__87320,G__87321,G__87322));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.block-content","div.block-content",-2073822457),(function (){var G__87332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"disable-resize?","disable-resize?",-1998248527),true);
var G__87333 = row;
return (asset_cp.cljs$core$IFn$_invoke$arity$2 ? asset_cp.cljs$core$IFn$_invoke$arity$2(G__87332,G__87333) : asset_cp.call(null,G__87332,G__87333));
})()], null);
} else {
return null;
}
...
var columns = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(class$),new cljs.core.Keyword("logseq.class","Pdf-annotation","logseq.class/Pdf-annotation",-504959620)))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__87337_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.property","ls-type","logseq.property/ls-type",326979345),null], null), null),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__87337_SHARP_));
}),columns_STAR_):((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(class$),new cljs.core.Keyword("logseq.class","Asset","logseq.class/Asset",-797502970)))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__87339_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.property.asset","checksum","logseq.property.asset/checksum",-1011416979),null], null), null),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__87339_SHARP_));
...
var columns__$1 = ((asset_QMARK_)?(function (){var vec__87355 = cljs.core.split_with((function (p1__87340_SHARP_){
return (!(logseq.db.frontend.property.logseq_property_QMARK_(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__87340_SHARP_))));
}),columns);
var before_cols = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87355,(0),null);
var after_cols = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__87355,(1),null);
...
var add_new_object_BANG_ = ((((asset_QMARK_) || (cljs.core.not((function (){var G__87366 = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(class$);
return (logseq.db.private_tags.cljs$core$IFn$_invoke$arity$1 ? logseq.db.private_tags.cljs$core$IFn$_invoke$arity$1(G__87366) : logseq.db.private_tags.call(null,G__87366));
})()))))?(function (_view,table,p__87368){
var map__87369 = p__87368;
var map__87369__$1 = cljs.core.__destructure_map(map__87369);
var properties__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87369__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
return promesa.protocols._promise(((cljs.core.seq(entities))?(function (){var G__87380 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(full_data,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),entities));
return (set_data_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_data_BANG_.cljs$core$IFn$_invoke$arity$1(G__87380) : set_data_BANG_.call(null,G__87380));
})():null));
}));
}));
}));
...
return (logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$1 ? logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$1(G__87376) : logseq.shui.ui.dialog_open_BANG_.call(null,G__87376));
} else {
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
var G__87392_87482 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(full_data),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block));
(set_data_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_data_BANG_.cljs$core$IFn$_invoke$arity$1(G__87392_87482) : set_data_BANG_.call(null,G__87392_87482));
...
frontend.components.objects.class_objects = rum.core.lazy_build(rum.core.build_defcs,(function (state,class$,p__87405){
var map__87406 = p__87405;
var map__87406__$1 = cljs.core.__destructure_map(map__87406);
var current_page_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87406__$1,new cljs.core.Keyword(null,"current-page?","current-page?",-1491305079));
var sidebar_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87406__$1,new cljs.core.Keyword(null,"sidebar?","sidebar?",-534999672));
if(cljs.core.truth_(class$)){
var class$__$1 = (function (){var G__87411 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(class$);
return (frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1 ? frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1(G__87411) : frontend.db.sub_block.call(null,G__87411));
})();
...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__87425 = (function (){var G__87428 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__87428) : frontend.db.entity.call(null,G__87428));
})();
var G__87426 = (0);
var G__87427 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"container-id","container-id",1274665684),new cljs.core.Keyword(null,"unknown-container","unknown-container",1739831473)], null);
return (frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(G__87425,G__87426,G__87427) : frontend.handler.editor.edit_block_BANG_.call(null,G__87425,G__87426,G__87427));
})()),(function (___40947__auto__){
return promesa.protocols._promise(block);
}));
}));
...
return frontend.components.views.view(new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"config","config",994861415),config,new cljs.core.Keyword(null,"view-parent","view-parent",675596601),property,new cljs.core.Keyword(null,"view-feature-type","view-feature-type",-945869610),new cljs.core.Keyword(null,"property-objects","property-objects",-1410914822),new cljs.core.Keyword(null,"columns","columns",1998437288),columns,new cljs.core.Keyword(null,"add-new-object!","add-new-object!",622560106),(function (_view,table,p__87448){
var map__87449 = p__87448;
var map__87449__$1 = cljs.core.__destructure_map(map__87449);
var properties__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__87449__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
var G__87457 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(full_data),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block));
return (set_data_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_data_BANG_.cljs$core$IFn$_invoke$arity$1(G__87457) : set_data_BANG_.call(null,G__87457));
})()
:null));
}));
}));
...
var property_SINGLEQUOTE_ = (function (){var G__87465 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(property);
return (frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1 ? frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1(G__87465) : frontend.db.sub_block.call(null,G__87465));
})();
