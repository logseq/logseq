...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__60351 = graph;
var G__60352 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transact-db?","transact-db?",1279612399),false], null);
var G__60353 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?p","?p",-10896580,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"_","_",-1201019570,null),new cljs.core.Keyword("block","properties","block/properties",708347145),new cljs.core.Symbol(null,"?p","?p",-10896580,null)], null)], null);
return (frontend.db.file_based.async._LT_q.cljs$core$IFn$_invoke$arity$3 ? frontend.db.file_based.async._LT_q.cljs$core$IFn$_invoke$arity$3(G__60351,G__60352,G__60353) : frontend.db.file_based.async._LT_q.call(null,G__60351,G__60352,G__60353));
})()),(function (properties){
...
return promesa.protocols._promise(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60350_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("block","title","block/title",710445684)],[p1__60350_SHARP_]);
 ...
 *   autocomplete
 */
frontend.db.file_based.async.property_value_for_refs_and_text = (function frontend$db$file_based$async$property_value_for_refs_and_text(p__60358){
var vec__60359 = p__60358;
var refs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60359,(0),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60359,(1),null);
if((((!(cljs.core.coll_QMARK_(refs)))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(refs))))){
return text;
} else {
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60354_SHARP_){
if(clojure.string.includes_QMARK_(text,logseq.common.util.page_ref.__GT_page_ref(p1__60354_SHARP_))){
return logseq.common.util.page_ref.__GT_page_ref(p1__60354_SHARP_);
} else {
if(clojure.string.includes_QMARK_(text,["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__60354_SHARP_)].join(''))){
return ["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__60354_SHARP_)].join('');
} else {
return p1__60354_SHARP_;
