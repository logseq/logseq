...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66374_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(k),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__66374_SHARP_)].join('');
...
var temp__5804__auto___66490 = new cljs.core.Keyword(null,"key-down-handler","key-down-handler",1352306780).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.handler.jump._STAR_jump_data));
if(cljs.core.truth_(temp__5804__auto___66490)){
var event_handler_66491 = temp__5804__auto___66490;
window.removeEventListener("keydown",event_handler_66491);
} else {
}
...
var map__66470 = cljs.core.deref(frontend.handler.jump._STAR_jump_data);
var map__66470__$1 = cljs.core.__destructure_map(map__66470);
var triggers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66470__$1,new cljs.core.Keyword(null,"triggers","triggers",-1443678770));
var _mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66470__$1,new cljs.core.Keyword(null,"_mode","_mode",1455298843));
...
var block_id = (function (){var G__66476 = dommy.core.attr(trigger,"blockid");
if((G__66476 == null)){
return null;
} else {
return cljs.core.uuid(G__66476);
}
})();
var container_id = (function (){var G__66477 = dommy.core.attr(trigger,"containerid");
if((G__66477 == null)){
return null;
} else {
return frontend.util.safe_parse_int(G__66477);
}
})();
var block = (cljs.core.truth_(block_id)?(function (){var G__66478 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__66478) : frontend.db.entity.call(null,G__66478));
})():null);
if(cljs.core.truth_(block)){
var G__66479 = block;
var G__66480 = new cljs.core.Keyword(null,"max","max",61366548);
var G__66481 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"container-id","container-id",1274665684),container_id], null);
return (frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.editor.edit_block_BANG_.cljs$core$IFn$_invoke$arity$3(G__66479,G__66480,G__66481) : frontend.handler.editor.edit_block_BANG_.call(null,G__66479,G__66480,G__66481));
} else {
return null;
}
} else {
...
return new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1((function (){var G__66485 = frontend.state.get_current_page();
return (frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(G__66485) : frontend.db.get_page.call(null,G__66485));
})());
}
}
})();
var current_block = ((cljs.core.uuid_QMARK_(current_block_id))?(function (){var G__66486 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),current_block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__66486) : frontend.db.entity.call(null,G__66486));
})():null);
...
var G__66487 = frontend.state.get_editing_block_dom_id();
var G__66487__$1 = (((G__66487 == null))?null:document.getElementById(G__66487));
if((G__66487__$1 == null)){
return null;
} else {
return frontend.util.rec_get_node(G__66487__$1,".ls-block");
}
}
})();
