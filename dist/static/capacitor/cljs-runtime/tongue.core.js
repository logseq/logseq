...
tongue.core.format_inst_iso = (function (){var G__95585 = "{year}-{month-numeric-padded}-{day-padded}T{hour24-padded}:{minutes-padded}:{seconds-padded}";
var G__95586 = cljs.core.PersistentArrayMap.EMPTY;
return (tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2 ? tongue.core.inst_formatter.cljs$core$IFn$_invoke$arity$2(G__95585,G__95586) : tongue.core.inst_formatter.call(null,G__95585,G__95586));
})();
...
var or__5002__auto__ = (function (){var fexpr__95589 = cljs.core.deref(tongue.core.tags_cache);
return (fexpr__95589.cljs$core$IFn$_invoke$arity$1 ? fexpr__95589.cljs$core$IFn$_invoke$arity$1(locale) : fexpr__95589.call(null,locale));
})();
...
var G__95636 = cljs.core.next(subtags);
var G__95637 = tag;
var G__95638 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(tags,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag));
subtags = G__95636;
last_tag = G__95637;
tags = G__95638;
continue;
...
var G__95639 = cljs.core.next(tags);
tags = G__95639;
continue;
}
}
...
var tongue$core$IInterpolate$interpolate_named$dyn_95640 = (function (v,dicts,locale,interpolations){
...
return tongue$core$IInterpolate$interpolate_named$dyn_95640(v,dicts,locale,interpolations);
}
});

var tongue$core$IInterpolate$interpolate_positional$dyn_95643 = (function (v,dicts,locale,interpolations){
var x__5350__auto__ = (((v == null))?null:v);
...
return tongue$core$IInterpolate$interpolate_positional$dyn_95643(v,dicts,locale,interpolations);
}
});
...
return clojure.string.replace(s,/\{([\w*!_?$%&=<>'\-+.#0-9]+|[\w*!_?$%&=<>'\-+.#0-9]+\/[\w*!_?$%&=<>'\-+.#0-9:]+)\}/,(function (p__95601){
var vec__95602 = p__95601;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95602,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95602,(1),null);
...
return clojure.string.replace(s,/\{(\d+)\}/,(function (p__95605){
var vec__95606 = p__95605;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95606,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95606,(1),null);
...
var len__5726__auto___95648 = arguments.length;
var i__5727__auto___95649 = (0);
while(true){
if((i__5727__auto___95649 < len__5726__auto___95648)){
args_arr__5751__auto__.push((arguments[i__5727__auto___95649]));

var G__95650 = (i__5727__auto___95649 + (1));
i__5727__auto___95649 = G__95650;
continue;
} else {
}
break;
...
/** @this {Function} */
(tongue.core.translate.cljs$lang$applyTo = (function (seq95611){
var G__95612 = cljs.core.first(seq95611);
var seq95611__$1 = cljs.core.next(seq95611);
var G__95613 = cljs.core.first(seq95611__$1);
var seq95611__$2 = cljs.core.next(seq95611__$1);
var G__95614 = cljs.core.first(seq95611__$2);
var seq95611__$3 = cljs.core.next(seq95611__$2);
var G__95615 = cljs.core.first(seq95611__$3);
var seq95611__$4 = cljs.core.next(seq95611__$3);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__95612,G__95613,G__95614,G__95615,seq95611__$4);
}));
...
var G__95652 = val;
var G__95653 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,v);
v = G__95652;
path = G__95653;
continue;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__95630_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.first(p1__95630_SHARP_),tongue.core.resolve_alias_1(m,cljs.core.second(p1__95630_SHARP_))],null));
}),m));
});
...
var G__95655 = function (locale,key,x,var_args){
var args = null;
if (arguments.length > 3) {
var G__95656__i = 0, G__95656__a = new Array(arguments.length -  3);
while (G__95656__i < G__95656__a.length) {G__95656__a[G__95656__i] = arguments[G__95656__i + 3]; ++G__95656__i;}
  args = new cljs.core.IndexedSeq(G__95656__a,0,null);
} 
return G__95655__delegate.call(this,locale,key,x,args);};
G__95655.cljs$lang$maxFixedArity = 3;
G__95655.cljs$lang$applyTo = (function (arglist__95657){
var locale = cljs.core.first(arglist__95657);
arglist__95657 = cljs.core.next(arglist__95657);
var key = cljs.core.first(arglist__95657);
arglist__95657 = cljs.core.next(arglist__95657);
var x = cljs.core.first(arglist__95657);
var args = cljs.core.rest(arglist__95657);
return G__95655__delegate(locale,key,x,args);
});
G__95655.cljs$core$IFn$_invoke$arity$variadic = G__95655__delegate;
return G__95655;
})()
;
G__95654 = function(locale,key,x,var_args){
var args = var_args;
switch(arguments.length){
case 2:
return G__95654__2.call(this,locale,key);
case 3:
return G__95654__3.call(this,locale,key,x);
default:
var G__95658 = null;
if (arguments.length > 3) {
var G__95659__i = 0, G__95659__a = new Array(arguments.length -  3);
while (G__95659__i < G__95659__a.length) {G__95659__a[G__95659__i] = arguments[G__95659__i + 3]; ++G__95659__i;}
G__95658 = new cljs.core.IndexedSeq(G__95659__a,0,null);
}
return G__95654__4.cljs$core$IFn$_invoke$arity$variadic(locale,key,x, G__95658);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__95654.cljs$lang$maxFixedArity = 3;
G__95654.cljs$lang$applyTo = G__95654__4.cljs$lang$applyTo;
G__95654.cljs$core$IFn$_invoke$arity$2 = G__95654__2;
G__95654.cljs$core$IFn$_invoke$arity$3 = G__95654__3;
G__95654.cljs$core$IFn$_invoke$arity$variadic = G__95654__4.cljs$core$IFn$_invoke$arity$variadic;
return G__95654;
})()
});
