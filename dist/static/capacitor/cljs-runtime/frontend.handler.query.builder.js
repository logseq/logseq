...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(((((cljs.core.coll_QMARK_(item)) && (cljs.core.not((function (){var G__70612 = cljs.core.first(item);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__70612) : frontend.handler.query.builder.operators_set.call(null,G__70612));
...
var f = (function (p1__70621_SHARP_){
return frontend.handler.query.builder.vec_dissoc_item(p1__70621_SHARP_,idx);
});
if(cljs.core.seq(ks)){
...
var G__70639 = cljs.core.first(q);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__70639) : frontend.handler.query.builder.operators_set.call(null,G__70639));
} else {
...
if(cljs.core.truth_(temp__5804__auto__)){
var x = temp__5804__auto__;
if(cljs.core.truth_((function (){var and__5000__auto__ = (function (){var G__70642 = cljs.core.first(x);
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__70642) : frontend.handler.query.builder.operators_set.call(null,G__70642));
})();
...
var G__70648 = cljs.core.second(x);
return (frontend.handler.query.builder.__GT_page_ref.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.__GT_page_ref.cljs$core$IFn$_invoke$arity$1(G__70648) : frontend.handler.query.builder.__GT_page_ref.call(null,G__70648));
}
});
...
var G__70671 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.first(f));
return (frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1 ? frontend.handler.query.builder.operators_set.cljs$core$IFn$_invoke$arity$1(G__70671) : frontend.handler.query.builder.operators_set.call(null,G__70671));
} else {
