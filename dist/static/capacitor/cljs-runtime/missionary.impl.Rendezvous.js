...
var self__ = this;
var self__ = this;
var G__57573 = (arguments.length - (1));
switch (G__57573) {
case (1):
...
(missionary.impl.Rendezvous.Port.prototype.apply = (function (self__,args57569){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57569)));
}));
...
var G__57593 = (new missionary.Cancelled("Rendez-vous give cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__57593) : f_BANG_.call(null,G__57593));
} else {
return null;
}
});
} else {
var vec__57599 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57599,(0),null);
...
if((temp__5806__auto__ == null)){
var _BANG_ = (function (p1__57564_SHARP_){
return (s_BANG_.cljs$core$IFn$_invoke$arity$1 ? s_BANG_.cljs$core$IFn$_invoke$arity$1(p1__57564_SHARP_) : s_BANG_.call(null,p1__57564_SHARP_));
});
...
var G__57610 = (new missionary.Cancelled("Rendez-vous take cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__57610) : f_BANG_.call(null,G__57610));
} else {
return null;
}
});
} else {
var vec__57617 = temp__5806__auto__;
var vec__57620 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57617,(0),null);
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57620,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57620,(1),null);
(self__.writers = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.writers,_BANG_));
