...
var G__60709 = ":%s:";
var G__60710 = clojure.string.upper_case(typ);
return (frontend.util.format.cljs$core$IFn$_invoke$arity$2 ? frontend.util.format.cljs$core$IFn$_invoke$arity$2(G__60709,G__60710) : frontend.util.format.call(null,G__60709,G__60710));
});
...
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60718_SHARP_){
return clojure.string.starts_with_QMARK_(p1__60718_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60719_SHARP_){
return clojure.string.starts_with_QMARK_(p1__60719_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.vec(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60720_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__60720_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__60720_SHARP_,"DEADLINE")))));
}),body));
var start_idx = body_without_timestamps.indexOf(frontend.util.file_based.drawer.drawer_start(typ));
var end_idx = (function (){var vec__60725 = cljs.core.split_at(start_idx,body_without_timestamps);
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60725,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60725,(1),null);
...
var and__5000__auto__ = (function (){var G__60735 = cljs.core.re_pattern(["(?i)",frontend.util.file_based.drawer.logbook_start].join(''));
var G__60736 = content;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__60735,G__60736) : frontend.util.safe_re_find.call(null,G__60735,G__60736));
})();
if(cljs.core.truth_(and__5000__auto__)){
var G__60737 = cljs.core.re_pattern(["(?i)",frontend.util.file_based.drawer.drawer_end].join(''));
var G__60738 = content;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__60737,G__60738) : frontend.util.safe_re_find.call(null,G__60737,G__60738));
} else {
return and__5000__auto__;
}
});
...
var lines = clojure.string.split_lines(content);
var vec__60741 = cljs.core.split_with((function (l){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(l)),":LOGBOOK:")));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60741,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60741,(1),null);
