...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__62204){
var vec__62205 = p__62204;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62205,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62205,(1),null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__62213){
var vec__62214 = p__62213;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62214,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62214,(1),null);
 ...
 */
frontend.handler.common.config_edn.detect_deprecations = (function frontend$handler$common$config_edn$detect_deprecations(path,content,p__62250){
var map__62251 = p__62250;
var map__62251__$1 = cljs.core.__destructure_map(map__62251);
var db_graph_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62251__$1,new cljs.core.Keyword(null,"db-graph?","db-graph?",-533494876));
var body = (function (){try{return clojure.edn.read_string.cljs$core$IFn$_invoke$arity$1(content);
}catch (e62252){var _ = e62252;
...
var warnings = (function (){var G__62253 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("editor","command-trigger","editor/command-trigger",1018337295),"is no longer supported. Please use '/' and report bugs on it.",new cljs.core.Keyword("arweave","gateway","arweave/gateway",-473231712),"is no longer supported."], null);
if(cljs.core.truth_(db_graph_QMARK_)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__62253,logseq.common.config.file_only_config], 0));
} else {
return G__62253;
}
})();
...
var temp__5804__auto__ = cljs.core.seq(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__62248_SHARP_){
if(cljs.core.truth_((function (){var G__62258 = cljs.core.key(p1__62248_SHARP_);
return (body.cljs$core$IFn$_invoke$arity$1 ? body.cljs$core$IFn$_invoke$arity$1(G__62258) : body.call(null,G__62258));
})())){
return p1__62248_SHARP_;
} else {
return null;
}
}),warnings));
