...
var or__5002__auto__ = new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1((function (){var G__66112 = frontend.state.get_current_page();
return (frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(G__66112) : frontend.db.get_page.call(null,G__66112));
})());
...
var or__5002__auto__ = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1((function (){var G__66118 = frontend.state.get_current_page();
return (frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(G__66118) : frontend.db.get_page.call(null,G__66118));
})());
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var temp__5804__auto__ = (function (){var G__66129 = page_name;
if((G__66129 == null)){
return null;
} else {
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__66129) : frontend.util.page_name_sanity_lc.call(null,G__66129));
}
})();
if(cljs.core.truth_(temp__5804__auto__)){
