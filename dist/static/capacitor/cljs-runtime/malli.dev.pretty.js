...
return cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"break","break",126570225),(function (){var iter__5480__auto__ = (function malli$dev$pretty$_errors_$_iter__74003(s__74004){
return (new cljs.core.LazySeq(null,(function (){
var s__74004__$1 = s__74004;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__74004__$1);
if(temp__5804__auto__){
var s__74004__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__74004__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__74004__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__74006 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__74005 = (0);
while(true){
if((i__74005 < size__5479__auto__)){
var error = cljs.core._nth(c__5478__auto__,i__74005);
cljs.core.chunk_append(b__74006,malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer));

var G__74146 = (i__74005 + (1));
i__74005 = G__74146;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__74006),malli$dev$pretty$_errors_$_iter__74003(cljs.core.chunk_rest(s__74004__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__74006),null);
}
} else {
var error = cljs.core.first(s__74004__$2);
return cljs.core.cons(malli.dev.virhe._visit(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,error),printer),malli$dev$pretty$_errors_$_iter__74003(cljs.core.rest(s__74004__$2)));
}
} else {
return null;
}
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","explain","malli.core/explain",36932858),(function (_,p__74035,printer){
var map__74036 = p__74035;
var map__74036__$1 = cljs.core.__destructure_map(map__74036);
var explanation = map__74036__$1;
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74036__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","coercion","malli.core/coercion",698994541),(function (_,p__74037,printer){
var map__74038 = p__74037;
var map__74038__$1 = cljs.core.__destructure_map(map__74038);
var explain = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74038__$1,new cljs.core.Keyword(null,"explain","explain",484226146));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-input","malli.core/invalid-input",2010057279),(function (_,p__74044,printer){
var map__74045 = p__74044;
var map__74045__$1 = cljs.core.__destructure_map(map__74045);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74045__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74045__$1,new cljs.core.Keyword(null,"input","input",556931961));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74045__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-output","malli.core/invalid-output",-147363519),(function (_,p__74049,printer){
...
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74050__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74050__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74050__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-guard","malli.core/invalid-guard",-946413611),(function (_,p__74052,printer){
var map__74053 = p__74052;
var map__74053__$1 = cljs.core.__destructure_map(map__74053);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74053__$1,new cljs.core.Keyword(null,"value","value",305978217));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74053__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var guard = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74053__$1,new cljs.core.Keyword(null,"guard","guard",-873147811));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74053__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-arity","malli.core/invalid-arity",577014581),(function (_,p__74054,printer){
var map__74055 = p__74054;
var map__74055__$1 = cljs.core.__destructure_map(map__74055);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74055__$1,new cljs.core.Keyword(null,"args","args",1315556576));
var arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74055__$1,new cljs.core.Keyword(null,"arity","arity",-1808556135));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74055__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74055__$1,new cljs.core.Keyword(null,"fn-name","fn-name",-766594004));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","register-function-schema","malli.core/register-function-schema",-1224381998),(function (_,p__74056,printer){
var map__74057 = p__74056;
var map__74057__$1 = cljs.core.__destructure_map(map__74057);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var _data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"_data","_data",-1394265439));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var _exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74057__$1,new cljs.core.Keyword(null,"_exception","_exception",69029009));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-ref","malli.core/invalid-ref",-1109933109),(function (_,p__74060,printer){
var map__74061 = p__74060;
var map__74061__$1 = cljs.core.__destructure_map(map__74061);
var ref = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74061__$1,new cljs.core.Keyword(null,"ref","ref",1289896967));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-schema","malli.core/invalid-schema",1923990979),(function (_,p__74062,printer){
var map__74063 = p__74062;
var map__74063__$1 = cljs.core.__destructure_map(map__74063);
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74063__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74063__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__74067),malli$dev$pretty$iter__74064(cljs.core.chunk_rest(s__74065__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__74067),null);
}
} else {
var proposal = cljs.core.first(s__74065__$2);
return cljs.core.cons(malli.dev.virhe._visit(proposal,printer),malli$dev$pretty$iter__74064(cljs.core.rest(s__74065__$2)));
}
} else {
return null;
}
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","child-error","malli.core/child-error",-473817473),(function (_,p__74071,printer){
var map__74073 = p__74071;
var map__74073__$1 = cljs.core.__destructure_map(map__74073);
var data = map__74073__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74073__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74073__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74073__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","invalid-entry","malli.core/invalid-entry",-1401097281),(function (_,p__74077,printer){
var map__74078 = p__74077;
var map__74078__$1 = cljs.core.__destructure_map(map__74078);
var entry = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74078__$1,new cljs.core.Keyword(null,"entry","entry",505168823));
...
var example = (function (){var G__74082 = wrapped;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(wrapped))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__74082,new cljs.core.Keyword(null,"any","any",1705907423));
} else {
return G__74082;
}
})();
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.core","duplicate-keys","malli.core/duplicate-keys",1684166326),(function (_,p__74084,printer){
var map__74085 = p__74084;
var map__74085__$1 = cljs.core.__destructure_map(map__74085);
var arr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74085__$1,new cljs.core.Keyword(null,"arr","arr",474961448));
...
malli.dev.virhe._format.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword("malli.edn","var-parsing-not-supported","malli.edn/var-parsing-not-supported",-283037656),(function (_,p__74089,printer){
var map__74090 = p__74089;
var map__74090__$1 = cljs.core.__destructure_map(map__74090);
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74090__$1,new cljs.core.Keyword(null,"string","string",-1989541586));
var var$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74090__$1,new cljs.core.Keyword(null,"var","var",-769682797));
...
}catch (e74091){if((e74091 instanceof Error)){
var ___$1 = e74091;
return string__$1;
} else {
throw e74091;
...
var _STAR_print_newline_STAR__orig_val__74117_74170 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__74118_74171 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__74119_74172 = true;
var _STAR_print_fn_STAR__temp_val__74120_74173 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__74119_74172);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__74120_74173);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__74118_74171);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__74117_74170);
}
...
var _STAR_print_newline_STAR__orig_val__74125_74176 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__74126_74177 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__74127_74178 = true;
var _STAR_print_fn_STAR__temp_val__74128_74179 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__74127_74178);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__74128_74179);

try{report(type,data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__74126_74177);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__74125_74176);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})();
...
return (function() { 
var G__74180__delegate = function (args){
var temp__5804__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,args);
if(cljs.core.truth_(temp__5804__auto__)){
var res = temp__5804__auto__;
var fexpr__74136_74181 = (actor.cljs$core$IFn$_invoke$arity$1 ? actor.cljs$core$IFn$_invoke$arity$1(printer) : actor.call(null,printer));
(fexpr__74136_74181.cljs$core$IFn$_invoke$arity$2 ? fexpr__74136_74181.cljs$core$IFn$_invoke$arity$2(type,res) : fexpr__74136_74181.call(null,type,res));
...
var G__74180 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__74182__i = 0, G__74182__a = new Array(arguments.length -  0);
while (G__74182__i < G__74182__a.length) {G__74182__a[G__74182__i] = arguments[G__74182__i + 0]; ++G__74182__i;}
  args = new cljs.core.IndexedSeq(G__74182__a,0,null);
} 
return G__74180__delegate.call(this,args);};
G__74180.cljs$lang$maxFixedArity = 0;
G__74180.cljs$lang$applyTo = (function (arglist__74183){
var args = cljs.core.seq(arglist__74183);
return G__74180__delegate(args);
});
G__74180.cljs$core$IFn$_invoke$arity$variadic = G__74180__delegate;
return G__74180;
})()
;
});
malli.dev.pretty.explain = (function malli$dev$pretty$explain(var_args){
var G__74139 = arguments.length;
switch (G__74139) {
case 2:
