...
var vec__70785 = new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70785,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70785,(1),null);
var display_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70785,(2),null);
...
var iter__5480__auto__ = (function frontend$extensions$latex$load_and_render_BANG__$_iter__70795(s__70796){
return (new cljs.core.LazySeq(null,(function (){
var s__70796__$1 = s__70796;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__70796__$1);
if(temp__5804__auto____$1){
var s__70796__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__70796__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__70796__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__70798 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__70797 = (0);
while(true){
if((i__70797 < size__5479__auto__)){
var map__70802 = cljs.core._nth(c__5478__auto__,i__70797);
var map__70802__$1 = cljs.core.__destructure_map(map__70802);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70802__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
cljs.core.chunk_append(b__70798,((cljs.core.fn_QMARK_(f))?(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(window.katex) : f.call(null,window.katex)):null));

var G__70882 = (i__70797 + (1));
i__70797 = G__70882;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70798),frontend$extensions$latex$load_and_render_BANG__$_iter__70795(cljs.core.chunk_rest(s__70796__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70798),null);
}
} else {
var map__70805 = cljs.core.first(s__70796__$2);
var map__70805__$1 = cljs.core.__destructure_map(map__70805);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70805__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
return cljs.core.cons(((cljs.core.fn_QMARK_(f))?(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(window.katex) : f.call(null,window.katex)):null),frontend$extensions$latex$load_and_render_BANG__$_iter__70795(cljs.core.rest(s__70796__$2)));
}
} else {
return null;
}
...
return daiquiri.interpreter.interpret(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [element,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),"initial"], null),(function (){var attrs70822 = s;
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs70822))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["opacity-0"], null)], null),attrs70822], 0))):{'className':"opacity-0"}),((cljs.core.map_QMARK_(attrs70822))?null:[daiquiri.interpreter.interpret(attrs70822)]));
})()], null));
}
