...
var sym_seq = (function (){var iter__5480__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__63674(s__63675){
return (new cljs.core.LazySeq(null,(function (){
var s__63675__$1 = s__63675;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__63675__$1);
if(temp__5804__auto__){
var s__63675__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63675__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__63675__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__63677 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__63676 = (0);
while(true){
if((i__63676 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__63676);
...
cljs.core.chunk_append(b__63677,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__63803 = (i__63676 + (1));
i__63676 = G__63803;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63677),rewrite_clj$node$fn$fn_walk_$_iter__63674(cljs.core.chunk_rest(s__63675__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63677),null);
}
} else {
var i = cljs.core.first(s__63675__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__63674(cljs.core.rest(s__63675__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__63670_SHARP_){
var or__5002__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__63670_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return p1__63670_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k63689,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__63706 = k63689;
var G__63706__$1 = (((G__63706 instanceof cljs.core.Keyword))?G__63706.fqn:null);
switch (G__63706__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k63689,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__63717){
var vec__63719 = p__63717;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63719,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63719,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__63688){
var self__ = this;
var G__63688__$1 = this;
return (new cljs.core.RecordIter((0),G__63688__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this63690,other63691){
var self__ = this;
var this63690__$1 = this;
return (((!((other63691 == null)))) && ((((this63690__$1.constructor === other63691.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63690__$1.children,other63691.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this63690__$1.__extmap,other63691.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k63689){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k63689);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__63688){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__63757 = cljs.core.keyword_identical_QMARK_;
var expr__63758 = k__5309__auto__;
if(cljs.core.truth_((pred__63757.cljs$core$IFn$_invoke$arity$2 ? pred__63757.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__63758) : pred__63757.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__63758)))){
return (new rewrite_clj.node.fn.FnNode(G__63688,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__63688),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__63688){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__63688,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__63695){
var extmap__5342__auto__ = (function (){var G__63787 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63695,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__63695)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__63787);
} else {
return G__63787;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__63695),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
