...
return promesa.protocols._mcat(promesa.protocols._promise((new Promise(frontend.handler.user.task__ensure_id_AMPERSAND_access_token))),(function (___40947__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","rtc-wait-download-graph-info-ready","thread-api/rtc-wait-download-graph-info-ready",1767428638),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([token,download_info_uuid,graph_uuid,graph_schema_version,timeout_ms], 0))),(function (p__69212){
var map__69214 = p__69212;
var map__69214__$1 = cljs.core.__destructure_map(map__69214);
var result = map__69214__$1;
var _download_info_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69214__$1,new cljs.core.Keyword(null,"_download-info-uuid","_download-info-uuid",-493542016));
var download_info_s3_url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69214__$1,new cljs.core.Keyword(null,"download-info-s3-url","download-info-s3-url",937853327));
var _download_info_tx_instant = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69214__$1,new cljs.core.Keyword(null,"_download-info-tx-instant","_download-info-tx-instant",-115220489));
var _download_info_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69214__$1,new cljs.core.Keyword(null,"_download-info-t","_download-info-t",-1601616779));
var _download_info_created_at = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69214__$1,new cljs.core.Keyword(null,"_download-info-created-at","_download-info-created-at",-306158633));
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"There's a higher schema-version graph on the server.",(function (){var G__69221 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
frontend.util.stop(e);

return frontend.handler.db_based.rtc._LT_rtc_download_graph_BANG_(graph_name_STAR_,graph_uuid,schema_version,(60000));
})], null);
var G__69222 = "Download";
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__69221,G__69222) : logseq.shui.ui.button.call(null,G__69221,G__69222));
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"The local graph has a higher schema version than the graph on the server.",(function (){var G__69223 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (e){
frontend.util.stop(e);

return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40957__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.db_based.rtc._LT_rtc_branch_graph_BANG_(repo)),(function (___40947__auto__){
return promesa.protocols._promise(frontend.handler.db_based.rtc_flows.trigger_rtc_start(repo));
}));
}));
})], null);
var G__69224 = "Upload to server";
return (logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.button.cljs$core$IFn$_invoke$arity$2(G__69223,G__69224) : logseq.shui.ui.button.call(null,G__69223,G__69224));
})()], null),new cljs.core.Keyword(null,"warning","warning",-1685650671),false);
});
...
var len__5726__auto___69255 = arguments.length;
var i__5727__auto___69256 = (0);
while(true){
if((i__5727__auto___69256 < len__5726__auto___69255)){
args__5732__auto__.push((arguments[i__5727__auto___69256]));

var G__69257 = (i__5727__auto___69256 + (1));
i__5727__auto___69256 = G__69257;
continue;
} else {
}
break;
...
(frontend.handler.db_based.rtc._LT_rtc_start_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,p__69229){
var map__69230 = p__69229;
var map__69230__$1 = cljs.core.__destructure_map(map__69230);
var stop_before_start_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69230__$1,new cljs.core.Keyword(null,"stop-before-start?","stop-before-start?",1190543403),true);
...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__69233 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(ex_data_STAR_);
...
var G__69234 = new cljs.core.Keyword(null,"sub-type","sub-type",-997954412).cljs$core$IFn$_invoke$arity$1(ex_data_STAR_);
...
var _STAR_print_newline_STAR__orig_val__69235_69261 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__69236_69262 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__69237_69263 = true;
var _STAR_print_fn_STAR__temp_val__69238_69264 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__69237_69263);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__69238_69264);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__69236_69262);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__69235_69261);
}
...
/** @this {Function} */
(frontend.handler.db_based.rtc._LT_rtc_start_BANG_.cljs$lang$applyTo = (function (seq69225){
var G__69226 = cljs.core.first(seq69225);
var seq69225__$1 = cljs.core.next(seq69225);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69226,seq69225__$1);
}));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","rtc-grant-graph-access","thread-api/rtc-grant-graph-access",1735035900),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([token,cljs.core.str.cljs$core$IFn$_invoke$arity$1(graph_uuid),cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [email], null)], 0))),(function (___40947__auto__){
