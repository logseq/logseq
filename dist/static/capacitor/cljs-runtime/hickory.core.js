...
var hickory$core$HiccupRepresentable$as_hiccup$dyn_100225 = (function (this$){
...
return hickory$core$HiccupRepresentable$as_hiccup$dyn_100225(this$);
}
});
...
var hickory$core$HickoryRepresentable$as_hickory$dyn_100226 = (function (this$){
var x__5350__auto__ = (((this$ == null))?null:this$);
...
return hickory$core$HickoryRepresentable$as_hickory$dyn_100226(this$);
}
});
...
var pred__100219 = cljs.core._EQ_;
var expr__100220 = (this$["nodeType"]);
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__100220) : pred__100219.call(null,hickory.core.Attribute,expr__100220)))){
...
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__100220) : pred__100219.call(null,hickory.core.Comment,expr__100220)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__100220) : pred__100219.call(null,hickory.core.Document,expr__100220)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,hickory.core.as_seq((this$["childNodes"])));
} else {
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__100220) : pred__100219.call(null,hickory.core.DocumentType,expr__100220)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__100220) : pred__100219.call(null,hickory.core.Element,expr__100220)))){
...
if(cljs.core.truth_((pred__100219.cljs$core$IFn$_invoke$arity$2 ? pred__100219.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__100220) : pred__100219.call(null,hickory.core.Text,expr__100220)))){
return hickory.utils.html_escape(goog.dom.getRawTextContent(this$));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__100220)].join('')));
}
}
}
}
...
var pred__100222 = cljs.core._EQ_;
var expr__100223 = (this$["nodeType"]);
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__100223) : pred__100222.call(null,hickory.core.Attribute,expr__100223)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__100223) : pred__100222.call(null,hickory.core.Comment,expr__100223)))){
...
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__100223) : pred__100222.call(null,hickory.core.Document,expr__100223)))){
...
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__100223) : pred__100222.call(null,hickory.core.DocumentType,expr__100223)))){
...
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__100223) : pred__100222.call(null,hickory.core.Element,expr__100223)))){
...
if(cljs.core.truth_((pred__100222.cljs$core$IFn$_invoke$arity$2 ? pred__100222.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__100223) : pred__100222.call(null,hickory.core.Text,expr__100223)))){
return goog.dom.getRawTextContent(this$);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__100223)].join('')));
}
}
}
}
...
var temp__5804__auto___100227 = (doc["head"]["firstChild"]);
if(cljs.core.truth_(temp__5804__auto___100227)){
var title_el_100228 = temp__5804__auto___100227;
if(cljs.core.empty_QMARK_((title_el_100228["text"]))){
hickory.core.remove_el(title_el_100228);
} else {
}
} else {
}
