...
var periods__$1 = cljs.core.vec((function (){var G__49945 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49941_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__49941_SHARP_,(0),(3));
}),G__49945);
} else {
return G__49945;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__49973){
var vec__49974 = p__49973;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49974,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49974,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__49977 = pattern;
switch (G__49977) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49977)].join('')));
...
var G__49993 = key;
var G__49993__$1 = (((G__49993 instanceof cljs.core.Keyword))?G__49993.fqn:null);
switch (G__49993__$1) {
case "millis":
return (function (p1__49981_SHARP_){
return p1__49981_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__49982_SHARP_){
return p1__49982_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__49983_SHARP_){
return p1__49983_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__49988_SHARP_){
return p1__49988_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__49989_SHARP_){
return p1__49989_SHARP_.getHours();
});

break;
case "day":
return (function (p1__49990_SHARP_){
return p1__49990_SHARP_.getDate();
});

break;
case "month":
return (function (p1__49991_SHARP_){
return p1__49991_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__49992_SHARP_){
return p1__49992_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__49993__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__49997){
var vec__49998 = p__49997;
var seq__49999 = cljs.core.seq(vec__49998);
var first__50000 = cljs.core.first(seq__49999);
var seq__49999__$1 = cljs.core.next(seq__49999);
var key = first__50000;
var args = seq__49999__$1;
var G__50002 = key;
...
break;
case "ordinal-suffix":
var vec__50016 = (function (){var G__50019 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__50019) : syntax_list.call(null,G__50019));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50016,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50002__$1)].join('')));
...
var d = value;
var G__50035 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__50036 = G__50035;
...
var unparser = first__50038;
var more = seq__50037__$1;
var s = "";
var d__$1 = d;
...
var unparser__$1 = first__50050;
var more__$1 = seq__50049__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__50055 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50055,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50055,(1),null);
var G__50180 = d__$3;
var G__50181 = more__$1;
var G__50182 = s__$3;
d__$1 = G__50180;
G__50035__$1 = G__50181;
s__$1 = G__50182;
continue;
}
break;
