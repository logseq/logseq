 ...
 */
frontend.handler.global_config.start = (function frontend$handler$global_config$start(p__62148){
var map__62149 = p__62148;
var map__62149__$1 = cljs.core.__destructure_map(map__62149);
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62149__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.timeout.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40957__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.global_config.restore_global_config_BANG_()),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.global_config.create_global_config_file_if_not_exists(repo)),(function (___40947__auto____$2){
