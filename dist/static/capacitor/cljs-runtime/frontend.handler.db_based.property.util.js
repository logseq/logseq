...
(frontend.handler.db_based.property.util.readable_properties.cljs$core$IFn$_invoke$arity$2 = (function (properties,p__60984){
var map__60985 = p__60984;
var map__60985__$1 = cljs.core.__destructure_map(map__60985);
var original_key_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60985__$1,new cljs.core.Keyword(null,"original-key?","original-key?",-219511082));
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__60985__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),cljs.core.identity);
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60988){
var vec__60989 = p__60988;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60989,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60989,(1),null);
var prop_ent = frontend.db.utils.entity.cljs$core$IFn$_invoke$arity$1(k);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60992 = (cljs.core.truth_(original_key_QMARK_)?k:cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1(prop_ent)));
return (key_fn.cljs$core$IFn$_invoke$arity$1 ? key_fn.cljs$core$IFn$_invoke$arity$1(G__60992) : key_fn.call(null,G__60992));
})(),((cljs.core.set_QMARK_(v))?cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(logseq.db.frontend.property.property_value_content,v)):((cljs.core.sequential_QMARK_(v))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60980_SHARP_){
return frontend.handler.db_based.property.util.get_property_value((function (){var or__5002__auto__ = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__60980_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return p1__60980_SHARP_;
}
})());
