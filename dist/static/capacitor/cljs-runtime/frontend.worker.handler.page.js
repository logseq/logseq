...
frontend.worker.handler.page.rtc_create_page_BANG_ = (function frontend$worker$handler$page$rtc_create_page_BANG_(conn,config,title,p__131295){
var map__131298 = p__131295;
var map__131298__$1 = cljs.core.__destructure_map(map__131298);
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131298__$1,new cljs.core.Keyword(null,"uuid","uuid",-2145095719));
...
var len__5726__auto___131391 = arguments.length;
var i__5727__auto___131392 = (0);
while(true){
if((i__5727__auto___131392 < len__5726__auto___131391)){
args__5732__auto__.push((arguments[i__5727__auto___131392]));

var G__131394 = (i__5727__auto___131392 + (1));
i__5727__auto___131392 = G__131394;
continue;
} else {
}
break;
...
(frontend.worker.handler.page.create_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,conn,config,title,p__131317){
var map__131318 = p__131317;
var map__131318__$1 = cljs.core.__destructure_map(map__131318);
var options = map__131318__$1;
if(cljs.core.truth_((function (){var G__131321 = cljs.core.deref(conn);
return (logseq.db.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(G__131321) : logseq.db.db_based_graph_QMARK_.call(null,G__131321));
})())){
...
/** @this {Function} */
(frontend.worker.handler.page.create_BANG_.cljs$lang$applyTo = (function (seq131309){
var G__131310 = cljs.core.first(seq131309);
var seq131309__$1 = cljs.core.next(seq131309);
var G__131311 = cljs.core.first(seq131309__$1);
var seq131309__$2 = cljs.core.next(seq131309__$1);
var G__131312 = cljs.core.first(seq131309__$2);
var seq131309__$3 = cljs.core.next(seq131309__$2);
var G__131313 = cljs.core.first(seq131309__$3);
var seq131309__$4 = cljs.core.next(seq131309__$3);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__131310,G__131311,G__131312,G__131313,seq131309__$4);
}));
...
var id_ref__GT_page = (function (p1__131328_SHARP_){
return logseq.db.frontend.content.content_id_ref__GT_page(p1__131328_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [page_entity], null));
});
if(cljs.core.seq(refs)){
var tx_data = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__131337){
var map__131338 = p__131337;
var map__131338__$1 = cljs.core.__destructure_map(map__131338);
var ref = map__131338__$1;
var raw_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131338__$1,new cljs.core.Keyword("block","raw-title","block/raw-title",1833669090));
...
var args__5732__auto__ = [];
var len__5726__auto___131407 = arguments.length;
var i__5727__auto___131408 = (0);
while(true){
if((i__5727__auto___131408 < len__5726__auto___131407)){
args__5732__auto__.push((arguments[i__5727__auto___131408]));

var G__131410 = (i__5727__auto___131408 + (1));
i__5727__auto___131408 = G__131410;
continue;
} else {
}
break;
...
(frontend.worker.handler.page.delete_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,conn,page_uuid,p__131352){
var map__131353 = p__131352;
var map__131353__$1 = cljs.core.__destructure_map(map__131353);
var persist_op_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131353__$1,new cljs.core.Keyword(null,"persist-op?","persist-op?",-531287534),true);
var rename_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131353__$1,new cljs.core.Keyword(null,"rename?","rename?",-1728043099));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131353__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p__131358){
var map__131359 = p__131358;
var map__131359__$1 = cljs.core.__destructure_map(map__131359);
var msg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131359__$1,new cljs.core.Keyword(null,"msg","msg",-1386103444));
...
var temp__5804__auto__ = (function (){var G__131366 = cljs.core.deref(conn);
var G__131367 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__131366,G__131367) : datascript.core.entity.call(null,G__131366,G__131367));
})();
...
var G__131370_131413 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"msg","msg",-1386103444),"Built-in page cannot be deleted"], null);
(error_handler.cljs$core$IFn$_invoke$arity$1 ? error_handler.cljs$core$IFn$_invoke$arity$1(G__131370_131413) : error_handler.call(null,G__131370_131413));
...
/** @this {Function} */
(frontend.worker.handler.page.delete_BANG_.cljs$lang$applyTo = (function (seq131347){
var G__131348 = cljs.core.first(seq131347);
var seq131347__$1 = cljs.core.next(seq131347);
var G__131349 = cljs.core.first(seq131347__$1);
var seq131347__$2 = cljs.core.next(seq131347__$1);
var G__131350 = cljs.core.first(seq131347__$2);
var seq131347__$3 = cljs.core.next(seq131347__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__131348,G__131349,G__131350,seq131347__$3);
}));
