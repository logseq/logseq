...
if(typeof s === 'string'){
var fexpr__59734 = frontend.date.goog$module$goog$object.get(module$node_modules$chrono_node$dist$index,"parseDate");
return (fexpr__59734.cljs$core$IFn$_invoke$arity$1 ? fexpr__59734.cljs$core$IFn$_invoke$arity$1(s) : fexpr__59734.call(null,s));
} else {
return null;
}
});
...
try{return cljs_time.format.unparse(cljs_time.format.formatter.cljs$core$IFn$_invoke$arity$1("MMM do, yyyy"),cljs_time.core.to_default_time_zone((function (){var G__59740 = input;
if(typeof input === 'string'){
return cljs_time.format.parse.cljs$core$IFn$_invoke$arity$2((cljs_time.format.formatters.cljs$core$IFn$_invoke$arity$1 ? cljs_time.format.formatters.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"date-time-no-ms","date-time-no-ms",1655953671)) : cljs_time.format.formatters.call(null,new cljs.core.Keyword(null,"date-time-no-ms","date-time-no-ms",1655953671))),G__59740);
} else {
return G__59740;
}
})()));
}catch (e59739){var _e = e59739;
return null;
}});
...
frontend.date.today_forward = (function frontend$date$today_forward(d){
return frontend.date.journal_name.cljs$core$IFn$_invoke$arity$1(cljs_time.core.plus.cljs$core$IFn$_invoke$arity$2(frontend.date.start_of_day(cljs_time.local.local_now()),cljs_time.core.days.cljs$core$IFn$_invoke$arity$1(d)));
});
frontend.date.today_backward = (function frontend$date$today_backward(d){
return frontend.date.journal_name.cljs$core$IFn$_invoke$arity$1(cljs_time.core.minus.cljs$core$IFn$_invoke$arity$2(frontend.date.start_of_day(cljs_time.local.local_now()),cljs_time.core.days.cljs$core$IFn$_invoke$arity$1(d)));
});
...
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__59768_SHARP_){
return cljs_time.coerce.to_long(p1__59768_SHARP_);
}));
});
...
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__59770_SHARP_){
return cljs_time.format.unparse(formatter,p1__59770_SHARP_);
}));
});
frontend.date.journal_title__GT_custom_format = (function frontend$date$journal_title__GT_custom_format(journal_title){
return frontend.date.journal_title__GT_.cljs$core$IFn$_invoke$arity$2(journal_title,(function (p1__59772_SHARP_){
return logseq.common.util.date_time.format(p1__59772_SHARP_,frontend.state.get_date_formatter());
}));
});
...
if(cljs.core.truth_((function (){var G__59783 = d;
if((G__59783 == null)){
return null;
} else {
return (G__59783 instanceof Date);
}
})())){
