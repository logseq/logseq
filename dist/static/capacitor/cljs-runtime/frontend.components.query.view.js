...
var or__5002__auto__ = (function (){var G__73100 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(b);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__73100) : frontend.db.entity.call(null,G__73100));
})();
...
var vec__73101 = rum.core.use_state(frontend.components.query.view.init_result(result_STAR_,view_entity));
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73101,(0),null);
var set_data_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73101,(1),null);
...
var G__73104 = frontend.components.query.view.init_result(result_STAR_,view_entity);
return (set_data_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_data_BANG_.cljs$core$IFn$_invoke$arity$1(G__73104) : set_data_BANG_.call(null,G__73104));
