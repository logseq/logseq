...
var state = (function (){var G__67675 = ({"rootMargin": "0px"});
return (frontend.ui.useInView.cljs$core$IFn$_invoke$arity$1 ? frontend.ui.useInView.cljs$core$IFn$_invoke$arity$1(G__67675) : frontend.ui.useInView.call(null,G__67675));
})();
...
})())?daiquiri.interpreter.interpret((function (){var fexpr__67695 = cljs.core.deref(frontend.components.lazy_editor.lazy_editor);
return (fexpr__67695.cljs$core$IFn$_invoke$arity$6 ? fexpr__67695.cljs$core$IFn$_invoke$arity$6(config,id,attr,code,theme,options) : fexpr__67695.call(null,config,id,attr,code,theme,options));
...
var iter__5480__auto__ = (function frontend$components$lazy_editor$iter__67714(s__67715){
return (new cljs.core.LazySeq(null,(function (){
var s__67715__$1 = s__67715;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__67715__$1);
if(temp__5804__auto____$1){
var s__67715__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__67715__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__67715__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__67717 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__67716 = (0);
while(true){
if((i__67716 < size__5479__auto__)){
var map__67718 = cljs.core._nth(c__5478__auto__,i__67716);
var map__67718__$1 = cljs.core.__destructure_map(map__67718);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67718__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
cljs.core.chunk_append(b__67717,((cljs.core.fn_QMARK_(f))?(function (){var G__67719 = window.CodeMirror;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__67719) : f.call(null,G__67719));
})():null));

var G__67736 = (i__67716 + (1));
i__67716 = G__67736;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67717),frontend$components$lazy_editor$iter__67714(cljs.core.chunk_rest(s__67715__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67717),null);
}
} else {
var map__67723 = cljs.core.first(s__67715__$2);
var map__67723__$1 = cljs.core.__destructure_map(map__67723);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67723__$1,new cljs.core.Keyword(null,"enhancer","enhancer",-929020171));
return cljs.core.cons(((cljs.core.fn_QMARK_(f))?(function (){var G__67725 = window.CodeMirror;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__67725) : f.call(null,G__67725));
})():null),frontend$components$lazy_editor$iter__67714(cljs.core.rest(s__67715__$2)));
}
} else {
return null;
}
