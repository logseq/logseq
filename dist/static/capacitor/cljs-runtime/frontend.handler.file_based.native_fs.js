goog.provide('frontend.handler.file_based.native_fs');
goog.scope(function(){
  frontend.handler.file_based.native_fs.goog$module$goog$object = goog.module.get('goog.object');
});
frontend.handler.file_based.native_fs.remove_ignore_files = (function frontend$handler$file_based$native_fs$remove_ignore_files(files,dir_name,nfs_QMARK_){
...
var temp__5802__auto__ = cljs.core.some((function (p1__66270_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","name","file/name",1848919477).cljs$core$IFn$_invoke$arity$1(p1__66270_SHARP_),".gitignore")){
return p1__66270_SHARP_;
} else {
return null;
}
}),files__$1);
...
frontend.handler.file_based.native_fs.__GT_db_files = (function frontend$handler$file_based$native_fs$__GT_db_files(result,nfs_QMARK_){
...
})())?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__66271){
var map__66272 = p__66271;
var map__66272__$1 = cljs.core.__destructure_map(map__66272);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66272__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66272__$1,new cljs.core.Keyword(null,"content","content",15833224));
var stat = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66272__$1,new cljs.core.Keyword(null,"stat","stat",-1370599836));
...
frontend.handler.file_based.native_fs.filter_markup_and_built_in_files = (function frontend$handler$file_based$native_fs$filter_markup_and_built_in_files(files){
 ...
 */
frontend.handler.file_based.native_fs.precheck_graph_dir = (function frontend$handler$file_based$native_fs$precheck_graph_dir(_dir,files){
if(cljs.core.truth_(cljs.core.some((function (p1__66273_SHARP_){
return clojure.string.ends_with_QMARK_(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(p1__66273_SHARP_),"/logseq/config.edn");
}),files))){
 ...
 */
frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_ = (function frontend$handler$file_based$native_fs$ls_dir_files_with_handler_BANG_(var_args){
var G__66276 = arguments.length;
switch (G__66276) {
case 1:
return frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (ok_handler){
return frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$2(ok_handler,null);
}));

(frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (ok_handler,p__66282){
var map__66287 = p__66282;
var map__66287__$1 = cljs.core.__destructure_map(map__66287);
var on_open_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66287__$1,new cljs.core.Keyword(null,"on-open-dir","on-open-dir",1666374285));
var dir_result_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66287__$1,new cljs.core.Keyword(null,"dir-result-fn","dir-result-fn",839285404));
var picked_root_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66287__$1,new cljs.core.Keyword(null,"picked-root-fn","picked-root-fn",42247568));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66287__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
...
return promesa.core.finally$.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_loading_files_BANG_(repo,true)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(((frontend.state.home_QMARK_())?null:frontend.handler.route.redirect_to_home_BANG_.cljs$core$IFn$_invoke$arity$1(false))),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.reset_BANG_(_STAR_repo,repo)),(function (___40947__auto____$2){
return promesa.protocols._promise(((clojure.string.blank_QMARK_(root_dir))?null:promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.native_fs.precheck_graph_dir(root_dir,new cljs.core.Keyword(null,"files","files",-472457450).cljs$core$IFn$_invoke$arity$1(result))),(function (___$2){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.native_fs.remove_ignore_files(frontend.handler.file_based.native_fs.__GT_db_files(files,nfs_QMARK_),root_dir,nfs_QMARK_)),(function (files__$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.native_fs.filter_markup_and_built_in_files(files__$1)),(function (markup_files){
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__66274_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__66274_SHARP_,new cljs.core.Keyword("file","file","file/file",-1241327538));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db._LT_new(repo,cljs.core.PersistentArrayMap.EMPTY)),(function (___40947__auto____$3){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.repo.start_repo_db_if_not_exists_BANG_(repo)),(function (___40947__auto____$4){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.config.global_config_enabled_QMARK_())?frontend.handler.global_config.restore_global_config_BANG_():null)),(function (___40947__auto____$5){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.repo.load_new_repo_to_db_BANG_(repo,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"new-graph?","new-graph?",-843567695),true,new cljs.core.Keyword(null,"empty-graph?","empty-graph?",981603639),(cljs.core.seq(markup_files) == null),new cljs.core.Keyword(null,"file-objs","file-objs",545613385),files__$2], null))),(function (___40947__auto____$6){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_parsing_state_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"graph-loading?","graph-loading?",1136649541),false], null))),(function (___40947__auto____$7){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.add_repo_BANG_(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"url","url",276297046),repo,new cljs.core.Keyword(null,"nfs?","nfs?",-544337673),true], null))),(function (___40947__auto____$8){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db._LT_export_db(repo,cljs.core.PersistentArrayMap.EMPTY)),(function (___40947__auto____$9){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_loading_files_BANG_(repo,false)),(function (___40947__auto____$10){
return promesa.protocols._promise((cljs.core.truth_(ok_handler)?(function (){var G__66317 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"url","url",276297046),repo], null);
return (ok_handler.cljs$core$IFn$_invoke$arity$1 ? ok_handler.cljs$core$IFn$_invoke$arity$1(G__66317) : ok_handler.call(null,G__66317));
})():null));
}));
}));
}));
...
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.handler.file-based.native-fs",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("fs","load-files-error","fs/load-files-error",1672389466),repo,new cljs.core.Keyword(null,"line","line",212345235),144], null)),null);

return lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.handler.file-based.native-fs",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"exception","exception",-335277064),error,new cljs.core.Keyword(null,"line","line",212345235),145], null)),error);
})));
}));
}));
}));
...
lambdaisland.glogi.log.cljs$core$IFn$_invoke$arity$4("frontend.handler.file-based.native-fs",new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.identity(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"exception","exception",-335277064),error,new cljs.core.Keyword(null,"line","line",212345235),147], null)),error);
...
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["Error",null,"AbortError",null], null), null),frontend.handler.file_based.native_fs.goog$module$goog$object.get(error,"name"))){
...
(frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$lang$maxFixedArity = 2);

frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_ = (function frontend$handler$file_based$native_fs$ls_dir_files_with_path_BANG_(var_args){
var G__66319 = arguments.length;
switch (G__66319) {
case 1:
return frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$1((arguments[(0)]));

break;
case 2:
return frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$2((arguments[(0)]),(arguments[(1)]));
...
(frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$1 = (function (path){
return frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$2(path,null);
}));

(frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (path,opts){
...
return frontend.handler.file_based.native_fs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089).cljs$core$IFn$_invoke$arity$1(opts),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dir-result-fn","dir-result-fn",839285404),dir_result_fn], null),opts], 0)));
} else {
return null;
}
}));

(frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$lang$maxFixedArity = 2);

frontend.handler.file_based.native_fs.compute_diffs = (function frontend$handler$file_based$native_fs$compute_diffs(old_files,new_files){
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66336_SHARP_){
return cljs.core.select_keys(p1__66336_SHARP_,ks__$1);
}),files));
} else {
return null;
}
...
return cljs.core.some((function (p1__66348_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","path","file/path",-191335748).cljs$core$IFn$_invoke$arity$1(p1__66348_SHARP_),path)){
return p1__66348_SHARP_;
} else {
return null;
}
}),files);
...
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("frontend.handler.file-based.native-fs","compute-diffs","frontend.handler.file-based.native-fs/compute-diffs",-1621522959),new cljs.core.Keyword(null,"added","added",2057651688),cljs.core.count(added),new cljs.core.Keyword(null,"modified","modified",-2134587826),cljs.core.count(modified),new cljs.core.Keyword(null,"deleted","deleted",-510100639),cljs.core.count(deleted)], 0));
 ...
 */
frontend.handler.file_based.native_fs.handle_diffs_BANG_ = (function frontend$handler$file_based$native_fs$handle_diffs_BANG_(repo,nfs_QMARK_,old_files,new_files,re_index_QMARK_,ok_handler){
...
return cljs.core.some((function (p1__66469_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","path","file/path",-191335748).cljs$core$IFn$_invoke$arity$1(p1__66469_SHARP_),path)){
return p1__66469_SHARP_;
} else {
return null;
}
}),files);
});
var map__66475 = frontend.handler.file_based.native_fs.compute_diffs(old_files,new_files);
var map__66475__$1 = cljs.core.__destructure_map(map__66475);
var added = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66475__$1,new cljs.core.Keyword(null,"added","added",2057651688));
var modified = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66475__$1,new cljs.core.Keyword(null,"modified","modified",-2134587826));
var deleted = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66475__$1,new cljs.core.Keyword(null,"deleted","deleted",-510100639));
...
var files = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66473_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__66473_SHARP_,new cljs.core.Keyword("file","file","file/file",-1241327538));
}),result);
var vec__66482 = (cljs.core.truth_(re_index_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [files,cljs.core.set(modified)], null):(function (){var modified_files = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (file){
...
var modified_files = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66482,(0),null);
var modified__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66482,(1),null);
 ...
 */
frontend.handler.file_based.native_fs.reload_dir_BANG_ = (function frontend$handler$file_based$native_fs$reload_dir_BANG_(repo,p__66488){
var map__66489 = p__66488;
var map__66489__$1 = cljs.core.__destructure_map(map__66489);
var re_index_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__66489__$1,new cljs.core.Keyword(null,"re-index?","re-index?",1279325395),false);
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66489__$1,new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089));
...
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.config.global_config_enabled_QMARK_())?frontend.handler.global_config.restore_global_config_BANG_():null)),(function (_){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.native_fs.remove_ignore_files(frontend.handler.file_based.native_fs.__GT_db_files(new cljs.core.Keyword(null,"files","files",-472457450).cljs$core$IFn$_invoke$arity$1(local_files_result),nfs_QMARK_),repo_dir,nfs_QMARK_)),(function (new_files){
return promesa.protocols._promise(frontend.handler.file_based.native_fs.handle_diffs_BANG_(repo,nfs_QMARK_,old_files,new_files,re_index_QMARK_,ok_handler));
}));
}));
}));
})):null));
...
frontend.handler.file_based.native_fs.rebuild_index_BANG_ = (function frontend$handler$file_based$native_fs$rebuild_index_BANG_(repo,ok_handler){
var graph_dir = frontend.config.get_repo_dir(repo);
if(cljs.core.truth_(repo)){
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40957__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.repo.remove_repo_BANG_.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"url","url",276297046),repo], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"switch-graph?","switch-graph?",1080858350),false], 0))),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.native_fs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$2(graph_dir,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"re-index?","re-index?",1279325395),true], null))),(function (___40947__auto____$1){
...
frontend.handler.file_based.native_fs.refresh_BANG_ = (function frontend$handler$file_based$native_fs$refresh_BANG_(repo,ok_handler){
...
return frontend.handler.file_based.native_fs.reload_dir_BANG_(repo,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089),ok_handler__$1], null));
} else {
return null;
}
});
frontend.handler.file_based.native_fs.supported_QMARK_ = (function frontend$handler$file_based$native_fs$supported_QMARK_(){
...
//# sourceMappingURL=frontend.handler.file_based.native_fs.js.map
