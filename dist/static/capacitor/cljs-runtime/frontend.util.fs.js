...
var or__5002__auto__ = cljs.core.some((function (p1__65899_SHARP_){
return clojure.string.starts_with_QMARK_(path,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(dir,""))?p1__65899_SHARP_:[cljs.core.str.cljs$core$IFn$_invoke$arity$1(dir),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__65899_SHARP_)].join('')));
}),ignores);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = cljs.core.some((function (p1__65900_SHARP_){
return clojure.string.includes_QMARK_(path,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(dir,""))?["/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__65900_SHARP_),"/"].join(''):[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__65900_SHARP_),"/"].join('')));
}),ignores);
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
var or__5002__auto____$2 = cljs.core.some((function (p1__65902_SHARP_){
return clojure.string.ends_with_QMARK_(path,p1__65902_SHARP_);
...
return (((!(clojure.string.blank_QMARK_(module$node_modules$path$path.extname(path__$1))))) && (cljs.core.not(cljs.core.some((function (p1__65903_SHARP_){
return clojure.string.ends_with_QMARK_(path__$1,p1__65903_SHARP_);
...
return promesa.protocols._promise((cljs.core.truth_(exists_QMARK_)?promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto____$1){
...
return promesa.core.all((function (){var iter__5480__auto__ = (function frontend$util$fs$inflate_graphs_info_$_iter__65916(s__65917){
return (new cljs.core.LazySeq(null,(function (){
var s__65917__$1 = s__65917;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__65917__$1);
if(temp__5804__auto__){
var s__65917__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65917__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__65917__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__65919 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__65918 = (0);
while(true){
if((i__65918 < size__5479__auto__)){
var map__65920 = cljs.core._nth(c__5478__auto__,i__65918);
var map__65920__$1 = cljs.core.__destructure_map(map__65920);
var graph = map__65920__$1;
var root = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65920__$1,new cljs.core.Keyword(null,"root","root",-448657453));
cljs.core.chunk_append(b__65919,promesa.protocols._mcat(promesa.protocols._promise(null),((function (i__65918,map__65920,map__65920__$1,graph,root,c__5478__auto__,size__5479__auto__,b__65919,s__65917__$2,temp__5804__auto__){
return (function (___40979__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.util.fs.read_graphs_txid_info(root)),((function (i__65918,map__65920,map__65920__$1,graph,root,c__5478__auto__,size__5479__auto__,b__65919,s__65917__$2,temp__5804__auto__){
...
});})(i__65918,map__65920,map__65920__$1,graph,root,c__5478__auto__,size__5479__auto__,b__65919,s__65917__$2,temp__5804__auto__))
);
});})(i__65918,map__65920,map__65920__$1,graph,root,c__5478__auto__,size__5479__auto__,b__65919,s__65917__$2,temp__5804__auto__))
));

var G__65937 = (i__65918 + (1));
i__65918 = G__65937;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65919),frontend$util$fs$inflate_graphs_info_$_iter__65916(cljs.core.chunk_rest(s__65917__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65919),null);
}
} else {
var map__65925 = cljs.core.first(s__65917__$2);
var map__65925__$1 = cljs.core.__destructure_map(map__65925);
var graph = map__65925__$1;
var root = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65925__$1,new cljs.core.Keyword(null,"root","root",-448657453));
return cljs.core.cons(promesa.protocols._mcat(promesa.protocols._promise(null),((function (map__65925,map__65925__$1,graph,root,s__65917__$2,temp__5804__auto__){
return (function (___40979__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.util.fs.read_graphs_txid_info(root)),(function (sync_meta){
return promesa.protocols._promise((cljs.core.truth_(sync_meta)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(graph,new cljs.core.Keyword(null,"sync-meta","sync-meta",-164400022),sync_meta,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"GraphUUID","GraphUUID",-237263531),cljs.core.second(sync_meta)], 0)):graph));
}));
});})(map__65925,map__65925__$1,graph,root,s__65917__$2,temp__5804__auto__))
),frontend$util$fs$inflate_graphs_info_$_iter__65916(cljs.core.rest(s__65917__$2)));
}
} else {
return null;
}
