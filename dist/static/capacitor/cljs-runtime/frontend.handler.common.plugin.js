...
var G__62241 = "https://plugins.logseq.io/r2";
var G__62242 = repo;
var G__62243 = (((!(typeof version === 'string')))?"":version);
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$3 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$3(G__62241,G__62242,G__62243) : frontend.util.node_path.join.call(null,G__62241,G__62242,G__62243));
}));
...
})())?promesa.core.then.cljs$core$IFn$_invoke$arity$2(res.json(),(function (p1__62247_SHARP_){
return cljs_bean.core.__GT_clj(p1__62247_SHARP_);
...
frontend.handler.common.plugin.async_install_or_update_for_web_BANG_ = (function frontend$handler$common$plugin$async_install_or_update_for_web_BANG_(p__62260){
var map__62261 = p__62260;
var map__62261__$1 = cljs.core.__destructure_map(map__62261);
var manifest = map__62261__$1;
var version = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62261__$1,new cljs.core.Keyword(null,"version","version",425292698));
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62261__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
var only_check = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62261__$1,new cljs.core.Keyword(null,"only-check","only-check",-1961506795));
...
return frontend.handler.common.plugin.emit_lsp_updates_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"completed","completed",-486056503),new cljs.core.Keyword(null,"only-check","only-check",-1961506795),only_check,new cljs.core.Keyword(null,"payload","payload",-383036092),(cljs.core.truth_(only_check)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(manifest,new cljs.core.Keyword(null,"latest-version","latest-version",-1985110248),valid_latest_version,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"latest-notes","latest-notes",-368663386),(function (){var G__62266 = web_pkg__$1;
var G__62266__$1 = (((G__62266 == null))?null:new cljs.core.Keyword(null,"_objectExtra","_objectExtra",-262784354).cljs$core$IFn$_invoke$arity$1(G__62266));
if((G__62266__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"releaseNotes","releaseNotes",959586112).cljs$core$IFn$_invoke$arity$1(G__62266__$1);
}
 ...
 */
frontend.handler.common.plugin.install_marketplace_plugin_BANG_ = (function frontend$handler$common$plugin$install_marketplace_plugin_BANG_(p__62283){
var map__62284 = p__62283;
var map__62284__$1 = cljs.core.__destructure_map(map__62284);
var manifest = map__62284__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62284__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
