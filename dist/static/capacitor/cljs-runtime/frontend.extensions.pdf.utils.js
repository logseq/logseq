...
frontend.extensions.pdf.utils.vw_to_scaled_pos = (function frontend$extensions$pdf$utils$vw_to_scaled_pos(viewer,p__63365){
var map__63366 = p__63365;
var map__63366__$1 = cljs.core.__destructure_map(map__63366);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63366__$1,new cljs.core.Keyword(null,"page","page",849072397));
var bounding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63366__$1,new cljs.core.Keyword(null,"bounding","bounding",-2125178263));
var rects = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63366__$1,new cljs.core.Keyword(null,"rects","rects",1714526167));
var temp__5804__auto__ = viewer.getPageView((page - (1))).viewport;
if(cljs.core.truth_(temp__5804__auto__)){
var viewport = temp__5804__auto__;
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"bounding","bounding",-2125178263),frontend.extensions.pdf.utils.viewport_to_scaled(bounding,viewport),new cljs.core.Keyword(null,"rects","rects",1714526167),(function (){var iter__5480__auto__ = (function frontend$extensions$pdf$utils$vw_to_scaled_pos_$_iter__63368(s__63369){
return (new cljs.core.LazySeq(null,(function (){
var s__63369__$1 = s__63369;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__63369__$1);
if(temp__5804__auto____$1){
var s__63369__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__63369__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__63369__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__63371 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__63370 = (0);
while(true){
if((i__63370 < size__5479__auto__)){
var rect = cljs.core._nth(c__5478__auto__,i__63370);
cljs.core.chunk_append(b__63371,frontend.extensions.pdf.utils.viewport_to_scaled(rect,viewport));

var G__63412 = (i__63370 + (1));
i__63370 = G__63412;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63371),frontend$extensions$pdf$utils$vw_to_scaled_pos_$_iter__63368(cljs.core.chunk_rest(s__63369__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63371),null);
}
} else {
var rect = cljs.core.first(s__63369__$2);
return cljs.core.cons(frontend.extensions.pdf.utils.viewport_to_scaled(rect,viewport),frontend$extensions$pdf$utils$vw_to_scaled_pos_$_iter__63368(cljs.core.rest(s__63369__$2)));
}
} else {
return null;
}
...
frontend.extensions.pdf.utils.scaled_to_vw_pos = (function frontend$extensions$pdf$utils$scaled_to_vw_pos(viewer,p__63375){
var map__63376 = p__63375;
var map__63376__$1 = cljs.core.__destructure_map(map__63376);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63376__$1,new cljs.core.Keyword(null,"page","page",849072397));
var bounding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63376__$1,new cljs.core.Keyword(null,"bounding","bounding",-2125178263));
var rects = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63376__$1,new cljs.core.Keyword(null,"rects","rects",1714526167));
var temp__5804__auto__ = viewer.getPageView((page - (1))).viewport;
if(cljs.core.truth_(temp__5804__auto__)){
var viewport = temp__5804__auto__;
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"bounding","bounding",-2125178263),frontend.extensions.pdf.utils.scaled_to_viewport(bounding,viewport),new cljs.core.Keyword(null,"rects","rects",1714526167),(function (){var iter__5480__auto__ = (function frontend$extensions$pdf$utils$scaled_to_vw_pos_$_iter__63377(s__63378){
return (new cljs.core.LazySeq(null,(function (){
var s__63378__$1 = s__63378;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__63378__$1);
if(temp__5804__auto____$1){
var s__63378__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__63378__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__63378__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__63380 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__63379 = (0);
while(true){
if((i__63379 < size__5479__auto__)){
var rect = cljs.core._nth(c__5478__auto__,i__63379);
cljs.core.chunk_append(b__63380,frontend.extensions.pdf.utils.scaled_to_viewport(rect,viewport));

var G__63413 = (i__63379 + (1));
i__63379 = G__63413;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63380),frontend$extensions$pdf$utils$scaled_to_vw_pos_$_iter__63377(cljs.core.chunk_rest(s__63378__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63380),null);
}
} else {
var rect = cljs.core.first(s__63378__$2);
return cljs.core.cons(frontend.extensions.pdf.utils.scaled_to_viewport(rect,viewport),frontend$extensions$pdf$utils$scaled_to_vw_pos_$_iter__63377(cljs.core.rest(s__63378__$2)));
}
} else {
return null;
}
...
var G__63383 = cljs_bean.core.__GT_clj(info);
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(G__63383) : resolve.call(null,G__63383));
} else {
return null;
}
})),(function (e){
...
var G__63387 = win;
var G__63387__$1 = (((G__63387 == null))?null:G__63387.getSelection());
if((G__63387__$1 == null)){
return null;
} else {
return G__63387__$1.removeAllRanges();
}
}));

(frontend.extensions.pdf.utils.clear_all_selection.cljs$lang$maxFixedArity = 1);

frontend.extensions.pdf.utils.adjust_viewer_size_BANG_ = (function (){var G__63401 = (function (viewer){
return (viewer.currentScaleValue = "auto");
});
var G__63402 = (200);
return (frontend.util.debounce.cljs$core$IFn$_invoke$arity$2 ? frontend.util.debounce.cljs$core$IFn$_invoke$arity$2(G__63401,G__63402) : frontend.util.debounce.call(null,G__63401,G__63402));
})();
...
if(cljs.core.map_QMARK_(p1__63403_SHARP_)){
return p1__63403_SHARP_;
} else {
return cljs_bean.core.__GT_clj(p1__63403_SHARP_);
}
}),its);
} else {
return null;
...
var rects = (function (){var iter__5480__auto__ = (function frontend$extensions$pdf$utils$get_range_rects_LT__page_cnt_$_iter__63404(s__63405){
return (new cljs.core.LazySeq(null,(function (){
var s__63405__$1 = s__63405;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__63405__$1);
if(temp__5804__auto__){
var s__63405__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63405__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__63405__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__63407 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__63406 = (0);
while(true){
if((i__63406 < size__5479__auto__)){
var rect = cljs.core._nth(c__5478__auto__,i__63406);
...
cljs.core.chunk_append(b__63407,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"top","top",-1856271961),((rect.top + page_cnt.scrollTop) - cnt_offset.top),new cljs.core.Keyword(null,"left","left",-399115937),((rect.left + page_cnt.scrollLeft) - cnt_offset.left),new cljs.core.Keyword(null,"width","width",-384071477),rect.width,new cljs.core.Keyword(null,"height","height",1025178622),rect.height], null));

var G__63415 = (i__63406 + (1));
i__63406 = G__63415;
continue;
} else {
var G__63416 = (i__63406 + (1));
i__63406 = G__63416;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63407),frontend$extensions$pdf$utils$get_range_rects_LT__page_cnt_$_iter__63404(cljs.core.chunk_rest(s__63405__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63407),null);
}
} else {
var rect = cljs.core.first(s__63405__$2);
if(cljs.core.truth_((function (){var and__5000__auto__ = rect;
if(cljs.core.truth_(and__5000__auto__)){
return (((!((rect.width === (0))))) && ((!((rect.height === (0))))));
} else {
...
}catch (e63411){if((e63411 instanceof Error)){
var _e = e63411;
return null;
} else {
throw e63411;
