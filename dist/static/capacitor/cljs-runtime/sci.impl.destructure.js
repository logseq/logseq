...
var G__78047 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__78048 = n;
var G__78049 = cljs.core.nnext(bs);
var G__78050 = true;
ret = G__78047;
n = G__78048;
bs = G__78049;
seen_rest_QMARK_ = G__78050;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__77938_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5002__auto__ = mkns;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.namespace(p1__77938_SHARP_);
}
})(),cljs.core.name(p1__77938_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__77941_SHARP_){
return (new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__5002__auto__ = mkns;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.namespace(p1__77941_SHARP_);
}
})(),cljs.core.name(p1__77941_SHARP_)),null,(1),null)),(2),null));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__77942_SHARP_,p2__77943_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__77942_SHARP_,p2__77943_SHARP_,(function (){var fexpr__78000 = cljs.core.val(entry);
return (fexpr__78000.cljs$core$IFn$_invoke$arity$1 ? fexpr__78000.cljs$core$IFn$_invoke$arity$1(p2__77943_SHARP_) : fexpr__78000.call(null,p2__77943_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__78001 = cljs.core.key(entry);
return (fexpr__78001.cljs$core$IFn$_invoke$arity$1 ? fexpr__78001.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__78001.call(null,bes));
})());
...
var G__78067 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__78068 = cljs.core.next(bes);
ret = G__78067;
bes = G__78068;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__77944_SHARP_){
return (cljs.core.first(p1__77944_SHARP_) instanceof cljs.core.Keyword);
}),bents));
