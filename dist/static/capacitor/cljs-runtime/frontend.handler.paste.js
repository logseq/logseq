...
var blocks_SINGLEQUOTE_ = (function (){var G__66784 = logseq.graph_parser.block.with_parent_and_order(page_id,blocks);
if(db_based_QMARK_){
...
if(cljs.core.truth_((function (){var G__66785 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985)))?/\s*\*+\s+/:/\s*-\s+/);
var G__66786 = p__$1;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__66785,G__66786) : frontend.util.safe_re_find.call(null,G__66785,G__66786));
})())){
return p__$1;
} else {
...
}catch (e66787){var _ = e66787;
return ({});
}});
frontend.handler.paste.get_whiteboard_tldr_from_text = (function frontend$handler$paste$get_whiteboard_tldr_from_text(text){
var temp__5804__auto__ = (function (){var G__66788 = /<whiteboard-tldr>(.*)<\/whiteboard-tldr>/;
var G__66789 = logseq.common.util.safe_decode_uri_component(text);
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__66788,G__66789) : frontend.util.safe_re_find.call(null,G__66788,G__66789));
})();
if(cljs.core.truth_(temp__5804__auto__)){
...
var map__66790 = selection_and_format;
var map__66790__$1 = cljs.core.__destructure_map(map__66790);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66790__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var selection_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66790__$1,new cljs.core.Keyword(null,"selection-start","selection-start",-888859581));
var selection_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66790__$1,new cljs.core.Keyword(null,"selection-end","selection-end",696987835));
var selection = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66790__$1,new cljs.core.Keyword(null,"selection","selection",975998651));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66790__$1,new cljs.core.Keyword(null,"value","value",305978217));
return ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(selection_start,selection_end)) && ((!((cljs.core.some((function (p__66791){
var vec__66792 = p__66791;
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66792,(0),null);
var matched_text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66792,(1),null);
...
}),(function (){var G__66795 = format;
var G__66795__$1 = (((G__66795 instanceof cljs.core.Keyword))?G__66795.fqn:null);
switch (G__66795__$1) {
case "markdown":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66795__$1)].join('')));
...
return cljs.core.boolean$((function (){var G__66796 = /^\s*(?:[-+*]|#+)\s+/m;
var G__66797 = text;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__66796,G__66797) : frontend.util.safe_re_find.call(null,G__66796,G__66797));
})());
});
frontend.handler.paste.org_blocks_QMARK_ = (function frontend$handler$paste$org_blocks_QMARK_(text){
return cljs.core.boolean$((function (){var G__66798 = /^\s*\*+\s+/m;
var G__66799 = text;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__66798,G__66799) : frontend.util.safe_re_find.call(null,G__66798,G__66799));
})());
});
/**
...
var map__66800 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(frontend.state.state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editor","last-replace-ref-content-tx","editor/last-replace-ref-content-tx",831177325),frontend.state.get_current_repo()], null));
var map__66800__$1 = cljs.core.__destructure_map(map__66800);
var retracted_block_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66800__$1,new cljs.core.Keyword(null,"retracted-block-ids","retracted-block-ids",-491940807));
var revert_tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66800__$1,new cljs.core.Keyword(null,"revert-tx","revert-tx",1745816539));
...
var map__66801 = frontend.handler.editor.get_selection_and_format();
var map__66801__$1 = cljs.core.__destructure_map(map__66801);
var selection_and_format = map__66801__$1;
var selection = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66801__$1,new cljs.core.Keyword(null,"selection","selection",975998651));
...
var format = (function (){var or__5002__auto__ = (function (){var G__66802 = frontend.state.get_current_page();
return (frontend.db.get_page_format.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page_format.cljs$core$IFn$_invoke$arity$1(G__66802) : frontend.db.get_page_format.call(null,G__66802));
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
if(cljs.core.truth_((function (){var G__66804 = /(?:\r?\n){2,}/;
var G__66805 = text_SINGLEQUOTE_;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__66804,G__66805) : frontend.util.safe_re_find.call(null,G__66804,G__66805));
})())){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.paste.get_copied_blocks()),(function (p__66807){
var map__66808 = p__66807;
var map__66808__$1 = cljs.core.__destructure_map(map__66808);
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66808__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66808__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
var embed_block_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66808__$1,new cljs.core.Keyword(null,"embed-block?","embed-block?",402074593));
...
if(cljs.core.truth_(cljs.core.some((function (p1__66806_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(block_id,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(p1__66806_SHARP_));
}),(function (){var G__66809 = repo;
var G__66810 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(current_block);
var G__66811 = cljs.core.PersistentArrayMap.EMPTY;
return (frontend.db.get_block_parents.cljs$core$IFn$_invoke$arity$3 ? frontend.db.get_block_parents.cljs$core$IFn$_invoke$arity$3(G__66809,G__66810,G__66811) : frontend.db.get_block_parents.call(null,G__66809,G__66810,G__66811));
})()))){
...
return cljs.core.boolean$((function (){var temp__5804__auto__ = (function (){var G__66813 = frontend.state.get_edit_block();
var G__66813__$1 = (((G__66813 == null))?null:new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(G__66813));
if((G__66813__$1 == null)){
return null;
} else {
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__66813__$1) : frontend.db.entity.call(null,G__66813__$1));
}
})();
if(cljs.core.truth_(temp__5804__auto__)){
var editing_block = temp__5804__auto__;
...
var files_66815__$1 = files;
while(true){
var temp__5804__auto___66816 = cljs.core.first(files_66815__$1);
if(cljs.core.truth_(temp__5804__auto___66816)){
var file_66817 = temp__5804__auto___66816;
var temp__5804__auto___66818__$1 = frontend.state.get_edit_block();
if(cljs.core.truth_(temp__5804__auto___66818__$1)){
var block_66819 = temp__5804__auto___66818__$1;
frontend.handler.editor.upload_asset_BANG_(id,[file_66817],cljs.core.get.cljs$core$IFn$_invoke$arity$3(block_66819,new cljs.core.Keyword("block","format","block/format",-1212045901),new cljs.core.Keyword(null,"markdown","markdown",1227225089)),frontend.handler.editor._STAR_asset_uploading_QMARK_,true);
} else {
}

var G__66820 = cljs.core.rest(files_66815__$1);
files_66815__$1 = G__66820;
continue;
} else {
}
break;
