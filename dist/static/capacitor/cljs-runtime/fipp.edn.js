...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__73371,open,xs,sep,close,f){
var map__73374 = p__73371;
var map__73374__$1 = cljs.core.__destructure_map(map__73374);
var printer = map__73374__$1;
var print_level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73374__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73374__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__73376 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__73376,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__73376;
}
})();
var xform = cljs.core.comp.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(print_length)?cljs.core.take.cljs$core$IFn$_invoke$arity$1(print_length):cljs.core.identity),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__73365_SHARP_){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(printer__$1,p1__73365_SHARP_) : f.call(null,printer__$1,p1__73365_SHARP_));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k73382,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__73394 = k73382;
var G__73394__$1 = (((G__73394 instanceof cljs.core.Keyword))?G__73394.fqn:null);
switch (G__73394__$1) {
case "symbols":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k73382,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__73395){
var vec__73396 = p__73395;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73396,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73396,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__73381){
var self__ = this;
var G__73381__$1 = this;
return (new cljs.core.RecordIter((0),G__73381__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var self__ = this;
var this$__$1 = this;
var _STAR_print_dup_STAR__orig_val__73417 = cljs.core._STAR_print_dup_STAR_;
var _STAR_print_dup_STAR__temp_val__73418 = false;
(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__temp_val__73418);
...
}finally {(cljs.core._STAR_print_dup_STAR_ = _STAR_print_dup_STAR__orig_val__73417);
}}));
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto__ = (function (){var G__73424 = cljs.core.first(x);
return (self__.symbols.cljs$core$IFn$_invoke$arity$1 ? self__.symbols.cljs$core$IFn$_invoke$arity$1(G__73424) : self__.symbols.call(null,G__73424));
})();
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__73425){
var self__ = this;
var map__73426 = p__73425;
var map__73426__$1 = cljs.core.__destructure_map(map__73426);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73426__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73426__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll(this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__73427){
var vec__73428 = p__73427;
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__73431 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__73432 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__73432);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__73431);
}})()], null);
}));
...
var self__ = this;
var this$__$1 = this;
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"text","text",-1790561697),(function (){var _STAR_print_readably_STAR__orig_val__73433 = cljs.core._STAR_print_readably_STAR_;
var _STAR_print_readably_STAR__temp_val__73434 = true;
(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__temp_val__73434);

try{return cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([x], 0));
}finally {(cljs.core._STAR_print_readably_STAR_ = _STAR_print_readably_STAR__orig_val__73433);
}})()], null);
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this73383,other73384){
var self__ = this;
var this73383__$1 = this;
return (((!((other73384 == null)))) && ((((this73383__$1.constructor === other73384.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this73383__$1.symbols,other73384.symbols)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this73383__$1.print_meta,other73384.print_meta)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this73383__$1.print_length,other73384.print_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this73383__$1.print_level,other73384.print_level)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this73383__$1.__extmap,other73384.__extmap)))))))))))));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k73382){
var self__ = this;
var this__5307__auto____$1 = this;
var G__73435 = k73382;
var G__73435__$1 = (((G__73435 instanceof cljs.core.Keyword))?G__73435.fqn:null);
switch (G__73435__$1) {
case "symbols":
case "print-meta":
case "print-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k73382);

}
}));

(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__73381){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__73436 = cljs.core.keyword_identical_QMARK_;
var expr__73437 = k__5309__auto__;
if(cljs.core.truth_((pred__73436.cljs$core$IFn$_invoke$arity$2 ? pred__73436.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__73437) : pred__73436.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__73437)))){
return (new fipp.edn.EdnPrinter(G__73381,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__73436.cljs$core$IFn$_invoke$arity$2 ? pred__73436.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__73437) : pred__73436.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__73437)))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__73381,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__73436.cljs$core$IFn$_invoke$arity$2 ? pred__73436.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__73437) : pred__73436.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__73437)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__73381,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__73436.cljs$core$IFn$_invoke$arity$2 ? pred__73436.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__73437) : pred__73436.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__73437)))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__73381,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__73381),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__73381){
var self__ = this;
var this__5299__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__73381,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__73388){
var extmap__5342__auto__ = (function (){var G__73444 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__73388,new cljs.core.Keyword(null,"symbols","symbols",1211743),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], 0));
if(cljs.core.record_QMARK_(G__73388)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__73444);
} else {
return G__73444;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__73388),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__73388),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__73388),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__73388),null,cljs.core.not_empty(extmap__5342__auto__),null));
});

fipp.edn.pretty = (function fipp$edn$pretty(var_args){
var G__73451 = arguments.length;
switch (G__73451) {
case 1:
...
var _STAR_print_meta_STAR__orig_val__73459 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__73460 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__73460);

try{return fipp.visit.visit(printer,x);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__73459);
}}));
