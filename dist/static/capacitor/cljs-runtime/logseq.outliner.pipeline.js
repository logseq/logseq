...
var temp__5804__auto__ = (function (){var G__63414 = db_after;
var G__63415 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63414,G__63415) : datascript.core.entity.call(null,G__63414,G__63415));
})();
...
var children_refs = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__63417){
var vec__63418 = p__63417;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63418,(0),null);
var map__63421 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63418,(1),null);
var map__63421__$1 = cljs.core.__destructure_map(map__63421);
var child_map = map__63421__$1;
var block_ref_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63421__$1,new cljs.core.Keyword(null,"block-ref-ids","block-ref-ids",-280941211));
...
var G__63527 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(parent_refs,new cljs.core.Keyword(null,"block-ref-ids","block-ref-ids",-280941211).cljs$core$IFn$_invoke$arity$1(parent));
var G__63528 = new cljs.core.Keyword(null,"parent-id","parent-id",-1400729131).cljs$core$IFn$_invoke$arity$1(parent);
parent_refs = G__63527;
parent_id = G__63528;
continue;
} else {
return parent_refs;
...
logseq.outliner.pipeline.compute_block_path_refs = (function logseq$outliner$pipeline$compute_block_path_refs(p__63425,blocks_STAR_){
var map__63426 = p__63425;
var map__63426__$1 = cljs.core.__destructure_map(map__63426);
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63426__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63426__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
if(cljs.core.truth_((function (){var G__63431 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block);
var fexpr__63430 = cljs.core.deref(_STAR_computed_ids);
return (fexpr__63430.cljs$core$IFn$_invoke$arity$1 ? fexpr__63430.cljs$core$IFn$_invoke$arity$1(G__63431) : fexpr__63430.call(null,G__63431));
})())){
return null;
} else {
...
var old_refs = (cljs.core.truth_(db_before)?cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","path-refs","block/path-refs",-2109181352).cljs$core$IFn$_invoke$arity$1((function (){var G__63437 = db_before;
var G__63438 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63437,G__63438) : datascript.core.entity.call(null,G__63437,G__63438));
})()))):cljs.core.PersistentHashSet.EMPTY);
var new_refs = cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((function (){var G__63441 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","page","block/page",822314108).cljs$core$IFn$_invoke$arity$1(block));
if((G__63441 == null)){
return null;
} else {
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[G__63441],null));
}
...
var children = ((refs_changed_QMARK_)?(cljs.core.truth_(page_QMARK_)?null:(function (){var G__63442 = db_after;
var G__63443 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block);
return (logseq.db.get_block_children_ids.cljs$core$IFn$_invoke$arity$2 ? logseq.db.get_block_children_ids.cljs$core$IFn$_invoke$arity$2(G__63442,G__63443) : logseq.db.get_block_children_ids.call(null,G__63442,G__63443));
})()):null);
...
var G__63450 = db_after;
var G__63451 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63450,G__63451) : datascript.core.entity.call(null,G__63450,G__63451));
} else {
...
var temp__5804__auto__ = (function (){var G__63468 = db;
var G__63469 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63468,G__63469) : datascript.core.entity.call(null,G__63468,G__63469));
})();
if(cljs.core.truth_(temp__5804__auto__)){
...
var private_built_in_props = cljs.core.set(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__63474){
...
var properties = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,logseq.db.common.entity_plus.lookup_kv_then_entity.cljs$core$IFn$_invoke$arity$2((function (){var G__63478 = db;
var G__63479 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63478,G__63479) : datascript.core.entity.call(null,G__63478,G__63479));
...
var property_value_refs = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__63483){
var vec__63485 = p__63483;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63485,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63485,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__63470_SHARP_){
return logseq.outliner.pipeline.get_journal_day_from_long(db,p1__63470_SHARP_);
}),v);
} else {
if(datetime_QMARK_){
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__63472_SHARP_){
return cljs.core.contains_QMARK_(cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","alias","block/alias",-2112644699).cljs$core$IFn$_invoke$arity$1(block))),p1__63472_SHARP_);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__63471_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block),p1__63471_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(db,p1__63471_SHARP_) : datascript.core.entity.call(null,db,p1__63471_SHARP_))))));
...
logseq.outliner.pipeline.rebuild_block_refs_tx = (function logseq$outliner$pipeline$rebuild_block_refs_tx(p__63490,blocks){
var map__63491 = p__63490;
var map__63491__$1 = cljs.core.__destructure_map(map__63491);
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63491__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (block){
if(cljs.core.truth_((function (){var G__63492 = db_after;
var G__63493 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(block);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63492,G__63493) : datascript.core.entity.call(null,G__63492,G__63493));
})())){
...
var map__63497 = logseq.outliner.datascript_report.get_blocks_and_pages(tx_report);
var map__63497__$1 = cljs.core.__destructure_map(map__63497);
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63497__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
...
var G__63501 = new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(refs_tx_report);
var G__63502 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(b);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__63501,G__63502) : datascript.core.entity.call(null,G__63501,G__63502));
}),blocks):blocks);
