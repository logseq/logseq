...
var temp__5804__auto__ = cljs.core.last(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(format,new cljs.core.Keyword(null,"org","org",1495985)))?(function (){var G__60818 = /^\s*:([^: ]+): /;
var G__60819 = line;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__60818,G__60819) : frontend.util.safe_re_find.call(null,G__60818,G__60819));
})():(function (){var G__60820 = /^\s*([^ ]+):: /;
var G__60821 = line;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__60820,G__60821) : frontend.util.safe_re_find.call(null,G__60820,G__60821));
})()));
...
if(and__5000__auto__){
var and__5000__auto____$1 = (function (){var G__60830 = /^\s*:[^: ]+: /;
var G__60831 = line;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__60830,G__60831) : frontend.util.safe_re_find.call(null,G__60830,G__60831));
})();
...
var vec__60848 = cljs.core.split_with((function (p1__60839_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__60839_SHARP_)),logseq.graph_parser.property.properties_start)));
}),content_lines);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60848,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60848,(1),null);
var properties = cljs.core.rest(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__60840_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__60840_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__60840_SHARP_)));
}),properties_AMPERSAND_body));
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60841_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__60841_SHARP_,":"))));
}),properties);
} else {
return null;
}
...
var content_lines = clojure.string.split_lines(content);
var properties = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__60854_SHARP_){
return cljs.core.re_matches(cljs.core.re_pattern(["^.+",logseq.graph_parser.property.colons,"\\s*.+"].join('')),p1__60854_SHARP_);
}),content_lines);
if(cljs.core.seq(properties)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60855_SHARP_){
return clojure.string.upper_case(cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(clojure.string.blank_QMARK_,clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__60855_SHARP_,logseq.graph_parser.property.colons))));
}),properties);
} else {
return null;
}
...
return cljs.core.contains_QMARK_(cljs.core.set((function (){var G__60858 = cljs.core.PersistentHashSet.createAsIfByAssoc([key__$1]);
var G__60859 = frontend.handler.file_based.property.util.get_property_keys(format,content);
return (frontend.util.remove_first.cljs$core$IFn$_invoke$arity$2 ? frontend.util.remove_first.cljs$core$IFn$_invoke$arity$2(G__60858,G__60859) : frontend.util.remove_first.call(null,G__60858,G__60859));
})()),key__$1);
});
...
var properties__$1 = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__60863){
var vec__60864 = p__60863;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60864,(0),null);
var _v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60864,(1),null);
var fexpr__60867 = (frontend.handler.file_based.property.util.built_in_properties.cljs$core$IFn$_invoke$arity$0 ? frontend.handler.file_based.property.util.built_in_properties.cljs$core$IFn$_invoke$arity$0() : frontend.handler.file_based.property.util.built_in_properties.call(null));
return (fexpr__60867.cljs$core$IFn$_invoke$arity$1 ? fexpr__60867.cljs$core$IFn$_invoke$arity$1(k) : fexpr__60867.call(null,k));
}),properties);
...
var vec__60868 = (cljs.core.truth_((function (){var G__60872 = cljs.core.first(cljs.core.ffirst(ast));
return (frontend.format.mldoc.block_with_title_QMARK_.cljs$core$IFn$_invoke$arity$1 ? frontend.format.mldoc.block_with_title_QMARK_.cljs$core$IFn$_invoke$arity$1(G__60872) : frontend.format.mldoc.block_with_title_QMARK_.call(null,G__60872));
...
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60868,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60868,(1),null);
...
var map__60871 = cljs.core.group_by((function (s){
...
var properties_lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60871__$1,true);
var body__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60871__$1,false);
...
var properties_in_content = cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60862_SHARP_){
return frontend.handler.file_based.property.util.get_property_key(p1__60862_SHARP_,format);
}),properties_lines)));
...
var built_in_properties_area = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__60877){
var vec__60878 = p__60877;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60878,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60878,(1),null);
if(org_QMARK_){
...
var G__60889 = clojure.string.lower_case;
var G__60890 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(c,aliases);
return (frontend.util.distinct_by.cljs$core$IFn$_invoke$arity$2 ? frontend.util.distinct_by.cljs$core$IFn$_invoke$arity$2(G__60889,G__60890) : frontend.util.distinct_by.call(null,G__60889,G__60890));
}));
} else {
 ...
 */
frontend.handler.file_based.property.util.get_visible_ordered_properties = (function frontend$handler$file_based$property$util$get_visible_ordered_properties(properties_STAR_,properties_order,p__60893){
var map__60894 = p__60893;
var map__60894__$1 = cljs.core.__destructure_map(map__60894);
var pre_block_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60894__$1,new cljs.core.Keyword(null,"pre-block?","pre-block?",-1762448460));
var page_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60894__$1,new cljs.core.Keyword(null,"page-id","page-id",-872941168));
var dissoc_keys = (function (m,keys){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,m,keys);
});
var properties = (function (){var G__60895 = cljs.core.update_keys(properties_STAR_,cljs.core.keyword);
var G__60895__$1 = dissoc_keys(G__60895,frontend.handler.file_based.property.util.hidden_properties())
;
var G__60895__$2 = (cljs.core.truth_(pre_block_QMARK_)?dissoc_keys(G__60895__$1,frontend.handler.file_based.property.util.hidden_editable_page_properties):G__60895__$1);
var G__60895__$3 = ((cljs.core.not(pre_block_QMARK_))?dissoc_keys(G__60895__$2,frontend.handler.file_based.property.util.hidden_editable_block_properties):G__60895__$2);
if(cljs.core.truth_(pre_block_QMARK_)){
return frontend.handler.file_based.property.util.add_aliases_to_properties(G__60895__$3,page_id);
} else {
return G__60895__$3;
}
})();
