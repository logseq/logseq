...
}),cljs.core.comp.cljs$core$IFn$_invoke$arity$2(module$node_modules$bignumber_DOT_js$bignumber.BigNumber,(function (p1__95183_SHARP_){
return clojure.string.replace(p1__95183_SHARP_,",","");
...
var G__95185 = ast;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__95184,G__95185) : instaparse.core.transform.call(null,G__95184,G__95185));
});
frontend.extensions.calc.eval = (function frontend$extensions$calc$eval(var_args){
var G__95187 = arguments.length;
switch (G__95187) {
case 1:
...
}catch (e95188){if((e95188 instanceof Error)){
var e = e95188;
return e;
} else {
throw e95188;
...
return [((cljs.core.neg_int_QMARK_(sign))?"-":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__95190 = base;
switch (G__95190) {
case (2):
return "0b";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__95190)].join('')));
...
var vec__95191 = val.toFraction(max_denominator);
var numerator = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95191,(0),null);
var denominator = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95191,(1),null);
...
})], null),(function (){var iter__5480__auto__ = (function frontend$extensions$calc$iter__95204(s__95205){
return (new cljs.core.LazySeq(null,(function (){
var s__95205__$1 = s__95205;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__95205__$1);
if(temp__5804__auto____$1){
var s__95205__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__95205__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__95205__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__95207 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__95206 = (0);
while(true){
if((i__95206 < size__5479__auto__)){
var vec__95208 = cljs.core._nth(c__5478__auto__,i__95206);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95208,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95208,(1),null);
cljs.core.chunk_append(b__95207,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.extensions__code-calc-output-line.CodeMirror-line","div.extensions__code-calc-output-line.CodeMirror-line",-293396137),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(((line == null))?"":((frontend.extensions.calc.failure_QMARK_(line))?"?":cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)
))], null)], null));

var G__95216 = (i__95206 + (1));
i__95206 = G__95216;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__95207),frontend$extensions$calc$iter__95204(cljs.core.chunk_rest(s__95205__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__95207),null);
}
} else {
var vec__95211 = cljs.core.first(s__95205__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95211,(0),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95211,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.extensions__code-calc-output-line.CodeMirror-line","div.extensions__code-calc-output-line.CodeMirror-line",-293396137),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(((line == null))?"":((frontend.extensions.calc.failure_QMARK_(line))?"?":cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)
))], null)], null),frontend$extensions$calc$iter__95204(cljs.core.rest(s__95205__$2)));
}
} else {
return null;
}
