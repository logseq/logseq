 ...
 */
logseq.db.frontend.property.type.url_entity_QMARK_ = (function logseq$db$frontend$property$type$url_entity_QMARK_(db,val,p__59057){
var map__59058 = p__59057;
var map__59058__$1 = cljs.core.__destructure_map(map__59058);
var new_closed_value_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59058__$1,new cljs.core.Keyword(null,"new-closed-value?","new-closed-value?",773408852));
...
logseq.db.frontend.property.type.number_entity_QMARK_ = (function logseq$db$frontend$property$type$number_entity_QMARK_(db,id_or_value,p__59129){
var map__59131 = p__59129;
var map__59131__$1 = cljs.core.__destructure_map(map__59131);
var new_closed_value_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59131__$1,new cljs.core.Keyword(null,"new-closed-value?","new-closed-value?",773408852));
if(cljs.core.truth_(new_closed_value_QMARK_)){
...
logseq.db.frontend.property.type.text_entity_QMARK_ = (function logseq$db$frontend$property$type$text_entity_QMARK_(db,s,p__59145){
var map__59147 = p__59145;
var map__59147__$1 = cljs.core.__destructure_map(map__59147);
var new_closed_value_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59147__$1,new cljs.core.Keyword(null,"new-closed-value?","new-closed-value?",773408852));
if(cljs.core.truth_(new_closed_value_QMARK_)){
...
var or__5002__auto__ = (function (){var G__59186 = new cljs.core.Keyword("logseq.property","type","logseq.property/type",83842404).cljs$core$IFn$_invoke$arity$1(property);
return (logseq.db.frontend.property.type.original_value_ref_property_types.cljs$core$IFn$_invoke$arity$1 ? logseq.db.frontend.property.type.original_value_ref_property_types.cljs$core$IFn$_invoke$arity$1(G__59186) : logseq.db.frontend.property.type.original_value_ref_property_types.call(null,G__59186));
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
