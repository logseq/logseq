...
var self__ = this;
var self__ = this;
var G__57801 = (arguments.length - (1));
switch (G__57801) {
case (0):
...
(missionary.impl.Semaphore.Port.prototype.apply = (function (self__,args57800){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57800)));
}));
...
var vec__57806 = temp__5806__auto__;
var _BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57806,(0),null);
...
var G__57828 = (new missionary.Cancelled("Semaphore acquire cancelled."));
return (f_BANG_.cljs$core$IFn$_invoke$arity$1 ? f_BANG_.cljs$core$IFn$_invoke$arity$1(G__57828) : f_BANG_.call(null,G__57828));
} else {
return null;
}
});
