...
var attrs69429 = header;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs69429))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-col","gap-1"], null)], null),attrs69429], 0))):{'className':"flex flex-col gap-1"}),((cljs.core.map_QMARK_(attrs69429))?[daiquiri.interpreter.interpret(row)]:[daiquiri.interpreter.interpret(attrs69429),daiquiri.interpreter.interpret(row)]));
} else {
...
frontend.components.select.search_input = rum.core.lazy_build(rum.core.build_defc,(function (_STAR_input,p__69430){
var map__69431 = p__69430;
var map__69431__$1 = cljs.core.__destructure_map(map__69431);
var prompt_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69431__$1,new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683));
var input_default_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69431__$1,new cljs.core.Keyword(null,"input-default-placeholder","input-default-placeholder",-1040139250));
var input_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69431__$1,new cljs.core.Keyword(null,"input-opts","input-opts",1688681135));
var on_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69431__$1,new cljs.core.Keyword(null,"on-input","on-input",-267523366));
var vec__69432 = (function (){var G__69435 = cljs.core.deref(_STAR_input);
return (logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1 ? logseq.shui.hooks.use_state.cljs$core$IFn$_invoke$arity$1(G__69435) : logseq.shui.hooks.use_state.call(null,G__69435));
})();
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69432,(0),null);
var set_input_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69432,(1),null);
...
return daiquiri.core.create_element("div",{'style':{'marginBottom':"-2px"},'className':"input-wrap"},[(function (){var attrs69438 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"class","class",-2030961996),"!p-1.5",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),(function (){var or__5002__auto__ = input_default_placeholder;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
return daiquiri.core.create_element("input",((cljs.core.map_QMARK_(attrs69438))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["cp__select-input","w-full"], null)], null),attrs69438], 0))):{'className':"cp__select-input w-full"}),((cljs.core.map_QMARK_(attrs69438))?null:[daiquiri.interpreter.interpret(attrs69438)]));
})()]);
 ...
 */
frontend.components.select.select = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__69455){
var map__69456 = p__69455;
var map__69456__$1 = cljs.core.__destructure_map(map__69456);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var on_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"on-input","on-input",-267523366));
var empty_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085),(function (_t){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null);
}));
var initial_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"initial-open?","initial-open?",1869534108),true);
var exact_match_exclude_items = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"exact-match-exclude-items","exact-match-exclude-items",-668398850),cljs.core.PersistentHashSet.EMPTY);
var prompt_key = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683),new cljs.core.Keyword("select","default-prompt","select/default-prompt",-657561626));
var on_chosen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900));
var tap__STAR_input_val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"tap-*input-val","tap-*input-val",1531539652));
var limit = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"limit","limit",-1355822363),(100));
var dropdown_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"dropdown?","dropdown?",-1027769147));
var show_new_when_not_exact_match_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"show-new-when-not-exact-match?","show-new-when-not-exact-match?",1510536201));
var loading_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"loading?","loading?",1905707049));
var input_container = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"input-container","input-container",-1901353206));
var item_cp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"item-cp","item-cp",294728683));
var new_case_sensitive_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"new-case-sensitive?","new-case-sensitive?",-581012500));
var extract_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"extract-fn","extract-fn",-339752723),new cljs.core.Keyword(null,"value","value",305978217));
var input_default_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"input-default-placeholder","input-default-placeholder",-1040139250));
var extract_chosen_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"extract-chosen-fn","extract-chosen-fn",1058364622),cljs.core.identity);
var input_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"input-opts","input-opts",1688681135));
var transform_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"transform-fn","transform-fn",1106801327));
var host_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"host-opts","host-opts",-933691505));
var on_apply = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"on-apply","on-apply",-1897056081));
var close_modal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69456__$1,new cljs.core.Keyword(null,"close-modal?","close-modal?",-207518383),true);
var grouped_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"grouped?","grouped?",531080948));
var multiple_choices_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69456__$1,new cljs.core.Keyword(null,"multiple-choices?","multiple-choices?",-1858892490));
...
var selected_choices = rum.core.react(_STAR_selected_choices);
var full_choices = (function (){var G__69457 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,items);
if(cljs.core.seq(cljs.core.deref(input))){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"clear?","clear?",1363344639),G__69457);
} else {
return G__69457;
}
})();
var search_result_SINGLEQUOTE_ = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,(function (){var G__69458 = (function (){var G__69459 = full_choices;
var G__69460 = cljs.core.deref(input);
var G__69461 = new cljs.core.Keyword(null,"limit","limit",-1355822363);
var G__69462 = limit;
var G__69463 = new cljs.core.Keyword(null,"extract-fn","extract-fn",-339752723);
var G__69464 = extract_fn;
return (frontend.search.fuzzy_search.cljs$core$IFn$_invoke$arity$6 ? frontend.search.fuzzy_search.cljs$core$IFn$_invoke$arity$6(G__69459,G__69460,G__69461,G__69462,G__69463,G__69464) : frontend.search.fuzzy_search.call(null,G__69459,G__69460,G__69461,G__69462,G__69463,G__69464));
})();
if(cljs.core.fn_QMARK_(transform_fn)){
var G__69465 = G__69458;
var G__69466 = cljs.core.deref(input);
return (transform_fn.cljs$core$IFn$_invoke$arity$2 ? transform_fn.cljs$core$IFn$_invoke$arity$2(G__69465,G__69466) : transform_fn.call(null,G__69465,G__69466));
} else {
return G__69458;
}
})());
var exact_transform_fn = (cljs.core.truth_(new_case_sensitive_QMARK_)?cljs.core.identity:clojure.string.lower_case);
var exact_match_QMARK_ = cljs.core.contains_QMARK_(cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$3(exact_transform_fn,cljs.core.str,extract_fn),search_result_SINGLEQUOTE_)),(function (){var G__69467 = cljs.core.deref(input);
return (exact_transform_fn.cljs$core$IFn$_invoke$arity$1 ? exact_transform_fn.cljs$core$IFn$_invoke$arity$1(G__69467) : exact_transform_fn.call(null,G__69467));
})());
...
if(cljs.core.truth_(and__5000__auto__)){
return (((!(exact_match_QMARK_))) && ((((!(clojure.string.blank_QMARK_(cljs.core.deref(input))))) && (cljs.core.not((function (){var G__69468 = cljs.core.deref(input);
return (exact_match_exclude_items.cljs$core$IFn$_invoke$arity$1 ? exact_match_exclude_items.cljs$core$IFn$_invoke$arity$1(G__69468) : exact_match_exclude_items.call(null,G__69468));
})())))));
} else {
return and__5000__auto__;
}
...
var input_opts_SINGLEQUOTE_ = ((cljs.core.fn_QMARK_(input_opts))?(function (){var G__69470 = cljs.core.empty_QMARK_(search_result);
return (input_opts.cljs$core$IFn$_invoke$arity$1 ? input_opts.cljs$core$IFn$_invoke$arity$1(G__69470) : input_opts.call(null,G__69470));
})():input_opts);
...
var G__69472 = chosen;
var G__69473 = false;
var G__69474 = cljs.core.deref(_STAR_selected_choices);
var G__69475 = e;
return (on_chosen.cljs$core$IFn$_invoke$arity$4 ? on_chosen.cljs$core$IFn$_invoke$arity$4(G__69472,G__69473,G__69474,G__69475) : on_chosen.call(null,G__69472,G__69473,G__69474,G__69475));
} else {
return null;
}
} else {
...
var G__69476 = chosen;
var G__69477 = true;
var G__69478 = cljs.core.deref(_STAR_selected_choices);
var G__69479 = e;
return (on_chosen.cljs$core$IFn$_invoke$arity$4 ? on_chosen.cljs$core$IFn$_invoke$arity$4(G__69476,G__69477,G__69478,G__69479) : on_chosen.call(null,G__69476,G__69477,G__69478,G__69479));
} else {
return null;
}
}
...
var G__69482 = chosen;
var G__69483 = true;
var G__69484 = cljs.core.deref(_STAR_selected_choices);
var G__69485 = e;
return (on_chosen.cljs$core$IFn$_invoke$arity$4 ? on_chosen.cljs$core$IFn$_invoke$arity$4(G__69482,G__69483,G__69484,G__69485) : on_chosen.call(null,G__69482,G__69483,G__69484,G__69485));
} else {
return null;
}
}
...
var fexpr__69488_69521 = cljs.core.deref(_STAR_toggle);
(fexpr__69488_69521.cljs$core$IFn$_invoke$arity$0 ? fexpr__69488_69521.cljs$core$IFn$_invoke$arity$0() : fexpr__69488_69521.call(null));
} else {
}
...
var attrs69454 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"cp__select-main"], null),host_opts], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs69454))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["cp__select"], null)], null),attrs69454], 0))):{'className':"cp__select"}),((cljs.core.map_QMARK_(attrs69454))?[(cljs.core.truth_(dropdown_QMARK_)?frontend.ui.dropdown(((cljs.core.fn_QMARK_(input_container__$1))?input_container__$1:(function (){
return input_container__$1;
})),results_container_f,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initial-open?","initial-open?",1869534108),initial_open_QMARK_,new cljs.core.Keyword(null,"*toggle-fn","*toggle-fn",458369769),_STAR_toggle], null)):(function (){var attrs69489 = ((cljs.core.fn_QMARK_(input_container__$1))?(input_container__$1.cljs$core$IFn$_invoke$arity$0 ? input_container__$1.cljs$core$IFn$_invoke$arity$0() : input_container__$1.call(null)):input_container__$1);
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs69489))?daiquiri.interpreter.element_attributes(attrs69489):null),((cljs.core.map_QMARK_(attrs69489))?[daiquiri.interpreter.interpret(results_container_f())]:[daiquiri.interpreter.interpret(attrs69489),daiquiri.interpreter.interpret(results_container_f())]));
})())]:[daiquiri.interpreter.interpret(attrs69454),(cljs.core.truth_(dropdown_QMARK_)?frontend.ui.dropdown(((cljs.core.fn_QMARK_(input_container__$1))?input_container__$1:(function (){
return input_container__$1;
})),results_container_f,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"initial-open?","initial-open?",1869534108),initial_open_QMARK_,new cljs.core.Keyword(null,"*toggle-fn","*toggle-fn",458369769),_STAR_toggle], null)):(function (){var attrs69490 = ((cljs.core.fn_QMARK_(input_container__$1))?(input_container__$1.cljs$core$IFn$_invoke$arity$0 ? input_container__$1.cljs$core$IFn$_invoke$arity$0() : input_container__$1.call(null)):input_container__$1);
return daiquiri.core.create_element(daiquiri.core.fragment,((cljs.core.map_QMARK_(attrs69490))?daiquiri.interpreter.element_attributes(attrs69490):null),((cljs.core.map_QMARK_(attrs69490))?[daiquiri.interpreter.interpret(results_container_f())]:[daiquiri.interpreter.interpret(attrs69490),daiquiri.interpreter.interpret(results_container_f())]));
})())]));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69494){
var map__69495 = p__69494;
var map__69495__$1 = cljs.core.__destructure_map(map__69495);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69495__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__69496){
var map__69497 = p__69496;
var map__69497__$1 = cljs.core.__destructure_map(map__69497);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69497__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683),new cljs.core.Keyword("select.graph","prompt","select.graph/prompt",640552877),new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),(function (p1__69491_SHARP_){
return frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("graph","switch","graph/switch",178853840),new cljs.core.Keyword(null,"graph","graph",1558099509).cljs$core$IFn$_invoke$arity$1(p1__69491_SHARP_)], null));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69498){
var map__69499 = p__69498;
var map__69499__$1 = cljs.core.__destructure_map(map__69499);
var original_graph = map__69499__$1;
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69499__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__69500){
var map__69501 = p__69500;
var map__69501__$1 = cljs.core.__destructure_map(map__69501);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69501__$1,new cljs.core.Keyword(null,"url","url",276297046));
return frontend.config.demo_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(url);
}),frontend.state.get_repos()));
}),new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),(function (p1__69492_SHARP_){
return frontend.handler.repo.remove_repo_BANG_(new cljs.core.Keyword(null,"original-graph","original-graph",1959751157).cljs$core$IFn$_invoke$arity$1(p1__69492_SHARP_));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__69502){
var map__69503 = p__69502;
var map__69503__$1 = cljs.core.__destructure_map(map__69503);
var original_graph = map__69503__$1;
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69503__$1,new cljs.core.Keyword(null,"url","url",276297046));
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),frontend.util.text.get_graph_name_from_path(url),new cljs.core.Keyword(null,"id","id",-1388402092),frontend.config.get_repo_dir(url),new cljs.core.Keyword(null,"graph","graph",1558099509),url,new cljs.core.Keyword(null,"original-graph","original-graph",1959751157),original_graph], null);
}),cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__69504){
var map__69505 = p__69504;
var map__69505__$1 = cljs.core.__destructure_map(map__69505);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69505__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
}),new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),(function (p1__69493_SHARP_){
return frontend.handler.common.developer.import_chosen_graph(new cljs.core.Keyword(null,"graph","graph",1558099509).cljs$core$IFn$_invoke$arity$1(p1__69493_SHARP_));
})], null)], null);
});
...
})),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-chosen","on-chosen",-114535900),new cljs.core.Keyword(null,"empty-placeholder","empty-placeholder",-68202085),new cljs.core.Keyword(null,"prompt-key","prompt-key",1549371683)], null)),new cljs.core.Keyword(null,"items","items",1031954938),(function (){var fexpr__69508 = new cljs.core.Keyword(null,"items-fn","items-fn",1580041737).cljs$core$IFn$_invoke$arity$1(select_type_config);
return (fexpr__69508.cljs$core$IFn$_invoke$arity$0 ? fexpr__69508.cljs$core$IFn$_invoke$arity$0() : fexpr__69508.call(null));
})()));
});
var G__69507 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"ls-select-modal","ls-select-modal",-1423366619),new cljs.core.Keyword(null,"close-btn?","close-btn?",336318726),false,new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"top","top",-1856271961),new cljs.core.Keyword(null,"content-props","content-props",687449284),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"ls-dialog-select"], null)], null);
return (logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2(G__69506,G__69507) : logseq.shui.ui.dialog_open_BANG_.call(null,G__69506,G__69507));
} else {
return null;
}
});
