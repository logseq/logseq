...
return promesa.core.finally$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
...
})),'className':"form-input font-mono block w-full sm:text-sm sm:leading-5"},[])])])]),(function (){var attrs92846 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Run",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),frontend.components.shell.run_command], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs92846))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-row","items-center"], null)], null),attrs92846], 0))):{'className':"flex flex-row items-center"}),((cljs.core.map_QMARK_(attrs92846))?[(function (){var attrs92851 = (cljs.core.truth_(loading_QMARK_)?frontend.ui.loading.cljs$core$IFn$_invoke$arity$1(""):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs92851))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-4"], null)], null),attrs92851], 0))):{'className':"ml-4"}),((cljs.core.map_QMARK_(attrs92851))?null:[daiquiri.interpreter.interpret(attrs92851)]));
})()]:[daiquiri.interpreter.interpret(attrs92846),(function (){var attrs92852 = (cljs.core.truth_(loading_QMARK_)?frontend.ui.loading.cljs$core$IFn$_invoke$arity$1(""):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs92852))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["ml-4"], null)], null),attrs92852], 0))):{'className':"ml-4"}),((cljs.core.map_QMARK_(attrs92852))?null:[daiquiri.interpreter.interpret(attrs92852)]));
})()]));
})()])]);
