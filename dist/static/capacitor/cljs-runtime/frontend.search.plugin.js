...
var map__62966 = service;
var map__62966__$1 = cljs.core.__destructure_map(map__62966);
var pid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62966__$1,new cljs.core.Keyword(null,"pid","pid",1018387698));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62966__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return frontend.state.update_plugin_search_engine(pid,name,(function (p1__62963_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__62963_SHARP_,new cljs.core.Keyword(null,"result","result",1415092211),cljs_bean.core.__GT_clj(e));
}));
}));
} else {
return null;
...
var blocks_to_remove_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62967__$1,new cljs.core.Keyword(null,"blocks-to-remove-set","blocks-to-remove-set",266406009));
var blocks_to_add = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62967__$1,new cljs.core.Keyword(null,"blocks-to-add","blocks-to-add",-814061792));
