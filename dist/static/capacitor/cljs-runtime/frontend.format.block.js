 ...
 */
frontend.format.block.extract_blocks = (function frontend$format$block$extract_blocks(blocks,content,format,p__63355){
var map__63356 = p__63355;
var map__63356__$1 = cljs.core.__destructure_map(map__63356);
var page_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63356__$1,new cljs.core.Keyword(null,"page-name","page-name",974981762));
var parse_block = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63356__$1,new cljs.core.Keyword(null,"parse-block","parse-block",-741293779));
...
var G__63358 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(block,new cljs.core.Keyword("block","format","block/format",-1212045901),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("block","properties","block/properties",708347145),new cljs.core.Keyword("block","macros","block/macros",650396438),new cljs.core.Keyword("block","properties-order","block/properties-order",-968493873)], 0));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__63358,cljs.core.update_keys(new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(block),(function (k){
var or__5002__auto__ = (function (){var fexpr__63360 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"heading","heading",-1312171873),new cljs.core.Keyword("logseq.property","heading","logseq.property/heading",1858749415)], null);
return (fexpr__63360.cljs$core$IFn$_invoke$arity$1 ? fexpr__63360.cljs$core$IFn$_invoke$arity$1(k) : fexpr__63360.call(null,k));
})();
...
var G__63362 = block;
var G__63362__$1 = (((G__63362 == null))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63362));
var G__63362__$2 = (((G__63362__$1 == null))?null:cljs.core.re_matches(/(-?\d+\.?\d*)%/,G__63362__$1));
var G__63362__$3 = (((G__63362__$2 == null))?null:cljs.core.second(G__63362__$2));
if((G__63362__$3 == null)){
return null;
} else {
return (function (p1__63361_SHARP_){
return (p1__63361_SHARP_ / (100));
})(G__63362__$3);
}
});
frontend.format.block.normalize_as_date = (function frontend$format$block$normalize_as_date(block){
var G__63363 = block;
var G__63363__$1 = (((G__63363 == null))?null:cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63363));
var G__63363__$2 = (((G__63363__$1 == null))?null:frontend.date.normalize_date(G__63363__$1));
if((G__63363__$2 == null)){
return null;
} else {
return cljs_time.format.unparse(frontend.date.custom_formatter,G__63363__$2);
}
});
/**
...
return cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63364_SHARP_){
var G__63367 = ((cljs.core.set_QMARK_(block))?cljs.core.first(block):block);
return (p1__63364_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__63364_SHARP_.cljs$core$IFn$_invoke$arity$1(G__63367) : p1__63364_SHARP_.call(null,G__63367));
...
frontend.format.block.parse_block = (function frontend$format$block$parse_block(p__63372){
var map__63373 = p__63372;
var map__63373__$1 = cljs.core.__destructure_map(map__63373);
var block = map__63373__$1;
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63373__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63373__$1,new cljs.core.Keyword("block","title","block/title",710445684));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63373__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
...
var block__$2 = (function (){var G__63374 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([block__$1,new_block], 0));
var G__63374__$1 = (((cljs.core.count(blocks) > (1)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63374,new cljs.core.Keyword("block","warning","block/warning",2131709542),new cljs.core.Keyword(null,"multiple-blocks","multiple-blocks",1235340805)):G__63374);
if(db_based_QMARK_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__63374__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
} else {
return G__63374__$1;
}
})();
...
var G__63381 = ((cljs.core.seq(body__$1))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block.temp","ast-body","block.temp/ast-body",-464258035),body__$1], null):cljs.core.PersistentArrayMap.EMPTY);
if(cljs.core.truth_(title)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__63381,new cljs.core.Keyword("block.temp","ast-title","block.temp/ast-title",-940352067),title);
} else {
return G__63381;
}
});
...
frontend.format.block.break_line_paragraph_QMARK_ = (function frontend$format$block$break_line_paragraph_QMARK_(p__63389){
var vec__63390 = p__63389;
var typ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63390,(0),null);
var break_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63390,(1),null);
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(typ,"Paragraph")) && (cljs.core.every_QMARK_((function (p1__63388_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__63388_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Break_Line"], null));
}),break_lines)));
});
...
var vec__63395 = ast;
var typ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63395,(0),null);
var paras = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63395,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [typ,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63394_SHARP_){
return cljs.core.last(p1__63394_SHARP_);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63393_SHARP_){
var vec__63398 = p1__63393_SHARP_;
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63398,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63398,(1),null);
