...
var map__65348 = logseq.publishing.html.build_html(db,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"repo","repo",-1999060679),repo,new cljs.core.Keyword(null,"app-state","app-state",-1509963278),cljs.core.select_keys(cljs.core.deref(frontend.state.state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ui","theme","ui/theme",-1247877132),new cljs.core.Keyword("ui","sidebar-collapsed-blocks","ui/sidebar-collapsed-blocks",395046921)], null)),new cljs.core.Keyword(null,"repo-config","repo-config",1551936565),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(frontend.state.state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"config","config",994861415),repo], null)),new cljs.core.Keyword(null,"db-graph?","db-graph?",-533494876),frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(repo)], null));
var map__65348__$1 = cljs.core.__destructure_map(map__65348);
var asset_filenames = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65348__$1,new cljs.core.Keyword(null,"asset-filenames","asset-filenames",-2076716428));
var html = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65348__$1,new cljs.core.Keyword(null,"html","html",-998796897));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.util.get_git_owner_and_repo(repo)),(function (p__65378){
var vec__65379 = p__65378;
var owner = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65379,(0),null);
var repo_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65379,(1),null);
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__65382){
var map__65383 = p__65382;
var map__65383__$1 = cljs.core.__destructure_map(map__65383);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65383__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return promesa.protocols._promise(((cljs.core.seq(files__$1))?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto____$1){
...
return promesa.protocols._promise((cljs.core.truth_(edn_str)?(function (){var data_str = (function (){var G__65402 = edn_str;
var G__65402__$1 = (((G__65402 == null))?null:encodeURIComponent(G__65402));
if((G__65402__$1 == null)){
return null;
} else {
return ["data:text/edn;charset=utf-8,",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65402__$1)].join('');
}
})();
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.export$.common._LT_get_all_pages(repo)),(function (pages){
return promesa.protocols._promise((function (){var non_empty_pages = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__65423_SHARP_){
return cljs.core.empty_QMARK_(new cljs.core.Keyword("block","children","block/children",-1040716209).cljs$core$IFn$_invoke$arity$1(p1__65423_SHARP_));
}),pages);
...
var seq__65427 = cljs.core.seq(files__$1);
var chunk__65428 = null;
var count__65429 = (0);
var i__65430 = (0);
while(true){
if((i__65430 < count__65429)){
var file = chunk__65428.cljs$core$IIndexed$_nth$arity$2(null,i__65430);
file.handle.remove();


var G__65459 = seq__65427;
var G__65460 = chunk__65428;
var G__65461 = count__65429;
var G__65462 = (i__65430 + (1));
seq__65427 = G__65459;
chunk__65428 = G__65460;
count__65429 = G__65461;
i__65430 = G__65462;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__65427);
if(temp__5804__auto__){
var seq__65427__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__65427__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__65427__$1);
var G__65463 = cljs.core.chunk_rest(seq__65427__$1);
var G__65464 = c__5525__auto__;
var G__65465 = cljs.core.count(c__5525__auto__);
var G__65466 = (0);
seq__65427 = G__65463;
chunk__65428 = G__65464;
count__65429 = G__65465;
i__65430 = G__65466;
continue;
} else {
var file = cljs.core.first(seq__65427__$1);
file.handle.remove();


var G__65467 = cljs.core.next(seq__65427__$1);
var G__65468 = null;
var G__65469 = (0);
var G__65470 = (0);
seq__65427 = G__65467;
chunk__65428 = G__65468;
count__65429 = G__65469;
i__65430 = G__65470;
continue;
}
} else {
...
return promesa.protocols._mcat(promesa.protocols._promise(console.dir(handle)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.idb.set_item_BANG_(["handle/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(btoa(repo)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(folder_name)].join(''),handle)),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(logseq.db.kv.cljs$core$IFn$_invoke$arity$2 ? logseq.db.kv.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("logseq.kv","graph-backup-folder","logseq.kv/graph-backup-folder",-1042314532),folder_name) : logseq.db.kv.call(null,new cljs.core.Keyword("logseq.kv","graph-backup-folder","logseq.kv/graph-backup-folder",-1042314532),folder_name))], null))),(function (___40947__auto____$2){
...
var vec__65436 = p__65435;
var _folder = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65436,(0),null);
var handle__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65436,(1),null);
return promesa.protocols._mcat(promesa.protocols._promise(logseq.db.common.sqlite.sanitize_db_name(repo)),(function (repo_name){
return promesa.protocols._promise((cljs.core.truth_(handle__$1)?promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise((((file.size > (0)))?backup_handle.move(backups_handle,[cljs.core.str.cljs$core$IFn$_invoke$arity$1((frontend.util.time_ms.cljs$core$IFn$_invoke$arity$0 ? frontend.util.time_ms.cljs$core$IFn$_invoke$arity$0() : frontend.util.time_ms.call(null))),".db.sqlite"].join('')):null)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.export$.truncate_old_versioned_files_BANG_(backups_handle)),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40979__auto____$2){
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Successfully created a backup for",repo_name,"at",cljs.core.str.cljs$core$IFn$_invoke$arity$1((new Date())),"."], 0))),(function (___40947__auto____$3){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$2("DB backup failed, please go to Export and specify a backup folder.",new cljs.core.Keyword(null,"error","error",-978969032))),(function (___40947__auto__){
...
frontend.handler.export$.auto_db_backup_BANG_ = (function frontend$handler$export$auto_db_backup_BANG_(repo,p__65442){
var map__65443 = p__65442;
var map__65443__$1 = cljs.core.__destructure_map(map__65443);
var backup_now_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65443__$1,new cljs.core.Keyword(null,"backup-now?","backup-now?",-918244579),true);
