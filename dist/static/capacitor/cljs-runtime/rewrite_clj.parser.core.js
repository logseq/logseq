...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66076 = cljs.core.get_global_hierarchy;
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__66077_SHARP_){
var _STAR_delimiter_STAR__orig_val__66080 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__66081 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__66081);

try{return rewrite_clj.parser.core.parse_next(p1__66077_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__66080);
}}));
});
...
var G__66118 = (i__5727__auto___66117 + (1));
i__5727__auto___66117 = G__66118;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__66095){
var vec__66096 = p__66095;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66096,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq66084){
var G__66085 = cljs.core.first(seq66084);
var seq66084__$1 = cljs.core.next(seq66084);
var G__66086 = cljs.core.first(seq66084__$1);
var seq66084__$2 = cljs.core.next(seq66084__$1);
var G__66087 = cljs.core.first(seq66084__$2);
var seq66084__$3 = cljs.core.next(seq66084__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66085,G__66086,G__66087,seq66084__$3);
}));
...
var G__66106 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__66106)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__66106)){
...
return cljs.core.cons((function (){var G__66108 = rewrite_clj.reader.peek(reader);
switch (G__66108) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__66106)){
