...
var G__67667 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__67667__$1 = (((G__67667 == null))?null:cljs.core.iterate((function (loc){
...
var G__67667__$2 = (((G__67667__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__67667__$1));
var G__67667__$3 = (((G__67667__$2 == null))?null:cljs.core.last(G__67667__$2));
if((G__67667__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__67667__$3);
}
} else {
return zloc;
}
...
var G__67709 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__67710 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__67709;
parent = G__67710;
continue;
} else {
var G__67711 = rewrite_clj.zip.move.right(zloc_map_value);
var G__67712 = parent;
loc = G__67711;
parent = G__67712;
continue;
...
var G__67713 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__67714 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__67713;
parent = G__67714;
continue;
} else {
var G__67715 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__67716 = parent;
loc = G__67715;
parent = G__67716;
continue;
...
var G__67705 = zloc;
var G__67705__$1 = (((G__67705 == null))?null:rewrite_clj.zip.move.down(G__67705));
var G__67705__$2 = (((G__67705__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__67705__$1,k));
if((G__67705__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__67705__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__67707 = zloc;
var G__67707__$1 = (((G__67707 == null))?null:rewrite_clj.zip.move.down(G__67707));
var G__67707__$2 = (((G__67707__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__67707__$1));
var G__67707__$3 = (((G__67707__$2 == null))?null:rewrite_clj.zip.move.down(G__67707__$2));
var G__67707__$4 = (((G__67707__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__67707__$3,k));
if((G__67707__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__67707__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__67708 = rewrite_clj.zip.move.down(zloc);
var G__67708__$1 = (((G__67708 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__67708));
if((G__67708__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__67708__$1);
}
})(),k);
