...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k64328,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k64328,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__64353){
var vec__64356 = p__64353;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64356,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64356,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__64327){
var self__ = this;
var G__64327__$1 = this;
return (new cljs.core.RecordIter((0),G__64327__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this64330,other64331){
var self__ = this;
var this64330__$1 = this;
return (((!((other64331 == null)))) && ((((this64330__$1.constructor === other64331.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.tag,other64331.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.format_string,other64331.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.wrap_length,other64331.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.seq_fn,other64331.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.children,other64331.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64330__$1.__extmap,other64331.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__64397 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__64397) : self__.seq_fn.call(null,G__64397));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k64328){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k64328);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__64327){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__64415 = cljs.core.keyword_identical_QMARK_;
var expr__64416 = k__5309__auto__;
if(cljs.core.truth_((pred__64415.cljs$core$IFn$_invoke$arity$2 ? pred__64415.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__64416) : pred__64415.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__64416)))){
return (new rewrite_clj.node.seq.SeqNode(G__64327,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64415.cljs$core$IFn$_invoke$arity$2 ? pred__64415.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__64416) : pred__64415.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__64416)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__64327,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64415.cljs$core$IFn$_invoke$arity$2 ? pred__64415.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__64416) : pred__64415.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__64416)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__64327,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64415.cljs$core$IFn$_invoke$arity$2 ? pred__64415.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__64416) : pred__64415.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__64416)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__64327,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64415.cljs$core$IFn$_invoke$arity$2 ? pred__64415.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__64416) : pred__64415.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__64416)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__64327,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__64327),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__64327){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__64327,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__64339){
var extmap__5342__auto__ = (function (){var G__64462 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__64339,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__64339)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__64462);
} else {
return G__64462;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__64339),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__64339),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__64339),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__64339),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__64339),null,cljs.core.not_empty(extmap__5342__auto__),null));
});

rewrite_clj.node.protocols.make_printable_BANG_(rewrite_clj.node.seq.SeqNode);
var list_node_seq_fn_64596 = (function (p1__64466_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__64466_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),list_node_seq_fn_64596,children);
});
/**
...
var map_seq_fn_64605 = (function (p1__64475_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__64475_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),map_seq_fn_64605,children);
});
