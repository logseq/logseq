...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_128774 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_128774(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_128775 = (function (self){
var x__5350__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_128775(self);
}
});
...
var G__128776 = n__$1;
var G__128777 = y;
var G__128778 = cljs.core.imul(z,z);
n = G__128776;
y = G__128777;
z = G__128778;
continue;
...
var G__128779 = n__$1;
var G__128780 = cljs.core.imul(z,y);
var G__128781 = cljs.core.imul(z,z);
n = G__128779;
y = G__128780;
z = G__128781;
continue;
...
var G__128782 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__128783 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__128782;
index__$1 = G__128783;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__128767 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__128767) : instaparse.auto_flatten_seq.true_count.call(null,G__128767));
})() - (1)))){
...
var G__128784 = v;
var G__128785 = cljs.core.pop(index);
v = G__128784;
index = G__128785;
continue;
...
var G__128769 = arguments.length;
switch (G__128769) {
case 1:
...
var G__128771 = arguments.length;
switch (G__128771) {
case 1:
...
while(true){
if((!((coll__$1 == null)))){
var G__128788 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__128789 = cljs.core.next(coll__$1);
unmixed_hash = G__128788;
coll__$1 = G__128789;
continue;
} else {
return unmixed_hash;
...
var G__128790 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__128791 = cljs.core.next(v);
acc = G__128790;
v = G__128791;
continue;
} else {
var G__128792 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__128793 = cljs.core.next(v);
acc = G__128792;
v = G__128793;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_128794 = (function (self){
var x__5350__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_128794(self);
}
});
...
var self__ = this;
var self__ = this;
var G__128773 = (arguments.length - (1));
switch (G__128773) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args128772){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args128772)));
}));
