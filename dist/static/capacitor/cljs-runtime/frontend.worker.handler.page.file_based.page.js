...
frontend.worker.handler.page.file_based.page.build_page_tx = (function frontend$worker$handler$page$file_based$page$build_page_tx(repo,conn,config,date_formatter,format,properties,page,p__131148){
var map__131151 = p__131148;
var map__131151__$1 = cljs.core.__destructure_map(map__131151);
var whiteboard_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131151__$1,new cljs.core.Keyword(null,"whiteboard?","whiteboard?",-1968190788));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131151__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
...
var page_SINGLEQUOTE_ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([page,(cljs.core.truth_(whiteboard_QMARK_)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","type","block/type",1537584409),"whiteboard"], null):null),(cljs.core.truth_(tags)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","tags","block/tags",1814948340),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__131140_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((function (){var G__131161 = cljs.core.deref(conn);
var G__131162 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),p1__131140_SHARP_], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__131161,G__131162) : datascript.core.entity.call(null,G__131161,G__131162));
})())]);
}),tags)], null):null)], 0));
...
var title__$1 = clojure.string.replace((function (){var G__131174 = clojure.string.trim(title);
return (logseq.graph_parser.text.page_ref_un_brackets_BANG_.cljs$core$IFn$_invoke$arity$1 ? logseq.graph_parser.text.page_ref_un_brackets_BANG_.cljs$core$IFn$_invoke$arity$1(G__131174) : logseq.graph_parser.text.page_ref_un_brackets_BANG_.call(null,G__131174));
})(),/^#+/,"");
...
frontend.worker.handler.page.file_based.page.create_BANG_ = (function frontend$worker$handler$page$file_based$page$create_BANG_(repo,conn,config,title,p__131178){
var map__131179 = p__131178;
var map__131179__$1 = cljs.core.__destructure_map(map__131179);
var options = map__131179__$1;
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131179__$1,new cljs.core.Keyword(null,"format","format",-1306924766),null);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131179__$1,new cljs.core.Keyword(null,"properties","properties",685819552),null);
var uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131179__$1,new cljs.core.Keyword(null,"uuid","uuid",-2145095719),null);
var persist_op_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__131179__$1,new cljs.core.Keyword(null,"persist-op?","persist-op?",-531287534),true);
var today_journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__131179__$1,new cljs.core.Keyword(null,"today-journal?","today-journal?",-388258460));
...
var vec__131180 = frontend.worker.handler.page.file_based.page.get_title_and_pagename(title);
var title__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__131180,(0),null);
var page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__131180,(1),null);
...
var txs = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__131175_SHARP_){
return frontend.worker.handler.page.file_based.page.build_page_tx(repo,conn,config,date_formatter,format__$1,null,p1__131175_SHARP_,cljs.core.PersistentArrayMap.EMPTY);
...
logseq.db.transact_BANG_.cljs$core$IFn$_invoke$arity$3(conn,txs__$2,(function (){var G__131202 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"persist-op?","persist-op?",-531287534),persist_op_QMARK_,new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"create-page","create-page",-1352656443)], null);
if(cljs.core.truth_(today_journal_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__131202,new cljs.core.Keyword(null,"create-today-journal?","create-today-journal?",136893930),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"today-journal-name","today-journal-name",1965349294),page_name], 0));
} else {
return G__131202;
}
})());
