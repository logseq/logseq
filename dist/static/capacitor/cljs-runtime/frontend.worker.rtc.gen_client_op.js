...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__133965){
var vec__133966 = p__133965;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133966,(0),null);
var add_QMARK___GT_v__GT_t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133966,(1),null);
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__133970){
var vec__133971 = p__133970;
var add_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133971,(0),null);
var v__GT_t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133971,(1),null);
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__133975){
var vec__133976 = p__133975;
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133976,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133976,(1),null);
var ref_QMARK_ = frontend.worker.rtc.gen_client_op.ref_attr_QMARK_(db_after,a);
var G__133982 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [add_QMARK_,ref_QMARK_], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__133982)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__133982)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__133982)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__133982)){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,logseq.db.write_transit_str(v),t,add_QMARK_], null);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__133982)].join('')));
...
var G__133986 = add_QMARK___GT_v__GT_t;
var G__133986__$1 = (((G__133986 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__133986,k));
if((G__133986__$1 == null)){
return null;
} else {
return cljs.core.first(G__133986__$1);
}
});
...
var map__133987 = entity;
var map__133987__$1 = cljs.core.__destructure_map(map__133987);
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133987__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
...
var map__133988 = a__GT_add_QMARK___GT_v__GT_t;
var map__133988__$1 = cljs.core.__destructure_map(map__133988);
var add_QMARK___GT_block_name__GT_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133988__$1,new cljs.core.Keyword("block","name","block/name",1619760316));
var add_QMARK___GT_block_title__GT_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133988__$1,new cljs.core.Keyword("block","title","block/title",710445684));
var add_QMARK___GT_block_uuid__GT_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133988__$1,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552));
var add_QMARK___GT_block_parent__GT_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133988__$1,new cljs.core.Keyword("block","parent","block/parent",-918309064));
var add_QMARK___GT_block_order__GT_t = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__133988__$1,new cljs.core.Keyword("block","order","block/order",-1429282437));
var vec__133989 = (function (){var G__134007 = add_QMARK___GT_block_uuid__GT_t;
var G__134007__$1 = (((G__134007 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__134007,false));
if((G__134007__$1 == null)){
return null;
} else {
return cljs.core.first(G__134007__$1);
}
})();
var retract_block_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133989,(0),null);
var t1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133989,(1),null);
var vec__133992 = (function (){var G__134008 = add_QMARK___GT_block_name__GT_t;
var G__134008__$1 = (((G__134008 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__134008,false));
if((G__134008__$1 == null)){
return null;
} else {
return cljs.core.first(G__134008__$1);
}
})();
var retract_block_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133992,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133992,(1),null);
var vec__133995 = (function (){var G__134009 = add_QMARK___GT_block_name__GT_t;
var G__134009__$1 = (((G__134009 == null))?null:frontend.worker.rtc.gen_client_op.latest_add_QMARK___GT_v__GT_t(G__134009));
if((G__134009__$1 == null)){
return null;
} else {
return frontend.worker.rtc.gen_client_op.get_first_vt(G__134009__$1,true);
}
})();
var add_block_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133995,(0),null);
var t2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133995,(1),null);
var vec__133998 = (function (){var G__134010 = add_QMARK___GT_block_title__GT_t;
var G__134010__$1 = (((G__134010 == null))?null:frontend.worker.rtc.gen_client_op.latest_add_QMARK___GT_v__GT_t(G__134010));
if((G__134010__$1 == null)){
return null;
} else {
return frontend.worker.rtc.gen_client_op.get_first_vt(G__134010__$1,true);
}
})();
var add_block_title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133998,(0),null);
var t3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__133998,(1),null);
var vec__134001 = (function (){var G__134011 = add_QMARK___GT_block_parent__GT_t;
var G__134011__$1 = (((G__134011 == null))?null:frontend.worker.rtc.gen_client_op.latest_add_QMARK___GT_v__GT_t(G__134011));
if((G__134011__$1 == null)){
return null;
} else {
return frontend.worker.rtc.gen_client_op.get_first_vt(G__134011__$1,true);
}
})();
var add_block_parent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134001,(0),null);
var t4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134001,(1),null);
var vec__134004 = (function (){var G__134012 = add_QMARK___GT_block_order__GT_t;
var G__134012__$1 = (((G__134012 == null))?null:frontend.worker.rtc.gen_client_op.latest_add_QMARK___GT_v__GT_t(G__134012));
if((G__134012__$1 == null)){
return null;
} else {
return frontend.worker.rtc.gen_client_op.get_first_vt(G__134012__$1,true);
}
})();
var add_block_order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134004,(0),null);
var t5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134004,(1),null);
var a__GT_add_QMARK___GT_v__GT_t_STAR_ = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__134013){
var vec__134014 = p__134013;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134014,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134014,(1),null);
...
var ops = (function (){var G__134017 = cljs.core.PersistentVector.EMPTY;
var G__134017__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = add_block_parent;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return add_block_order;
}
})())?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__134017,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"move","move",-2110884309),(function (){var or__5002__auto__ = t4;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return t5;
}
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638),block_uuid], null)], null)):G__134017);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__134017__$1,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"update-page","update-page",-503479891),(function (){var or__5002__auto__ = t2;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return t3;
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__134018,update_op);
} else {
return G__134018;
}
...
var vec__134019 = datom;
var _e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134019,(0),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134019,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134019,(2),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134019,(3),null);
var add_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__134019,(4),null);
