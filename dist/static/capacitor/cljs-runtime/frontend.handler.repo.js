...
var len__5726__auto___66206 = arguments.length;
var i__5727__auto___66207 = (0);
while(true){
if((i__5727__auto___66207 < len__5726__auto___66206)){
args__5732__auto__.push((arguments[i__5727__auto___66207]));

var G__66208 = (i__5727__auto___66207 + (1));
i__5727__auto___66207 = G__66208;
continue;
} else {
}
break;
...
(frontend.handler.repo.remove_repo_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__65979,p__65980){
var map__65981 = p__65979;
var map__65981__$1 = cljs.core.__destructure_map(map__65981);
var repo = map__65981__$1;
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65981__$1,new cljs.core.Keyword(null,"url","url",276297046));
var map__65982 = p__65980;
var map__65982__$1 = cljs.core.__destructure_map(map__65982);
var switch_graph_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__65982__$1,new cljs.core.Keyword(null,"switch-graph?","switch-graph?",1080858350),true);
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.idb.clear_local_db_BANG_(url)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((frontend.db.remove_conn_BANG_.cljs$core$IFn$_invoke$arity$1 ? frontend.db.remove_conn_BANG_.cljs$core$IFn$_invoke$arity$1(url) : frontend.db.remove_conn_BANG_.call(null,url))),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.db.persist.delete_graph_BANG_(url)),(function (___40947__auto____$2){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.search.remove_db_BANG_(url)),(function (___40947__auto____$3){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.delete_repo_BANG_(repo)),(function (___40947__auto____$4){
...
/** @this {Function} */
(frontend.handler.repo.remove_repo_BANG_.cljs$lang$applyTo = (function (seq65977){
var G__65978 = cljs.core.first(seq65977);
var seq65977__$1 = cljs.core.next(seq65977);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65978,seq65977__$1);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___66211 = arguments.length;
var i__5727__auto___66212 = (0);
while(true){
if((i__5727__auto___66212 < len__5726__auto___66211)){
args__5732__auto__.push((arguments[i__5727__auto___66212]));

var G__66277 = (i__5727__auto___66212 + (1));
i__5727__auto___66212 = G__66277;
continue;
} else {
}
break;
...
(frontend.handler.repo.start_repo_db_if_not_exists_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,p__66027){
var map__66028 = p__66027;
var map__66028__$1 = cljs.core.__destructure_map(map__66028);
var opts = map__66028__$1;
...
/** @this {Function} */
(frontend.handler.repo.start_repo_db_if_not_exists_BANG_.cljs$lang$applyTo = (function (seq65983){
var G__65984 = cljs.core.first(seq65983);
var seq65983__$1 = cljs.core.next(seq65983);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65984,seq65983__$1);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___66278 = arguments.length;
var i__5727__auto___66279 = (0);
while(true){
if((i__5727__auto___66279 < len__5726__auto___66278)){
args__5732__auto__.push((arguments[i__5727__auto___66279]));

var G__66280 = (i__5727__auto___66279 + (1));
i__5727__auto___66279 = G__66280;
continue;
} else {
}
break;
...
(frontend.handler.repo.restore_and_setup_repo_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,p__66054){
var map__66055 = p__66054;
var map__66055__$1 = cljs.core.__destructure_map(map__66055);
var opts = map__66055__$1;
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40957__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_db_restoring_BANG_(true)),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.db.restore.restore_graph_BANG_.cljs$core$IFn$_invoke$arity$variadic(repo,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([opts], 0))),(function (___40947__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.repo_config.restore_repo_config_BANG_.cljs$core$IFn$_invoke$arity$1(repo)),(function (___40947__auto____$2){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.config.global_config_enabled_QMARK_())?frontend.handler.global_config.restore_global_config_BANG_():null)),(function (___40947__auto____$3){
return promesa.protocols._mcat(promesa.protocols._promise(((new cljs.core.Keyword(null,"ignore-style?","ignore-style?",-1936882338).cljs$core$IFn$_invoke$arity$1(opts) === true)?null:frontend.handler.ui.add_style_if_exists_BANG_())),(function (___40947__auto____$4){
...
/** @this {Function} */
(frontend.handler.repo.restore_and_setup_repo_BANG_.cljs$lang$applyTo = (function (seq66037){
var G__66038 = cljs.core.first(seq66037);
var seq66037__$1 = cljs.core.next(seq66037);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66038,seq66037__$1);
}));
...
var temp__5804__auto__ = cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__66092){
var map__66093 = p__66092;
var map__66093__$1 = cljs.core.__destructure_map(map__66093);
var repo = map__66093__$1;
var sync_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66093__$1,new cljs.core.Keyword(null,"sync-meta","sync-meta",-164400022));
var metadata = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66093__$1,new cljs.core.Keyword(null,"metadata","metadata",1799301597));
var graph_id = (function (){var G__66094 = (function (){var or__5002__auto__ = new cljs.core.Keyword("kv","value","kv/value",305981670).cljs$core$IFn$_invoke$arity$1(metadata);
...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66094);
}
})();
...
}),local_repos),(function (){var G__66095 = remote_repos;
if((G__66095 == null)){
return null;
} else {
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66091_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66091_SHARP_,new cljs.core.Keyword(null,"remote?","remote?",-517415110),true);
}),G__66095);
}
})()));
...
var repos_SINGLEQUOTE__SINGLEQUOTE_ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__66096){
var vec__66097 = p__66096;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66097,(0),null);
var vs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66097,(1),null);
if((!((k == null)))){
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66108_SHARP_){
var temp__5804__auto____$1 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(p1__66108_SHARP_);
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_repos_BANG_(repos_SINGLEQUOTE_)),(function (___40947__auto__){
...
return cljs.core.some((function (p1__66123_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((function (){var G__66125 = new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(p1__66123_SHARP_);
if((G__66125 == null)){
return null;
} else {
return clojure.string.lower_case(G__66125);
}
})(),full_graph_name);
}),frontend.state.get_repos());
});
frontend.handler.repo.create_db = (function frontend$handler$repo$create_db(full_graph_name,p__66133){
var map__66134 = p__66133;
var map__66134__$1 = cljs.core.__destructure_map(map__66134);
var file_graph_import_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66134__$1,new cljs.core.Keyword(null,"file-graph-import?","file-graph-import?",-2126895083));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db._LT_new(full_graph_name,(function (){var G__66135 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"config","config",994861415),config,new cljs.core.Keyword(null,"graph-git-sha","graph-git-sha",-266655130),frontend.config.revision], null);
if(cljs.core.truth_(file_graph_import_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66135,new cljs.core.Keyword(null,"import-type","import-type",-499283032),new cljs.core.Keyword(null,"file-graph","file-graph",-246966187));
} else {
return G__66135;
}
})())),(function (_){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("shortcut","refresh","shortcut/refresh",-1755508577)], null))),(function (___40947__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.route.redirect_to_home_BANG_.cljs$core$IFn$_invoke$arity$0()),(function (___40947__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.graph.settle_metadata_to_local_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"created-at","created-at",-89248644),Date.now()], null))),(function (___40947__auto____$3){
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["New db created: ",full_graph_name], 0))),(function (___40947__auto____$4){
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___40957__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","gc-graph","thread-api/gc-graph",1137283006),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([graph], 0))),(function (___40947__auto__){
