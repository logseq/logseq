...
var periods__$1 = cljs.core.vec((function (){var G__58142 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58141_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__58141_SHARP_,(0),(3));
}),G__58142);
} else {
return G__58142;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__58186){
var vec__58187 = p__58186;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58187,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58187,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__58191 = pattern;
switch (G__58191) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58191)].join('')));
...
var G__58206 = key;
var G__58206__$1 = (((G__58206 instanceof cljs.core.Keyword))?G__58206.fqn:null);
switch (G__58206__$1) {
case "millis":
return (function (p1__58198_SHARP_){
return p1__58198_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__58199_SHARP_){
return p1__58199_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__58200_SHARP_){
return p1__58200_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__58201_SHARP_){
return p1__58201_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__58202_SHARP_){
return p1__58202_SHARP_.getHours();
});

break;
case "day":
return (function (p1__58203_SHARP_){
return p1__58203_SHARP_.getDate();
});

break;
case "month":
return (function (p1__58204_SHARP_){
return p1__58204_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__58205_SHARP_){
return p1__58205_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58206__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__58215){
var vec__58216 = p__58215;
...
break;
case "ordinal-suffix":
var vec__58223 = (function (){var G__58228 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__58228) : syntax_list.call(null,G__58228));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58223,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58219__$1)].join('')));
...
var d = value;
var G__58233 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__58234 = G__58233;
...
var unparser = first__58236;
var more = seq__58235__$1;
var s = "";
var d__$1 = d;
var G__58233__$1 = G__58233;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__58244 = G__58233__$1;
...
var unparser__$1 = first__58246;
var more__$1 = seq__58245__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__58249 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58249,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58249,(1),null);
var G__58334 = d__$3;
var G__58335 = more__$1;
var G__58336 = s__$3;
d__$1 = G__58334;
G__58233__$1 = G__58335;
s__$1 = G__58336;
continue;
}
break;
