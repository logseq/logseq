...
var temp__5802__auto__ = cljs.core.some((function (p1__64696_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","name","file/name",1848919477).cljs$core$IFn$_invoke$arity$1(p1__64696_SHARP_),".gitignore")){
return p1__64696_SHARP_;
} else {
return null;
}
}),files__$1);
...
})())?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64698){
var map__64699 = p__64698;
var map__64699__$1 = cljs.core.__destructure_map(map__64699);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64699__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64699__$1,new cljs.core.Keyword(null,"content","content",15833224));
var stat = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64699__$1,new cljs.core.Keyword(null,"stat","stat",-1370599836));
...
if(cljs.core.truth_(cljs.core.some((function (p1__64700_SHARP_){
return clojure.string.ends_with_QMARK_(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(p1__64700_SHARP_),"/logseq/config.edn");
}),files))){
...
(frontend.handler.file_based.nfs.ls_dir_files_with_handler_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (ok_handler,p__64704){
var map__64705 = p__64704;
var map__64705__$1 = cljs.core.__destructure_map(map__64705);
var on_open_dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64705__$1,new cljs.core.Keyword(null,"on-open-dir","on-open-dir",1666374285));
var dir_result_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64705__$1,new cljs.core.Keyword(null,"dir-result-fn","dir-result-fn",839285404));
var picked_root_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64705__$1,new cljs.core.Keyword(null,"picked-root-fn","picked-root-fn",42247568));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64705__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
...
return promesa.core.finally$.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_loading_files_BANG_(repo,true)),(function (___41063__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(((frontend.state.home_QMARK_())?null:frontend.handler.route.redirect_to_home_BANG_.cljs$core$IFn$_invoke$arity$1(false))),(function (___41063__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.reset_BANG_(_STAR_repo,repo)),(function (___41063__auto____$2){
return promesa.protocols._promise(((clojure.string.blank_QMARK_(root_dir))?null:promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$2){
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__64701_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__64701_SHARP_,new cljs.core.Keyword("file","file","file/file",-1241327538));
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41073__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db._LT_new(repo,cljs.core.PersistentArrayMap.EMPTY)),(function (___41063__auto____$3){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.repo.start_repo_db_if_not_exists_BANG_(repo)),(function (___41063__auto____$4){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.config.global_config_enabled_QMARK_())?frontend.handler.global_config.restore_global_config_BANG_():null)),(function (___41063__auto____$5){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.repo.load_new_repo_to_db_BANG_(repo,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"new-graph?","new-graph?",-843567695),true,new cljs.core.Keyword(null,"empty-graph?","empty-graph?",981603639),(cljs.core.seq(markup_files) == null),new cljs.core.Keyword(null,"file-objs","file-objs",545613385),files__$2], null))),(function (___41063__auto____$6){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_parsing_state_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"graph-loading?","graph-loading?",1136649541),false], null))),(function (___41063__auto____$7){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.add_repo_BANG_(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"url","url",276297046),repo,new cljs.core.Keyword(null,"nfs?","nfs?",-544337673),true], null))),(function (___41063__auto____$8){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db._LT_export_db(repo,cljs.core.PersistentArrayMap.EMPTY)),(function (___41063__auto____$9){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_loading_files_BANG_(repo,false)),(function (___41063__auto____$10){
return promesa.protocols._promise((cljs.core.truth_(ok_handler)?(function (){var G__64706 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"url","url",276297046),repo], null);
return (ok_handler.cljs$core$IFn$_invoke$arity$1 ? ok_handler.cljs$core$IFn$_invoke$arity$1(G__64706) : ok_handler.call(null,G__64706));
})():null));
}));
}));
}));
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64709_SHARP_){
return cljs.core.select_keys(p1__64709_SHARP_,ks__$1);
}),files));
} else {
return null;
}
...
return cljs.core.some((function (p1__64710_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","path","file/path",-191335748).cljs$core$IFn$_invoke$arity$1(p1__64710_SHARP_),path)){
return p1__64710_SHARP_;
} else {
return null;
}
}),files);
...
return cljs.core.some((function (p1__64713_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("file","path","file/path",-191335748).cljs$core$IFn$_invoke$arity$1(p1__64713_SHARP_),path)){
return p1__64713_SHARP_;
} else {
return null;
}
}),files);
});
var map__64716 = frontend.handler.file_based.nfs.compute_diffs(old_files,new_files);
var map__64716__$1 = cljs.core.__destructure_map(map__64716);
var added = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64716__$1,new cljs.core.Keyword(null,"added","added",2057651688));
var modified = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64716__$1,new cljs.core.Keyword(null,"modified","modified",-2134587826));
var deleted = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64716__$1,new cljs.core.Keyword(null,"deleted","deleted",-510100639));
...
var files = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__64714_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__64714_SHARP_,new cljs.core.Keyword("file","file","file/file",-1241327538));
}),result);
var vec__64717 = (cljs.core.truth_(re_index_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [files,cljs.core.set(modified)], null):(function (){var modified_files = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (file){
...
var modified_files = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64717,(0),null);
var modified__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64717,(1),null);
 ...
 */
frontend.handler.file_based.nfs.reload_dir_BANG_ = (function frontend$handler$file_based$nfs$reload_dir_BANG_(repo,p__64722){
var map__64723 = p__64722;
var map__64723__$1 = cljs.core.__destructure_map(map__64723);
var re_index_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__64723__$1,new cljs.core.Keyword(null,"re-index?","re-index?",1279325395),false);
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64723__$1,new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089));
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41073__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.repo.remove_repo_BANG_.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"url","url",276297046),repo], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"switch-graph?","switch-graph?",1080858350),false], 0))),(function (___41063__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.file_based.nfs.ls_dir_files_with_path_BANG_.cljs$core$IFn$_invoke$arity$2(graph_dir,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"re-index?","re-index?",1279325395),true], null))),(function (___41063__auto____$1){
