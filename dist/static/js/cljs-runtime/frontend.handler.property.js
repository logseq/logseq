...
var len__5726__auto___102599 = arguments.length;
var i__5727__auto___102600 = (0);
while(true){
if((i__5727__auto___102600 < len__5726__auto___102599)){
args__5732__auto__.push((arguments[i__5727__auto___102600]));

var G__102601 = (i__5727__auto___102600 + (1));
i__5727__auto___102600 = G__102601;
continue;
} else {
}
break;
...
(frontend.handler.property.batch_set_block_property_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (repo,block_ids,key,value,p__102582){
var map__102583 = p__102582;
var map__102583__$1 = cljs.core.__destructure_map(map__102583);
var opts = map__102583__$1;
if((!((key == null)))){
} else {
throw (new Error(["Assert failed: ","key is nil","\n","(some? key)"].join('')));
}
...
/** @this {Function} */
(frontend.handler.property.batch_set_block_property_BANG_.cljs$lang$applyTo = (function (seq102577){
var G__102578 = cljs.core.first(seq102577);
var seq102577__$1 = cljs.core.next(seq102577);
var G__102579 = cljs.core.first(seq102577__$1);
var seq102577__$2 = cljs.core.next(seq102577__$1);
var G__102580 = cljs.core.first(seq102577__$2);
var seq102577__$3 = cljs.core.next(seq102577__$2);
var G__102581 = cljs.core.first(seq102577__$3);
var seq102577__$4 = cljs.core.next(seq102577__$3);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__102578,G__102579,G__102580,G__102581,seq102577__$4);
}));
