...
var G__89260 = parseInt(node);
if((G__89260 == null)){
return null;
} else {
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__89260) : frontend.db.entity.call(null,G__89260));
}
} else {
