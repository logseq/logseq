...
var rewrite_clj$node$protocols$Node$tag$dyn_64035 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_64035(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_64036 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_64036(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_64037 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_64037(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_64038 = (function (node,opts){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_64038(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_64040 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_64040(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_64042 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_64042(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63985_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__63985_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_64046 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_64046(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_64049 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_64049(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_64050 = (function (node,children){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_64050(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_64052 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_64052(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_64058 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_64058(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_64059 = (function (node,map_qualifier){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_64059(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_64060 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_64060(node);
}
});
...
var map__64016 = cljs.core.meta(node);
var map__64016__$1 = cljs.core.__destructure_map(map__64016);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64016__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64016__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64016__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64016__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__64017,p__64018){
var vec__64019 = p__64017;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64019,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64019,(1),null);
var vec__64022 = p__64018;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64022,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64022,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__64025 = col_extent;
if((row_extent === (0))){
return (G__64025 + col);
} else {
return G__64025;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__64029 = rewrite_clj.node.protocols.children(node);
var G__64029__$1 = (((G__64029 == null))?null:cljs.core.first(G__64029));
if((G__64029__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__64029__$1);
}
} else {
