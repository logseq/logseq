...
var vec__67530 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471)], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67530,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67530,(1),null);
 ...
 */
cljs_http_missionary.util.build_url = (function cljs_http_missionary$util$build_url(p__67549){
var map__67550 = p__67549;
var map__67550__$1 = cljs.core.__destructure_map(map__67550);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67550__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67550__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67550__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67550__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67550__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__67552 = (new goog.Uri());
G__67552.setScheme(cljs.core.name((function (){var or__5002__auto__ = scheme;
...
G__67552.setDomain(server_name);

G__67552.setPort(server_port);

G__67552.setPath(uri);

G__67552.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__67579_SHARP_,p2__67578_SHARP_){
var vec__67581 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__67578_SHARP_,/:\s+/);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67581,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67581,(1),null);
if(((clojure.string.blank_QMARK_(k)) || (clojure.string.blank_QMARK_(v)))){
return p1__67579_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__67579_SHARP_,clojure.string.lower_case(k),v);
}
