...
var _STAR_query_component_STAR__orig_val__49872 = frontend.db.react._STAR_query_component_STAR_;
var _STAR_reactive_queries_STAR__orig_val__49873 = frontend.db.react._STAR_reactive_queries_STAR_;
var _STAR_query_component_STAR__temp_val__49874 = new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248).cljs$core$IFn$_invoke$arity$1(state);
var _STAR_reactive_queries_STAR__temp_val__49875 = new cljs.core.Keyword(null,"reactive-queries","reactive-queries",1681514457).cljs$core$IFn$_invoke$arity$1(state);
(frontend.db.react._STAR_query_component_STAR_ = _STAR_query_component_STAR__temp_val__49874);

(frontend.db.react._STAR_reactive_queries_STAR_ = _STAR_reactive_queries_STAR__temp_val__49875);
...
}finally {(frontend.db.react._STAR_reactive_queries_STAR_ = _STAR_reactive_queries_STAR__orig_val__49873);

(frontend.db.react._STAR_query_component_STAR_ = _STAR_query_component_STAR__orig_val__49872);
}});
