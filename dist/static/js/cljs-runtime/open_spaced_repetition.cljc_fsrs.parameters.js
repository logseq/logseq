...
var G__120308 = rating;
var G__120308__$1 = (((G__120308 instanceof cljs.core.Keyword))?G__120308.fqn:null);
switch (G__120308__$1) {
case "again":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__120308__$1)].join('')));
 ...
 */
open_spaced_repetition.cljc_fsrs.parameters.next_interval = (function open_spaced_repetition$cljc_fsrs$parameters$next_interval(p__120317,stability){
var map__120319 = p__120317;
var map__120319__$1 = cljs.core.__destructure_map(map__120319);
var maximum_interval = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__120319__$1,new cljs.core.Keyword(null,"maximum-interval","maximum-interval",76033288));
var request_retention = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__120319__$1,new cljs.core.Keyword(null,"request-retention","request-retention",1139336831));
