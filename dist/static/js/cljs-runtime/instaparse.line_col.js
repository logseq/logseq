...
(instaparse.line_col.Cursor.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k137446,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__137461 = k137446;
var G__137461__$1 = (((G__137461 instanceof cljs.core.Keyword))?G__137461.fqn:null);
switch (G__137461__$1) {
case "index":
return self__.index;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k137446,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__137463){
var vec__137464 = p__137463;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__137464,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__137464,(1),null);
...
(instaparse.line_col.Cursor.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__137445){
var self__ = this;
var G__137445__$1 = this;
return (new cljs.core.RecordIter((0),G__137445__$1,3,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"index","index",-1531685915),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this137447,other137448){
var self__ = this;
var this137447__$1 = this;
return (((!((other137448 == null)))) && ((((this137447__$1.constructor === other137448.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this137447__$1.index,other137448.index)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this137447__$1.line,other137448.line)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this137447__$1.column,other137448.column)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this137447__$1.__extmap,other137448.__extmap)))))))))));
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k137446){
var self__ = this;
var this__5307__auto____$1 = this;
var G__137489 = k137446;
var G__137489__$1 = (((G__137489 instanceof cljs.core.Keyword))?G__137489.fqn:null);
switch (G__137489__$1) {
case "index":
case "line":
case "column":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k137446);

}
}));

(instaparse.line_col.Cursor.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__137445){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__137490 = cljs.core.keyword_identical_QMARK_;
var expr__137491 = k__5309__auto__;
if(cljs.core.truth_((pred__137490.cljs$core$IFn$_invoke$arity$2 ? pred__137490.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"index","index",-1531685915),expr__137491) : pred__137490.call(null,new cljs.core.Keyword(null,"index","index",-1531685915),expr__137491)))){
return (new instaparse.line_col.Cursor(G__137445,self__.line,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__137490.cljs$core$IFn$_invoke$arity$2 ? pred__137490.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"line","line",212345235),expr__137491) : pred__137490.call(null,new cljs.core.Keyword(null,"line","line",212345235),expr__137491)))){
return (new instaparse.line_col.Cursor(self__.index,G__137445,self__.column,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__137490.cljs$core$IFn$_invoke$arity$2 ? pred__137490.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"column","column",2078222095),expr__137491) : pred__137490.call(null,new cljs.core.Keyword(null,"column","column",2078222095),expr__137491)))){
return (new instaparse.line_col.Cursor(self__.index,self__.line,G__137445,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__137445),null));
}
}
}
}));
...
(instaparse.line_col.Cursor.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__137445){
var self__ = this;
var this__5299__auto____$1 = this;
return (new instaparse.line_col.Cursor(self__.index,self__.line,self__.column,G__137445,self__.__extmap,self__.__hash));
}));
 ...
 */
instaparse.line_col.map__GT_Cursor = (function instaparse$line_col$map__GT_Cursor(G__137453){
var extmap__5342__auto__ = (function (){var G__137508 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__137453,new cljs.core.Keyword(null,"index","index",-1531685915),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"column","column",2078222095)], 0));
if(cljs.core.record_QMARK_(G__137453)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__137508);
} else {
return G__137508;
}
})();
return (new instaparse.line_col.Cursor(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(G__137453),new cljs.core.Keyword(null,"line","line",212345235).cljs$core$IFn$_invoke$arity$1(G__137453),new cljs.core.Keyword(null,"column","column",2078222095).cljs$core$IFn$_invoke$arity$1(G__137453),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
var G__137572 = (index + (1));
var G__137573 = (line + (1));
var G__137574 = (1);
index = G__137572;
line = G__137573;
column = G__137574;
...
var G__137575 = (index + (1));
var G__137576 = line;
var G__137577 = (column + (1));
index = G__137575;
line = G__137576;
column = G__137577;
continue;
