...
var G__39832 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__39832 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__39832,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__39833 = cljs.core.seq(lvls);
var chunk__39835 = null;
var count__39836 = (0);
var i__39837 = (0);
while(true){
if((i__39837 < count__39836)){
var vec__39846 = chunk__39835.cljs$core$IIndexed$_nth$arity$2(null,i__39837);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39846,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39846,(1),null);
var level_39908__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_39908__$1);


var G__39909 = seq__39833;
var G__39910 = chunk__39835;
var G__39911 = count__39836;
var G__39912 = (i__39837 + (1));
seq__39833 = G__39909;
chunk__39835 = G__39910;
count__39836 = G__39911;
i__39837 = G__39912;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__39833);
if(temp__5804__auto__){
var seq__39833__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__39833__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__39833__$1);
var G__39914 = cljs.core.chunk_rest(seq__39833__$1);
var G__39915 = c__5525__auto__;
var G__39916 = cljs.core.count(c__5525__auto__);
var G__39917 = (0);
seq__39833 = G__39914;
chunk__39835 = G__39915;
count__39836 = G__39916;
i__39837 = G__39917;
continue;
} else {
var vec__39852 = cljs.core.first(seq__39833__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39852,(1),null);
var level_39921__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_39921__$1);


var G__39925 = cljs.core.next(seq__39833__$1);
var G__39926 = null;
var G__39928 = (0);
var G__39929 = (0);
seq__39833 = G__39925;
chunk__39835 = G__39926;
count__39836 = G__39928;
i__39837 = G__39929;
continue;
}
} else {
...
var temp__5804__auto___39940 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5804__auto___39940)){
var instance_39945 = temp__5804__auto___39940;
instance_39945.setCapturing(true);

var instance_39946__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_39946__$1);

instance_39946__$1.setCapturing();
} else {
}
...
var G__39858 = (new goog.debug.FancyWindow());
...
var G__39859 = (new goog.debug.DivConsole(element));
G__39859.setCapturing(true);
...
var len__5726__auto___39951 = arguments.length;
var i__5727__auto___39952 = (0);
while(true){
if((i__5727__auto___39952 < len__5726__auto___39951)){
args__5732__auto__.push((arguments[i__5727__auto___39952]));

var G__39953 = (i__5727__auto___39952 + (1));
i__5727__auto___39952 = G__39953;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq39865){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39866,G__39867,seq39865__$2);
}));
...
var G__39878 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__39878) : handler_fn.call(null,G__39878));
});
if(cljs.core.truth_(logger)){
var temp__5804__auto___39970 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5804__auto___39970)){
var handler_39972 = temp__5804__auto___39970;
lambdaisland.glogi.goog_removeHandler(logger,handler_39972);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__39880,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5804__auto___39980 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5804__auto___39980)){
var handler_39982 = temp__5804__auto___39980;
lambdaisland.glogi.goog_removeHandler(logger,handler_39982);
} else {
}
