...
var G__100419 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child),new cljs.core.Keyword(null,"level","level",1290497552),cur_level], null));
var G__100420 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(next_children,cljs.core.rest(children));
var G__100421 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(cljs.core.count(next_children),(cur_level + (1))),cljs.core.rest(levels));
result = G__100419;
children = G__100420;
levels = G__100421;
continue;
...
var G__100396 = arguments.length;
switch (G__100396) {
case 1:
...
var G__100397 = (function (){var G__100398 = new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?page","?page",-1343187612,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?path","?path",385070032,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?file","?file",-1121006094,null),new cljs.core.Keyword("file","path","file/path",-191335748),new cljs.core.Symbol(null,"?path","?path",385070032,null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?page","?page",-1343187612,null),new cljs.core.Keyword("block","name","block/name",1619760316)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?page","?page",-1343187612,null),new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.Symbol(null,"?file","?file",-1121006094,null)], null)], null);
var G__100399 = db;
var G__100400 = file_path;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__100398,G__100399,G__100400) : datascript.core.q.call(null,G__100398,G__100399,G__100400));
})();
var G__100397__$1 = (((G__100397 == null))?null:frontend.db.utils.seq_flatten(G__100397));
if((G__100397__$1 == null)){
return null;
} else {
return cljs.core.first(G__100397__$1);
}
} else {
return null;
}
...
var G__100405 = arguments.length;
switch (G__100405) {
case 1:
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__100413){
var vec__100414 = p__100413;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100414,(0),null);
var _QMARK_parent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100414,(1),null);
...
var sort_fn = (function (p1__100417_SHARP_){
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","name","block/name",1619760316),p1__100417_SHARP_);
});
...
var page__$1 = (function (){var G__100418 = clojure.string.trim(page);
return (frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1 ? frontend.util.page_name_sanity_lc.cljs$core$IFn$_invoke$arity$1(G__100418) : frontend.util.page_name_sanity_lc.call(null,G__100418));
})();
