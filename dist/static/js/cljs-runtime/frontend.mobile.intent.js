...
var vec__121687 = cljs.core.re_find(/\s+([a-zA-Z0-9]+:\/\/[\S]*)$/,url);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121687,(0),null);
var link = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121687,(1),null);
...
var map__121697 = args;
var map__121697__$1 = cljs.core.__destructure_map(map__121697);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121697__$1,new cljs.core.Keyword(null,"url","url",276297046));
if(cljs.core.truth_(frontend.mobile.intent.is_link(url))){
return args;
} else {
var vec__121699 = frontend.mobile.intent.extract_highlight(url);
var highlight = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121699,(0),null);
var url_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121699,(1),null);
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.date.get_current_time()),(function (time){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.date.today()),(function (date_ref_name){
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__121748 = (function (){var or__5002__auto__ = title;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var G__121748__$1 = (((G__121748 == null))?null:logseq.common.util.safe_decode_uri_component(G__121748));
var G__121748__$2 = (((G__121748__$1 == null))?null:(frontend.util.node_path.name.cljs$core$IFn$_invoke$arity$1 ? frontend.util.node_path.name.cljs$core$IFn$_invoke$arity$1(G__121748__$1) : frontend.util.node_path.name.call(null,G__121748__$1)));
if((G__121748__$2 == null)){
return null;
} else {
return logseq.common.util.page_name_sanity(G__121748__$2);
}
})()),(function (title__$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(result),(function (p__121777){
var map__121779 = p__121777;
var map__121779__$1 = cljs.core.__destructure_map(map__121779);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121779__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(result),(function (p__121800){
var map__121801 = p__121800;
var map__121801__$1 = cljs.core.__destructure_map(map__121801);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121801__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121801__$1,new cljs.core.Keyword(null,"url","url",276297046));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121801__$1,new cljs.core.Keyword(null,"type","type",1174270348));
return promesa.protocols._mcat(promesa.protocols._promise((function (){var or__5002__auto__ = frontend.state.get_current_page();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5480__auto__ = (function frontend$mobile$intent$decode_received_result_$_iter__121815(s__121816){
return (new cljs.core.LazySeq(null,(function (){
var s__121816__$1 = s__121816;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__121816__$1);
if(temp__5804__auto__){
var s__121816__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__121816__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__121816__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__121818 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__121817 = (0);
while(true){
if((i__121817 < size__5479__auto__)){
var vec__121821 = cljs.core._nth(c__5478__auto__,i__121817);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121821,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121821,(1),null);
cljs.core.chunk_append(b__121818,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,((cljs.core.vector_QMARK_(v))?cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(frontend.mobile.intent.decode_received_result,v)):((clojure.string.blank_QMARK_(v))?null:(cljs.core.truth_(frontend.mobile.util.native_ios_QMARK_())?logseq.common.util.safe_decode_uri_component(v):v)
))], null));

var G__122014 = (i__121817 + (1));
i__121817 = G__122014;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__121818),frontend$mobile$intent$decode_received_result_$_iter__121815(cljs.core.chunk_rest(s__121816__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__121818),null);
}
} else {
var vec__121827 = cljs.core.first(s__121816__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121827,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__121827,(1),null);
...
))], null),frontend$mobile$intent$decode_received_result_$_iter__121815(cljs.core.rest(s__121816__$2)));
}
} else {
return null;
}
...
frontend.mobile.intent.handle_payload_resource = (function frontend$mobile$intent$handle_payload_resource(p__121863,format){
var map__121865 = p__121863;
var map__121865__$1 = cljs.core.__destructure_map(map__121865);
var resource = map__121865__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121865__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121865__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var ext = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121865__$1,new cljs.core.Keyword(null,"ext","ext",-996964541));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121865__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var _STAR_print_newline_STAR__orig_val__121868_122023 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__121869_122024 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__121870_122025 = true;
var _STAR_print_fn_STAR__temp_val__121871_122026 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__121870_122025);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__121871_122026);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(resource);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__121869_122024);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__121868_122023);
}
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Parsing current shared content are not supported. Please report the following codes on ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",new cljs.core.Keyword(null,"target","target",253001721),"_blank"], null),"Github"], null),". We will look into it soon.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre.code","pre.code",2043838796),(function (){var sb__5647__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__121872_122032 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__121873_122033 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__121874_122034 = true;
var _STAR_print_fn_STAR__temp_val__121875_122035 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__121874_122034);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__121875_122035);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(resource);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__121873_122033);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__121872_122032);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})()], null)], null),new cljs.core.Keyword(null,"warning","warning",-1685650671),false);
...
return promesa.protocols._mcat(promesa.protocols._promise(payload),(function (p__121918){
var map__121920 = p__121918;
var map__121920__$1 = cljs.core.__destructure_map(map__121920);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121920__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var resources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__121920__$1,new cljs.core.Keyword(null,"resources","resources",1632806811));
...
return frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),"Parsing current shared content are not supported. Please report the following codes on ",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"href","href",-793805698),"https://github.com/logseq/logseq/issues/new?labels=from:in-app&template=bug_report.yaml",new cljs.core.Keyword(null,"target","target",253001721),"_blank"], null),"Github"], null),". We will look into it soon.",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre.code","pre.code",2043838796),(function (){var sb__5647__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__121955_122059 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__121956_122060 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__121957_122061 = true;
var _STAR_print_fn_STAR__temp_val__121958_122062 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__121957_122061);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__121958_122062);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(result__$1);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__121956_122060);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__121955_122059);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})()], null)], null),new cljs.core.Keyword(null,"warning","warning",-1685650671),false);
