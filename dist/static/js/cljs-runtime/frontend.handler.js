...
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
...
return promesa.core.finally$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41621__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.config.global_config_enabled_QMARK_())?frontend.handler.global_config.start(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"repo","repo",-1999060679),repo], null)):null)),(function (___41611__auto__){
...
frontend.state.set_online_BANG_(online_QMARK_);
...
return promesa.protocols._mcat(promesa.protocols._promise(promesa.core.finally$.cljs$core$IFn$_invoke$arity$2(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.set_network_watcher_BANG_()),(function (___41611__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(frontend.util.electron_QMARK_())?frontend.persist_db.run_export_periodically_BANG_():null)),(function (___41611__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.util._LT_app_wake_up_from_sleep_loop(cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false))),(function (___41611__auto____$1){
