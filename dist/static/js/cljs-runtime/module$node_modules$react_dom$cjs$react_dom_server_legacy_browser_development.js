shadow$provide.module$node_modules$react_dom$cjs$react_dom_server_legacy_browser_development = function(global, require, module, exports) {
  (function() {
    ...
    function getChildFormatContext(parentContext, type, props) {
      switch(type) {
        case "select":
          return createFormatContext(1, null != props.value ? props.value : props.defaultValue);
        case "svg":
      ...
      return 4 <= parentContext.insertionMode || 0 === parentContext.insertionMode ? createFormatContext(1, null) : parentContext;
    }
        ...
        if (hasOwnProperty.call(style, styleName)) {
          ...
          if (null != styleValue && "boolean" !== typeof styleValue && "" !== styleValue) {
            if (0 === styleName.indexOf("--")) {
              ...
              void 0 !== chunk ? nameChunk = chunk : (chunk = escapeTextForBrowser(nameChunk.replace(uppercasePattern, "-$1").toLowerCase().replace(msPattern$1, "-ms-")), styleNameCache.set(nameChunk, chunk), nameChunk = chunk);
              styleValue = "number" === typeof styleValue ? 0 === styleValue || hasOwnProperty.call(isUnitlessNumber, styleName) ? "" + styleValue : styleValue + "px" : escapeTextForBrowser(("" + styleValue).trim());
            }
    ...
    function pushAttribute(target, responseState, name, value) {
      ...
      if (!(2 < name.length) || "o" !== name[0] && "O" !== name[0] || "n" !== name[1] && "N" !== name[1]) {
        if (responseState = getPropertyInfo(name), null !== responseState) {
          switch(typeof value) {
            case "function":
            case "symbol":
              return;
          ...
          switch(responseState.type) {
            case 3:
              ...
              break;
            case 4:
              !0 === value ? target.push(" ", name, '\x3d""') : !1 !== value && target.push(" ", name, '\x3d"', escapeTextForBrowser(value), attributeEnd);
              break;
            case 5:
              isNaN(value) || target.push(" ", name, '\x3d"', escapeTextForBrowser(value), attributeEnd);
              break;
            case 6:
              !isNaN(value) && 1 <= value && target.push(" ", name, '\x3d"', escapeTextForBrowser(value), attributeEnd);
              break;
            default:
              responseState.sanitizeURL && (responseState = value = "" + value, !didWarn && isJavaScriptProtocol.test(responseState) && (didWarn = !0, error("A future version of React will block javascript: URLs as a security precaution. Use event handlers instead if you can. If you need to generate unsafe HTML try using dangerouslySetInnerHTML instead. React was passed %s.", JSON.stringify(responseState)))), target.push(" ", name, '\x3d"', escapeTextForBrowser(value), attributeEnd);
          }
          ...
          switch(typeof value) {
            ...
            case "symbol":
              return;
            case "boolean":
              if (responseState = name.toLowerCase().slice(0, 5), "data-" !== responseState && "aria-" !== responseState) {
                return;
              }
          }
          target.push(" ", name, '\x3d"', escapeTextForBrowser(value), attributeEnd);
        }
      }
    }
    ...
    function checkSelectProp(props, propName) {
      ...
      null != value && (value = isArrayImpl(value), props.multiple && !value ? error("The `%s` prop supplied to \x3cselect\x3e must be an array if `multiple` is true.", propName) : !props.multiple && value && error("The `%s` prop supplied to \x3cselect\x3e must be a scalar value if `multiple` is false.", propName));
    }
    function flattenOptionChildren(children) {
      var content = "";
      React.Children.forEach(children, function(child) {
        null != child && (content += child, didWarnInvalidOptionChildren || "string" === typeof child || "number" === typeof child || (didWarnInvalidOptionChildren = !0, error("Cannot infer the option value of complex children. Pass a `value` prop or use a plain string as children to \x3coption\x3e.")));
      });
      return content;
    }
    ...
    function pushStartInstance(target, type, props, responseState, formatContext) {
      ...
      2 !== formatContext.insertionMode && 3 !== formatContext.insertionMode && -1 === type.indexOf("-") && "string" !== typeof props.is && type.toLowerCase() !== type && error("\x3c%s /\x3e is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", type);
      switch(type) {
        case "select":
          checkControlledValueProps("select", props);
          checkSelectProp(props, "value");
          checkSelectProp(props, "defaultValue");
          void 0 === props.value || void 0 === props.defaultValue || didWarnDefaultSelectValue || (error("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), didWarnDefaultSelectValue = !0);
        ...
        case "option":
          ...
          if (null != innerHTML) {
            if (null !== value ? props = "" + value : (null === propKey || didWarnInvalidOptionInnerHTML || (didWarnInvalidOptionInnerHTML = !0, error("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected.")), props = flattenOptionChildren(propValue)), isArrayImpl(innerHTML)) {
              ...
              "" + innerHTML === props && target.push(' selected\x3d""');
            }
          } else {
        ...
        case "textarea":
          ...
          void 0 === props.value || void 0 === props.defaultValue || didWarnDefaultTextareaValue || (error("Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components"), didWarnDefaultTextareaValue = !0);
          target.push(startChunkForTag("textarea"));
          propKey = innerHTML = children = null;
          for (propValue in props) {
            if (hasOwnProperty.call(props, propValue) && (value = props[propValue], null != value)) {
              switch(propValue) {
                case "children":
                  propKey = value;
                  break;
          ...
          "string" === typeof children && "\n" === children[0] && target.push(leadingNewline);
          null !== children && target.push(escapeTextForBrowser("" + children));
          return null;
        case "input":
          ...
          !0);
          void 0 === props.value || void 0 === props.defaultValue || didWarnDefaultInputValue || (error("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", props.type), didWarnDefaultInputValue = 
          !0);
          target.push(startChunkForTag("input"));
          value = propKey = propValue = children = null;
          for (innerHTML in props) {
            if (hasOwnProperty.call(props, innerHTML) && (selected = props[innerHTML], null != selected)) {
              switch(innerHTML) {
                case "children":
                case "dangerouslySetInnerHTML":
          ...
          null !== propKey ? pushAttribute(target, responseState, "checked", propKey) : null !== value && pushAttribute(target, responseState, "checked", value);
          null !== children ? pushAttribute(target, responseState, "value", children) : null !== propValue && pushAttribute(target, responseState, "value", propValue);
          target.push("/\x3e");
          return null;
        case "menuitem":
          target.push(startChunkForTag("menuitem"));
          for (var propKey$jscomp$0 in props) {
            if (hasOwnProperty.call(props, propKey$jscomp$0) && (children = props[propKey$jscomp$0], null != children)) {
        ...
        case "title":
          ...
          for (propValue$jscomp$0 in props) {
            if (hasOwnProperty.call(props, propValue$jscomp$0) && (innerHTML = props[propValue$jscomp$0], null != innerHTML)) {
          ...
          target.push("\x3e");
          target = Array.isArray(children) && 2 > children.length ? children[0] || null : children;
          Array.isArray(children) && 1 < children.length ? error("A title element received an array with more than 1 element as children. In browsers title Elements can only have Text Nodes as children. If the children being rendered output more than a single text node in aggregate the browser will display markup and comments as text in the title and hydration will likely fail and fall back to client rendering") : null != target && null != target.$$typeof ? error("A title element received a React element for children. In the browser title Elements can only have Text Nodes as children. If the children being rendered output more than a single text node in aggregate the browser will display markup and comments as text in the title and hydration will likely fail and fall back to client rendering") : 
          null != target && "string" !== typeof target && "number" !== typeof target && error("A title element received a value that was not a string or number for children. In the browser title Elements can only have Text Nodes as children. If the children being rendered output more than a single text node in aggregate the browser will display markup and comments as text in the title and hydration will likely fail and fall back to client rendering");
          return children;
        case "listing":
        case "pre":
          ...
          for (value in props) {
            if (hasOwnProperty.call(props, value) && (propValue = props[value], null != propValue)) {
              switch(value) {
                case "children":
                  children = propValue;
                  break;
          ...
          if (null != innerHTML) {
            ...
            null !== props && void 0 !== props && ("string" === typeof props && 0 < props.length && "\n" === props[0] ? target.push(leadingNewline, props) : target.push("" + props));
          }
          "string" === typeof children && "\n" === children[0] && target.push(leadingNewline);
          return children;
        case "area":
        ...
        case "wbr":
          ...
          for (var propKey$jscomp$1 in props) {
            if (hasOwnProperty.call(props, propKey$jscomp$1) && (children = props[propKey$jscomp$1], null != children)) {
        ...
        case "html":
          return 0 === formatContext.insertionMode && target.push("\x3c!DOCTYPE html\x3e"), pushStartGenericElement(target, props, type, responseState);
        default:
          ...
          for (selected in props) {
            if (hasOwnProperty.call(props, selected) && (propValue = props[selected], null != propValue)) {
              switch(selected) {
                case "children":
                  children = propValue;
                  break;
                ...
                case "suppressHydrationWarning":
                  break;
                default:
                  isAttributeNameSafe(selected) && "function" !== typeof propValue && "symbol" !== typeof propValue && target.push(" ", selected, '\x3d"', escapeTextForBrowser(propValue), attributeEnd);
              }
            }
          }
          target.push("\x3e");
    ...
    function writeStartSegment(destination, responseState, formatContext, id) {
      switch(formatContext.insertionMode) {
        case 0:
        case 1:
          return destination.push('\x3cdiv hidden id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 2:
          return destination.push('\x3csvg aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 3:
          return destination.push('\x3cmath aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 4:
          return destination.push('\x3ctable hidden id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 5:
          return destination.push('\x3ctable hidden\x3e\x3ctbody id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 6:
          return destination.push('\x3ctable hidden\x3e\x3ctr id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        case 7:
          return destination.push('\x3ctable hidden\x3e\x3ccolgroup id\x3d"'), destination.push(responseState.segmentPrefix), responseState = id.toString(16), destination.push(responseState), destination.push('"\x3e');
        default:
    ...
    function mountClassInstance(instance, ctor, newProps, maskedLegacyContext) {
      ...
      hasMutatedProps = void 0 !== instance.state ? instance.state : null;
      ...
      instance.context = "object" === typeof contextType && null !== contextType ? contextType._currentValue2 : maskedLegacyContext;
      ...
      "function" === typeof contextType && (contextType = contextType(newProps, hasMutatedProps), warnOnUndefinedDerivedState(ctor, contextType), hasMutatedProps = null === contextType || void 0 === contextType ? hasMutatedProps : assign({}, hasMutatedProps, contextType), instance.state = hasMutatedProps);
      if ("function" !== typeof ctor.getDerivedStateFromProps && "function" !== typeof instance.getSnapshotBeforeUpdate && ("function" === typeof instance.UNSAFE_componentWillMount || "function" === typeof instance.componentWillMount)) {
        if (hasMutatedProps = instance.state, "function" === typeof instance.componentWillMount && (!0 !== instance.componentWillMount.__suppressDeprecationWarning && (contextType = getComponentNameFromType(ctor) || "Unknown", didWarnAboutDeprecatedWillMount[contextType] || (warn("componentWillMount has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move code from componentWillMount to componentDidMount (preferred in most cases) or the constructor.\n\nPlease update the following components: %s", 
        contextType), didWarnAboutDeprecatedWillMount[contextType] = !0)), instance.componentWillMount()), "function" === typeof instance.UNSAFE_componentWillMount && instance.UNSAFE_componentWillMount(), hasMutatedProps !== instance.state && (error("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", getComponentNameFromType(ctor) || "Component"), classComponentUpdater.enqueueReplaceState(instance, instance.state, 
        null)), null !== name.queue && 0 < name.queue.length) {
          if (ctor = name.queue, contextType = name.replace, name.queue = null, name.replace = !1, contextType && 1 === ctor.length) {
            ...
            for (contextType = contextType ? 1 : 0; contextType < ctor.length; contextType++) {
              ...
              partial = "function" === typeof partial ? partial.call(instance, name, newProps, maskedLegacyContext) : partial;
              null != partial && (hasMutatedProps ? (hasMutatedProps = !1, name = assign({}, name, partial)) : assign(name, partial));
            }
            instance.state = name;
          }
        } else {
    ...
    function dispatchAction(componentIdentity, queue, action) {
      ...
      if (componentIdentity === currentlyRenderingComponent) {
        if (didScheduleRenderPhaseUpdate = !0, componentIdentity = {action, next:null}, null === renderPhaseUpdates && (renderPhaseUpdates = new Map()), action = renderPhaseUpdates.get(queue), void 0 === action) {
    ...
    function createRequest(children, responseState, rootFormatContext, progressiveChunkSize, onError, onAllReady, onShellReady, onShellError, onFatalError) {
      ...
      responseState = {destination:null, responseState, progressiveChunkSize:void 0 === progressiveChunkSize ? 12800 : progressiveChunkSize, status:0, fatalError:null, nextSegmentId:0, allPendingTasks:0, pendingRootTasks:0, completedRootSegment:null, abortableTasks:abortSet, pingedTasks, clientRenderedBoundaries:[], completedBoundaries:[], partialBoundaries:[], onError:void 0 === onError ? defaultErrorHandler : onError, onAllReady:void 0 === onAllReady ? noop$1 : onAllReady, onShellReady:void 0 === 
      onShellReady ? noop$1 : onShellReady, onShellError:void 0 === onShellError ? noop$1 : onShellError, onFatalError:void 0 === onFatalError ? noop$1 : onFatalError};
    ...
    function popComponentStackInDEV(task) {
      null === task.componentStack ? error("Unexpectedly popped too many stack frames. This is a bug in React.") : task.componentStack = task.componentStack.parent;
    }
    function captureBoundaryErrorDetailsDev(boundary, error) {
      error = "string" === typeof error ? error : error && "string" === typeof error.message ? error.message : String(error);
    ...
    function renderElement(request, task, type, props, ref) {
      if ("function" === typeof type) {
        if (type.prototype && type.prototype.isReactComponent) {
          ...
          if ("contextType" in type && null !== contextType && (void 0 === contextType || contextType.$$typeof !== REACT_CONTEXT_TYPE || void 0 !== contextType._context) && !didWarnAboutInvalidateContextType.has(type)) {
            didWarnAboutInvalidateContextType.add(type);
            var addendum = void 0 === contextType ? " However, it is set to undefined. This can be caused by a typo or by mixing up named and default imports. This can also happen due to a circular dependency, so try moving the createContext() call to a separate file." : "object" !== typeof contextType ? " However, it is set to a " + typeof contextType + "." : contextType.$$typeof === REACT_PROVIDER_TYPE ? " Did you accidentally pass the Context.Provider instead?" : void 0 !== contextType._context ? 
          ...
          contextType = new type(props, "object" === typeof contextType && null !== contextType ? contextType._currentValue2 : ref);
          "function" !== typeof type.getDerivedStateFromProps || null !== contextType.state && void 0 !== contextType.state || (addendum = getComponentNameFromType(type) || "Component", didWarnAboutUninitializedState.has(addendum) || (didWarnAboutUninitializedState.add(addendum), error("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.", 
          addendum, null === contextType.state ? "null" : "undefined", addendum)));
          if ("function" === typeof type.getDerivedStateFromProps || "function" === typeof contextType.getSnapshotBeforeUpdate) {
            var foundWillReceivePropsName = addendum = null, foundWillUpdateName = null;
            "function" === typeof contextType.componentWillMount && !0 !== contextType.componentWillMount.__suppressDeprecationWarning ? addendum = "componentWillMount" : "function" === typeof contextType.UNSAFE_componentWillMount && (addendum = "UNSAFE_componentWillMount");
            "function" === typeof contextType.componentWillReceiveProps && !0 !== contextType.componentWillReceiveProps.__suppressDeprecationWarning ? foundWillReceivePropsName = "componentWillReceiveProps" : "function" === typeof contextType.UNSAFE_componentWillReceiveProps && (foundWillReceivePropsName = "UNSAFE_componentWillReceiveProps");
            "function" === typeof contextType.componentWillUpdate && !0 !== contextType.componentWillUpdate.__suppressDeprecationWarning ? foundWillUpdateName = "componentWillUpdate" : "function" === typeof contextType.UNSAFE_componentWillUpdate && (foundWillUpdateName = "UNSAFE_componentWillUpdate");
            if (null !== addendum || null !== foundWillReceivePropsName || null !== foundWillUpdateName) {
          ...
          if (addendum = getMaskedContext(type, task.legacyContext), task.componentStack = {tag:1, parent:task.componentStack, type}, type.prototype && "function" === typeof type.prototype.render && (ref = getComponentNameFromType(type) || "Unknown", didWarnAboutBadClass[ref] || (error("The \x3c%s /\x3e component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", ref, ref), didWarnAboutBadClass[ref] = 
          !0)), ref = renderWithHooks(request, task, type, props, addendum), contextType = 0 !== localIdCounter, "object" === typeof ref && null !== ref && "function" === typeof ref.render && void 0 === ref.$$typeof && (foundWillReceivePropsName = getComponentNameFromType(type) || "Unknown", didWarnAboutModulePatternComponent[foundWillReceivePropsName] || (error("The \x3c%s /\x3e component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype \x3d React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.", 
          foundWillReceivePropsName, foundWillReceivePropsName, foundWillReceivePropsName), didWarnAboutModulePatternComponent[foundWillReceivePropsName] = !0)), "object" === typeof ref && null !== ref && "function" === typeof ref.render && void 0 === ref.$$typeof) {
            ...
            if (type && type.childContextTypes && error("%s(...): childContextTypes cannot be defined on a function component.", type.displayName || type.name || "Component"), void 0 !== type.defaultProps && (props = getComponentNameFromType(type) || "Unknown", didWarnAboutDefaultPropsOnFunctionComponent[props] || (error("%s: Support for defaultProps will be removed from function components in a future major release. Use JavaScript default parameters instead.", props), didWarnAboutDefaultPropsOnFunctionComponent[props] = 
            !0)), "function" === typeof type.getDerivedStateFromProps && (props = getComponentNameFromType(type) || "Unknown", didWarnAboutGetDerivedStateOnFunctionComponent[props] || (error("%s: Function components do not support getDerivedStateFromProps.", props), didWarnAboutGetDerivedStateOnFunctionComponent[props] = !0)), "object" === typeof type.contextType && null !== type.contextType && (props = getComponentNameFromType(type) || "Unknown", didWarnAboutContextTypeOnFunctionComponent[props] || 
        ...
        if ("string" === typeof type) {
          ...
          switch(type) {
            ...
            case REACT_SUSPENSE_TYPE:
              a: {
                ...
                try {
                  if (renderNode(request, task, props), request.responseState.generateStaticMarkup || _componentName.lastPushedText && _componentName.textEmbedded && _componentName.chunks.push("\x3c!-- --\x3e"), _componentName.status = 1, queueCompletedSegment(foundWillReceivePropsName, _componentName), 0 === foundWillReceivePropsName.pendingTasks) {
                    popComponentStackInDEV(task);
                    break a;
                  }
                } catch (error) {
          ...
          if ("object" === typeof type && null !== type) {
            switch(type.$$typeof) {
              ...
              case REACT_PROVIDER_TYPE:
                ...
                void 0 !== type._currentRenderer2 && null !== type._currentRenderer2 && type._currentRenderer2 !== rendererSigil && error("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported.");
                type._currentRenderer2 = rendererSigil;
                foundWillReceivePropsName = currentActiveSnapshot;
                currentActiveSnapshot = ref = {parent:foundWillReceivePropsName, depth:null === foundWillReceivePropsName ? 0 : foundWillReceivePropsName.depth + 1, context:type, parentValue:addendum, value:ref};
                task.context = ref;
                ...
                return;
              case REACT_CONTEXT_TYPE:
                void 0 === type._context ? type === type.Consumer || hasWarnedAboutUsingContextAsConsumer || (hasWarnedAboutUsingContextAsConsumer = !0, error("Rendering \x3cContext\x3e directly is not supported and will be removed in a future major release. Did you mean to render \x3cContext.Consumer\x3e instead?")) : type = type._context;
                props = props.children;
                "function" !== typeof props && error("A context consumer was rendered with multiple children, or a child that isn't a function. A context consumer expects a single child that is a function. If you did pass a function, make sure there is no trailing or leading whitespace around it.");
          ...
          throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: " + ((null == type ? type : typeof type) + "." + task));
        }
      }
    }
    function renderNodeDestructive(request, task, node) {
      try {
        a: {
          ...
          if ("object" === typeof node && null !== node) {
            switch(node.$$typeof) {
              ...
              case REACT_LAZY_TYPE:
                ...
                try {
                  ...
                  throw "object" === typeof x && null !== x && "function" === typeof x.then && pushBuiltInComponentStackInDEV(task, "Lazy"), x;
                }
            ...
            if (null === node || "object" !== typeof node) {
              ...
              iteratorFn = "function" === typeof maybeIterator ? maybeIterator : null;
            }
            if (iteratorFn) {
              payload = iteratorFn;
              "function" === typeof Symbol && "Generator" === node[Symbol.toStringTag] && (didWarnAboutGenerators || error("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), didWarnAboutGenerators = !0);
            ...
            throw Error("Objects are not valid as a React child (found: " + ("[object Object]" === childString ? "object with keys {" + Object.keys(node).join(", ") + "}" : childString) + "). If you meant to render a collection of children, use an array instead.");
          }
          if ("string" === typeof node) {
            ...
            if ("number" === typeof node) {
              ...
              "function" === typeof node && error("Functions are not valid as a React child. This may happen if you return a Component instead of \x3cComponent /\x3e from render. Or maybe you meant to call this function rather than return it.");
            }
          }
          JSCompiler_inline_result = void 0;
        }
        ...
        if ("object" !== typeof x || null === x || "function" !== typeof x.then) {
          lastBoundaryErrorComponentStackDev = null !== lastBoundaryErrorComponentStackDev ? lastBoundaryErrorComponentStackDev : getCurrentStackInDEV();
        }
        throw x;
      }
    }
    ...
    function renderNode(request, task, node) {
      ...
      try {
        ...
        if (resetHooksState(), "object" === typeof x && null !== x && "function" === typeof x.then) {
          node = x;
          ...
          null !== task.componentStack && (request.componentStack = task.componentStack.parent);
    ...
    function abortTask(task, request, reason) {
      ...
      if (null === boundary) {
        request.allPendingTasks--, 2 !== request.status && (request.status = 2, null !== request.destination && request.destination.push(null));
      } else {
        boundary.pendingTasks--;
        if (!boundary.forceClientRender) {
          boundary.forceClientRender = !0;
          var _error = void 0 === reason ? Error("The render was aborted by the server without a reason.") : reason;
          boundary.errorDigest = request.onError(_error);
          _error = _error && "string" === typeof _error.message ? "The server did not finish this Suspense boundary: " + _error.message : "The server did not finish this Suspense boundary: " + String(_error);
    ...
    function queueCompletedSegment(boundary, segment) {
      if (0 === segment.chunks.length && 1 === segment.children.length && null === segment.children[0].boundary) {
    ...
    function finishedTask(request, boundary, segment) {
      if (null === boundary) {
        ...
        0 === request.pendingRootTasks && (request.onShellError = noop$1, boundary = request.onShellReady, boundary());
      } else {
        boundary.pendingTasks--, boundary.forceClientRender || (0 === boundary.pendingTasks ? (segment.parentFlushed && 1 === segment.status && queueCompletedSegment(boundary, segment), boundary.parentFlushed && request.completedBoundaries.push(boundary), boundary.fallbackAbortableTasks.forEach(abortTaskSoft, request), boundary.fallbackAbortableTasks.clear()) : segment.parentFlushed && 1 === segment.status && (queueCompletedSegment(boundary, segment), 1 === boundary.completedSegments.length && boundary.parentFlushed && 
    ...
    function performWork(request$jscomp$0) {
      if (2 !== request$jscomp$0.status) {
        ...
        try {
            ...
            if (0 === segment.status) {
              ...
              try {
                ...
                if (resetHooksState(), "object" === typeof x && null !== x && "function" === typeof x.then) {
                  ...
                  null === boundary ? fatalError(request, error) : (boundary.pendingTasks--, boundary.forceClientRender || (boundary.forceClientRender = !0, boundary.errorDigest = errorDigest, captureBoundaryErrorDetailsDev(boundary, error), boundary.parentFlushed && request.clientRenderedBoundaries.push(boundary)));
                  request.allPendingTasks--;
          ...
          null !== request$jscomp$0.destination && flushCompletedQueues(request$jscomp$0, request$jscomp$0.destination);
        } catch (error) {
    ...
    function flushSegment(request, destination, segment) {
      ...
      if (boundary.forceClientRender) {
        if (!request.responseState.generateStaticMarkup) {
          ...
          errorDigest && (destination.push(' data-dgst\x3d"'), errorDigest = escapeTextForBrowser(errorDigest), destination.push(errorDigest), destination.push('"'));
          errorMesssage && (destination.push(' data-msg\x3d"'), errorMesssage = escapeTextForBrowser(errorMesssage), destination.push(errorMesssage), destination.push('"'));
          boundary && (destination.push(' data-stck\x3d"'), boundary = escapeTextForBrowser(boundary), destination.push(boundary), destination.push('"'));
      ...
      try {
        ...
        for (i = 0; i < clientRenderedBoundaries.length; i++) {
          ...
          if (errorMessage || errorComponentStack) {
            bootstrapChunks.push(",");
            var chunk$jscomp$0 = escapeJSStringsForInstructionScripts(errorMessage || "");
            bootstrapChunks.push(chunk$jscomp$0);
          }
          if (errorComponentStack) {
            bootstrapChunks.push(",");
            var chunk$jscomp$1 = escapeJSStringsForInstructionScripts(errorComponentStack);
        ...
        0 === request.allPendingTasks && 0 === request.pingedTasks.length && 0 === request.clientRenderedBoundaries.length && 0 === request.completedBoundaries.length && (0 !== request.abortableTasks.size && error("There was still abortable task at the root when we closed. This is a bug in React."), destination.push(null));
      }
    }
    function startFlowing(request, destination) {
      if (1 === request.status) {
        ...
        if (2 !== request.status && null === request.destination) {
    ...
    var React = require("module$react"), ReactSharedInternals = React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, hasOwnProperty = Object.prototype.hasOwnProperty, VALID_ATTRIBUTE_NAME_REGEX = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), 
    ...
    var classComponentUpdater = {isMounted:function(inst) {
      ...
      null === internals.queue ? warnNoop(inst, "setState") : (internals.queue.push(payload), void 0 !== callback && null !== callback && warnOnInvalidCallback(callback, "setState"));
    }, enqueueReplaceState:function(inst, payload, callback) {
      inst = inst._reactInternals;
      inst.replace = !0;
      inst.queue = [payload];
      void 0 !== callback && null !== callback && warnOnInvalidCallback(callback, "setState");
    }, enqueueForceUpdate:function(inst, callback) {
      null === inst._reactInternals.queue ? warnNoop(inst, "forceUpdate") : void 0 !== callback && null !== callback && warnOnInvalidCallback(callback, "setState");
    }}, emptyTreeContext = {id:1, overflow:""}, clz32 = Math.clz32 ? Math.clz32 : clz32Fallback, log = Math.log, LN2 = Math.LN2, objectIs = "function" === typeof Object.is ? Object.is : is, currentlyRenderingComponent = null, currentlyRenderingTask = null, firstWorkInProgressHook = null, workInProgressHook = null, isReRender = !1, didScheduleRenderPhaseUpdate = !1, localIdCounter = 0, renderPhaseUpdates = null, numberOfReRenders = 0, isInHookUserCodeInDev = !1, currentHookNameInDev, Dispatcher = 
