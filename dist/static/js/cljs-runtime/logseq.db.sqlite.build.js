...
var G__143572 = cljs.core.first(val);
var G__143572__$1 = (((G__143572 instanceof cljs.core.Keyword))?G__143572.fqn:null);
switch (G__143572__$1) {
case "build/page":
...
var block__$1 = (function (){var G__143581 = block;
var G__143581__$1 = (((new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551).cljs$core$IFn$_invoke$arity$1(block) == null))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143581,new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551),updated_at):G__143581);
if((new cljs.core.Keyword("block","created-at","block/created-at",1440015).cljs$core$IFn$_invoke$arity$1(block) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143581__$1,new cljs.core.Keyword("block","created-at","block/created-at",1440015),updated_at);
} else {
return G__143581__$1;
}
})();
return block__$1;
});
...
logseq.db.sqlite.build.__GT_block_properties = (function logseq$db$sqlite$build$__GT_block_properties(properties,page_uuids,all_idents,p__143592){
var map__143593 = p__143592;
var map__143593__$1 = cljs.core.__destructure_map(map__143593);
var translate_property_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143593__$1,new cljs.core.Keyword(null,"translate-property-values?","translate-property-values?",-1950851544));
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143590_SHARP_){
return logseq.db.sqlite.build.translate_property_value(p1__143590_SHARP_,page_uuids);
}),val));
} else {
return logseq.db.sqlite.build.translate_property_value(val,page_uuids);
}
}):cljs.core.identity);
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__143594){
var vec__143596 = p__143594;
var prop_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143596,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143596,(1),null);
...
if(cljs.core.truth_((function (){var and__5000__auto__ = (function (){var G__143609 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(properties_config,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,new cljs.core.Keyword("logseq.property","type","logseq.property/type",83842404)], null));
return (logseq.db.frontend.property.type.value_ref_property_types.cljs$core$IFn$_invoke$arity$1 ? logseq.db.frontend.property.type.value_ref_property_types.cljs$core$IFn$_invoke$arity$1(G__143609) : logseq.db.frontend.property.type.value_ref_property_types.call(null,G__143609));
})();
if(cljs.core.truth_(and__5000__auto__)){
...
return logseq.db.frontend.property.build.build_property_values_tx_m(new_block,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__143614){
var vec__143617 = p__143614;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143617,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143617,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var pvalue_attrs = (cljs.core.truth_(new cljs.core.Keyword("build","property-value","build/property-value",1425188701).cljs$core$IFn$_invoke$arity$1(v))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(v),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","tags","block/tags",1814948340),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143613_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","ident","db/ident",-737096)],[logseq.db.sqlite.build.get_ident(all_idents,p1__143613_SHARP_)]);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143622,new cljs.core.Keyword(null,"property-value-properties","property-value-properties",339042228),pvalue_attrs);
} else {
return G__143622;
}
...
logseq.db.sqlite.build.__GT_block_tx = (function logseq$db$sqlite$build$__GT_block_tx(p__143640,page_uuids,all_idents,page_id,p__143641){
var map__143642 = p__143640;
var map__143642__$1 = cljs.core.__destructure_map(map__143642);
var m = map__143642__$1;
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143642__$1,new cljs.core.Keyword("build","properties","build/properties",708607786));
var map__143643 = p__143641;
var map__143643__$1 = cljs.core.__destructure_map(map__143643);
var options = map__143643__$1;
var properties_config = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143643__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143643__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
var extract_content_refs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143643__$1,new cljs.core.Keyword(null,"extract-content-refs?","extract-content-refs?",-1224729418));
...
var G__143645 = cljs.core.PersistentVector.EMPTY;
var G__143645__$1 = ((cljs.core.seq(pvalue_tx_m))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__143645,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143630_SHARP_){
if(cljs.core.set_QMARK_(p1__143630_SHARP_)){
return p1__143630_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__143630_SHARP_], null);
}
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(pvalue_tx_m)], 0))):G__143645);
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__143645__$1,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(cljs.core.truth_(build_existing_tx_QMARK__SINGLEQUOTE_)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","updated-at","block/updated-at",-1516550551),logseq.common.util.time_ms()], null):logseq.db.sqlite.build.block_with_timestamps(block)),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(m,new cljs.core.Keyword("build","properties","build/properties",708607786),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("build","tags","build/tags",1814686611),new cljs.core.Keyword("build","keep-uuid?","build/keep-uuid?",705498954)], 0)),((cljs.core.seq(properties))?logseq.db.sqlite.build.__GT_block_properties(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([properties,logseq.db.frontend.property.build.build_properties_with_ref_values(pvalue_tx_m)], 0)),page_uuids,all_idents,options):null),(function (){var temp__5804__auto__ = new cljs.core.Keyword("build","tags","build/tags",1814686611).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto__)){
var tags = temp__5804__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","tags","block/tags",1814948340),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143633_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","ident","db/ident",-737096)],[logseq.db.sqlite.build.get_ident(all_idents,p1__143633_SHARP_)]);
}),tags)], null);
} else {
return null;
}
})(),((cljs.core.seq(ref_strings))?(function (){var block_refs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143634_SHARP_){
var temp__5802__auto__ = cljs.core.parse_uuid(p1__143634_SHARP_);
if(cljs.core.truth_(temp__5802__auto__)){
...
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","title","block/title",710445684)],[(function (){var or__5002__auto__ = (page_uuids.cljs$core$IFn$_invoke$arity$1 ? page_uuids.cljs$core$IFn$_invoke$arity$1(p1__143634_SHARP_) : page_uuids.call(null,p1__143634_SHARP_));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["No uuid for page ref name",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__143634_SHARP_], 0))].join(''),cljs.core.PersistentArrayMap.EMPTY);
}
})(),p1__143634_SHARP_]);
}
}),ref_strings);
...
logseq.db.sqlite.build.build_property_tx = (function logseq$db$sqlite$build$build_property_tx(properties,page_uuids,all_idents,property_db_ids,options,p__143653){
var vec__143656 = p__143653;
var prop_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143656,(0),null);
var map__143659 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143656,(1),null);
var map__143659__$1 = cljs.core.__destructure_map(map__143659);
var prop_m = map__143659__$1;
var property_classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143659__$1,new cljs.core.Keyword("build","property-classes","build/property-classes",1099271032));
var vec__143662 = (function (){var temp__5802__auto__ = cljs.core.seq(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143648_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"uuid","uuid",-2145095719),cljs.core.random_uuid()], null),p1__143648_SHARP_], 0));
...
var seq__143663 = cljs.core.seq(vec__143662);
var first__143664 = cljs.core.first(seq__143663);
var seq__143663__$1 = cljs.core.next(seq__143663);
var new_block = first__143664;
var additional_tx = seq__143663__$1;
...
var G__143669 = cljs.core.PersistentVector.EMPTY;
var G__143669__$1 = ((cljs.core.seq(pvalue_tx_m))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__143669,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143649_SHARP_){
if(cljs.core.set_QMARK_(p1__143649_SHARP_)){
return p1__143649_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__143649_SHARP_], null);
}
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(pvalue_tx_m)], 0))):G__143669);
var G__143669__$2 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__143669__$1,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(new_block,new cljs.core.Keyword("build","properties-ref-types","build/properties-ref-types",-1991321370)),(function (){var temp__5804__auto__ = cljs.core.not_empty(new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(prop_m));
if(cljs.core.truth_(temp__5804__auto__)){
...
})(),((cljs.core.seq(property_classes))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.property","classes","logseq.property/classes",913750486),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143650_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","ident","db/ident",-737096)],[logseq.db.sqlite.build.get_ident(all_idents,p1__143650_SHARP_)]);
}),property_classes)], null):null)], 0)))
;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__143669__$2,additional_tx);

});
logseq.db.sqlite.build.build_properties_tx = (function logseq$db$sqlite$build$build_properties_tx(properties,page_uuids,all_idents,p__143683){
var map__143684 = p__143683;
var map__143684__$1 = cljs.core.__destructure_map(map__143684);
var options = map__143684__$1;
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143684__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
var properties_SINGLEQUOTE_ = (cljs.core.truth_(build_existing_tx_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__143689){
var vec__143690 = p__143689;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143690,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143690,(1),null);
...
var property_db_ids = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143680_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__143680_SHARP_,logseq.db.sqlite.build.new_db_id()],null));
...
logseq.db.sqlite.build.build_classes_tx = (function logseq$db$sqlite$build$build_classes_tx(classes,properties_config,uuid_maps,all_idents,p__143700){
var map__143701 = p__143700;
var map__143701__$1 = cljs.core.__destructure_map(map__143701);
var options = map__143701__$1;
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143701__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
var classes_SINGLEQUOTE_ = (cljs.core.truth_(build_existing_tx_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__143704){
var vec__143705 = p__143704;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143705,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143705,(1),null);
var and__5000__auto__ = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(v);
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.not(new cljs.core.Keyword("build","keep-uuid?","build/keep-uuid?",705498954).cljs$core$IFn$_invoke$arity$1(v));
} else {
...
var class_db_ids = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143697_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__143697_SHARP_,logseq.db.sqlite.build.new_db_id()],null));
}),cljs.core.keys(classes_SINGLEQUOTE_)));
var classes_tx = cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__143708){
var vec__143709 = p__143708;
var class_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143709,(0),null);
var map__143712 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143709,(1),null);
var map__143712__$1 = cljs.core.__destructure_map(map__143712);
var class_m = map__143712__$1;
var class_parent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143712__$1,new cljs.core.Keyword("build","class-parent","build/class-parent",1092120922));
var class_properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143712__$1,new cljs.core.Keyword("build","class-properties","build/class-properties",1278125544));
...
var G__143718 = cljs.core.PersistentVector.EMPTY;
var G__143718__$1 = ((cljs.core.seq(pvalue_tx_m))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__143718,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143698_SHARP_){
if(cljs.core.set_QMARK_(p1__143698_SHARP_)){
return p1__143698_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__143698_SHARP_], null);
}
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(pvalue_tx_m)], 0))):G__143718);
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__143718__$1,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_block,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(class_m,new cljs.core.Keyword("build","properties","build/properties",708607786),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("build","class-parent","build/class-parent",1092120922),new cljs.core.Keyword("build","class-properties","build/class-properties",1278125544),new cljs.core.Keyword("build","keep-uuid?","build/keep-uuid?",705498954)], 0)),(function (){var temp__5804__auto__ = cljs.core.not_empty(new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(class_m));
if(cljs.core.truth_(temp__5804__auto__)){
var props = temp__5804__auto__;
...
})()], null):null),(cljs.core.truth_(class_properties)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.property.class","properties","logseq.property.class/properties",-2123712050),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143699_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","ident","db/ident",-737096)],[logseq.db.sqlite.build.get_ident(all_idents,p1__143699_SHARP_)]);
 ...
 * a ::no-value value
 */
logseq.db.sqlite.build.get_used_properties_from_options = (function logseq$db$sqlite$build$get_used_properties_from_options(p__143749){
var map__143750 = p__143749;
var map__143750__$1 = cljs.core.__destructure_map(map__143750);
var pages_and_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143750__$1,new cljs.core.Keyword(null,"pages-and-blocks","pages-and-blocks",-214876185));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143750__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143750__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(logseq.db.sqlite.build.page_prop_value_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143745_SHARP_){
if(cljs.core.set_QMARK_(p1__143745_SHARP_)){
return p1__143745_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__143745_SHARP_], null);
}
...
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143744_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(new cljs.core.Keyword(null,"blocks","blocks",-610462153).cljs$core$IFn$_invoke$arity$1(p1__143744_SHARP_)),new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(p1__143744_SHARP_));
}),pages_and_blocks)], 0)));
var property_properties = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143746_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(p1__143746_SHARP_));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(properties)], 0));
var class_properties = cljs.core.set(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143747_SHARP_){
...
}),new cljs.core.Keyword("build","class-properties","build/class-properties",1278125544).cljs$core$IFn$_invoke$arity$1(p1__143747_SHARP_)),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(p1__143747_SHARP_)));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(classes)], 0)));
var props_to_values = (function (x){
return cljs.core.update_vals(x,(function (p1__143748_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.second,p1__143748_SHARP_);
}));
...
logseq.db.sqlite.build.create_all_idents = (function logseq$db$sqlite$build$create_all_idents(properties,classes,p__143764){
var map__143765 = p__143764;
var map__143765__$1 = cljs.core.__destructure_map(map__143765);
var graph_namespace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143765__$1,new cljs.core.Keyword(null,"graph-namespace","graph-namespace",-317059511));
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143765__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
var property_idents = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143758_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__143758_SHARP_,(cljs.core.truth_(graph_namespace)?logseq.db.frontend.db_ident.create_db_ident_from_name([cljs.core.name(graph_namespace),".property"].join(''),cljs.core.name(p1__143758_SHARP_)):logseq.db.frontend.property.create_user_property_ident_from_name.cljs$core$IFn$_invoke$arity$1(cljs.core.name(p1__143758_SHARP_)))],null));
...
var class_idents = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143759_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__143759_SHARP_,(cljs.core.truth_(graph_namespace)?logseq.db.frontend.db_ident.create_db_ident_from_name([cljs.core.name(graph_namespace),".class"].join(''),cljs.core.name(p1__143759_SHARP_)):logseq.db.frontend.class$.create_user_class_ident_from_name(cljs.core.name(p1__143759_SHARP_)))],null));
...
var G__143770 = cljs.core.PersistentVector.EMPTY;
var G__143770__$1 = ((cljs.core.seq(pvalue_tx_m))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(G__143770,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143767_SHARP_){
if(cljs.core.set_QMARK_(p1__143767_SHARP_)){
return p1__143767_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__143767_SHARP_], null);
}
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(pvalue_tx_m)], 0))):G__143770);
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__143770__$1,logseq.db.sqlite.build.block_with_timestamps(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([page_SINGLEQUOTE_,((cljs.core.seq(new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(page)))?logseq.db.sqlite.build.__GT_block_properties(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("build","properties","build/properties",708607786).cljs$core$IFn$_invoke$arity$1(page),logseq.db.frontend.property.build.build_properties_with_ref_values(pvalue_tx_m)], 0)),page_uuids,all_idents,options):null),(function (){var temp__5804__auto__ = cljs.core.seq(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143768_SHARP_){
return logseq.db.sqlite.build.get_ident(all_idents,p1__143768_SHARP_);
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","tags","block/tags",1814948340),(function (){var G__143774 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143769_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","ident","db/ident",-737096)],[p1__143769_SHARP_]);
}),tag_idents);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__143774,new cljs.core.Keyword("logseq.class","Page","logseq.class/Page",1484340329));
} else {
return G__143774;
}
})()], null);
...
logseq.db.sqlite.build.build_pages_and_blocks_tx = (function logseq$db$sqlite$build$build_pages_and_blocks_tx(pages_and_blocks,all_idents,page_uuids,p__143778){
var map__143779 = p__143778;
var map__143779__$1 = cljs.core.__destructure_map(map__143779);
var options = map__143779__$1;
var page_id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__143779__$1,new cljs.core.Keyword(null,"page-id-fn","page-id-fn",242471299),new cljs.core.Keyword("db","id","db/id",-1388397098));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143779__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143779__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
return cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__143780){
var map__143781 = p__143780;
var map__143781__$1 = cljs.core.__destructure_map(map__143781);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143781__$1,new cljs.core.Keyword(null,"page","page",849072397));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143781__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
var build_existing_tx_QMARK__SINGLEQUOTE_ = (function (){var and__5000__auto__ = build_existing_tx_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
...
})())?(function (p1__143777_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(p1__143777_SHARP_)],null));
}):page_id_fn);
...
var property_idents = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__143782_SHARP_){
if(cljs.core.truth_(new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659).cljs$core$IFn$_invoke$arity$1(p1__143782_SHARP_))){
return new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(p1__143782_SHARP_);
} else {
return null;
}
}),blocks_tx),cljs.core.keys(properties));
var vec__143789 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__143796,m){
var vec__143797 = p__143796;
var init_tx_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143797,(0),null);
var block_props_tx_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143797,(1),null);
...
var init_tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143789,(0),null);
var block_props_tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__143789,(1),null);
...
var existing_pages = cljs.core.set(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__143804_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__143804_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword("block","title","block/title",710445684)], null));
}),pages_and_blocks));
var new_pages_from_refs = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143806_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"page","page",849072397)],[new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","title","block/title",710445684),p1__143806_SHARP_], null)]);
}),cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__143810){
var map__143811 = p__143810;
var map__143811__$1 = cljs.core.__destructure_map(map__143811);
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143811__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(existing_pages,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(logseq.common.util.uuid_string_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143805_SHARP_){
return logseq.db.sqlite.build.extract_basic_content_refs(new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1(p1__143805_SHARP_));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([blocks], 0))));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pages_and_blocks], 0))));
if(cljs.core.seq(new_pages_from_refs)){
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Building additional pages from content refs:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143807_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__143807_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword("block","title","block/title",710445684)], null));
...
var existing_pages = cljs.core.set(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__143812_SHARP_){
return cljs.core.select_keys(new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(p1__143812_SHARP_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("build","journal","build/journal",1781180096),new cljs.core.Keyword("block","title","block/title",710445684)], null));
}),pages_and_blocks));
var new_pages = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__143814_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"page","page",849072397)],[p1__143814_SHARP_]);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__143813_SHARP_){
if(logseq.db.sqlite.build.page_prop_value_QMARK_(p1__143813_SHARP_)){
return cljs.core.second(p1__143813_SHARP_);
} else {
return null;
}
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Building additional pages from property values:",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143815_SHARP_){
var or__5002__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__143815_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword("block","title","block/title",710445684)], null));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__143815_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword("build","journal","build/journal",1781180096)], null));
}
}),new_pages)], 0))], 0));
} else {
}
...
var G__143817 = arguments.length;
switch (G__143817) {
case 1:
...
var block_SINGLEQUOTE__SINGLEQUOTE_ = (function (){var G__143820 = block_SINGLEQUOTE_;
var G__143820__$1 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__143820,new cljs.core.Keyword("build","children","build/children",-1040452432))
;
if(cljs.core.truth_(parent_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143820__$1,new cljs.core.Keyword("block","parent","block/parent",-918309064),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),parent_id], null)], null));
} else {
return G__143820__$1;
}
})();
 ...
 */
logseq.db.sqlite.build.pre_build_pages_and_blocks = (function logseq$db$sqlite$build$pre_build_pages_and_blocks(pages_and_blocks,properties,p__143822){
var map__143823 = p__143822;
var map__143823__$1 = cljs.core.__destructure_map(map__143823);
var extract_content_refs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143823__$1,new cljs.core.Keyword(null,"extract-content-refs?","extract-content-refs?",-1224729418));
...
var G__143824 = pages;
var G__143824__$1 = (cljs.core.truth_(extract_content_refs_QMARK_)?logseq.db.sqlite.build.add_new_pages_from_refs(G__143824):G__143824);
var G__143824__$2 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(ensure_page_uuids,G__143824__$1)
;
return cljs.core.vec(G__143824__$2);
...
var prop_value = cljs.core.some((function (p1__143825_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("logseq.db.sqlite.build","no-value","logseq.db.sqlite.build/no-value",745233686),p1__143825_SHARP_)){
return p1__143825_SHARP_;
} else {
return null;
}
...
var G__143827 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.property","type","logseq.property/type",83842404),prop_type], null);
if(cljs.core.set_QMARK_(prop_value)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143827,new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659),new cljs.core.Keyword(null,"many","many",1092119164));
} else {
return G__143827;
}
});
 ...
 *   :build/tags
 */
logseq.db.sqlite.build.auto_create_ontology = (function logseq$db$sqlite$build$auto_create_ontology(p__143831){
var map__143832 = p__143831;
var map__143832__$1 = cljs.core.__destructure_map(map__143832);
var options = map__143832__$1;
var pages_and_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143832__$1,new cljs.core.Keyword(null,"pages-and-blocks","pages-and-blocks",-214876185));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143832__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143832__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
var new_classes = cljs.core.zipmap(clojure.set.difference.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__143828_SHARP_){
return (((p1__143828_SHARP_ instanceof cljs.core.Keyword)) && (logseq.db.frontend.class$.logseq_class_QMARK_(p1__143828_SHARP_)));
}),cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143829_SHARP_){
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("build","tags","build/tags",1814686611),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"blocks","blocks",-610462153).cljs$core$IFn$_invoke$arity$1(p1__143829_SHARP_)], 0));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pages_and_blocks], 0)),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143830_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__143830_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword("build","tags","build/tags",1814686611)], null));
...
logseq.db.sqlite.build.build_blocks_tx_STAR_ = (function logseq$db$sqlite$build$build_blocks_tx_STAR_(p__143844){
var map__143845 = p__143844;
var map__143845__$1 = cljs.core.__destructure_map(map__143845);
var options = map__143845__$1;
var pages_and_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143845__$1,new cljs.core.Keyword(null,"pages-and-blocks","pages-and-blocks",-214876185));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143845__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var auto_create_ontology_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143845__$1,new cljs.core.Keyword(null,"auto-create-ontology?","auto-create-ontology?",1327966901));
var build_existing_tx_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143845__$1,new cljs.core.Keyword(null,"build-existing-tx?","build-existing-tx?",-2032344658));
...
var map__143846 = (cljs.core.truth_(auto_create_ontology_QMARK_)?logseq.db.sqlite.build.auto_create_ontology(options):options);
var map__143846__$1 = cljs.core.__destructure_map(map__143846);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143846__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
var properties__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143846__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143842_SHARP_){
if(logseq.db.frontend.class$.logseq_class_QMARK_(new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(p1__143842_SHARP_))){
return p1__143842_SHARP_;
} else {
var or__5002__auto__ = (function (){var G__143847 = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(p1__143842_SHARP_);
var G__143847__$1 = (((G__143847 == null))?null:(class_ident__GT_id.cljs$core$IFn$_invoke$arity$1 ? class_ident__GT_id.cljs$core$IFn$_invoke$arity$1(G__143847) : class_ident__GT_id.call(null,G__143847)));
if((G__143847__$1 == null)){
return null;
} else {
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[G__143847__$1]);
}
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
if(cljs.core.truth_(and__5000__auto__)){
var G__143848 = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(p1__143842_SHARP_);
if((G__143848 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(classes,G__143848);
}
} else {
return and__5000__auto__;
}
})())?new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(p1__143842_SHARP_):null);
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["No :db/id found for :db/ident ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__143842_SHARP_], 0))].join(''),cljs.core.PersistentArrayMap.EMPTY);
}
}
}
}),cs);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__143849,new cljs.core.Keyword(null,"init-tx","init-tx",191693574),(function (init_tx){
var indices = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__143843_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)],[p1__143843_SHARP_]);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143853_SHARP_){
return logseq$db$sqlite$build$extract_from_blocks_$_apply_to_block_and_all_children(p1__143853_SHARP_,f__$1);
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__143856_SHARP_){
return apply_to_block_and_all_children(p1__143856_SHARP_,f);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([blocks], 0));
});
/**
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(updated_m,new cljs.core.Keyword("build","children","build/children",-1040452432),(function (){var G__143871 = new cljs.core.Keyword("build","children","build/children",-1040452432).cljs$core$IFn$_invoke$arity$1(m);
var G__143872 = f;
return (logseq.db.sqlite.build.update_each_block.cljs$core$IFn$_invoke$arity$2 ? logseq.db.sqlite.build.update_each_block.cljs$core$IFn$_invoke$arity$2(G__143871,G__143872) : logseq.db.sqlite.build.update_each_block.call(null,G__143871,G__143872));
})());
} else {
return updated_m;
}
...
logseq.db.sqlite.build.validate_options = (function logseq$db$sqlite$build$validate_options(p__143880){
var map__143882 = p__143880;
var map__143882__$1 = cljs.core.__destructure_map(map__143882);
var options = map__143882__$1;
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143882__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var temp__5804__auto___144177 = malli.core.explain.cljs$core$IFn$_invoke$arity$2(logseq.db.sqlite.build.Options,options);
if(cljs.core.truth_(temp__5804__auto___144177)){
var errors_144178 = temp__5804__auto___144177;
...
cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(malli.error.humanize.cljs$core$IFn$_invoke$arity$1(errors_144178));
...
}),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"errors","errors",-908790718).cljs$core$IFn$_invoke$arity$1(errors_144178)));

throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Options validation failed",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"errors","errors",-908790718),malli.error.humanize.cljs$core$IFn$_invoke$arity$1(errors_144178)], null));
} else {
}
...
var map__143925 = logseq.db.sqlite.build.build_blocks_tx(options_SINGLEQUOTE_);
var map__143925__$1 = cljs.core.__destructure_map(map__143925);
var _txs = map__143925__$1;
var init_tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143925__$1,new cljs.core.Keyword(null,"init-tx","init-tx",191693574));
var block_props_tx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143925__$1,new cljs.core.Keyword(null,"block-props-tx","block-props-tx",414649));
