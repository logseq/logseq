...
var G__123684 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(page);
var G__123685 = (function (){
...
var G__123686 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p__123690){
var map__123691 = p__123690;
var map__123691__$1 = cljs.core.__destructure_map(map__123691);
var msg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123691__$1,new cljs.core.Keyword(null,"msg","msg",-1386103444));
...
return (frontend.handler.page._LT_delete_BANG_.cljs$core$IFn$_invoke$arity$3 ? frontend.handler.page._LT_delete_BANG_.cljs$core$IFn$_invoke$arity$3(G__123684,G__123685,G__123686) : frontend.handler.page._LT_delete_BANG_.call(null,G__123684,G__123685,G__123686));
});
...
var G__123699 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-auto md:max-w-4xl max-h-[80vh] overflow-y-auto"], null);
return (logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2(G__123698,G__123699) : logseq.shui.ui.dialog_open_BANG_.call(null,G__123698,G__123699));
...
})], null)], null):null),(cljs.core.truth_(frontend.config.lsp_enabled_QMARK_)?(function (){var iter__5480__auto__ = (function frontend$components$page_menu$page_menu_$_iter__123700(s__123701){
return (new cljs.core.LazySeq(null,(function (){
var s__123701__$1 = s__123701;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__123701__$1);
if(temp__5804__auto____$1){
var s__123701__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__123701__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__123701__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__123703 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__123702 = (0);
while(true){
if((i__123702 < size__5479__auto__)){
var vec__123705 = cljs.core._nth(c__5478__auto__,i__123702);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123705,(0),null);
var map__123708 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123705,(1),null);
var map__123708__$1 = cljs.core.__destructure_map(map__123708);
var cmd = map__123708__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123708__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123705,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123705,(3),null);
cljs.core.chunk_append(b__123703,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),label,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__123702,vec__123705,___$1,map__123708,map__123708__$1,cmd,label,action,pid,c__5478__auto__,size__5479__auto__,b__123703,s__123701__$2,temp__5804__auto____$1,repo,db_based_QMARK_,page_title,whiteboard_QMARK_,block_QMARK_,contents_QMARK_,public_QMARK_,_favorites_updated_QMARK_,favorited_QMARK_,developer_mode_QMARK_,file_rpath,_,file_sync_graph_uuid,page_name,temp__5804__auto__){
return (function (){
...
});})(i__123702,vec__123705,___$1,map__123708,map__123708__$1,cmd,label,action,pid,c__5478__auto__,size__5479__auto__,b__123703,s__123701__$2,temp__5804__auto____$1,repo,db_based_QMARK_,page_title,whiteboard_QMARK_,block_QMARK_,contents_QMARK_,public_QMARK_,_favorites_updated_QMARK_,favorited_QMARK_,developer_mode_QMARK_,file_rpath,_,file_sync_graph_uuid,page_name,temp__5804__auto__))
], null)], null));

var G__123728 = (i__123702 + (1));
i__123702 = G__123728;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__123703),frontend$components$page_menu$page_menu_$_iter__123700(cljs.core.chunk_rest(s__123701__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__123703),null);
}
} else {
var vec__123709 = cljs.core.first(s__123701__$2);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123709,(0),null);
var map__123712 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123709,(1),null);
var map__123712__$1 = cljs.core.__destructure_map(map__123712);
var cmd = map__123712__$1;
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__123712__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var action = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123709,(2),null);
var pid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123709,(3),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"title","title",636505583),label,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__123709,___$1,map__123712,map__123712__$1,cmd,label,action,pid,s__123701__$2,temp__5804__auto____$1,repo,db_based_QMARK_,page_title,whiteboard_QMARK_,block_QMARK_,contents_QMARK_,public_QMARK_,_favorites_updated_QMARK_,favorited_QMARK_,developer_mode_QMARK_,file_rpath,_,file_sync_graph_uuid,page_name,temp__5804__auto__){
return (function (){
return frontend.commands.exec_plugin_simple_command_BANG_(pid,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cmd,new cljs.core.Keyword(null,"page","page",849072397),page_name),action);
});})(vec__123709,___$1,map__123712,map__123712__$1,cmd,label,action,pid,s__123701__$2,temp__5804__auto____$1,repo,db_based_QMARK_,page_title,whiteboard_QMARK_,block_QMARK_,contents_QMARK_,public_QMARK_,_favorites_updated_QMARK_,favorited_QMARK_,developer_mode_QMARK_,file_rpath,_,file_sync_graph_uuid,page_name,temp__5804__auto__))
], null)], null),frontend$components$page_menu$page_menu_$_iter__123700(cljs.core.rest(s__123701__$2)));
}
} else {
return null;
}
...
var page__$1 = (function (){var G__123717 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","format","block/format",-1212045901),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","content","file/content",12680964)], null)], null)], null);
var G__123718 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$2 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$2(G__123717,G__123718) : frontend.db.pull.call(null,G__123717,G__123718));
})();
