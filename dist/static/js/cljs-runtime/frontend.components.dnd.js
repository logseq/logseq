...
var attrs108773 = props;
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs108773))?daiquiri.interpreter.element_attributes(attrs108773):null),((cljs.core.map_QMARK_(attrs108773))?[daiquiri.interpreter.interpret(children)]:[daiquiri.interpreter.interpret(attrs108773),daiquiri.interpreter.interpret(children)]));
...
var style = ({"transform": (function (){var fexpr__108808 = module$node_modules$$dnd_kit$utilities$dist$index.CSS.Transform.toString;
return (fexpr__108808.cljs$core$IFn$_invoke$arity$1 ? fexpr__108808.cljs$core$IFn$_invoke$arity$1(transform) : fexpr__108808.call(null,transform));
})(), "transition": transition});
var attrs108807 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ref","ref",1289896967),set_node_ref,new cljs.core.Keyword(null,"style","style",-496642736),style], null),cljs_bean.core.__GT_clj(attributes),cljs_bean.core.__GT_clj(listeners),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"id","id",-1388402092))], 0));
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs108807))?daiquiri.interpreter.element_attributes(attrs108807):null),((cljs.core.map_QMARK_(attrs108807))?[daiquiri.interpreter.interpret(children)]:[daiquiri.interpreter.interpret(attrs108807),daiquiri.interpreter.interpret(children)]));
}),null,"frontend.components.dnd/sortable-item");
frontend.components.dnd.items = rum.core.lazy_build(rum.core.build_defc,(function (col,p__108811){
var map__108812 = p__108811;
var map__108812__$1 = cljs.core.__destructure_map(map__108812);
var on_drag_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108812__$1,new cljs.core.Keyword(null,"on-drag-end","on-drag-end",520272671));
var parent_node = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108812__$1,new cljs.core.Keyword(null,"parent-node","parent-node",-605954869));
var vertical_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__108812__$1,new cljs.core.Keyword(null,"vertical?","vertical?",-1522630444),true);
var sort_by_inner_element_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108812__$1,new cljs.core.Keyword(null,"sort-by-inner-element?","sort-by-inner-element?",235482267));
...
var vec__108813 = rum.core.use_state(items_SINGLEQUOTE_);
var items_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108813,(0),null);
var set_items = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108813,(1),null);
...
var vec__108816 = rum.core.use_state(null);
var _active_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108816,(0),null);
var set_active_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108816,(1),null);
...
var G__108823 = event.active.id;
return (set_active_id.cljs$core$IFn$_invoke$arity$1 ? set_active_id.cljs$core$IFn$_invoke$arity$1(G__108823) : set_active_id.call(null,G__108823));
}
...
var old_index_108867 = ids.indexOf(active_id);
var new_index_108868 = ids.indexOf(over_id);
var new_items_108869 = module$node_modules$$dnd_kit$sortable$dist$index.arrayMove(items_state,old_index_108867,new_index_108868);
if(cljs.core.fn_QMARK_(on_drag_end)){
var new_values_108870 = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (id){
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(new_values_108870),cljs.core.count(ids))){
console.error("Dnd length not matched: ");

new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"old-items","old-items",1364373850),items_state,new cljs.core.Keyword(null,"new-items","new-items",-2122710837),new_items_108869], null);
} else {
(set_items.cljs$core$IFn$_invoke$arity$1 ? set_items.cljs$core$IFn$_invoke$arity$1(new_items_108869) : set_items.call(null,new_items_108869));

var G__108825_108887 = new_values_108870;
var G__108826_108888 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"active-id","active-id",-59238656),active_id,new cljs.core.Keyword(null,"over-id","over-id",257293900),over_id,new cljs.core.Keyword(null,"direction","direction",-633359395),(((new_index_108868 > old_index_108867))?new cljs.core.Keyword(null,"down","down",1565245570):new cljs.core.Keyword(null,"up","up",-269712113))], null);
(on_drag_end.cljs$core$IFn$_invoke$arity$2 ? on_drag_end.cljs$core$IFn$_invoke$arity$2(G__108825_108887,G__108826_108888) : on_drag_end.call(null,G__108825_108887,G__108826_108888));
}
} else {
}
}
...
var children = (function (){var iter__5480__auto__ = (function frontend$components$dnd$iter__108827(s__108828){
return (new cljs.core.LazySeq(null,(function (){
var s__108828__$1 = s__108828;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__108828__$1);
if(temp__5804__auto__){
var s__108828__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__108828__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__108828__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__108830 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__108829 = (0);
while(true){
if((i__108829 < size__5479__auto__)){
var item = cljs.core._nth(c__5478__auto__,i__108829);
cljs.core.chunk_append(b__108830,(function (){var id = cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__108830),frontend$components$dnd$iter__108827(cljs.core.chunk_rest(s__108828__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__108830),null);
}
} else {
var item = cljs.core.first(s__108828__$2);
...
})(),frontend$components$dnd$iter__108827(cljs.core.rest(s__108828__$2)));
}
} else {
return null;
}
...
return daiquiri.interpreter.interpret((function (){var G__108853 = dnd_opts;
var G__108854 = (frontend.components.dnd.sortable_context.cljs$core$IFn$_invoke$arity$2 ? frontend.components.dnd.sortable_context.cljs$core$IFn$_invoke$arity$2(sortable_opts,children_SINGLEQUOTE_) : frontend.components.dnd.sortable_context.call(null,sortable_opts,children_SINGLEQUOTE_));
return (frontend.components.dnd.dnd_context.cljs$core$IFn$_invoke$arity$2 ? frontend.components.dnd.dnd_context.cljs$core$IFn$_invoke$arity$2(G__108853,G__108854) : frontend.components.dnd.dnd_context.call(null,G__108853,G__108854));
})());
