...
var vec__103577 = frontend.util.file_based.clock.s__GT_dhms_util(seconds);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103577,(0),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103577,(1),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103577,(2),null);
var seconds__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103577,(3),null);
if((days > (0))){
var G__103580 = "%s%s";
var G__103581 = (((days === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(days),"d"].join(''));
var G__103582 = (((hours === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(hours),"h"].join(''));
return (frontend.util.format.cljs$core$IFn$_invoke$arity$3 ? frontend.util.format.cljs$core$IFn$_invoke$arity$3(G__103580,G__103581,G__103582) : frontend.util.format.call(null,G__103580,G__103581,G__103582));
} else {
if((minutes > (0))){
var G__103586 = "%s%s";
var G__103587 = (((hours === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(hours),"h"].join(''));
var G__103588 = (((minutes === (0)))?"":[cljs.core.str.cljs$core$IFn$_invoke$arity$1(minutes),"m"].join(''));
return (frontend.util.format.cljs$core$IFn$_invoke$arity$3 ? frontend.util.format.cljs$core$IFn$_invoke$arity$3(G__103586,G__103587,G__103588) : frontend.util.format.call(null,G__103586,G__103587,G__103588));
} else {
if((seconds__$1 > (0))){
...
var vec__103590 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__103589_SHARP_){
return cljs_time.format.parse.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(frontend.util.file_based.clock.support_seconds_QMARK_)?frontend.date.custom_formatter_4:frontend.date.custom_formatter_3),p1__103589_SHARP_);
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [stime,etime], null));
var stime__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103590,(0),null);
var etime__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103590,(1),null);
...
return frontend.util.file_based.drawer.insert_drawer(format,content,"logbook",(function (){var G__103593 = "CLOCK: [%s]";
var G__103594 = frontend.util.file_based.clock.now();
return (frontend.util.format.cljs$core$IFn$_invoke$arity$2 ? frontend.util.format.cljs$core$IFn$_invoke$arity$2(G__103593,G__103594) : frontend.util.format.call(null,G__103593,G__103594));
})());
});
...
var temp__5804__auto____$2 = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__103596_SHARP_){
return clojure.string.starts_with_QMARK_(p1__103596_SHARP_,"CLOCK:");
}),logbook_lines));
if(temp__5804__auto____$2){
var clock_lines = temp__5804__auto____$2;
var vec__103602 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.map,cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__103598_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.int$,p1__103598_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__103597_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(clojure.string.trim(cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__103597_SHARP_,"=>"))),":");
}),clock_lines)));
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103602,(0),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103602,(1),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103602,(2),null);
