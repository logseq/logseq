...
var temp__5804__auto___102571 = goog.dom.getElement("commit-message");
if(cljs.core.truth_(temp__5804__auto___102571)){
var input_102572 = temp__5804__auto___102571;
input_102572.focus();

frontend.util.cursor.move_cursor_to_end(input_102572);
} else {
}
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.persist_db.export_current_graph_BANG_()),(function (___41611__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__102556 = frontend.components.commit.add_commit_message;
var G__102557 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"content-props","content-props",687449284),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"onOpenAutoFocus","onOpenAutoFocus",-99363202),(function (p1__102555_SHARP_){
return p1__102555_SHARP_.preventDefault();
})], null)], null);
return (logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.dialog_open_BANG_.cljs$core$IFn$_invoke$arity$2(G__102556,G__102557) : logseq.shui.ui.dialog_open_BANG_.call(null,G__102556,G__102557));
