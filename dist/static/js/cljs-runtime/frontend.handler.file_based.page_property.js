...
var key_part = (function (){var G__102490 = (function (){var G__102492 = format;
...
var G__102491 = clojure.string.lower_case(cljs.core.name(key__$1));
return (frontend.util.format.cljs$core$IFn$_invoke$arity$2 ? frontend.util.format.cljs$core$IFn$_invoke$arity$2(G__102490,G__102491) : frontend.util.format.call(null,G__102490,G__102491));
})();
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (content__$1,p__102510){
var vec__102513 = p__102510;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102513,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102513,(1),null);
...
var v__$1 = ((cljs.core.coll_QMARK_(v))?(function (){var G__102518 = cljs.core.seq(v);
var G__102518__$1 = (((G__102518 == null))?null:cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(G__102518));
if((G__102518__$1 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",G__102518__$1);
}
})():v);
...
var _STAR_outliner_ops_STAR__orig_val__102524 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__102525 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__102525);
...
return logseq.outliner.op.apply_ops_BANG_(frontend.state.get_current_repo(),frontend.db.conn.get_db.cljs$core$IFn$_invoke$arity$1(false),r__49429__auto__,frontend.state.get_date_formatter(),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"insert-blocks","insert-blocks",-1269782013),new cljs.core.Keyword(null,"additional-tx","additional-tx",-343057604),page_properties_tx], null));
} else {
return null;
}
} else {
...
return frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","apply-outliner-ops","thread-api/apply-outliner-ops",654139693),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.state.get_current_repo(),r__49429__auto__,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"insert-blocks","insert-blocks",-1269782013),new cljs.core.Keyword(null,"additional-tx","additional-tx",-343057604),page_properties_tx], null),new cljs.core.Keyword(null,"request-id","request-id",-985684093),request_id__49430__auto__,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"client-id","client-id",-464622140),new cljs.core.Keyword(null,"client-id","client-id",-464622140).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.state.state))], 0))], 0));
});
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__102524);
}}
}
});
