...
var frontend$util$persist_var$ILoad$_load$dyn_107124 = (function (this$){
...
return frontend$util$persist_var$ILoad$_load$dyn_107124(this$);
}
});

var frontend$util$persist_var$ILoad$_loaded_QMARK_$dyn_107125 = (function (this$){
var x__5350__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$ILoad$_loaded_QMARK_$dyn_107125(this$);
}
});
...
var frontend$util$persist_var$ISave$_save$dyn_107126 = (function (this$){
var x__5350__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$ISave$_save$dyn_107126(this$);
}
});
...
var frontend$util$persist_var$IResetValue$_reset_value_BANG_$dyn_107128 = (function (this$,new$,graph){
var x__5350__auto__ = (((this$ == null))?null:this$);
...
return frontend$util$persist_var$IResetValue$_reset_value_BANG_$dyn_107128(this$,new$,graph);
}
});
...
}catch (e107086){var e = e107086;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__107087 = "read persist-var failed: %s";
var G__107088 = frontend.util.persist_var.load_rpath(self__.location);
return (frontend.util.format.cljs$core$IFn$_invoke$arity$2 ? frontend.util.format.cljs$core$IFn$_invoke$arity$2(G__107087,G__107088) : frontend.util.format.call(null,G__107087,G__107088));
})()], 0));
...
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__107090 = "load persist-var failed: %s: %s";
var G__107091 = frontend.util.persist_var.load_rpath(self__.location);
var G__107092 = e;
return (frontend.util.format.cljs$core$IFn$_invoke$arity$3 ? frontend.util.format.cljs$core$IFn$_invoke$arity$3(G__107090,G__107091,G__107092) : frontend.util.format.call(null,G__107090,G__107091,G__107092));
})()], 0));
})):null));
}));
}));
