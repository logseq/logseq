...
var G__124774 = arguments.length;
switch (G__124774) {
case 2:
...
return ["var(--rx-",cljs.core.name(color),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__124780 = value;
if(cljs.core.truth_(cljs.core.keyword_QMARK_)){
return cljs.core.name(G__124780);
} else {
return G__124780;
}
...
var temp__5804__auto__ = (function (){var G__124781 = document.documentElement;
var G__124781__$1 = (((G__124781 == null))?null:getComputedStyle(G__124781));
if((G__124781__$1 == null)){
return null;
} else {
return G__124781__$1.getPropertyValue("--lx-accent-09");
}
})();
...
var hsl_color = (function (){var G__124783 = color;
var G__124783__$1 = (((G__124783 == null))?null:clojure.string.replace(G__124783,"hsl(",""));
var G__124783__$2 = (((G__124783__$1 == null))?null:clojure.string.replace(G__124783__$1,")",""));
if((G__124783__$2 == null)){
return null;
} else {
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(G__124783__$2,",");
}
})();
