...
if((c === "\n")){
var G__65152 = escape_QMARK_;
var G__65153 = rewrite_clj.parser.impl.flush_into(lines,buf);
escape_QMARK_ = G__65152;
lines = G__65153;
continue;
} else {
buf.append(c);

var G__65158 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__65159 = lines;
escape_QMARK_ = G__65158;
lines = G__65159;
continue;
