...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__105871){
var vec__105872 = p__105871;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105872,(0),null);
var map__105875 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105872,(1),null);
var map__105875__$1 = cljs.core.__destructure_map(map__105875);
var opts = map__105875__$1;
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105875__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
...
return cljs.core.reduce_kv((function (r__$1,id,p__105876){
var map__105877 = p__105876;
var map__105877__$1 = cljs.core.__destructure_map(map__105877);
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105877__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
...
var map__105878 = binding_map;
var map__105878__$1 = cljs.core.__destructure_map(map__105878);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105878__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105878__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var cmd = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105878__$1,new cljs.core.Keyword(null,"cmd","cmd",-302931143));
...
var G__105879 = id;
var G__105879__$1 = (((G__105879 == null))?null:frontend.modules.shortcut.utils.decorate_namespace(G__105879));
if((G__105879__$1 == null)){
return null;
} else {
return frontend.context.i18n.t.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__105879__$1], 0));
}
}
}
})();
...
}),((plugin_QMARK_)?cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__105880_SHARP_){
return clojure.string.starts_with_QMARK_(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__105880_SHARP_),":plugin.");
...
var G__105882 = arguments.length;
switch (G__105882) {
case 1:
...
var handler_m = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__105883){
var vec__105884 = p__105883;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105884,(0),null);
var map__105887 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105884,(1),null);
var map__105887__$1 = cljs.core.__destructure_map(map__105887);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105887__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
...
var G__105888 = handler_m;
var G__105888__$1 = (cljs.core.truth_(state)?cljs.core.reduce_kv((function (r,k,handle_fn){
var handle_fn_SINGLEQUOTE_ = ((cljs.core.volatile_QMARK_(state))?(function() { 
var G__105919__delegate = function (_STAR_state,args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(handle_fn,cljs.core.cons(cljs.core.deref(_STAR_state),args));
};
var G__105919 = function (_STAR_state,var_args){
var args = null;
if (arguments.length > 1) {
var G__105920__i = 0, G__105920__a = new Array(arguments.length -  1);
while (G__105920__i < G__105920__a.length) {G__105920__a[G__105920__i] = arguments[G__105920__i + 1]; ++G__105920__i;}
  args = new cljs.core.IndexedSeq(G__105920__a,0,null);
} 
return G__105919__delegate.call(this,_STAR_state,args);};
G__105919.cljs$lang$maxFixedArity = 1;
G__105919.cljs$lang$applyTo = (function (arglist__105921){
var _STAR_state = cljs.core.first(arglist__105921);
var args = cljs.core.rest(arglist__105921);
return G__105919__delegate(_STAR_state,args);
});
G__105919.cljs$core$IFn$_invoke$arity$variadic = G__105919__delegate;
return G__105919;
})()
:handle_fn);
...
}),cljs.core.PersistentArrayMap.EMPTY,G__105888):G__105888);
if(cljs.core.truth_(before)){
return cljs.core.reduce_kv((function (r,k,f){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(r,k,(function (){var G__105889 = f;
var G__105890 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(raw_SINGLEQUOTE_,k);
return (before.cljs$core$IFn$_invoke$arity$2 ? before.cljs$core$IFn$_invoke$arity$2(G__105889,G__105890) : before.call(null,G__105889,G__105890));
})());
}),cljs.core.PersistentArrayMap.EMPTY,G__105888__$1);
} else {
return G__105888__$1;
}
}));
...
return cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.key,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__105891){
var vec__105892 = p__105891;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105892,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105892,(1),null);
...
var G__105898 = arguments.length;
switch (G__105898) {
case 1:
...
(frontend.modules.shortcut.data_helper.get_conflicts_by_keys.cljs$core$IFn$_invoke$arity$3 = (function (ks,handler_id,p__105899){
var map__105900 = p__105899;
var map__105900__$1 = cljs.core.__destructure_map(map__105900);
var exclude_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105900__$1,new cljs.core.Keyword(null,"exclude-ids","exclude-ids",7408318));
var group_global_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105900__$1,new cljs.core.Keyword(null,"group-global?","group-global?",188550543));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__105896_SHARP_){
return cljs.core.empty_QMARK_(cljs.core.vals(cljs.core.second(p1__105896_SHARP_)));
...
var same_leading_key_QMARK_ = (function (p__105901){
var vec__105902 = p__105901;
var k_SINGLEQUOTE___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105902,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105902,(1),null);
...
var into_conflict_refs = (function (p__105905){
var vec__105906 = p__105905;
var k__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105906,(0),null);
var o = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105906,(1),null);
var temp__5804__auto____$1 = o;
if(cljs.core.truth_(temp__5804__auto____$1)){
var map__105909 = temp__5804__auto____$1;
var map__105909__$1 = cljs.core.__destructure_map(map__105909);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105909__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105909__$1,new cljs.core.Keyword(null,"refs","refs",-1560051448));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k_SINGLEQUOTE_,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__105895_SHARP_){
return cljs.core.empty_QMARK_(cljs.core.second(cljs.core.second(p1__105895_SHARP_)));
...
var temp__5804__auto____$1 = (function (){var G__105911 = target;
var G__105911__$1 = (((G__105911 == null))?null:frontend.modules.shortcut.data_helper.mod_key(G__105911));
var G__105911__$2 = (((G__105911__$1 == null))?null:frontend.modules.shortcut.utils.safe_parse_string_binding(G__105911__$1));
if((G__105911__$2 == null)){
return null;
} else {
return cljs_bean.core.__GT_clj(G__105911__$2);
}
})();
if(cljs.core.truth_(temp__5804__auto____$1)){
var target__$1 = temp__5804__auto____$1;
return cljs.core.filterv((function (p1__105910_SHARP_){
var temp__5804__auto____$2 = (function (){var G__105912 = p1__105910_SHARP_;
var G__105912__$1 = (((G__105912 == null))?null:frontend.modules.shortcut.data_helper.mod_key(G__105912));
var G__105912__$2 = (((G__105912__$1 == null))?null:frontend.modules.shortcut.utils.safe_parse_string_binding(G__105912__$1));
if((G__105912__$2 == null)){
return null;
} else {
return cljs_bean.core.__GT_clj(G__105912__$2);
}
})();
...
var data = (function (){var G__105913 = frontend.modules.shortcut.data_helper.shortcuts_map_full();
return (id.cljs$core$IFn$_invoke$arity$1 ? id.cljs$core$IFn$_invoke$arity$1(G__105913) : id.call(null,G__105913));
})();
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__105914){
var vec__105915 = p__105914;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105915,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105915,(1),null);
