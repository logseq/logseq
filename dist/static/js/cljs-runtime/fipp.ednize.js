...
var fipp$ednize$IEdn$_edn$dyn_71048 = (function (x){
...
return fipp$ednize$IEdn$_edn$dyn_71048(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5480__auto__ = (function fipp$ednize$edn_$_iter__70926(s__70927){
return (new cljs.core.LazySeq(null,(function (){
var s__70927__$1 = s__70927;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__70927__$1);
if(temp__5804__auto__){
var s__70927__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70927__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__70927__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__70929 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__70928 = (0);
while(true){
if((i__70928 < size__5479__auto__)){
var k = cljs.core._nth(c__5478__auto__,i__70928);
cljs.core.chunk_append(b__70929,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__71080 = (i__70928 + (1));
i__70928 = G__71080;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70929),fipp$ednize$edn_$_iter__70926(cljs.core.chunk_rest(s__70927__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70929),null);
}
} else {
var k = cljs.core.first(s__70927__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__70926(cljs.core.rest(s__70927__$2)));
}
} else {
return null;
}
