...
var map__125809 = cljs_bean.core.__GT_clj(args);
var map__125809__$1 = cljs.core.__destructure_map(map__125809);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__125809__$1,new cljs.core.Keyword(null,"url","url",276297046));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__125809__$1,new cljs.core.Keyword(null,"title","title",636505583));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__125809__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__125809__$1,new cljs.core.Keyword(null,"page","page",849072397));
var append = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__125809__$1,new cljs.core.Keyword(null,"append","append",-291298229));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.editor.escape_editing()),(function (___41611__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(page__$1,frontend.state.get_current_page()))?(function (){var G__125814 = page__$1;
var G__125815 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),redirect_page_QMARK_], null);
return (frontend.handler.page._LT_create_BANG_.cljs$core$IFn$_invoke$arity$2 ? frontend.handler.page._LT_create_BANG_.cljs$core$IFn$_invoke$arity$2(G__125814,G__125815) : frontend.handler.page._LT_create_BANG_.call(null,G__125814,G__125815));
