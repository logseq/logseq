...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63271_SHARP_){
return [cljs.core.name(cljs.core.key(p1__63271_SHARP_)),[logseq.graph_parser.property.colons," "].join(''),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.val(p1__63271_SHARP_))].join('');
}),properties));
});
...
var vec__63272 = logseq.common.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63272,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63272,(1),null);
...
logseq.graph_parser.property.insert_property_not_org = (function logseq$graph_parser$property$insert_property_not_org(key_STAR_,value,lines,p__63279){
var map__63280 = p__63279;
var map__63280__$1 = cljs.core.__destructure_map(map__63280);
var front_matter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63280__$1,new cljs.core.Keyword(null,"front-matter?","front-matter?",-1524574675));
var has_properties_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63280__$1,new cljs.core.Keyword(null,"has-properties?","has-properties?",-1165607917));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63280__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
...
if(cljs.core.truth_((function (){var G__63281 = cljs.core.first(lines__$1);
return (property_f.cljs$core$IFn$_invoke$arity$1 ? property_f.cljs$core$IFn$_invoke$arity$1(G__63281) : property_f.call(null,G__63281));
})())){
var lines__$2 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (text){
var vec__63283 = logseq.common.util.split_first(sym,text);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63283,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63283,(1),null);
if(cljs.core.truth_((function (){var and__5000__auto__ = k;
if(cljs.core.truth_(and__5000__auto__)){
return v;
} else {
...
var has_properties_QMARK_ = ((((title_QMARK_) && (((logseq.graph_parser.mldoc.properties_QMARK_(cljs.core.second(ast))) || (logseq.graph_parser.mldoc.properties_QMARK_(cljs.core.second(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__63296){
var vec__63297 = p__63296;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63297,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63297,(1),null);
...
var lines = clojure.string.split_lines(content);
var vec__63293 = logseq.graph_parser.mldoc.get_title_AMPERSAND_body(repo,content,format);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63293,(0),null);
var body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63293,(1),null);
var scheduled = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63288_SHARP_){
return clojure.string.starts_with_QMARK_(p1__63288_SHARP_,"SCHEDULED");
}),lines);
var deadline = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63289_SHARP_){
return clojure.string.starts_with_QMARK_(p1__63289_SHARP_,"DEADLINE");
}),lines);
var body_without_timestamps = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63290_SHARP_){
return (!(((clojure.string.starts_with_QMARK_(p1__63290_SHARP_,"SCHEDULED")) || (clojure.string.starts_with_QMARK_(p1__63290_SHARP_,"DEADLINE")))));
...
var vec__63300 = logseq.common.util.split_first(":",cljs.core.subs.cljs$core$IFn$_invoke$arity$2(text,(1)));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63300,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63300,(1),null);
if(cljs.core.truth_((function (){var and__5000__auto__ = k;
if(cljs.core.truth_(and__5000__auto__)){
return v;
} else {
...
var lines = (function (){var G__63305 = (function (line){
...
var G__63306 = clojure.string.split_lines(content);
return (remove_f.cljs$core$IFn$_invoke$arity$2 ? remove_f.cljs$core$IFn$_invoke$arity$2(G__63305,G__63306) : remove_f.call(null,G__63305,G__63306));
})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",lines);
}
} else {
...
if(cljs.core.truth_(logseq.graph_parser.property.contains_properties_QMARK_(content))){
var lines = clojure.string.split_lines(content);
var vec__63309 = cljs.core.split_with((function (p1__63307_SHARP_){
return (!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.triml(p1__63307_SHARP_)),logseq.graph_parser.property.properties_start)));
}),lines);
var title_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63309,(0),null);
var properties_AMPERSAND_body = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63309,(1),null);
var body = cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__63308_SHARP_){
return (((!(clojure.string.starts_with_QMARK_(clojure.string.upper_case(clojure.string.trim(p1__63308_SHARP_)),logseq.graph_parser.property.properties_end)))) || (clojure.string.blank_QMARK_(p1__63308_SHARP_)));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (content__$1,p__63312){
var vec__63313 = p__63312;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63313,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63313,(1),null);
...
var v__$1 = ((cljs.core.coll_QMARK_(v))?(function (){var G__63316 = cljs.core.seq(v);
var G__63316__$1 = (((G__63316 == null))?null:cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(G__63316));
var G__63316__$2 = (((G__63316__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (item){
return logseq.common.util.page_ref.__GT_page_ref(logseq.common.util.page_ref.page_ref_un_brackets_BANG_(item));
}),G__63316__$1));
if((G__63316__$2 == null)){
return null;
} else {
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",G__63316__$2);
}
