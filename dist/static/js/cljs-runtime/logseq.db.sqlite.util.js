...
var G__143369 = arguments.length;
switch (G__143369) {
case 2:
...
(logseq.db.sqlite.util.build_new_property.cljs$core$IFn$_invoke$arity$3 = (function (db_ident,prop_schema,p__143370){
var map__143371 = p__143370;
var map__143371__$1 = cljs.core.__destructure_map(map__143371);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143371__$1,new cljs.core.Keyword(null,"title","title",636505583));
var block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143371__$1,new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638));
var ref_type_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143371__$1,new cljs.core.Keyword(null,"ref-type?","ref-type?",622803158));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__143371__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
})(),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.class","Property","logseq.class/Property",1038767048),null], null), null),cljs.core.name(prop_name),(cljs.core.truth_((function (){var G__143375 = new cljs.core.Keyword("db","cardinality","db/cardinality",-104975659).cljs$core$IFn$_invoke$arity$1(prop_schema);
var fexpr__143374 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("db.cardinality","many","db.cardinality/many",772806234),null,new cljs.core.Keyword(null,"many","many",1092119164),null], null), null);
return (fexpr__143374.cljs$core$IFn$_invoke$arity$1 ? fexpr__143374.cljs$core$IFn$_invoke$arity$1(G__143375) : fexpr__143374.call(null,G__143375));
...
var G__143373__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = ref_type_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return cljs.core.contains_QMARK_(logseq.db.frontend.property.type.all_ref_property_types,prop_type);
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143373,new cljs.core.Keyword("db","valueType","db/valueType",1827971944),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079)):G__143373);
if(cljs.core.seq(properties)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__143373__$1,properties], 0));
} else {
return G__143373__$1;
}
})();
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__143372) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__143372));
})()], 0));
}));
...
var G__143376 = (function (){var G__143377 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([block,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","tags","block/tags",1814948340),cljs.core.set(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","tags","block/tags",1814948340).cljs$core$IFn$_invoke$arity$1(block),new cljs.core.Keyword("logseq.class","Tag","logseq.class/Tag",-538902083)))], null)], 0));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__143377,new cljs.core.Keyword("logseq.property","parent","logseq.property/parent",177984509),new cljs.core.Keyword("logseq.class","Root","logseq.class/Root",273783827));
} else {
return G__143377;
}
})();
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__143376) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__143376));
});
/**
...
var G__143378 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("block","name","block/name",1619760316),logseq.common.util.page_name_sanity_lc(page_name),new cljs.core.Keyword("block","title","block/title",710445684),page_name,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),logseq.common.uuid.gen_uuid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"builtin-block-uuid","builtin-block-uuid",-652923992),page_name),new cljs.core.Keyword("block","tags","block/tags",1814948340),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.class","Page","logseq.class/Page",1484340329),null], null), null)], null);
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__143378) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__143378));
});
/**
