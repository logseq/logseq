...
var zloc_SINGLEQUOTE_ = (function (){var G__67515 = zloc;
var G__67515__$1 = (((G__67515 == null))?null:rewrite_clj.custom_zipper.core.node(G__67515));
if((G__67515__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.of_node_STAR_.cljs$core$IFn$_invoke$arity$2(G__67515__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__67520 = rewrite_clj.zip.subedit.subzip(zloc);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__67520) : f.call(null,G__67520));
})();
if((!((zloc_SINGLEQUOTE_ == null)))){
} else {
