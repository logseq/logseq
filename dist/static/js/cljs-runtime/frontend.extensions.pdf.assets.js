...
if(cljs.core.truth_((function (){var G__118564 = url;
var G__118564__$1 = (((G__118564 == null))?null:clojure.string.trim(G__118564));
if((G__118564__$1 == null)){
return null;
} else {
return clojure.string.includes_QMARK_(G__118564__$1,repo_dir);
}
})())){
var G__118577 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(url,repo_dir);
var G__118577__$1 = (((G__118577 == null))?null:cljs.core.last(G__118577));
if((G__118577__$1 == null)){
return null;
} else {
return clojure.string.replace_first(G__118577__$1,"/assets/","");
}
} else {
return null;
}
...
var len__5726__auto___119460 = arguments.length;
var i__5727__auto___119461 = (0);
while(true){
if((i__5727__auto___119461 < len__5726__auto___119460)){
args__5732__auto__.push((arguments[i__5727__auto___119461]));

var G__119462 = (i__5727__auto___119461 + (1));
i__5727__auto___119461 = G__119462;
continue;
} else {
}
break;
...
(frontend.extensions.pdf.assets.inflate_asset.cljs$core$IFn$_invoke$arity$variadic = (function (original_path,p__118601){
var map__118602 = p__118601;
var map__118602__$1 = cljs.core.__destructure_map(map__118602);
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118602__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var block = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118602__$1,new cljs.core.Keyword(null,"block","block",664686210));
var web_link_QMARK_ = clojure.string.starts_with_QMARK_(original_path,"http");
var blob_res_QMARK_ = (function (){var G__118608 = href;
if((G__118608 == null)){
return null;
} else {
return clojure.string.starts_with_QMARK_(G__118608,"blob");
}
})();
var asset_res_QMARK_ = (function (){var G__118610 = href;
if((G__118610 == null)){
return null;
} else {
return clojure.string.starts_with_QMARK_(G__118610,"assets");
}
})();
...
})())?filename:(function (){var G__118616 = url;
var G__118616__$1 = (((G__118616 == null))?null:decodeURIComponent(G__118616));
var G__118616__$2 = (((G__118616__$1 == null))?null:frontend.extensions.pdf.assets.get_in_repo_assets_full_filename(G__118616__$1));
if((G__118616__$2 == null)){
return null;
} else {
return clojure.string.replace(G__118616__$2,"/","_");
}
})());
...
/** @this {Function} */
(frontend.extensions.pdf.assets.inflate_asset.cljs$lang$applyTo = (function (seq118586){
var G__118588 = cljs.core.first(seq118586);
var seq118586__$1 = cljs.core.next(seq118586);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__118588,seq118586__$1);
}));

frontend.extensions.pdf.assets.resolve_area_image_file = (function frontend$extensions$pdf$assets$resolve_area_image_file(img_stamp,current,p__118638){
var map__118640 = p__118638;
var map__118640__$1 = cljs.core.__destructure_map(map__118640);
var _hl = map__118640__$1;
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118640__$1,new cljs.core.Keyword(null,"page","page",849072397));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118640__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var temp__5804__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(current);
if(cljs.core.truth_(temp__5804__auto__)){
var key = temp__5804__auto__;
return [logseq.common.config.local_assets_dir,cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$0())?(function (){var image_id = (function (){var G__118647 = id;
var G__118647__$1 = (((G__118647 == null))?null:frontend.db.utils.entity.cljs$core$IFn$_invoke$arity$1(G__118647));
var G__118647__$2 = (((G__118647__$1 == null))?null:new cljs.core.Keyword("logseq.property.pdf","hl-image","logseq.property.pdf/hl-image",137767009).cljs$core$IFn$_invoke$arity$1(G__118647__$1));
if((G__118647__$2 == null)){
return null;
} else {
return new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(G__118647__$2);
}
})();
...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__118681 = page_name__$1;
var G__118682 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),false,new cljs.core.Keyword(null,"split-namespace?","split-namespace?",-1035468161),false,new cljs.core.Keyword(null,"format","format",-1306924766),format,new cljs.core.Keyword(null,"properties","properties",685819552),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),(function (){var G__118683 = format;
var G__118683__$1 = (((G__118683 instanceof cljs.core.Keyword))?G__118683.fqn:null);
switch (G__118683__$1) {
case "markdown":
...
return (frontend.handler.page._LT_create_BANG_.cljs$core$IFn$_invoke$arity$2 ? frontend.handler.page._LT_create_BANG_.cljs$core$IFn$_invoke$arity$2(G__118681,G__118682) : frontend.handler.page._LT_create_BANG_.call(null,G__118681,G__118682));
})()),(function (___41611__auto__){
return promesa.protocols._promise(frontend.db.model.get_page(page_name__$1));
}));
}));
})():(function (){
if(((function (){var G__118693 = page;
var G__118693__$1 = (((G__118693 == null))?null:new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(G__118693));
if((G__118693__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"file-path","file-path",-2005501162).cljs$core$IFn$_invoke$arity$1(G__118693__$1);
}
})() == null)){
...
frontend.extensions.pdf.assets.file_based_ensure_ref_block_BANG_ = (function frontend$extensions$pdf$assets$file_based_ensure_ref_block_BANG_(pdf_current,p__118703,insert_opts){
var map__118704 = p__118703;
var map__118704__$1 = cljs.core.__destructure_map(map__118704);
var hl = map__118704__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118704__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118704__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118704__$1,new cljs.core.Keyword(null,"page","page",849072397));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118704__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
...
var wrap_props = (function (p1__118698_SHARP_){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__118698_SHARP_,new cljs.core.Keyword(null,"hl-type","hl-type",992471876),new cljs.core.Keyword(null,"area","area",472007256),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"hl-stamp","hl-stamp",-695479513),stamp], 0));
} else {
return p1__118698_SHARP_;
}
});
var db_base_QMARK_ = frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(frontend.state.get_current_repo());
var props = (function (){var G__118717 = cljs.core.PersistentArrayMap.createAsIfByAssoc([frontend.handler.property.util.get_pid(new cljs.core.Keyword("logseq.property","ls-type","logseq.property/ls-type",326979345)),new cljs.core.Keyword(null,"annotation","annotation",-344661666),frontend.handler.property.util.get_pid(new cljs.core.Keyword("logseq.property.pdf","hl-page","logseq.property.pdf/hl-page",-753284596)),page,frontend.handler.property.util.get_pid(new cljs.core.Keyword("logseq.property.pdf","hl-color","logseq.property.pdf/hl-color",-674793887)),new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(properties)]);
var G__118717__$1 = ((db_base_QMARK_)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__118717,frontend.handler.property.util.get_pid(new cljs.core.Keyword("logseq.property.pdf","hl-value","logseq.property.pdf/hl-value",545829402)),hl):G__118717);
if((!(db_base_QMARK_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__118717__$1,new cljs.core.Keyword(null,"id","id",-1388402092),((typeof id === 'string')?cljs.core.uuid(id):id));
} else {
return G__118717__$1;
}
})();
...
frontend.extensions.pdf.assets.db_based_ensure_ref_block_BANG_ = (function frontend$extensions$pdf$assets$db_based_ensure_ref_block_BANG_(pdf_current,p__118729,insert_opts){
var map__118731 = p__118729;
var map__118731__$1 = cljs.core.__destructure_map(map__118731);
var hl = map__118731__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118731__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118731__$1,new cljs.core.Keyword(null,"content","content",15833224));
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118731__$1,new cljs.core.Keyword(null,"page","page",849072397));
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118731__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
...
var properties__$1 = (function (){var G__118746 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword("block","tags","block/tags",1814948340),new cljs.core.Keyword("logseq.class","Pdf-annotation","logseq.class/Pdf-annotation",-504959620),new cljs.core.Keyword("logseq.property","ls-type","logseq.property/ls-type",326979345),new cljs.core.Keyword(null,"annotation","annotation",-344661666),new cljs.core.Keyword("logseq.property.pdf","hl-color","logseq.property.pdf/hl-color",-674793887),color_id,new cljs.core.Keyword("logseq.property","asset","logseq.property/asset",876856790),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(pdf_block),new cljs.core.Keyword("logseq.property.pdf","hl-page","logseq.property.pdf/hl-page",-753284596),page,new cljs.core.Keyword("logseq.property.pdf","hl-value","logseq.property.pdf/hl-value",545829402),hl], null);
if(cljs.core.truth_(new cljs.core.Keyword(null,"image","image",-58725096).cljs$core$IFn$_invoke$arity$1(content))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__118746,new cljs.core.Keyword("logseq.property.pdf","hl-type","logseq.property.pdf/hl-type",-998437832),new cljs.core.Keyword(null,"area","area",472007256),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("logseq.property.pdf","hl-image","logseq.property.pdf/hl-image",137767009),new cljs.core.Keyword(null,"image","image",-58725096).cljs$core$IFn$_invoke$arity$1(content)], 0));
} else {
return G__118746;
}
})();
...
frontend.extensions.pdf.assets.file_based_load_hls_data$ = (function frontend$extensions$pdf$assets$file_based_load_hls_data$(p__118768){
var map__118771 = p__118768;
var map__118771__$1 = cljs.core.__destructure_map(map__118771);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118771__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
...
return promesa.protocols._promise(((db_base_QMARK_)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto____$1){
...
frontend.extensions.pdf.assets.file_based_persist_hls_data$ = (function frontend$extensions$pdf$assets$file_based_persist_hls_data$(p__118786,highlights,extra){
var map__118787 = p__118786;
var map__118787__$1 = cljs.core.__destructure_map(map__118787);
var hls_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118787__$1,new cljs.core.Keyword(null,"hls-file","hls-file",192681120));
if(cljs.core.truth_(hls_file)){
...
var _STAR_print_newline_STAR__orig_val__118793_119573 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__118794_119574 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__118795_119575 = true;
var _STAR_print_fn_STAR__temp_val__118796_119576 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__118795_119575);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__118796_119576);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__118794_119574);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__118793_119573);
}
...
return promesa.protocols._mcat(promesa.protocols._promise(current),(function (p__118829){
var map__118830 = p__118829;
var map__118830__$1 = cljs.core.__destructure_map(map__118830);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118830__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
 ...
 */
frontend.extensions.pdf.assets.persist_hl_area_image$ = (function frontend$extensions$pdf$assets$persist_hl_area_image$(viewer,current,new_hl,old_hl,p__118970){
var map__118972 = p__118970;
var map__118972__$1 = cljs.core.__destructure_map(map__118972);
var top = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118972__$1,new cljs.core.Keyword(null,"top","top",-1856271961));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118972__$1,new cljs.core.Keyword(null,"left","left",-399115937));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118972__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118972__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2((function (){var G__119034 = frontend.extensions.pdf.assets.persist_hl_area_image(repo_url,repo_dir,current,new_hl,old_hl,png);
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(G__119034) : resolve.call(null,G__119034));
})(),(function (err){
...
var fpath = (function (){var G__119103 = repo_dir;
var G__119104 = [fdir,"/",fname,"_",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fstamp),".png"].join('');
return (frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2 ? frontend.util.node_path.join.cljs$core$IFn$_invoke$arity$2(G__119103,G__119104) : frontend.util.node_path.join.call(null,G__119103,G__119104));
})();
...
frontend.extensions.pdf.assets.del_ref_block_BANG_ = (function frontend$extensions$pdf$assets$del_ref_block_BANG_(p__119127){
var map__119128 = p__119127;
var map__119128__$1 = cljs.core.__destructure_map(map__119128);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119128__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var page = (function (){var G__119176 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","page","block/page",822314108).cljs$core$IFn$_invoke$arity$1(block));
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__119176) : frontend.db.entity.call(null,G__119176));
})();
...
if(cljs.core.truth_(and__5000__auto__)){
return medley.core.find_first.cljs$core$IFn$_invoke$arity$2((function (p1__119173_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__119173_SHARP_));
}),hls__$1);
} else {
return and__5000__auto__;
}
...
var temp__5804__auto____$1 = (function (){var G__119187 = hl_value;
if((G__119187 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"page","page",849072397).cljs$core$IFn$_invoke$arity$1(G__119187);
}
})();
if(cljs.core.truth_(temp__5804__auto____$1)){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.state.set_state_BANG_(new cljs.core.Keyword("pdf","ref-highlight","pdf/ref-highlight",-1374529267),hl_value)),(function (___41611__auto__){
...
frontend.extensions.pdf.assets.goto_block_ref_BANG_ = (function frontend$extensions$pdf$assets$goto_block_ref_BANG_(p__119252){
var map__119257 = p__119252;
var map__119257__$1 = cljs.core.__destructure_map(map__119257);
var hl = map__119257__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__119257__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
if(cljs.core.truth_(id)){
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41621__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.extensions.pdf.assets.ensure_ref_block_BANG_(frontend.state.get_current_pdf(),hl,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"edit-block?","edit-block?",-310383789),false], null))),(function (___41611__auto__){
...
var G__119292 = arguments.length;
switch (G__119292) {
case 1:
...
var temp__5804__auto__ = (function (){var G__119339 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(current);
var G__119339__$1 = (((G__119339 == null))?null:["hls__",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__119339)].join(''));
if((G__119339__$1 == null)){
return null;
} else {
return frontend.db.model.get_page(G__119339__$1);
}
})();
if(cljs.core.truth_(temp__5804__auto__)){
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.reverse(cljs.core.split_with(cljs.core.complement(cljs.core.PersistentHashSet.createAsIfByAssoc([image__$1])),cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2((function (p1__119368_SHARP_){
return p1__119368_SHARP_.y;
}),(function (p1__119369_SHARP_){
return p1__119369_SHARP_.x;
})),images__$1))));
})():images__$1);
var images__$3 = (function (){var iter__5480__auto__ = (function frontend$extensions$pdf$assets$open_lightbox_$_iter__119381(s__119382){
return (new cljs.core.LazySeq(null,(function (){
var s__119382__$1 = s__119382;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__119382__$1);
if(temp__5804__auto__){
var s__119382__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__119382__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__119382__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__119384 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__119383 = (0);
while(true){
if((i__119383 < size__5479__auto__)){
var it = cljs.core._nth(c__5478__auto__,i__119383);
cljs.core.chunk_append(b__119384,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),it.src,new cljs.core.Keyword(null,"w","w",354169001),it.naturalWidth,new cljs.core.Keyword(null,"h","h",1109658740),it.naturalHeight], null));

var G__119650 = (i__119383 + (1));
i__119383 = G__119650;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__119384),frontend$extensions$pdf$assets$open_lightbox_$_iter__119381(cljs.core.chunk_rest(s__119382__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__119384),null);
}
} else {
var it = cljs.core.first(s__119382__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),it.src,new cljs.core.Keyword(null,"w","w",354169001),it.naturalWidth,new cljs.core.Keyword(null,"h","h",1109658740),it.naturalHeight], null),frontend$extensions$pdf$assets$open_lightbox_$_iter__119381(cljs.core.rest(s__119382__$2)));
}
} else {
return null;
}
...
var asset_block = (function (){var G__119429 = block;
if((G__119429 == null)){
return null;
} else {
return new cljs.core.Keyword("logseq.property.pdf","hl-image","logseq.property.pdf/hl-image",137767009).cljs$core$IFn$_invoke$arity$1(G__119429);
}
})();
var resize_metadata = (function (){var G__119430 = asset_block;
if((G__119430 == null)){
return null;
} else {
return new cljs.core.Keyword("logseq.property.asset","resize-metadata","logseq.property.asset/resize-metadata",-1297523055).cljs$core$IFn$_invoke$arity$1(G__119430);
}
})();
...
if(cljs.core.truth_(and__5000__auto__)){
var G__119433 = asset_block;
if((G__119433 == null)){
return null;
} else {
return new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(G__119433);
}
} else {
return and__5000__auto__;
}
