...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__104819){
var map__104820 = p__104819;
var map__104820__$1 = cljs.core.__destructure_map(map__104820);
var repo = map__104820__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104820__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
}),cljs.core.concat.cljs$core$IFn$_invoke$arity$2(idb_repos,(function (){var G__104821 = electron_disk_graphs;
if((G__104821 == null)){
return null;
} else {
return cljs_bean.core.__GT_clj(G__104821);
}
})())))));
}));
}));
