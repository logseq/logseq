...
var G__137301 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__137301)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__137301)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__137301)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__137301)].join('')));
...
var G__137497 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__137498 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__137497;
v = G__137498;
continue;
} else {
var G__137499 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__137500 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__137499;
v = G__137500;
continue;
}
...
break;
case "\"":
var G__137501 = cljs.core.next(sq);
var G__137502 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__137501;
v = G__137502;
continue;
...
break;
default:
var G__137503 = cljs.core.next(sq);
var G__137504 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__137503;
v = G__137504;
continue;
...
while(true){
var G__137372 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__137372__$1 = (((G__137372 instanceof cljs.core.Keyword))?G__137372.fqn:null);
switch (G__137372__$1) {
case "rule":
var vec__137376 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__137376,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__137376,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__137379 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__137379) : instaparse.cfg.content.call(null,G__137379));
...
break;
case "paren":
var G__137510 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__137510;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__137385 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137385) : instaparse.cfg.build_rule.call(null,G__137385));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__137386 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137386) : instaparse.cfg.build_rule.call(null,G__137386));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__137389 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137389) : instaparse.cfg.build_rule.call(null,G__137389));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__137390 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137390) : instaparse.cfg.build_rule.call(null,G__137390));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__137392 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137392) : instaparse.cfg.build_rule.call(null,G__137392));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__137393 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__137393) : instaparse.cfg.build_rule.call(null,G__137393));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__137372__$1)].join('')));
...
while(true){
var G__137396 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__137396__$1 = (((G__137396 instanceof cljs.core.Keyword))?G__137396.fqn:null);
switch (G__137396__$1) {
case "nt":
...
case "neg":
case "rep":
var G__137517 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__137517;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__137396__$1)].join('')));
...
var valid_nts_137518 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__137415_137519 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__137416_137520 = null;
var count__137417_137521 = (0);
var i__137418_137522 = (0);
while(true){
if((i__137418_137522 < count__137417_137521)){
var nt_137523 = chunk__137416_137520.cljs$core$IIndexed$_nth$arity$2(null,i__137418_137522);
if(cljs.core.truth_((valid_nts_137518.cljs$core$IFn$_invoke$arity$1 ? valid_nts_137518.cljs$core$IFn$_invoke$arity$1(nt_137523) : valid_nts_137518.call(null,nt_137523)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_137523),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__137524 = seq__137415_137519;
var G__137525 = chunk__137416_137520;
var G__137526 = count__137417_137521;
var G__137527 = (i__137418_137522 + (1));
seq__137415_137519 = G__137524;
chunk__137416_137520 = G__137525;
count__137417_137521 = G__137526;
i__137418_137522 = G__137527;
continue;
} else {
var temp__5804__auto___137531 = cljs.core.seq(seq__137415_137519);
if(temp__5804__auto___137531){
var seq__137415_137532__$1 = temp__5804__auto___137531;
if(cljs.core.chunked_seq_QMARK_(seq__137415_137532__$1)){
var c__5525__auto___137533 = cljs.core.chunk_first(seq__137415_137532__$1);
var G__137534 = cljs.core.chunk_rest(seq__137415_137532__$1);
var G__137535 = c__5525__auto___137533;
var G__137536 = cljs.core.count(c__5525__auto___137533);
var G__137537 = (0);
seq__137415_137519 = G__137534;
chunk__137416_137520 = G__137535;
count__137417_137521 = G__137536;
i__137418_137522 = G__137537;
continue;
} else {
var nt_137538 = cljs.core.first(seq__137415_137532__$1);
if(cljs.core.truth_((valid_nts_137518.cljs$core$IFn$_invoke$arity$1 ? valid_nts_137518.cljs$core$IFn$_invoke$arity$1(nt_137538) : valid_nts_137518.call(null,nt_137538)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_137538),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__137540 = cljs.core.next(seq__137415_137532__$1);
var G__137541 = null;
var G__137542 = (0);
var G__137543 = (0);
seq__137415_137519 = G__137540;
chunk__137416_137520 = G__137541;
count__137417_137521 = G__137542;
i__137418_137522 = G__137543;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__137441_137544 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__137442_137545 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__137443_137546 = true;
var _STAR_print_fn_STAR__temp_val__137444_137547 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__137443_137546);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__137444_137547);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__137442_137545);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__137441_137544);
}
...
var len__5726__auto___137550 = arguments.length;
var i__5727__auto___137551 = (0);
while(true){
if((i__5727__auto___137551 < len__5726__auto___137550)){
args__5732__auto__.push((arguments[i__5727__auto___137551]));

var G__137555 = (i__5727__auto___137551 + (1));
i__5727__auto___137551 = G__137555;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__137467){
var map__137468 = p__137467;
var map__137468__$1 = cljs.core.__destructure_map(map__137468);
var opts = map__137468__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__137470 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__137471 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__137471);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5647__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__137473_137557 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__137474_137558 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__137475_137559 = true;
var _STAR_print_fn_STAR__temp_val__137476_137560 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__137475_137559);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__137476_137560);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__137474_137558);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__137473_137557);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__137470);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq137459){
var G__137460 = cljs.core.first(seq137459);
var seq137459__$1 = cljs.core.next(seq137459);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__137460,seq137459__$1);
}));
