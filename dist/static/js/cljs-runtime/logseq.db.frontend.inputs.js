...
var G__86468 = (function (){var or__5002__auto__ = cljs.core.namespace(input);
...
break;
default:
throw (new Error(["No matching clause: ",G__86468].join('')));
...
var offset_fn = (function (){var G__86479 = direction;
switch (G__86479) {
case "+":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86479)].join('')));

}
})();
var offset_amount = cljs.core.parse_long(amount);
var offset_unit_fn = (function (){var G__86482 = unit;
switch (G__86482) {
case "d":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__86482)].join('')));

}
})();
var G__86483 = (function (){var G__86484 = relative_date;
var G__86485 = (offset_unit_fn.cljs$core$IFn$_invoke$arity$1 ? offset_unit_fn.cljs$core$IFn$_invoke$arity$1(offset_amount) : offset_unit_fn.call(null,offset_amount));
return (offset_fn.cljs$core$IFn$_invoke$arity$2 ? offset_fn.cljs$core$IFn$_invoke$arity$2(G__86484,G__86485) : offset_fn.call(null,G__86484,G__86485));
})();
return (offset_fn.cljs$core$IFn$_invoke$arity$1 ? offset_fn.cljs$core$IFn$_invoke$arity$1(G__86483) : offset_fn.call(null,G__86483));
});
/**
...
break;
default:
var vec__86494 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(offset_time),"000000000"].join('');
var h1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(0),null);
var h2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(1),null);
var m1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(2),null);
var m2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(3),null);
var s1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(4),null);
var s2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(5),null);
var ms1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(6),null);
var ms2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(7),null);
var ms3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86494,(8),null);
...
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__86506 = cljs.core.get_global_hierarchy;
return (fexpr__86506.cljs$core$IFn$_invoke$arity$0 ? fexpr__86506.cljs$core$IFn$_invoke$arity$0() : fexpr__86506.call(null));
})());
...
logseq.db.frontend.inputs.resolve_keyword_input.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"current-page","current-page",-101294180),(function (_,___$1,p__86514){
var map__86515 = p__86514;
var map__86515__$1 = cljs.core.__destructure_map(map__86515);
var current_page_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86515__$1,new cljs.core.Keyword(null,"current-page-fn","current-page-fn",1987406514));
if(cljs.core.truth_(current_page_fn)){
var G__86516 = (current_page_fn.cljs$core$IFn$_invoke$arity$0 ? current_page_fn.cljs$core$IFn$_invoke$arity$0() : current_page_fn.call(null));
if((G__86516 == null)){
return null;
} else {
return clojure.string.lower_case(G__86516);
}
} else {
return null;
}
}));
logseq.db.frontend.inputs.resolve_keyword_input.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"query-page","query-page",1890357937),(function (db,_,p__86518){
var map__86519 = p__86518;
var map__86519__$1 = cljs.core.__destructure_map(map__86519);
var current_block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86519__$1,new cljs.core.Keyword(null,"current-block-uuid","current-block-uuid",-559721957));
var temp__5804__auto__ = (function (){var and__5000__auto__ = current_block_uuid;
if(cljs.core.truth_(and__5000__auto__)){
var G__86521 = db;
var G__86522 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),current_block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__86521,G__86522) : datascript.core.entity.call(null,G__86521,G__86522));
} else {
...
logseq.db.frontend.inputs.resolve_keyword_input.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"current-block","current-block",1027687970),(function (db,_,p__86534){
var map__86535 = p__86534;
var map__86535__$1 = cljs.core.__destructure_map(map__86535);
var current_block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86535__$1,new cljs.core.Keyword(null,"current-block-uuid","current-block-uuid",-559721957));
if(cljs.core.truth_(current_block_uuid)){
return new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1((function (){var G__86539 = db;
var G__86540 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),current_block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__86539,G__86540) : datascript.core.entity.call(null,G__86539,G__86540));
})());
} else {
return null;
}
}));
logseq.db.frontend.inputs.resolve_keyword_input.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"parent-block","parent-block",-1919487774),(function (db,_,p__86543){
var map__86544 = p__86543;
var map__86544__$1 = cljs.core.__destructure_map(map__86544);
var current_block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86544__$1,new cljs.core.Keyword(null,"current-block-uuid","current-block-uuid",-559721957));
if(cljs.core.truth_(current_block_uuid)){
return new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","parent","block/parent",-918309064).cljs$core$IFn$_invoke$arity$1((function (){var G__86547 = db;
var G__86548 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),current_block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__86547,G__86548) : datascript.core.entity.call(null,G__86547,G__86548));
})()));
} else {
return null;
}
...
var vec__86558 = (function (){var G__86561 = input;
...
var hh = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86558,(0),null);
var mm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86558,(1),null);
var ss = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86558,(2),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86558,(3),null);
...
var vec__86567 = cljs.core.re_find(/^([+-])(\d+)([dwmy])$/,cljs.core.name(input));
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86567,(0),null);
var offset_direction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86567,(1),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86567,(2),null);
var offset_unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86567,(3),null);
...
var relative_to = logseq.db.frontend.inputs.get_relative_date(input);
var vec__86575 = cljs.core.re_find(/^([+-])(\d+)([dwmy])-(ms|start|end|\d{2,9})$/,cljs.core.name(input));
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86575,(0),null);
var offset_direction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86575,(1),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86575,(2),null);
var offset_unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86575,(3),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86575,(4),null);
var offset_date = logseq.db.frontend.inputs.get_offset_date(relative_to,offset_direction,offset,offset_unit);
var vec__86578 = logseq.db.frontend.inputs.get_ts_units(offset_direction,ts);
var hh = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86578,(0),null);
var mm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86578,(1),null);
var ss = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86578,(2),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__86578,(3),null);
 ...
 */
logseq.db.frontend.inputs.resolve_input = (function logseq$db$frontend$inputs$resolve_input(db,input,p__86587){
var map__86588 = p__86587;
var map__86588__$1 = cljs.core.__destructure_map(map__86588);
var current_block_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__86588__$1,new cljs.core.Keyword(null,"current-block-uuid","current-block-uuid",-559721957));
var current_page_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__86588__$1,new cljs.core.Keyword(null,"current-page-fn","current-page-fn",1987406514),cljs.core.constantly(null));
