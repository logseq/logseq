...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__154842){
var vec__154846 = p__154842;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154846,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154846,(1),null);
...
var color = (function (){var G__154872 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dark_QMARK_,current_page_QMARK_], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__154872)){
return "#999";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__154872)){
return "#045591";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__154872)){
return "#93a1a1";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__154872)){
return "#ffffff";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__154872)].join('')));
...
frontend.common.graph_view.normalize_page_name = (function frontend$common$graph_view$normalize_page_name(p__154910){
var map__154916 = p__154910;
var map__154916__$1 = cljs.core.__destructure_map(map__154916);
var nodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154916__$1,new cljs.core.Keyword(null,"nodes","nodes",-2099585805));
var links = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154916__$1,new cljs.core.Keyword(null,"links","links",-654507394));
...
frontend.common.graph_view.build_global_graph = (function frontend$common$graph_view$build_global_graph(db,p__154944){
var map__154945 = p__154944;
var map__154945__$1 = cljs.core.__destructure_map(map__154945);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"journal?","journal?",-897756522));
var orphan_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"orphan-pages?","orphan-pages?",-824819206));
var builtin_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"builtin-pages?","builtin-pages?",1299611390));
var excluded_pages_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"excluded-pages?","excluded-pages?",1527958391));
var created_at_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__154945__$1,new cljs.core.Keyword(null,"created-at-filter","created-at-filter",708262492));
...
var full_pages_SINGLEQUOTE_ = (function (){var G__154952 = full_pages;
var G__154952__$1 = (cljs.core.truth_(created_at_filter)?cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__154928_SHARP_){
return (new cljs.core.Keyword("block","created-at","block/created-at",1440015).cljs$core$IFn$_invoke$arity$1(p1__154928_SHARP_) <= (cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.min,created_ats) + created_at_filter));
}),G__154952):G__154952);
var G__154952__$2 = ((cljs.core.not(journal_QMARK_))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2(logseq.db.journal_QMARK_,G__154952__$1):G__154952__$1);
...
var nodes = (function (){var G__154962 = full_pages_SINGLEQUOTE_;
var G__154962__$1 = ((cljs.core.not(builtin_pages_QMARK_))?cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__154931_SHARP_){
return cljs.core.contains_QMARK_(build_in_pages,new cljs.core.Keyword("block","name","block/name",1619760316).cljs$core$IFn$_invoke$arity$1(p1__154931_SHARP_));
}),G__154962):G__154962);
if(cljs.core.not(orphan_pages_QMARK_)){
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__154932_SHARP_){
return cljs.core.contains_QMARK_(linked,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__154932_SHARP_));
}),G__154962__$1);
} else {
return G__154962__$1;
}
})();
var links__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__154963){
var vec__154966 = p__154963;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154966,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154966,(1),null);
...
var page_links = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__154977){
var vec__154978 = p__154977;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154978,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__154978,(1),null);
...
var dark_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("dark",theme);
var page_entity = (function (){var G__155072 = db;
var G__155073 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__155072,G__155073) : datascript.core.entity.call(null,G__155072,G__155073));
})();
var db_based_QMARK_ = logseq.db.common.entity_plus.db_based_graph_QMARK_(db);
...
var tags__$1 = cljs.core.set(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__155062_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(page_id,p1__155062_SHARP_);
}),tags));
...
var nodes = logseq.common.util.distinct_by(new cljs.core.Keyword("db","id","db/id",-1388397098),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__155063_SHARP_){
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(db,p1__155063_SHARP_) : datascript.core.entity.call(null,db,p1__155063_SHARP_));
...
if(and__5000__auto__){
var G__155086 = db;
var G__155087 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__155086,G__155087) : datascript.core.entity.call(null,G__155086,G__155087));
} else {
return and__5000__auto__;
}
})();
...
var G__155103 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(opts);
var G__155103__$1 = (((G__155103 instanceof cljs.core.Keyword))?G__155103.fqn:null);
switch (G__155103__$1) {
case "global":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__155103__$1)].join('')));
