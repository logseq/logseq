...
var temp__5804__auto____$1 = (function (){var G__47208 = cljs.core.deref(conn);
var G__47209 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","path","file/path",-191335748),current_file_path], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__47208,G__47209) : datascript.core.entity.call(null,G__47208,G__47209));
})();
if(cljs.core.truth_(temp__5804__auto____$1)){
var file = temp__5804__auto____$1;
var G__47210_47247 = new cljs.core.Keyword(null,"backup-file","backup-file",-560755353);
var G__47211_47248 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [repo,current_file_path,new cljs.core.Keyword("file","content","file/content",12680964).cljs$core$IFn$_invoke$arity$1(file)], null);
(frontend.worker.util.post_message.cljs$core$IFn$_invoke$arity$2 ? frontend.worker.util.post_message.cljs$core$IFn$_invoke$arity$2(G__47210_47247,G__47211_47248) : frontend.worker.util.post_message.call(null,G__47210_47247,G__47211_47248));
...
var G__47212 = new cljs.core.Keyword(null,"notify-existing-file","notify-existing-file",1395099748);
var G__47213 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"current-file-path","current-file-path",2051233087),current_file_path,new cljs.core.Keyword(null,"file-path","file-path",-2005501162),file_path], null)], null);
return (frontend.worker.util.post_message.cljs$core$IFn$_invoke$arity$2 ? frontend.worker.util.post_message.cljs$core$IFn$_invoke$arity$2(G__47212,G__47213) : frontend.worker.util.post_message.call(null,G__47212,G__47213));
...
(frontend.worker.file.reset.reset_file_BANG_.cljs$core$IFn$_invoke$arity$5 = (function (repo,conn,file_path,content,p__47227){
var map__47228 = p__47227;
var map__47228__$1 = cljs.core.__destructure_map(map__47228);
var options = map__47228__$1;
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47228__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060));
var _ctime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47228__$1,new cljs.core.Keyword(null,"_ctime","_ctime",851368378));
var _mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47228__$1,new cljs.core.Keyword(null,"_mtime","_mtime",-882459022));
