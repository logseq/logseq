...
return promesa.protocols._promise((cljs.core.truth_(frontend.handler.db_based.page.valid_tag_QMARK_(repo,(function (){var G__104721 = repo;
var G__104722 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),block_id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__104721,G__104722) : frontend.db.entity.call(null,G__104721,G__104722));
...
if(cljs.core.truth_((function (){var G__104728 = new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1(page_entity);
var G__104729 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.class","Tag","logseq.class/Tag",-538902083),null], null), null);
return (frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2 ? frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(G__104728,G__104729) : frontend.db.page_exists_QMARK_.call(null,G__104728,G__104729));
})())){
...
if(cljs.core.truth_((function (){var G__104755 = new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1(page_entity);
var G__104756 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("logseq.class","Page","logseq.class/Page",1484340329),null], null), null);
return (frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2 ? frontend.db.page_exists_QMARK_.cljs$core$IFn$_invoke$arity$2(G__104755,G__104756) : frontend.db.page_exists_QMARK_.call(null,G__104755,G__104756));
})())){
...
var tags = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__104742_SHARP_){
var G__104758 = frontend.state.get_current_repo();
var G__104759 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__104742_SHARP_);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$2 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$2(G__104758,G__104759) : frontend.db.entity.call(null,G__104758,G__104759));
...
return promesa.core.then.cljs$core$IFn$_invoke$arity$2((function (){var G__104762 = "Converting a tag to page also removes tags from any nodes that have that tag. Are you ok with that?";
var G__104763 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"convert-tag-to-page","convert-tag-to-page",-1819851675),new cljs.core.Keyword(null,"data-reminder","data-reminder",1296338874),new cljs.core.Keyword(null,"ok","ok",967785236)], null);
return (logseq.shui.ui.dialog_confirm_BANG_.cljs$core$IFn$_invoke$arity$2 ? logseq.shui.ui.dialog_confirm_BANG_.cljs$core$IFn$_invoke$arity$2(G__104762,G__104763) : logseq.shui.ui.dialog_confirm_BANG_.call(null,G__104762,G__104763));
})(),convert_fn);
})());
}));
}));
...
var nearest_node = (function (){var G__104776 = frontend.handler.editor.get_nearest_page();
if((G__104776 == null)){
return null;
} else {
return clojure.string.trim(G__104776);
}
})();
