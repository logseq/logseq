...
var map__118773 = cljs_bean.core.__GT_clj(data);
var map__118773__$1 = cljs.core.__destructure_map(map__118773);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118773__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118773__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
...
var map__118784 = cljs_bean.core.__GT_clj(data);
var map__118784__$1 = cljs.core.__destructure_map(map__118784);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118784__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118784__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
...
var map__118791 = cljs_bean.core.__GT_clj(data);
var map__118791__$1 = cljs.core.__destructure_map(map__118791);
var payload = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118791__$1,new cljs.core.Keyword(null,"payload","payload",-383036092));
...
var map__118799 = cljs_bean.core.__GT_clj(data);
var map__118799__$1 = cljs.core.__destructure_map(map__118799);
var page_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118799__$1,new cljs.core.Keyword(null,"page-name","page-name",974981762));
var block_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118799__$1,new cljs.core.Keyword(null,"block-id","block-id",-70582834));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__118799__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var ns_method = (function (){var G__118831 = method;
if((G__118831 == null)){
return null;
} else {
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(G__118831,"@");
}
})();
var ns_SINGLEQUOTE_ = cljs.core.first(ns_method);
var method_SINGLEQUOTE_ = cljs.core.last(ns_method);
var args = data.args;
var ret_fn_BANG_ = (function (p1__118752_SHARP_){
return electron.ipc.invoke.cljs$core$IFn$_invoke$arity$variadic([cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("electron.server","sync!","electron.server/sync!",749164490)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sync_id)].join(''),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__118752_SHARP_], 0));
});
...
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$4(cljs.core.js_invoke,methodTarget,method_SINGLEQUOTE_,args)),(function (p1__118757_SHARP_){
return ret_fn_BANG_(p1__118757_SHARP_);
})),(function (p1__118759_SHARP_){
return ret_fn_BANG_(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__118759_SHARP_], null));
}));
}catch (e118832){if((e118832 instanceof Error)){
var e = e118832;
