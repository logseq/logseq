...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$1){
...
(frontend.fs.nfs.Nfs.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k48291,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__48299 = k48291;
switch (G__48299) {
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48291,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__48300){
var vec__48301 = p__48300;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301,(1),null);
...
(frontend.fs.nfs.Nfs.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48290){
var self__ = this;
var G__48290__$1 = this;
return (new cljs.core.RecordIter((0),G__48290__$1,0,cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.fs.nfs.Nfs.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48292,other48293){
var self__ = this;
var this48292__$1 = this;
return (((!((other48293 == null)))) && ((((this48292__$1.constructor === other48293.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48292__$1.__extmap,other48293.__extmap)))));
}));
...
(frontend.fs.nfs.Nfs.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k48291){
var self__ = this;
var this__5307__auto____$1 = this;
return cljs.core.contains_QMARK_(self__.__extmap,k48291);
}));

(frontend.fs.nfs.Nfs.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__48290){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__48311 = cljs.core.keyword_identical_QMARK_;
var expr__48312 = k__5309__auto__;
return (new frontend.fs.nfs.Nfs(self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__48290),null));
}));
...
(frontend.fs.nfs.Nfs.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__48290){
var self__ = this;
var this__5299__auto____$1 = this;
return (new frontend.fs.nfs.Nfs(G__48290,self__.__extmap,self__.__hash));
}));
...
return promesa.protocols._promise((cljs.core.truth_(parent_handle)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$1){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.fs.nfs.add_nfs_file_handle_BANG_(handle_path,new_handle)),(function (___41063__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.idb.remove_item_BANG_(handle_path)),(function (___41063__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise(handle.getFile()),(function (file){
return promesa.protocols._promise((function (){var get_attr = (function (p1__48287_SHARP_){
return frontend.fs.nfs.goog$module$goog$object.get(file,p1__48287_SHARP_);
});
...
return promesa.protocols._promise((cljs.core.truth_(file_handle)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$1){
...
return promesa.protocols._promise((((((!(clojure.string.blank_QMARK_(db_content)))) && (((cljs.core.not(new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960).cljs$core$IFn$_invoke$arity$1(opts))) && (((cljs.core.not(contents_matched_QMARK__SINGLEQUOTE_)) && ((((!(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["excalidraw",null,"css",null,"edn",null], null), null),ext)))) && ((!(clojure.string.includes_QMARK_(path,"/.recycle/"))))))))))))?frontend.state.pub_event_BANG_(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","not-matched-from-disk","file/not-matched-from-disk",1915939272),path,disk_content,content], null)):promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$2){
...
return promesa.protocols._promise((cljs.core.truth_(parent_dir_handle)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$2){
...
return promesa.protocols._promise(((clojure.string.blank_QMARK_(text))?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$3){
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.fs.nfs.add_nfs_file_handle_BANG_(["handle/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(dir_name)].join(''),dir_handle)),(function (___41063__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.idb.set_item_BANG_(["handle/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(dir_name)].join(''),dir_handle)),(function (___41063__auto____$1){
...
return promesa.protocols._promise(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41095__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise((function (){var or__5002__auto__ = frontend.fs.nfs.get_nfs_file_handle(handle_path);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
 ...
 */
frontend.fs.nfs.map__GT_Nfs = (function frontend$fs$nfs$map__GT_Nfs(G__48296){
var extmap__5342__auto__ = (function (){var G__48510 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__48296);
