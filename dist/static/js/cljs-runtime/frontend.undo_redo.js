...
var vec__102189 = frontend.undo_redo.pop_stack(undo_stack);
var op = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102189,(0),null);
var undo_stack_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102189,(1),null);
...
var vec__102192 = frontend.undo_redo.pop_stack(redo_stack);
var op = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102192,(0),null);
var redo_stack_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102192,(1),null);
...
return cljs.core.set(cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__102195){
var vec__102196 = p__102195;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102196,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102196,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__102204){
var vec__102205 = p__102204;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102205,(0),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102205,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102205,(2),null);
var _tx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102205,(3),null);
var add_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102205,(4),null);
...
var or__5002__auto____$1 = (function (){var G__102208 = cljs.core.deref(conn);
var G__102209 = v;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102208,G__102209) : datascript.core.entity.call(null,G__102208,G__102209));
})();
...
if(cljs.core.truth_(and__5000__auto__)){
var b = (function (){var G__102210 = cljs.core.deref(conn);
var G__102211 = e;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102210,G__102211) : datascript.core.entity.call(null,G__102210,G__102211));
})();
...
return ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cur_parent,before_parent)) || (((function (){var G__102212 = cljs.core.deref(conn);
var G__102213 = after_parent;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102212,G__102213) : datascript.core.entity.call(null,G__102212,G__102213));
})() == null)));
} else {
return ((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cur_parent,after_parent)) || (((function (){var G__102214 = cljs.core.deref(conn);
var G__102215 = before_parent;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102214,G__102215) : datascript.core.entity.call(null,G__102214,G__102215));
})() == null)));
}
} else {
...
frontend.undo_redo.get_reversed_datoms = (function frontend$undo_redo$get_reversed_datoms(conn,undo_QMARK_,p__102217,_tx_meta){
var map__102218 = p__102217;
var map__102218__$1 = cljs.core.__destructure_map(map__102218);
var op = map__102218__$1;
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102218__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var added_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102218__$1,new cljs.core.Keyword(null,"added-ids","added-ids",-422897273));
var retracted_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102218__$1,new cljs.core.Keyword(null,"retracted-ids","retracted-ids",351906643));
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__102221){
var vec__102222 = p__102221;
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102222,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102222,(1),null);
var entity = (function (){var G__102225 = cljs.core.deref(conn);
var G__102226 = e;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102225,G__102226) : datascript.core.entity.call(null,G__102225,G__102226));
})();
...
var temp__5802__auto__ = cljs.core.not_empty((function (){var fexpr__102229 = (cljs.core.truth_(undo_QMARK_)?frontend.undo_redo.pop_undo_op:frontend.undo_redo.pop_redo_op);
return (fexpr__102229.cljs$core$IFn$_invoke$arity$1 ? fexpr__102229.cljs$core$IFn$_invoke$arity$1(repo) : fexpr__102229.call(null,repo));
})());
...
var fexpr__102230_102277 = (cljs.core.truth_(undo_QMARK_)?frontend.undo_redo.push_redo_op:frontend.undo_redo.push_undo_op);
(fexpr__102230_102277.cljs$core$IFn$_invoke$arity$2 ? fexpr__102230_102277.cljs$core$IFn$_invoke$arity$2(repo,op) : fexpr__102230_102277.call(null,repo,op));
...
var map__102231 = cljs.core.some((function (p1__102227_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("frontend.undo-redo","db-transact","frontend.undo-redo/db-transact",-1060271440),cljs.core.first(p1__102227_SHARP_))){
return cljs.core.second(p1__102227_SHARP_);
} else {
return null;
}
}),op);
var map__102231__$1 = cljs.core.__destructure_map(map__102231);
var data = map__102231__$1;
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102231__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var tx_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102231__$1,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194));
...
var fexpr__102232_102280 = (cljs.core.truth_(undo_QMARK_)?frontend.undo_redo.push_redo_op:frontend.undo_redo.push_undo_op);
(fexpr__102232_102280.cljs$core$IFn$_invoke$arity$2 ? fexpr__102232_102280.cljs$core$IFn$_invoke$arity$2(repo,op) : fexpr__102232_102280.call(null,repo,op));

var editor_cursors = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__102228_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("frontend.undo-redo","record-editor-info","frontend.undo-redo/record-editor-info",-1249633720),cljs.core.first(p1__102228_SHARP_));
}),op));
var block_content = new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1((function (){var G__102235 = cljs.core.deref(conn);
var G__102236 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new cljs.core.Keyword(null,"block-uuid","block-uuid",-1558039638).cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(undo_QMARK_)?cljs.core.first(editor_cursors):cljs.core.last(editor_cursors)))], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__102235,G__102236) : datascript.core.entity.call(null,G__102235,G__102236));
})());
...
return promesa.protocols._mcat(promesa.protocols._promise(logseq.db.transact_BANG_.cljs$core$IFn$_invoke$arity$3(repo,reversed_tx_data,tx_meta_SINGLEQUOTE_)),(function (___41611__auto__){
...
if(cljs.core.truth_((function (){var fexpr__102241 = (cljs.core.truth_(undo_QMARK_)?frontend.undo_redo.empty_undo_stack_QMARK_:frontend.undo_redo.empty_redo_stack_QMARK_);
return (fexpr__102241.cljs$core$IFn$_invoke$arity$1 ? fexpr__102241.cljs$core$IFn$_invoke$arity$1(repo) : fexpr__102241.call(null,repo));
})())){
...
frontend.undo_redo.gen_undo_ops_BANG_ = (function frontend$undo_redo$gen_undo_ops_BANG_(repo,p__102248){
var map__102249 = p__102248;
var map__102249__$1 = cljs.core.__destructure_map(map__102249);
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102249__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var tx_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102249__$1,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102249__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102249__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var map__102250 = tx_meta;
var map__102250__$1 = cljs.core.__destructure_map(map__102250);
var outliner_op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102250__$1,new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450));
...
var G__102251 = conn;
var G__102252 = new cljs.core.Keyword("frontend.undo-redo","gen-undo-ops","frontend.undo-redo/gen-undo-ops",-690871153);
var G__102253 = (function (tx_report){
return frontend.undo_redo.gen_undo_ops_BANG_(repo,tx_report);
});
return (datascript.core.listen_BANG_.cljs$core$IFn$_invoke$arity$3 ? datascript.core.listen_BANG_.cljs$core$IFn$_invoke$arity$3(G__102251,G__102252,G__102253) : datascript.core.listen_BANG_.call(null,G__102251,G__102252,G__102253));
});
