...
var self__ = this;
var self__ = this;
var G__43921 = (arguments.length - (1));
switch (G__43921) {
case (0):
...
(missionary.impl.Never.Process.prototype.apply = (function (self__,args43919){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args43919)));
}));
...
var G__43944 = (new missionary.Cancelled("Never cancelled."));
var fexpr__43943 = ps.f;
