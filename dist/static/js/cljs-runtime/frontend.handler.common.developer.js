...
var result = (function (){var G__110170 = result_STAR_;
var G__110170__$1 = ((((cljs.core.seq(new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(entity))) && (frontend.config.db_based_graph_QMARK_.cljs$core$IFn$_invoke$arity$1(frontend.state.get_current_repo()))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__110170,new cljs.core.Keyword("block.debug","properties","block.debug/properties",1532223470),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__110171){
var vec__110172 = p__110171;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__110172,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__110172,(1),null);
...
}),new cljs.core.Keyword("block","properties","block/properties",708347145).cljs$core$IFn$_invoke$arity$1(entity)))):G__110170);
if(cljs.core.seq(new cljs.core.Keyword("block","refs","block/refs",-1214495349).cljs$core$IFn$_invoke$arity$1(result_STAR_))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__110170__$1,new cljs.core.Keyword("block.debug","refs","block.debug/refs",-1504277838),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__110169_SHARP_){
var or__5002__auto__ = new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1((function (){var G__110175 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__110169_SHARP_);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__110175) : frontend.db.entity.call(null,G__110175));
})());
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return p1__110169_SHARP_;
}
}),new cljs.core.Keyword("block","refs","block/refs",-1214495349).cljs$core$IFn$_invoke$arity$1(result_STAR_)));
} else {
return G__110170__$1;
}
})();
var pull_data = (function (){var sb__5647__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__110176_110268 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__110177_110269 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__110178_110270 = true;
var _STAR_print_fn_STAR__temp_val__110179_110271 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__110178_110270);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__110179_110271);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(result);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__110177_110269);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__110176_110268);
}
...
var _STAR_print_newline_STAR__orig_val__110180_110276 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__110181_110277 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__110182_110278 = true;
var _STAR_print_fn_STAR__temp_val__110183_110279 = (function (x__5648__auto__){
return sb__5647__auto__.append(x__5648__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__110182_110278);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__110183_110279);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(frontend.format.mldoc.__GT_edn(content,format));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__110181_110277);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__110180_110276);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5647__auto__);
})();
...
if(cljs.core.truth_(temp__5802__auto__)){
var map__110187 = temp__5802__auto__;
var map__110187__$1 = cljs.core.__destructure_map(map__110187);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__110187__$1,new cljs.core.Keyword("block","title","block/title",710445684));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__110187__$1,new cljs.core.Keyword("block","format","block/format",-1212045901));
...
var page_data = (function (){var G__110194 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","format","block/format",-1212045901),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","file","block/file",183171933),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","content","file/content",12680964)], null)], null)], null);
var G__110195 = frontend.util.page.get_current_page_id();
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$2 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$2(G__110194,G__110195) : frontend.db.pull.call(null,G__110194,G__110195));
})();
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$2("Graph updated! Switching to graph ...",new cljs.core.Keyword(null,"success","success",1890645906))),(function (___41611__auto__){
