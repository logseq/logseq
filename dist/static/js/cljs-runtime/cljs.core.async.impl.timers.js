...
var i_36753 = (0);
while(true){
if((i_36753 < arr.length)){
(arr[i_36753] = null);

var G__36754 = (i_36753 + (1));
i_36753 = G__36754;
continue;
} else {
}
...
var i_36765 = (self__.level + (1));
while(true){
if((i_36765 <= (new_level + (1)))){
(update[i_36765] = self__.header);

var G__36767 = (i_36765 + (1));
i_36765 = G__36767;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_36769 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_36769[i]));
} else {
x__$2.forward.push((((i < links_36769.length))?(links_36769[i]):null));
}

if((i < links_36769.length)){
(links_36769[i] = x__$2);
} else {
links_36769.push(x__$2);
}
...
var i_36771 = (0);
while(true){
if((i_36771 <= self__.level)){
var links_36772 = (update[i_36771]).forward;
if((x__$1 === (((i_36771 < links_36772.length))?(links_36772[i_36771]):null))){
(links_36772[i_36771] = (x__$1.forward[i_36771]));

var G__36773 = (i_36771 + (1));
i_36771 = G__36773;
continue;
} else {
var G__36774 = (i_36771 + (1));
i_36771 = G__36774;
continue;
}
} else {
...
var G__36777 = nx;
var G__36778 = (level__$1 - (1));
x = G__36777;
level__$1 = G__36778;
continue;
} else {
var G__36779 = x;
var G__36780 = (level__$1 - (1));
x = G__36779;
level__$1 = G__36780;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__36782 = nx;
var G__36783 = (level__$1 - (1));
x = G__36782;
level__$1 = G__36783;
continue;
} else {
var G__36784 = x;
var G__36785 = (level__$1 - (1));
x = G__36784;
level__$1 = G__36785;
continue;
}
