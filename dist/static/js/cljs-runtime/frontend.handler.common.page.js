...
var G__104410 = arguments.length;
switch (G__104410) {
case 1:
...
(frontend.handler.common.page._LT_create_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (title,p__104411){
var map__104412 = p__104411;
var map__104412__$1 = cljs.core.__destructure_map(map__104412);
var options = map__104412__$1;
var redirect_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__104412__$1,new cljs.core.Keyword(null,"redirect?","redirect?",-1229259098),true);
var today_journal_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104412__$1,new cljs.core.Keyword(null,"today-journal?","today-journal?",-388258460));
...
})())?frontend.handler.notification.show_BANG_.cljs$core$IFn$_invoke$arity$2("Page name can't include \"#\".",new cljs.core.Keyword(null,"warning","warning",-1685650671)):((clojure.string.blank_QMARK_(title_SINGLEQUOTE_))?null:promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(db_based_QMARK_)?(function (){var G__104418 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(options,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.concat,new cljs.core.Keyword("block","tags","block/tags",1814948340).cljs$core$IFn$_invoke$arity$1(parsed_result));
if((new cljs.core.Keyword(null,"split-namespace?","split-namespace?",-1035468161).cljs$core$IFn$_invoke$arity$1(options) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__104418,new cljs.core.Keyword(null,"split-namespace?","split-namespace?",-1035468161),true);
} else {
return G__104418;
}
...
var _STAR_outliner_ops_STAR__orig_val__104425 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__104426 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__104426);
...
return logseq.outliner.op.apply_ops_BANG_(frontend.state.get_current_repo(),frontend.db.conn.get_db.cljs$core$IFn$_invoke$arity$1(false),r__49429__auto__,frontend.state.get_date_formatter(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"create-page","create-page",-1352656443)], null));
} else {
return null;
}
} else {
...
return frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","apply-outliner-ops","thread-api/apply-outliner-ops",654139693),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.state.get_current_repo(),r__49429__auto__,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"create-page","create-page",-1352656443)], null),new cljs.core.Keyword(null,"request-id","request-id",-985684093),request_id__49430__auto__,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"client-id","client-id",-464622140),new cljs.core.Keyword(null,"client-id","client-id",-464622140).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.state.state))], 0))], 0));
});
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__104425);
}}
})()),(function (p__104429){
var vec__104434 = p__104429;
var _page_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104434,(0),null);
var page_uuid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104434,(1),null);
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__104437 = (function (){var or__5002__auto__ = page_uuid;
...
return (frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(G__104437) : frontend.db.get_page.call(null,G__104437));
})()),(function (page){
...
var temp__5804__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__104408_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page)),dommy.core.attr(p1__104408_SHARP_,"data-blockId"));
...
var new_favorites = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__104445_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(clojure.string.lower_case(p1__104445_SHARP_),clojure.string.lower_case(page_name));
}),old_favorites));
...
var temp__5804__auto____$1 = (function (){var G__104446 = db;
var G__104447 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__104446,G__104447) : datascript.core.entity.call(null,G__104446,G__104447));
})();
...
if(cljs.core.truth_((function (){var G__104448 = frontend.db.conn.get_db.cljs$core$IFn$_invoke$arity$0();
var G__104449 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_block_uuid], null);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__104448,G__104449) : datascript.core.entity.call(null,G__104448,G__104449));
})())){
...
var _STAR_outliner_ops_STAR__orig_val__104450 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__104451 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__104451);
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__104450);
}}
})());
}));
} else {
...
var _STAR_outliner_ops_STAR__orig_val__104453 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__104454 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__104454);
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__104453);
}}
} else {
return null;
}
...
var len__5726__auto___104543 = arguments.length;
var i__5727__auto___104544 = (0);
while(true){
if((i__5727__auto___104544 < len__5726__auto___104543)){
args__5732__auto__.push((arguments[i__5727__auto___104544]));

var G__104545 = (i__5727__auto___104544 + (1));
i__5727__auto___104544 = G__104545;
continue;
} else {
}
break;
...
(frontend.handler.common.page._LT_delete_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (page_uuid_or_name,ok_handler,p__104464){
var map__104466 = p__104464;
var map__104466__$1 = cljs.core.__destructure_map(map__104466);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104466__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
...
var page = (function (){var G__104471 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),page_uuid], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__104471) : frontend.db.entity.call(null,G__104471));
})();
...
return promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41621__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(((home_page_QMARK_)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41621__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.config.set_config_BANG_(new cljs.core.Keyword(null,"default-home","default-home",171104159),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(default_home,new cljs.core.Keyword(null,"page","page",849072397)))),(function (___41611__auto__){
...
return promesa.protocols._promise(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((function (){var test_QMARK___49426__auto__ = frontend.util.node_test_QMARK_;
var ops__49427__auto__ = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var editor_info__49428__auto__ = frontend.state.get_editor_info();
cljs.core.reset_BANG_(frontend.state._STAR_editor_info,editor_info__49428__auto__);
...
var _STAR_outliner_ops_STAR__orig_val__104484 = frontend.modules.outliner.op._STAR_outliner_ops_STAR_;
var _STAR_outliner_ops_STAR__temp_val__104485 = cljs.core.transient$(cljs.core.PersistentVector.EMPTY);
(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__temp_val__104485);
...
if(test_QMARK___49426__auto__){
if(cljs.core.seq(r__49429__auto__)){
return logseq.outliner.op.apply_ops_BANG_(frontend.state.get_current_repo(),frontend.db.conn.get_db.cljs$core$IFn$_invoke$arity$1(false),r__49429__auto__,frontend.state.get_date_formatter(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"delete-page","delete-page",-1371381770)], null));
} else {
return null;
}
} else {
...
var request_id__49430__auto__ = (frontend.state.get_worker_next_request_id.cljs$core$IFn$_invoke$arity$0 ? frontend.state.get_worker_next_request_id.cljs$core$IFn$_invoke$arity$0() : frontend.state.get_worker_next_request_id.call(null));
var request__49431__auto__ = (function (){
return frontend.state._LT_invoke_db_worker.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("thread-api","apply-outliner-ops","thread-api/apply-outliner-ops",654139693),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([frontend.state.get_current_repo(),r__49429__auto__,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"delete-page","delete-page",-1371381770)], null),new cljs.core.Keyword(null,"request-id","request-id",-985684093),request_id__49430__auto__,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"client-id","client-id",-464622140),new cljs.core.Keyword(null,"client-id","client-id",-464622140).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(frontend.state.state))], 0))], 0));
});
var response__49432__auto__ = (frontend.state.add_worker_request_BANG_.cljs$core$IFn$_invoke$arity$2 ? frontend.state.add_worker_request_BANG_.cljs$core$IFn$_invoke$arity$2(request_id__49430__auto__,request__49431__auto__) : frontend.state.add_worker_request_BANG_.call(null,request_id__49430__auto__,request__49431__auto__));
return response__49432__auto__;
} else {
...
}finally {(frontend.modules.outliner.op._STAR_outliner_ops_STAR_ = _STAR_outliner_ops_STAR__orig_val__104484);
}}
})()),(function (res){
...
/** @this {Function} */
(frontend.handler.common.page._LT_delete_BANG_.cljs$lang$applyTo = (function (seq104456){
var G__104457 = cljs.core.first(seq104456);
var seq104456__$1 = cljs.core.next(seq104456);
var G__104458 = cljs.core.first(seq104456__$1);
var seq104456__$2 = cljs.core.next(seq104456__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__104457,G__104458,seq104456__$2);
}));
...
var temp__5804__auto___104550 = new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1((frontend.db.get_page.cljs$core$IFn$_invoke$arity$1 ? frontend.db.get_page.cljs$core$IFn$_invoke$arity$1(page_name) : frontend.db.get_page.call(null,page_name)));
if(cljs.core.truth_(temp__5804__auto___104550)){
var page_block_uuid_104551 = temp__5804__auto___104550;
frontend.handler.common.page._LT_db_unfavorite_page_BANG_(page_block_uuid_104551);
} else {
}
} else {
...
frontend.handler.common.page.after_page_renamed_BANG_ = (function frontend$handler$common$page$after_page_renamed_BANG_(repo,p__104531){
var map__104532 = p__104531;
var map__104532__$1 = cljs.core.__destructure_map(map__104532);
var page_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104532__$1,new cljs.core.Keyword(null,"page-id","page-id",-872941168));
var old_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104532__$1,new cljs.core.Keyword(null,"old-name","old-name",1289683869));
var new_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104532__$1,new cljs.core.Keyword(null,"new-name","new-name",1288355058));
var old_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104532__$1,new cljs.core.Keyword(null,"old-path","old-path",-2069757806));
var new_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104532__$1,new cljs.core.Keyword(null,"new-path","new-path",1732999939));
...
var redirect_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((function (){var G__104533 = frontend.state.get_current_page();
if((G__104533 == null)){
return null;
} else {
return logseq.common.util.page_name_sanity_lc(G__104533);
}
...
var home_104554 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.state.get_config.cljs$core$IFn$_invoke$arity$0(),new cljs.core.Keyword(null,"default-home","default-home",171104159),cljs.core.PersistentArrayMap.EMPTY);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_page_name,logseq.common.util.page_name_sanity_lc(cljs.core.get.cljs$core$IFn$_invoke$arity$3(home_104554,new cljs.core.Keyword(null,"page","page",849072397),"")))){
frontend.handler.config.set_config_BANG_(new cljs.core.Keyword(null,"default-home","default-home",171104159),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(home_104554,new cljs.core.Keyword(null,"page","page",849072397),new_name));
} else {
}
