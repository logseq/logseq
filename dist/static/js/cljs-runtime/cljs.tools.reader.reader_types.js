...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41603 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41603(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41607 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41607(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41613 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41613(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41614 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41614(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41616 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41616(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41617 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41617(reader);
}
});
...
var G__41678 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41679 = s.append(c);
c = G__41678;
s = G__41679;
continue;
}
