...
var len__5726__auto___100899 = arguments.length;
var i__5727__auto___100900 = (0);
while(true){
if((i__5727__auto___100900 < len__5726__auto___100899)){
args__5732__auto__.push((arguments[i__5727__auto___100900]));

var G__100901 = (i__5727__auto___100900 + (1));
i__5727__auto___100900 = G__100901;
continue;
} else {
}
break;
...
(frontend.fs.get_fs.cljs$core$IFn$_invoke$arity$variadic = (function (dir,p__100847){
var map__100848 = p__100847;
var map__100848__$1 = cljs.core.__destructure_map(map__100848);
var repo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100848__$1,new cljs.core.Keyword(null,"repo","repo",-1999060679));
var rpath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100848__$1,new cljs.core.Keyword(null,"rpath","rpath",1489437835));
...
/** @this {Function} */
(frontend.fs.get_fs.cljs$lang$applyTo = (function (seq100845){
var G__100846 = cljs.core.first(seq100845);
var seq100845__$1 = cljs.core.next(seq100845);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__100846,seq100845__$1);
}));
...
var args__5732__auto__ = [];
var len__5726__auto___100902 = arguments.length;
var i__5727__auto___100903 = (0);
while(true){
if((i__5727__auto___100903 < len__5726__auto___100902)){
args__5732__auto__.push((arguments[i__5727__auto___100903]));

var G__100904 = (i__5727__auto___100903 + (1));
i__5727__auto___100903 = G__100904;
continue;
} else {
}
break;
...
(frontend.fs.readdir.cljs$core$IFn$_invoke$arity$variadic = (function (dir,p__100868){
var map__100869 = p__100868;
var map__100869__$1 = cljs.core.__destructure_map(map__100869);
var path_only_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100869__$1,new cljs.core.Keyword(null,"path-only?","path-only?",-825545027));
...
/** @this {Function} */
(frontend.fs.readdir.cljs$lang$applyTo = (function (seq100865){
var G__100866 = cljs.core.first(seq100865);
var seq100865__$1 = cljs.core.next(seq100865);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__100866,seq100865__$1);
}));
...
var G__100883 = arguments.length;
switch (G__100883) {
case 1:
...
var vec__100885 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100884_SHARP_){
if(cljs.core.truth_(frontend.util.electron_QMARK_())){
return p1__100884_SHARP_;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(frontend.config.get_repo_dir(repo)),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__100884_SHARP_)].join('');
}
}),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [old_path,new_path], null));
var old_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100885,(0),null);
var new_path__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100885,(1),null);
...
return promesa.protocols._promise((cljs.core.truth_(result)?(function (){var map__100888 = result;
var map__100888__$1 = cljs.core.__destructure_map(map__100888);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100888__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var files = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100888__$1,new cljs.core.Keyword(null,"files","files",-472457450));
var dir__$1 = path;
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("frontend.fs","get-files","frontend.fs/get-files",52623820),cljs.core.count(files),"files"], 0))),(function (___41611__auto__){
...
var G__100890 = arguments.length;
switch (G__100890) {
case 1:
...
var G__100892 = arguments.length;
switch (G__100892) {
case 3:
...
var G__100895 = arguments.length;
switch (G__100895) {
case 1:
