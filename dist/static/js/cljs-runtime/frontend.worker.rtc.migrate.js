...
var sorted_schema_version__GT_updates = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__187139){
var vec__187140 = p__187139;
var schema_version = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187140,(0),null);
var updates = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187140,(1),null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p__187143){
var vec__187147 = p__187143;
var schema_version = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187147,(0),null);
var _updates = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187147,(1),null);
return (!((logseq.db.frontend.schema.compare_schema_version(client_schema_version,schema_version) < (0))));
}),cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p__187155){
var vec__187156 = p__187155;
var schema_version = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187156,(0),null);
var _updates = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__187156,(1),null);
...
var temp__5804__auto__ = cljs.core.not_empty((function (){var G__187167 = frontend.worker.rtc.migrate.server_client_schema_version__GT_migrations(server_schema_version,client_schema_version);
if((G__187167 == null)){
return null;
} else {
return frontend.worker.rtc.migrate.migration_updates__GT_client_ops(db,client_schema_version,G__187167);
}
})());
