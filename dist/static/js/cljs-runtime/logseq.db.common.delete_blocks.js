...
var G__154526 = ref_raw_title;
var G__154526__$1 = (((G__154526 == null))?null:clojure.string.replace(G__154526,cljs.core.re_pattern(logseq.common.util.format.cljs$core$IFn$_invoke$arity$variadic("(?i){{embed \\(\\(%s\\)\\)\\s?}}",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block))], 0))),block_content));
var G__154526__$2 = (((G__154526__$1 == null))?null:clojure.string.replace(G__154526__$1,logseq.common.util.block_ref.__GT_block_ref(cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block))),block_content));
if((G__154526__$2 == null)){
return null;
} else {
return clojure.string.replace(G__154526__$2,logseq.common.util.page_ref.__GT_page_ref(cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("block","uuid","block/uuid",-1991494552).cljs$core$IFn$_invoke$arity$1(block))),block_content);
}
});
...
var tx = (function (){var G__154535 = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (block){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__154535,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),id,new cljs.core.Keyword("block","title","block/title",710445684),replaced_title], null));
} else {
return G__154535;
}
})();
...
var retracted_blocks = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__154537_SHARP_){
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(db,p1__154537_SHARP_) : datascript.core.entity.call(null,db,p1__154537_SHARP_));
}),retracted_block_ids);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p1__154538_SHARP_){
if((cljs.core.count(new cljs.core.Keyword("block","_macros","block/_macros",1753994265).cljs$core$IFn$_invoke$arity$1((function (){var G__154555 = db;
var G__154556 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__154538_SHARP_);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__154555,G__154556) : datascript.core.entity.call(null,G__154555,G__154556));
})())) <= (1))){
if(cljs.core.truth_(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__154538_SHARP_))){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword("db.fn","retractEntity","db.fn/retractEntity",-1423535441),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__154538_SHARP_)],null));
} else {
return null;
}
} else {
