...
var self__ = this;
var self__ = this;
var G__43957 = (arguments.length - (1));
switch (G__43957) {
case (0):
...
(missionary.impl.Sleep.Process.prototype.apply = (function (self__,args43949){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args43949)));
}));
...
var G__43972 = (new missionary.Cancelled("Sleep cancelled."));
var fexpr__43971 = s.failure;
