...
var G__100039 = content;
var G__100040 = config;
var G__100041 = (function (){var or__5002__auto__ = references;
...
return (frontend.format.mldoc.parseAndExportMarkdown.cljs$core$IFn$_invoke$arity$3 ? frontend.format.mldoc.parseAndExportMarkdown.cljs$core$IFn$_invoke$arity$3(G__100039,G__100040,G__100041) : frontend.format.mldoc.parseAndExportMarkdown.call(null,G__100039,G__100040,G__100041));
});
frontend.format.mldoc.parse_export_opml = (function frontend$format$mldoc$parse_export_opml(content,config,title,references){
var G__100043 = content;
var G__100044 = config;
var G__100045 = title;
var G__100046 = (function (){var or__5002__auto__ = references;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return logseq.graph_parser.mldoc.default_references;
...
return (frontend.format.mldoc.parseAndExportOPML.cljs$core$IFn$_invoke$arity$4 ? frontend.format.mldoc.parseAndExportOPML.cljs$core$IFn$_invoke$arity$4(G__100043,G__100044,G__100045,G__100046) : frontend.format.mldoc.parseAndExportOPML.call(null,G__100043,G__100044,G__100045,G__100046));
});
...
var vec__100051 = logseq.common.util.json__GT_clj(frontend.format.mldoc.parse_opml(content));
var headers = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100051,(0),null);
var blocks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100051,(1),null);
...
(frontend.format.mldoc.MldocMode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k100060,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__100079 = k100060;
switch (G__100079) {
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k100060,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__100082){
var vec__100084 = p__100082;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100084,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100084,(1),null);
...
(frontend.format.mldoc.MldocMode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__100059){
var self__ = this;
var G__100059__$1 = this;
return (new cljs.core.RecordIter((0),G__100059__$1,0,cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.format.mldoc.MldocMode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this100061,other100062){
var self__ = this;
var this100061__$1 = this;
return (((!((other100062 == null)))) && ((((this100061__$1.constructor === other100062.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this100061__$1.__extmap,other100062.__extmap)))));
}));
...
(frontend.format.mldoc.MldocMode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k100060){
var self__ = this;
var this__5307__auto____$1 = this;
return cljs.core.contains_QMARK_(self__.__extmap,k100060);
}));

(frontend.format.mldoc.MldocMode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__100059){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__100114 = cljs.core.keyword_identical_QMARK_;
var expr__100115 = k__5309__auto__;
return (new frontend.format.mldoc.MldocMode(self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__100059),null));
}));
...
(frontend.format.mldoc.MldocMode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__100059){
var self__ = this;
var this__5299__auto____$1 = this;
return (new frontend.format.mldoc.MldocMode(G__100059,self__.__extmap,self__.__hash));
}));
 ...
 */
frontend.format.mldoc.map__GT_MldocMode = (function frontend$format$mldoc$map__GT_MldocMode(G__100068){
var extmap__5342__auto__ = (function (){var G__100123 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__100068);
if(cljs.core.record_QMARK_(G__100068)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__100123);
} else {
return G__100123;
}
})();
