...
var G__100318 = cljs.core.re_pattern(["(?i)\\.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fmt),"(?:\\?([^#]*))?(?:#(.*))?$"].join(''));
var G__100319 = s;
return (frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2 ? frontend.util.safe_re_find.cljs$core$IFn$_invoke$arity$2(G__100318,G__100319) : frontend.util.safe_re_find.call(null,G__100318,G__100319));
}),media_formats);
});
 ...
 */
frontend.util.text.get_string_all_indexes = (function frontend$util$text$get_string_all_indexes(s,value,p__100320){
var map__100321 = p__100320;
var map__100321__$1 = cljs.core.__destructure_map(map__100321);
var before_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__100321__$1,new cljs.core.Keyword(null,"before?","before?",765621039),true);
...
var G__100322 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,i__$1);
var G__100323 = (i__$1 + cljs.core.count(value));
acc = G__100322;
i = G__100323;
continue;
} else {
