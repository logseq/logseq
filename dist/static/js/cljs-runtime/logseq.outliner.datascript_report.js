...
var r = (function (){var G__63732 = db_after;
var G__63733 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__63734 = db_id;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__63732,G__63733,G__63734) : datascript.core.pull.call(null,G__63732,G__63733,G__63734));
})();
...
var G__63735 = db_before;
var G__63736 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__63737 = db_id;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__63735,G__63736,G__63737) : datascript.core.pull.call(null,G__63735,G__63736,G__63737));
} else {
return r;
}
});
 ...
 */
logseq.outliner.datascript_report.get_blocks_and_pages = (function logseq$outliner$datascript_report$get_blocks_and_pages(p__63740){
var map__63741 = p__63740;
var map__63741__$1 = cljs.core.__destructure_map(map__63741);
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63741__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63741__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
var tx_data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63741__$1,new cljs.core.Keyword(null,"tx-data","tx-data",934159761));
var tx_meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63741__$1,new cljs.core.Keyword(null,"tx-meta","tx-meta",1159283194));
...
var G__63742 = acc;
var G__63742__$1 = (((!((block_entity == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__63742,new cljs.core.Keyword(null,"blocks","blocks",-610462153),cljs.core.conj,block_entity):G__63742);
if((!((page_entity == null)))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__63742__$1,new cljs.core.Keyword(null,"pages","pages",-285406513),cljs.core.conj,page_entity);
} else {
return G__63742__$1;
}
...
var tx_meta_pages = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63739_SHARP_){
return logseq.outliner.datascript_report.get_entity_from_db_after_or_before(db_before,db_after,p1__63739_SHARP_);
