...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__101537_SHARP_){
return frontend.handler.file_based.file.load_file(repo_url,p1__101537_SHARP_);
}),paths));
});
...
var file_contents = (function (){var G__101538 = cljs.core.zipmap(files__$1,contents);
if(cljs.core.seq(images)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__101538,cljs.core.zipmap(images,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(cljs.core.count(images),""))], 0));
} else {
return G__101538;
}
})();
var file_contents__$1 = (function (){var iter__5480__auto__ = (function frontend$handler$file_based$file$load_files_contents_BANG__$_iter__101539(s__101540){
return (new cljs.core.LazySeq(null,(function (){
var s__101540__$1 = s__101540;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__101540__$1);
if(temp__5804__auto__){
var s__101540__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__101540__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__101540__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__101542 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__101541 = (0);
while(true){
if((i__101541 < size__5479__auto__)){
var vec__101543 = cljs.core._nth(c__5478__auto__,i__101541);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101543,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101543,(1),null);
cljs.core.chunk_append(b__101542,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("file","path","file/path",-191335748),logseq.common.util.path_normalize(file),new cljs.core.Keyword("file","content","file/content",12680964),content], null));

var G__101567 = (i__101541 + (1));
i__101541 = G__101567;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__101542),frontend$handler$file_based$file$load_files_contents_BANG__$_iter__101539(cljs.core.chunk_rest(s__101540__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__101542),null);
}
} else {
var vec__101546 = cljs.core.first(s__101540__$2);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101546,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101546,(1),null);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("file","path","file/path",-191335748),logseq.common.util.path_normalize(file),new cljs.core.Keyword("file","content","file/content",12680964),content], null),frontend$handler$file_based$file$load_files_contents_BANG__$_iter__101539(cljs.core.rest(s__101540__$2)));
}
} else {
return null;
}
 ...
 */
frontend.handler.file_based.file.alter_global_file = (function frontend$handler$file_based$file$alter_global_file(path,content,p__101549){
var map__101550 = p__101549;
var map__101550__$1 = cljs.core.__destructure_map(map__101550);
var from_disk_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101550__$1,new cljs.core.Keyword(null,"from-disk?","from-disk?",-1991074161));
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.global_config.restore_global_config_BANG_()),(function (___41611__auto__){
 ...
 */
frontend.handler.file_based.file.alter_file = (function frontend$handler$file_based$file$alter_file(repo,path,content,p__101551){
var map__101552 = p__101551;
var map__101552__$1 = cljs.core.__destructure_map(map__101552);
var mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101552__$1,new cljs.core.Keyword(null,"mtime","mtime",963165087));
var skip_compare_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101552__$1,new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960),false);
var reset_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101552__$1,new cljs.core.Keyword(null,"reset?","reset?",-1051875415),true);
var re_render_root_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101552__$1,new cljs.core.Keyword(null,"re-render-root?","re-render-root?",-1452609623),false);
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101552__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060));
var from_disk_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101552__$1,new cljs.core.Keyword(null,"from-disk?","from-disk?",-1991074161),false);
var new_graph_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101552__$1,new cljs.core.Keyword(null,"new-graph?","new-graph?",-843567695));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101552__$1,new cljs.core.Keyword("fs","event","fs/event",301434435));
var ctime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101552__$1,new cljs.core.Keyword(null,"ctime","ctime",1459030131));
...
return promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(reset_QMARK_)?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41621__auto__){
...
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(re_render_root_QMARK_)?frontend.handler.ui.re_render_root_BANG_.cljs$core$IFn$_invoke$arity$0():null)),(function (___41611__auto__){
...
:((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path__$1,"logseq/config.edn"))?promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto____$1){
 ...
 */
frontend.handler.file_based.file.alter_file_test_version = (function frontend$handler$file_based$file$alter_file_test_version(repo,path,content,p__101553){
var map__101554 = p__101553;
var map__101554__$1 = cljs.core.__destructure_map(map__101554);
var reset_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101554__$1,new cljs.core.Keyword(null,"reset?","reset?",-1051875415),true);
var from_disk_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101554__$1,new cljs.core.Keyword(null,"from-disk?","from-disk?",-1991074161),false);
var new_graph_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101554__$1,new cljs.core.Keyword(null,"new-graph?","new-graph?",-843567695));
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101554__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060));
var ctime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101554__$1,new cljs.core.Keyword(null,"ctime","ctime",1459030131));
var mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101554__$1,new cljs.core.Keyword(null,"mtime","mtime",963165087));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101554__$1,new cljs.core.Keyword("fs","event","fs/event",301434435));
var path__$1 = logseq.common.util.path_normalize(path);
var config_file_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(path__$1,"logseq/config.edn");
var _ = ((config_file_QMARK_)?frontend.handler.file_based.file.detect_deprecations(path__$1,content):null);
var config_valid_QMARK_ = ((config_file_QMARK_) && (frontend.handler.file_based.file.validate_file(path__$1,content)));
...
var temp__5804__auto___101568 = frontend.db.file_based.model.get_file_page_id(path__$1);
if(cljs.core.truth_(temp__5804__auto___101568)){
var page_id_101569 = temp__5804__auto___101568;
frontend.db.transact_BANG_.cljs$core$IFn$_invoke$arity$3(repo,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),page_id_101569,new cljs.core.Keyword("block","alias","block/alias",-2112644699)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),page_id_101569,new cljs.core.Keyword("block","tags","block/tags",1814948340)], null)], null),opts);
} else {
}
...
frontend.handler.file_based.file.alter_files_handler_BANG_ = (function frontend$handler$file_based$file$alter_files_handler_BANG_(repo,files,p__101555,file__GT_content){
var map__101556 = p__101555;
var map__101556__$1 = cljs.core.__destructure_map(map__101556);
var finish_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101556__$1,new cljs.core.Keyword(null,"finish-handler","finish-handler",770511735));
var write_file_f = (function (p__101557){
var vec__101558 = p__101557;
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101558,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101558,(1),null);
...
frontend.handler.file_based.file.alter_files = (function frontend$handler$file_based$file$alter_files(repo,files,p__101561){
var map__101562 = p__101561;
var map__101562__$1 = cljs.core.__destructure_map(map__101562);
var opts = map__101562__$1;
var reset_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101562__$1,new cljs.core.Keyword(null,"reset?","reset?",-1051875415),false);
var update_db_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101562__$1,new cljs.core.Keyword(null,"update-db?","update-db?",-1641846808),true);
...
promesa.core.all(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__101563){
var vec__101564 = p__101563;
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101564,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101564,(1),null);
