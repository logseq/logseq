...
var G__56285 = db;
var G__56286 = e;
var G__56287 = cljs.core.volatile_BANG_(false);
var G__56288 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__56285,G__56286,G__56287,G__56288) : datascript.impl.entity.__GT_Entity.call(null,G__56285,G__56286,G__56287,G__56288));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56290_SHARP_,p2__56291_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__56290_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__56291_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56292_SHARP_,p2__56293_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__56292_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__56293_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56299_SHARP_,p2__56300_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__56299_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__56300_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5480__auto__ = (function datascript$impl$entity$js_seq_$_iter__56324(s__56325){
return (new cljs.core.LazySeq(null,(function (){
var s__56325__$1 = s__56325;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__56325__$1);
if(temp__5804__auto__){
var s__56325__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56325__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__56325__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__56327 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__56326 = (0);
while(true){
if((i__56326 < size__5479__auto__)){
var vec__56331 = cljs.core._nth(c__5478__auto__,i__56326);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56331,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56331,(1),null);
cljs.core.chunk_append(b__56327,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__56546 = (i__56326 + (1));
i__56326 = G__56546;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56327),datascript$impl$entity$js_seq_$_iter__56324(cljs.core.chunk_rest(s__56325__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56327),null);
}
} else {
var vec__56338 = cljs.core.first(s__56325__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56338,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56338,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__56324(cljs.core.rest(s__56325__$2)));
}
} else {
return null;
}
...
var G__56547 = null;
var G__56547__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__56364 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__56365 = null;
var count__56366 = (0);
var i__56367 = (0);
while(true){
if((i__56367 < count__56366)){
var vec__56392 = chunk__56365.cljs$core$IIndexed$_nth$arity$2(null,i__56367);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56392,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56392,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__56548 = seq__56364;
var G__56549 = chunk__56365;
var G__56550 = count__56366;
var G__56551 = (i__56367 + (1));
seq__56364 = G__56548;
chunk__56365 = G__56549;
count__56366 = G__56550;
i__56367 = G__56551;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__56364);
if(temp__5804__auto__){
var seq__56364__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__56364__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__56364__$1);
var G__56552 = cljs.core.chunk_rest(seq__56364__$1);
var G__56553 = c__5525__auto__;
var G__56554 = cljs.core.count(c__5525__auto__);
var G__56555 = (0);
seq__56364 = G__56552;
chunk__56365 = G__56553;
count__56366 = G__56554;
i__56367 = G__56555;
continue;
} else {
var vec__56401 = cljs.core.first(seq__56364__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56401,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56401,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__56556 = cljs.core.next(seq__56364__$1);
var G__56557 = null;
var G__56558 = (0);
var G__56559 = (0);
seq__56364 = G__56556;
chunk__56365 = G__56557;
count__56366 = G__56558;
i__56367 = G__56559;
continue;
}
} else {
...
var G__56547__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__56405 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__56406 = null;
var count__56407 = (0);
var i__56408 = (0);
while(true){
if((i__56408 < count__56407)){
var vec__56423 = chunk__56406.cljs$core$IIndexed$_nth$arity$2(null,i__56408);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56423,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56423,(1),null);
f.call(use_as_this,v,a,this$);


var G__56565 = seq__56405;
var G__56566 = chunk__56406;
var G__56567 = count__56407;
var G__56568 = (i__56408 + (1));
seq__56405 = G__56565;
chunk__56406 = G__56566;
count__56407 = G__56567;
i__56408 = G__56568;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__56405);
if(temp__5804__auto__){
var seq__56405__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__56405__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__56405__$1);
var G__56573 = cljs.core.chunk_rest(seq__56405__$1);
var G__56574 = c__5525__auto__;
var G__56575 = cljs.core.count(c__5525__auto__);
var G__56576 = (0);
seq__56405 = G__56573;
chunk__56406 = G__56574;
count__56407 = G__56575;
i__56408 = G__56576;
continue;
} else {
var vec__56430 = cljs.core.first(seq__56405__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56430,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56430,(1),null);
f.call(use_as_this,v,a,this$);


var G__56577 = cljs.core.next(seq__56405__$1);
var G__56578 = null;
var G__56579 = (0);
var G__56580 = (0);
seq__56405 = G__56577;
chunk__56406 = G__56578;
count__56407 = G__56579;
i__56408 = G__56580;
continue;
}
} else {
...
G__56547 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__56547__1.call(this,f);
case 2:
return G__56547__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__56547.cljs$core$IFn$_invoke$arity$1 = G__56547__1;
G__56547.cljs$core$IFn$_invoke$arity$2 = G__56547__2;
return G__56547;
})()
);
...
var G__56433 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__56433);
} else {
return G__56433;
}
}
...
var self__ = this;
var self__ = this;
var G__56469 = (arguments.length - (1));
switch (G__56469) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args56355){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56355)));
}));
...
var temp__5806__auto__ = (function (){var fexpr__56502 = cljs.core.deref(this$.cache);
return (fexpr__56502.cljs$core$IFn$_invoke$arity$1 ? fexpr__56502.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__56502.call(null,attr));
})();
...
var temp__5804__auto___56611 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5804__auto___56611)){
var datoms_56612 = temp__5804__auto___56611;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_56612)));
