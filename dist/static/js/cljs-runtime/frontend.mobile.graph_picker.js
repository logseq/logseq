...
frontend.mobile.graph_picker.toggle_item = rum.core.lazy_build(rum.core.build_defc,(function (p__128172){
var map__128173 = p__128172;
var map__128173__$1 = cljs.core.__destructure_map(map__128173);
var on_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128173__$1,new cljs.core.Keyword(null,"on?","on?",-74017086));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128173__$1,new cljs.core.Keyword(null,"title","title",636505583));
var on_toggle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128173__$1,new cljs.core.Keyword(null,"on-toggle","on-toggle",-695538774));
...
return null;
}),true)], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class","class",-2030961996),["toggle-item ",(cljs.core.truth_(on_QMARK_)?"is-on":null)].join(''),new cljs.core.Keyword(null,"intent","intent",-390846953),"logseq",new cljs.core.Keyword(null,"on-pointer-down","on-pointer-down",573334138),(function (p1__128170_SHARP_){
return frontend.util.stop(p1__128170_SHARP_);
}),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
if(cljs.core.fn_QMARK_(on_toggle)){
var G__128175 = cljs.core.not(on_QMARK_);
return (on_toggle.cljs$core$IFn$_invoke$arity$1 ? on_toggle.cljs$core$IFn$_invoke$arity$1(G__128175) : on_toggle.call(null,G__128175));
} else {
return null;
}
})], 0)));
}),null,"frontend.mobile.graph-picker/toggle-item");
frontend.mobile.graph_picker.graph_picker_cp = rum.core.lazy_build(rum.core.build_defc,(function (p__128178){
var map__128179 = p__128178;
var map__128179__$1 = cljs.core.__destructure_map(map__128179);
var opts = map__128179__$1;
var onboarding_and_home_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128179__$1,new cljs.core.Keyword(null,"onboarding-and-home?","onboarding-and-home?",2124338635));
var logged_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128179__$1,new cljs.core.Keyword(null,"logged?","logged?",-814149905));
var native_icloud_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__128179__$1,new cljs.core.Keyword(null,"native-icloud?","native-icloud?",-1892335688));
...
var vec__128180 = rum.core.use_state(new cljs.core.Keyword(null,"init","init",-1875481434));
var step = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128180,(0),null);
var set_step_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128180,(1),null);
var vec__128183 = rum.core.use_state((cljs.core.truth_(can_logseq_sync_QMARK_)?new cljs.core.Keyword(null,"logseq-sync","logseq-sync",-1666232809):(cljs.core.truth_(native_icloud_QMARK_)?new cljs.core.Keyword(null,"icloud-sync","icloud-sync",-1926574907):null)));
var sync_mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128183,(0),null);
var set_sync_mode_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128183,(1),null);
...
return daiquiri.core.create_element("div",{'className':daiquiri.util.join_classes(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["cp__graph-picker","w-full",(cljs.core.truth_(onboarding_and_home_QMARK_)?frontend.util.hiccup__GT_class("px-10.py-10"):null)], null))},[(cljs.core.truth_(onboarding_and_home_QMARK_)?null:daiquiri.core.create_element("h1",{'className':"flex items-center"},[(function (){var attrs128193 = frontend.components.svg.logo.cljs$core$IFn$_invoke$arity$0();
return daiquiri.core.create_element("span",((cljs.core.map_QMARK_(attrs128193))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["scale-75"], null)], null),attrs128193], 0))):{'className':"scale-75"}),((cljs.core.map_QMARK_(attrs128193))?null:[daiquiri.interpreter.interpret(attrs128193)]));
})(),daiquiri.core.create_element("span",{'className':"pl-1"},["Set up a graph"])])),(function (){var G__128196 = step;
var G__128196__$1 = (((G__128196 instanceof cljs.core.Keyword))?G__128196.fqn:null);
switch (G__128196__$1) {
case "init":
var attrs128192 = frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.flex.items-center.justify-between.w-full.py-1","span.flex.items-center.justify-between.w-full.py-1",-303126278),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),"Create a new graph"], null),frontend.ui.icon("chevron-right")], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs128192))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-col","w-full","space-y-6"], null)], null),attrs128192], 0))):{'className':"flex flex-col w-full space-y-6"}),((cljs.core.map_QMARK_(attrs128192))?[daiquiri.interpreter.interpret(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.flex.items-center.justify-between.w-full.py-1","span.flex.items-center.justify-between.w-full.py-1",-303126278),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),"Select an existing graph"], null),frontend.ui.icon("folder-plus")], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"intent","intent",-390846953),"logseq",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], 0)))]:[daiquiri.interpreter.interpret(attrs128192),daiquiri.interpreter.interpret(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.flex.items-center.justify-between.w-full.py-1","span.flex.items-center.justify-between.w-full.py-1",-303126278),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),"Select an existing graph"], null),frontend.ui.icon("folder-plus")], null),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"intent","intent",-390846953),"logseq",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
(logseq.shui.ui.dialog_close_BANG_.cljs$core$IFn$_invoke$arity$0 ? logseq.shui.ui.dialog_close_BANG_.cljs$core$IFn$_invoke$arity$0() : logseq.shui.ui.dialog_close_BANG_.call(null));
...
break;
case "new-graph":
return daiquiri.core.create_element("div",{'className':"flex flex-col w-full space-y-3 faster fade-in"},[daiquiri.core.create_element("input",{'autoFocus':true,'ref':_STAR_input_ref,'placeholder':"What's the graph name?",'className':"form-input block"},[]),(function (){var attrs128212 = (cljs.core.truth_(can_logseq_sync_QMARK_)?frontend.mobile.graph_picker.toggle_item(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"Logseq sync",new cljs.core.Keyword(null,"on?","on?",-74017086),logseq_sync_on_QMARK_,new cljs.core.Keyword(null,"on-toggle","on-toggle",-695538774),(function (p1__128176_SHARP_){
var G__128214 = (cljs.core.truth_(p1__128176_SHARP_)?new cljs.core.Keyword(null,"logseq-sync","logseq-sync",-1666232809):(cljs.core.truth_(native_icloud_QMARK_)?new cljs.core.Keyword(null,"icloud-sync","icloud-sync",-1926574907):null));
return (set_sync_mode_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_sync_mode_BANG_.cljs$core$IFn$_invoke$arity$1(G__128214) : set_sync_mode_BANG_.call(null,G__128214));
})], null)):null);
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs128212))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","flex-col"], null)], null),attrs128212], 0))):{'className':"flex flex-col"}),((cljs.core.map_QMARK_(attrs128212))?[(cljs.core.truth_((function (){var and__5000__auto__ = native_icloud_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
return (!(logseq_sync_on_QMARK_));
} else {
return and__5000__auto__;
}
})())?frontend.mobile.graph_picker.toggle_item(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),"iCloud sync",new cljs.core.Keyword(null,"on?","on?",-74017086),icloud_sync_on_QMARK_,new cljs.core.Keyword(null,"on-toggle","on-toggle",-695538774),(function (p1__128177_SHARP_){
var G__128216 = (cljs.core.truth_(p1__128177_SHARP_)?new cljs.core.Keyword(null,"icloud-sync","icloud-sync",-1926574907):null);
return (set_sync_mode_BANG_.cljs$core$IFn$_invoke$arity$1 ? set_sync_mode_BANG_.cljs$core$IFn$_invoke$arity$1(G__128216) : set_sync_mode_BANG_.call(null,G__128216));
})], null)):null)]:[daiquiri.interpreter.interpret(attrs128212),(cljs.core.truth_((function (){var and__5000__auto__ = native_icloud_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
return (!(logseq_sync_on_QMARK_));
} else {
return and__5000__auto__;
...
return daiquiri.core.create_element("div",((cljs.core.map_QMARK_(attrs128213))?daiquiri.interpreter.element_attributes(daiquiri.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["flex","justify-between","items-center","pt-2"], null)], null),attrs128213], 0))):{'className':"flex justify-between items-center pt-2"}),((cljs.core.map_QMARK_(attrs128213))?[daiquiri.interpreter.interpret(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Create",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
})], 0)))]:[daiquiri.interpreter.interpret(attrs128213),daiquiri.interpreter.interpret(frontend.ui.button.cljs$core$IFn$_invoke$arity$variadic("Create",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var val = frontend.util.trim_safe(rum.core.deref(_STAR_input_ref).value);
if(clojure.string.blank_QMARK_(val)){
return rum.core.deref(_STAR_input_ref).focus();
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__128196__$1)].join('')));
