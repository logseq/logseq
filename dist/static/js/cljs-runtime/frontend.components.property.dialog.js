...
var temp__5804__auto___126291 = new cljs.core.Keyword(null,"selected-blocks","selected-blocks",-96882948).cljs$core$IFn$_invoke$arity$1(opts);
if(cljs.core.truth_(temp__5804__auto___126291)){
var view_selected_blocks_126293 = temp__5804__auto___126291;
frontend.state.set_state_BANG_(new cljs.core.Keyword("view","selected-blocks","view/selected-blocks",-92053027),view_selected_blocks_126293);
} else {
}
...
var temp__5804__auto___126294 = new cljs.core.Keyword(null,"on-dialog-close","on-dialog-close",-900873769).cljs$core$IFn$_invoke$arity$1(cljs.core.last(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state)));
if(cljs.core.truth_(temp__5804__auto___126294)){
var close_fn_126295 = temp__5804__auto___126294;
(close_fn_126295.cljs$core$IFn$_invoke$arity$0 ? close_fn_126295.cljs$core$IFn$_invoke$arity$0() : close_fn_126295.call(null));
} else {
}
