...
logseq.graph_parser.text.get_ref_from_ast = (function logseq$graph_parser$text$get_ref_from_ast(p__63393){
var vec__63394 = p__63393;
var typ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63394,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63394,(1),null);
var G__63397 = typ;
switch (G__63397) {
case "Link":
var G__63398 = cljs.core.first(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(data));
switch (G__63398) {
case "Page_ref":
...
var G__63402 = cljs.core.first(data);
return (logseq.graph_parser.text.get_ref_from_ast.cljs$core$IFn$_invoke$arity$1 ? logseq.graph_parser.text.get_ref_from_ast.cljs$core$IFn$_invoke$arity$1(G__63402) : logseq.graph_parser.text.get_ref_from_ast.call(null,G__63402));
}
...
var plains = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__63412_SHARP_){
return ((cljs.core.vector_QMARK_(p1__63412_SHARP_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("Plain",cljs.core.first(p1__63412_SHARP_))));
