...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.draw.create_draws_directory_BANG_(repo)),(function (___41611__auto__){
return promesa.protocols._mcat(promesa.protocols._promise(frontend.fs.write_plain_text_file_BANG_(repo,repo_dir,path,data,null)),(function (___41611__auto____$1){
