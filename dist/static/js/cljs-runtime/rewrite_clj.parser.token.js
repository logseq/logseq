...
var len__5726__auto___65806 = arguments.length;
var i__5727__auto___65807 = (0);
while(true){
if((i__5727__auto___65807 < len__5726__auto___65806)){
args__5732__auto__.push((arguments[i__5727__auto___65807]));

var G__65808 = (i__5727__auto___65807 + (1));
i__5727__auto___65807 = G__65808;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__65783){
var vec__65784 = p__65783;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65784,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__65769_SHARP_){
var and__5000__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__65769_SHARP_) : allowed_QMARK_.call(null,p1__65769_SHARP_)));
if(and__5000__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__65769_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq65771){
var G__65772 = cljs.core.first(seq65771);
var seq65771__$1 = cljs.core.next(seq65771);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65772,seq65771__$1);
}));
 ...
 */
rewrite_clj.parser.token.number_literal_QMARK_ = (function rewrite_clj$parser$token$number_literal_QMARK_(p__65798){
var vec__65799 = p__65798;
var c1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65799,(0),null);
var c2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65799,(1),null);
