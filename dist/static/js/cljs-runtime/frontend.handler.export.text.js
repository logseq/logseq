...
frontend.handler.export$.text.block_heading = (function frontend$handler$export$text$block_heading(p__103106){
var map__103107 = p__103106;
var map__103107__$1 = cljs.core.__destructure_map(map__103107);
var _meta = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"_meta","_meta",937543236));
var marker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"marker","marker",865118313));
var _anchor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"_anchor","_anchor",-1041309458));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"title","title",636505583));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"priority","priority",1431093715));
var _tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"_tags","_tags",58828915));
var _numbering = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"_numbering","_numbering",1825467892));
var _unordered = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103107__$1,new cljs.core.Keyword(null,"_unordered","_unordered",1249595382));
var indent_style = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"indent-style","indent-style",855468755)], null));
...
frontend.handler.export$.text.block_list_item = (function frontend$handler$export$text$block_list_item(p__103109){
var map__103110 = p__103109;
var map__103110__$1 = cljs.core.__destructure_map(map__103110);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103110__$1,new cljs.core.Keyword(null,"content","content",15833224));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103110__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var number = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103110__$1,new cljs.core.Keyword(null,"number","number",1570378438));
var _name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103110__$1,new cljs.core.Keyword(null,"_name","_name",-1979660747));
var checkbox = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103110__$1,new cljs.core.Keyword(null,"checkbox","checkbox",1612615655));
...
var len__5726__auto___103611 = arguments.length;
var i__5727__auto___103612 = (0);
while(true){
if((i__5727__auto___103612 < len__5726__auto___103611)){
args__5732__auto__.push((arguments[i__5727__auto___103612]));

var G__103613 = (i__5727__auto___103612 + (1));
i__5727__auto___103612 = G__103613;
continue;
} else {
}
break;
...
(frontend.handler.export$.text.block_list.cljs$core$IFn$_invoke$arity$variadic = (function (l,p__103135){
var map__103136 = p__103135;
var map__103136__$1 = cljs.core.__destructure_map(map__103136);
var in_list_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103136__$1,new cljs.core.Keyword(null,"in-list?","in-list?",-632658365));
var _STAR_state_STAR__orig_val__103145 = frontend.handler.export$.common._STAR_state_STAR_;
var _STAR_state_STAR__temp_val__103146 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"current-level","current-level",-11925890),cljs.core.inc);
(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__temp_val__103146);
...
}finally {(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__103145);
}}));

(frontend.handler.export$.text.block_list.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(frontend.handler.export$.text.block_list.cljs$lang$applyTo = (function (seq103121){
var G__103122 = cljs.core.first(seq103121);
var seq103121__$1 = cljs.core.next(seq103121);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__103122,seq103121__$1);
}));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__103210){
var vec__103215 = p__103210;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103215,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103215,(1),null);
...
frontend.handler.export$.text.block_src = (function frontend$handler$export$text$block_src(p__103227){
var map__103229 = p__103227;
var map__103229__$1 = cljs.core.__destructure_map(map__103229);
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103229__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var language = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103229__$1,new cljs.core.Keyword(null,"language","language",-1591107564));
var level = (cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"current-level","current-level",-11925890),(1)) - (1));
...
var level = (cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"current-level","current-level",-11925890),(1)) - (1));
var _STAR_state_STAR__orig_val__103234 = frontend.handler.export$.common._STAR_state_STAR_;
var _STAR_state_STAR__temp_val__103235 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"indent-after-break-line?","indent-after-break-line?",-736379041),true);
(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__temp_val__103235);
...
}finally {(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__103234);
}});
...
frontend.handler.export$.text.block_latex_env = (function frontend$handler$export$text$block_latex_env(p__103429){
var vec__103430 = p__103429;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103430,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103430,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103430,(2),null);
var level = (cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"current-level","current-level",-11925890),(1)) - (1));
...
frontend.handler.export$.text.block_drawer = (function frontend$handler$export$text$block_drawer(p__103439){
var vec__103440 = p__103439;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103440,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103440,(1),null);
...
frontend.handler.export$.text.block_footnote_definition = (function frontend$handler$export$text$block_footnote_definition(p__103452){
var vec__103454 = p__103452;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103454,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103454,(1),null);
...
frontend.handler.export$.text.block_table = (function frontend$handler$export$text$block_table(p__103458){
var map__103459 = p__103458;
var map__103459__$1 = cljs.core.__destructure_map(map__103459);
var header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103459__$1,new cljs.core.Keyword(null,"header","header",119441134));
var groups = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103459__$1,new cljs.core.Keyword(null,"groups","groups",-136896102));
var level = (cljs.core.get.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"current-level","current-level",-11925890),(1)) - (1));
...
frontend.handler.export$.text.inline_link = (function frontend$handler$export$text$inline_link(p__103474){
var map__103475 = p__103474;
var map__103475__$1 = cljs.core.__destructure_map(map__103475);
var full_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103475__$1,new cljs.core.Keyword(null,"full_text","full_text",1634289075));
...
frontend.handler.export$.text.inline_nested_link = (function frontend$handler$export$text$inline_nested_link(p__103478){
var map__103479 = p__103478;
var map__103479__$1 = cljs.core.__destructure_map(map__103479);
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103479__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
frontend.handler.export$.text.inline_footnote_reference = (function frontend$handler$export$text$inline_footnote_reference(p__103486){
var map__103487 = p__103486;
var map__103487__$1 = cljs.core.__destructure_map(map__103487);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103487__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var G__103488 = cljs.core.first(ast_content);
switch (G__103488) {
case "Absolute":
var vec__103489 = ast_content;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103489,(0),null);
var current = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103489,(1),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103489,(2),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__103488)].join('')));
...
var vec__103492 = ast_content;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103492,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103492,(1),null);
var wrapper = (function (){var G__103495 = type;
switch (G__103495) {
case "Inline":
return "$";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__103495)].join('')));
...
frontend.handler.export$.text.inline_macro = (function frontend$handler$export$text$inline_macro(p__103500){
var map__103501 = p__103500;
var map__103501__$1 = cljs.core.__destructure_map(map__103501);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103501__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var arguments$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103501__$1,new cljs.core.Keyword(null,"arguments","arguments",-1182834456));
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name,"cloze"))?clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",arguments$):(function (){var l = (function (){var G__103502 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["{{",name], null);
var G__103502__$1 = (((cljs.core.count(arguments$) > (0)))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(G__103502,"(",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",arguments$),")"], 0)):G__103502);
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__103502__$1,"}}");

})();
return clojure.string.join.cljs$core$IFn$_invoke$arity$1(l);
})())], 0))],null));
});
frontend.handler.export$.text.inline_entity = (function frontend$handler$export$text$inline_entity(p__103503){
var map__103504 = p__103503;
var map__103504__$1 = cljs.core.__destructure_map(map__103504);
var unicode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103504__$1,new cljs.core.Keyword(null,"unicode","unicode",-542572710));
...
var vec__103505 = ast_content;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103505,(0),null);
var timestamp_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103505,(1),null);
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[frontend.handler.export$.common.raw_text.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var G__103510 = type;
switch (G__103510) {
case "Scheduled":
...
break;
case "Range":
var map__103511 = timestamp_content;
var map__103511__$1 = cljs.core.__destructure_map(map__103511);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103511__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103511__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__103510)].join('')));

}
})())], 0))],null));
});
frontend.handler.export$.text.inline_email = (function frontend$handler$export$text$inline_email(p__103512){
var map__103513 = p__103512;
var map__103513__$1 = cljs.core.__destructure_map(map__103513);
var local_part = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103513__$1,new cljs.core.Keyword(null,"local_part","local_part",-1705904558));
var domain = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103513__$1,new cljs.core.Keyword(null,"domain","domain",1847214937));
...
var _STAR_state_STAR__orig_val__103517 = frontend.handler.export$.common._STAR_state_STAR_;
var _STAR_state_STAR__temp_val__103518 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"outside-em-symbol","outside-em-symbol",478063381),cljs.core.first(em_symbol));
(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__temp_val__103518);
...
}finally {(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__103517);
}});
frontend.handler.export$.text.inline_emphasis = (function frontend$handler$export$text$inline_emphasis(emphasis){
var vec__103519 = emphasis;
var vec__103522 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103519,(0),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103522,(0),null);
var inline_coll = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103519,(1),null);
...
break;
case "Underline":
var _STAR_state_STAR__orig_val__103527 = frontend.handler.export$.common._STAR_state_STAR_;
var _STAR_state_STAR__temp_val__103528 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.Keyword(null,"outside-em-symbol","outside-em-symbol",478063381),outside_em_symbol);
(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__temp_val__103528);
...
}finally {(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__103527);
}
break;
case "Strike_through":
...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,(function (){var vec__103531 = block;
var ast_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103531,(0),null);
var ast_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103531,(1),null);
var G__103534 = ast_type;
switch (G__103534) {
case "Paragraph":
var map__103535 = cljs.core.meta(block);
var map__103535__$1 = cljs.core.__destructure_map(map__103535);
var origin_ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103535__$1,new cljs.core.Keyword(null,"origin-ast","origin-ast",915928394));
...
var vec__103536 = last_element;
var last_element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103536,(0),null);
...
var vec__103541 = inline;
var ast_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103541,(0),null);
var ast_content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103541,(1),null);
var G__103545 = ast_type;
switch (G__103545) {
case "Emphasis":
...
(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__temp_val__103549);
...
var config_for_walk_block_ast = (function (){var G__103551 = cljs.core.PersistentArrayMap.EMPTY;
var G__103551__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-emphasis?","remove-emphasis?",-1751965539)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__103551,new cljs.core.Keyword(null,"mapcat-fns-on-inline-ast","mapcat-fns-on-inline-ast",-988900078),cljs.core.conj,frontend.handler.export$.common.remove_emphasis):G__103551);
var G__103551__$2 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-page-ref-brackets?","remove-page-ref-brackets?",-276534720)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__103551__$1,new cljs.core.Keyword(null,"map-fns-on-inline-ast","map-fns-on-inline-ast",-1834139513),cljs.core.conj,frontend.handler.export$.common.remove_page_ref_brackets):G__103551__$1);
var G__103551__$3 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"remove-tags?","remove-tags?",690905372)], null)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__103551__$2,new cljs.core.Keyword(null,"mapcat-fns-on-inline-ast","mapcat-fns-on-inline-ast",-988900078),cljs.core.conj,frontend.handler.export$.common.remove_tags):G__103551__$2);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("no-indent",cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frontend.handler.export$.common._STAR_state_STAR_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"export-options","export-options",672321679),new cljs.core.Keyword(null,"indent-style","indent-style",855468755)], null)))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__103551__$3,new cljs.core.Keyword(null,"fns-on-inline-coll","fns-on-inline-coll",-2007934714),cljs.core.conj,frontend.handler.export$.common.remove_prefix_spaces_in_Plain);
} else {
return G__103551__$3;
}
})();
...
}finally {(frontend.handler.export$.common._STAR_state_STAR_ = _STAR_state_STAR__orig_val__103548);
}});
/**
 * options:
...
var k__99485__auto__ = new cljs.core.Keyword(null,"export-blocks-as-markdown","export-blocks-as-markdown",-915039746);
console.time(k__99485__auto__);

var res__99486__auto__ = (function (){try{var content = (cljs.core.truth_((function (){var and__5000__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(root_block_uuids_or_page_uuid));
if(and__5000__auto__){
var G__103554 = (function (){var G__103555 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_uuid)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103555) : frontend.db.entity.call(null,G__103555));
})();
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(G__103554) : logseq.db.page_QMARK_.call(null,G__103554));
} else {
return and__5000__auto__;
}
})())?frontend.handler.export$.common.get_page_content(cljs.core.first(root_block_uuids_or_page_uuid)):((((cljs.core.coll_QMARK_(root_block_uuids_or_page_uuid)) && (cljs.core.every_QMARK_((function (p1__103552_SHARP_){
var G__103556 = (function (){var G__103557 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),p1__103552_SHARP_], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103557) : frontend.db.entity.call(null,G__103557));
})();
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(G__103556) : logseq.db.page_QMARK_.call(null,G__103556));
...
return new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1((function (){var G__103558 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103558) : frontend.db.entity.call(null,G__103558));
})());
...
if(and__5000__auto__){
var G__103559 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_uuid)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103559) : frontend.db.entity.call(null,G__103559));
} else {
return and__5000__auto__;
}
})();
...
if(and__5000__auto__){
var G__103562 = (function (){var G__103563 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_uuid)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103563) : frontend.db.entity.call(null,G__103563));
})();
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(G__103562) : logseq.db.page_QMARK_.call(null,G__103562));
} else {
return and__5000__auto__;
}
})())?frontend.handler.export$.common.get_page_content(cljs.core.first(root_block_uuids_or_page_uuid)):((((cljs.core.coll_QMARK_(root_block_uuids_or_page_uuid)) && (cljs.core.every_QMARK_((function (p1__103552_SHARP_){
var G__103564 = (function (){var G__103565 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),p1__103552_SHARP_], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103565) : frontend.db.entity.call(null,G__103565));
})();
return (logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1 ? logseq.db.page_QMARK_.cljs$core$IFn$_invoke$arity$1(G__103564) : logseq.db.page_QMARK_.call(null,G__103564));
}),root_block_uuids_or_page_uuid))))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (id){
return new cljs.core.Keyword("block","title","block/title",710445684).cljs$core$IFn$_invoke$arity$1((function (){var G__103566 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103566) : frontend.db.entity.call(null,G__103566));
})());
}),root_block_uuids_or_page_uuid)):frontend.handler.export$.common.root_block_uuids__GT_content(repo,root_block_uuids_or_page_uuid)
));
var first_block = (function (){var and__5000__auto__ = cljs.core.coll_QMARK_(root_block_uuids_or_page_uuid);
if(and__5000__auto__){
var G__103568 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),cljs.core.first(root_block_uuids_or_page_uuid)], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__103568) : frontend.db.entity.call(null,G__103568));
} else {
return and__5000__auto__;
}
})();
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__103574){
var map__103575 = p__103574;
var map__103575__$1 = cljs.core.__destructure_map(map__103575);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103575__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103575__$1,new cljs.core.Keyword(null,"title","title",636505583));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103575__$1,new cljs.core.Keyword(null,"content","content",15833224));
if(cljs.core.truth_(goog.DEBUG)){
var k__99485__auto__ = cljs.core.print_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"export-files-as-markdown","export-files-as-markdown",1418547627),title], 0));
console.time(k__99485__auto__);

var res__99486__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var or__5002__auto__ = path;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return title;
...
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(goog.DEBUG)?(function (){var k__99485__auto__ = new cljs.core.Keyword(null,"get-file-content","get-file-content",643543160);
console.time(k__99485__auto__);

var res__99486__auto__ = frontend.handler.export$.common._LT_get_file_contents(repo,"md");
console.timeEnd(k__99485__auto__);
