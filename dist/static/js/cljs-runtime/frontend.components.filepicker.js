...
frontend.components.filepicker.picker = rum.core.lazy_build(rum.core.build_defcs,(function (state,p__124716){
var map__124717 = p__124716;
var map__124717__$1 = cljs.core.__destructure_map(map__124717);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__124717__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var on_change_124720 = new cljs.core.Keyword(null,"on-change","on-change",-732046149).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state)));
var temp__5804__auto___124721 = goog.dom.getElement("filepicker");
if(cljs.core.truth_(temp__5804__auto___124721)){
var element_124722 = temp__5804__auto___124721;
cljs_drag_n_drop.core.subscribe_BANG_(element_124722,new cljs.core.Keyword(null,"upload-files","upload-files",-771877630),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"drop","drop",364481611),(function (e,files){
return (on_change_124720.cljs$core$IFn$_invoke$arity$2 ? on_change_124720.cljs$core$IFn$_invoke$arity$2(e,files) : on_change_124720.call(null,e,files));
})], null));
} else {
}
...
var temp__5804__auto___124723 = goog.dom.getElement("filepicker");
if(cljs.core.truth_(temp__5804__auto___124723)){
var el_124724 = temp__5804__auto___124723;
cljs_drag_n_drop.core.unsubscribe_BANG_(el_124724,new cljs.core.Keyword(null,"upload-files","upload-files",-771877630));
} else {
}
