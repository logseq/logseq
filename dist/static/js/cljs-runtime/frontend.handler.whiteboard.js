...
var shapes = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__105793_SHARP_){
return (new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__105793_SHARP_) == null);
...
var get_k = (function (p1__105794_SHARP_){
return frontend.handler.whiteboard.goog$module$goog$object.get(tldraw_page,p1__105794_SHARP_);
});
...
var get_k = (function (p1__105795_SHARP_){
return frontend.handler.whiteboard.goog$module$goog$object.get(tldraw_page,p1__105795_SHARP_);
});
...
var upsert_shapes = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__105798){
var map__105799 = p__105798;
var map__105799__$1 = cljs.core.__destructure_map(map__105799);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105799__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var created_shapes = cljs.core.set(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__105796_SHARP_){
var G__105800 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__105796_SHARP_);
return (created_ids.cljs$core$IFn$_invoke$arity$1 ? created_ids.cljs$core$IFn$_invoke$arity$1(G__105800) : created_ids.call(null,G__105800));
}),upsert_shapes));
...
}),(function (){var G__105801 = repo;
var G__105802 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__105803 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (id){
...
return (frontend.db.pull_many.cljs$core$IFn$_invoke$arity$3 ? frontend.db.pull_many.cljs$core$IFn$_invoke$arity$3(G__105801,G__105802,G__105803) : frontend.db.pull_many.call(null,G__105801,G__105802,G__105803));
})())):null);
...
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(logseq.db.sqlite.util.block_with_timestamps,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105797_SHARP_){
return frontend.handler.whiteboard.shape__GT_block(p1__105797_SHARP_,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page_entity));
}),upsert_shapes)));
...
return new cljs.core.Keyword("block","order","block/order",-1429282437).cljs$core$IFn$_invoke$arity$1((function (){var G__105805 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__105805) : frontend.db.entity.call(null,G__105805));
})());
} else {
return null;
}
...
if(cljs.core.truth_(temp__5804__auto__)){
var id = temp__5804__auto__;
return new cljs.core.Keyword("block","order","block/order",-1429282437).cljs$core$IFn$_invoke$arity$1((function (){var G__105806 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__105806) : frontend.db.entity.call(null,G__105806));
})());
} else {
return null;
}
...
if(cljs.core.truth_((function (){var G__105807 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id], null);
return (frontend.db.entity.cljs$core$IFn$_invoke$arity$1 ? frontend.db.entity.cljs$core$IFn$_invoke$arity$1(G__105807) : frontend.db.entity.call(null,G__105807));
})())){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),id,new cljs.core.Keyword("block","order","block/order",-1429282437),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(new_orders,idx)], null);
} else {
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__105804)].join('')));
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105808_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__105808_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.str);
...
var map__105812 = frontend.handler.whiteboard.compute_tx(app,tl_page,new_id_nonces,db_id_nonces,page_uuid,replace_QMARK_);
var map__105812__$1 = cljs.core.__destructure_map(map__105812);
var result = map__105812__$1;
var page_block__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"page-block","page-block",504302814));
var new_shapes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"new-shapes","new-shapes",1387380119));
var deleted_shapes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"deleted-shapes","deleted-shapes",-866326203));
var upserted_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"upserted-blocks","upserted-blocks",-1257152432));
var delete_blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"delete-blocks","delete-blocks",-1868631596));
var metadata = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105812__$1,new cljs.core.Keyword(null,"metadata","metadata",1799301597));
...
var metadata_SINGLEQUOTE_ = (cljs.core.truth_(cljs.core.some((function (p1__105809_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("group",new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__105809_SHARP_));
...
return cljs.core.every_QMARK_((function (p1__105810_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("group",new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__105810_SHARP_));
}),deleted_shapes);
} else {
return and__5000__auto__;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(metadata,new cljs.core.Keyword(null,"outliner-op","outliner-op",1716232450),new cljs.core.Keyword(null,"un-group","un-group",1594045164)):(cljs.core.truth_(cljs.core.some((function (p1__105811_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("line",new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__105811_SHARP_))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("arrow ",new cljs.core.Keyword(null,"end","end",-268185958).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"decorations","decorations",-1882398759).cljs$core$IFn$_invoke$arity$1(p1__105811_SHARP_)))));
...
var G__105814 = arguments.length;
switch (G__105814) {
case 0:
...
var len__5726__auto___105833 = arguments.length;
var i__5727__auto___105834 = (0);
while(true){
if((i__5727__auto___105834 < len__5726__auto___105833)){
args__5732__auto__.push((arguments[i__5727__auto___105834]));

var G__105835 = (i__5727__auto___105834 + (1));
i__5727__auto___105834 = G__105835;
continue;
} else {
}
break;
...
(frontend.handler.whiteboard.add_new_block_portal_shape_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (block_uuid,source_shape,p__105820){
var map__105821 = p__105820;
var map__105821__$1 = cljs.core.__destructure_map(map__105821);
var link_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105821__$1,new cljs.core.Keyword(null,"link?","link?",-1241171248));
var bottom_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105821__$1,new cljs.core.Keyword(null,"bottom?","bottom?",-1926481628));
...
/** @this {Function} */
(frontend.handler.whiteboard.add_new_block_portal_shape_BANG_.cljs$lang$applyTo = (function (seq105817){
var G__105818 = cljs.core.first(seq105817);
var seq105817__$1 = cljs.core.next(seq105817);
var G__105819 = cljs.core.first(seq105817__$1);
var seq105817__$2 = cljs.core.next(seq105817__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__105818,G__105819,seq105817__$2);
}));
...
var react_page = (function (){var G__105822 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1 ? frontend.db.sub_block.cljs$core$IFn$_invoke$arity$1(G__105822) : frontend.db.sub_block.call(null,G__105822));
})();
...
return promesa.protocols._mcat(promesa.protocols._promise((function (){var G__105823 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword("block","uuid","block/uuid",-1991494552),new_block_id,new cljs.core.Keyword("block","title","block/title",710445684),(function (){var or__5002__auto__ = content;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return "";
...
return (logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1 ? logseq.db.sqlite.util.block_with_timestamps.cljs$core$IFn$_invoke$arity$1(G__105823) : logseq.db.sqlite.util.block_with_timestamps.call(null,G__105823));
})()),(function (tx){
...
var G__105825 = arguments.length;
switch (G__105825) {
case 1:
...
(frontend.handler.whiteboard.clone_whiteboard_from_edn.cljs$core$IFn$_invoke$arity$2 = (function (p__105826,api){
var map__105827 = p__105826;
var map__105827__$1 = cljs.core.__destructure_map(map__105827);
var pages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105827__$1,new cljs.core.Keyword(null,"pages","pages",-285406513));
var blocks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105827__$1,new cljs.core.Keyword(null,"blocks","blocks",-610462153));
...
var shapes_index = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.str,new cljs.core.Keyword("block","uuid","block/uuid",-1991494552)),(function (){var G__105828 = new cljs.core.Keyword("block","_page","block/_page",1150043350).cljs$core$IFn$_invoke$arity$1(page);
return (frontend.db.sort_by_order.cljs$core$IFn$_invoke$arity$1 ? frontend.db.sort_by_order.cljs$core$IFn$_invoke$arity$1(G__105828) : frontend.db.sort_by_order.call(null,G__105828));
})());
...
return promesa.protocols._mcat(promesa.protocols._promise(frontend.handler.whiteboard.clone_whiteboard_from_edn.cljs$core$IFn$_invoke$arity$2(edn,api)),(function (___41611__auto__){
...
var shapes = tl_page.shapes;
return tl_page.cleanup(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__105829_SHARP_){
return p1__105829_SHARP_.id;
}),shapes));
});
