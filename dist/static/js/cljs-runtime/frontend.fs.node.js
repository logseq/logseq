...
frontend.fs.node.write_file_impl_BANG_ = (function frontend$fs$node$write_file_impl_BANG_(repo,dir,rpath,content,p__100782,stat){
var map__100783 = p__100782;
var map__100783__$1 = cljs.core.__destructure_map(map__100783);
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100783__$1,new cljs.core.Keyword(null,"ok-handler","ok-handler",-804644089));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100783__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var old_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100783__$1,new cljs.core.Keyword(null,"old-content","old-content",1851086779));
var skip_compare_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100783__$1,new cljs.core.Keyword(null,"skip-compare?","skip-compare?",82692960));
var skip_transact_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__100783__$1,new cljs.core.Keyword(null,"skip-transact?","skip-transact?",-1820887310));
...
return promesa.protocols._promise(promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41643__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise(electron.ipc.ipc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["writeFile",repo,file_fpath,content], 0))),(function (result){
...
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(contents_matched_QMARK_)?null:electron.ipc.ipc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["backupDbFile",frontend.config.get_local_dir(repo),rpath,disk_content__$1,content], 0)))),(function (___41611__auto__){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(skip_transact_QMARK_)?null:frontend.db.set_file_last_modified_at_BANG_(repo,rpath,mtime))),(function (___41611__auto____$1){
return promesa.protocols._mcat(promesa.protocols._promise((cljs.core.truth_(ok_handler)?(ok_handler.cljs$core$IFn$_invoke$arity$3 ? ok_handler.cljs$core$IFn$_invoke$arity$3(repo,rpath,result) : ok_handler.call(null,repo,rpath,result)):null)),(function (___41611__auto____$2){
...
(frontend.fs.node.Node.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k100785,else__5303__auto__){
var self__ = this;
var this__5302__auto____$1 = this;
var G__100789 = k100785;
switch (G__100789) {
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k100785,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__100790){
var vec__100791 = p__100790;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100791,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100791,(1),null);
...
(frontend.fs.node.Node.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__100784){
var self__ = this;
var G__100784__$1 = this;
return (new cljs.core.RecordIter((0),G__100784__$1,0,cljs.core.PersistentVector.EMPTY,(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(frontend.fs.node.Node.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this100786,other100787){
var self__ = this;
var this100786__$1 = this;
return (((!((other100787 == null)))) && ((((this100786__$1.constructor === other100787.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this100786__$1.__extmap,other100787.__extmap)))));
}));
...
(frontend.fs.node.Node.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k100785){
var self__ = this;
var this__5307__auto____$1 = this;
return cljs.core.contains_QMARK_(self__.__extmap,k100785);
}));

(frontend.fs.node.Node.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__100784){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__100794 = cljs.core.keyword_identical_QMARK_;
var expr__100795 = k__5309__auto__;
return (new frontend.fs.node.Node(self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__100784),null));
}));
...
(frontend.fs.node.Node.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__100784){
var self__ = this;
var this__5299__auto____$1 = this;
return (new frontend.fs.node.Node(G__100784,self__.__extmap,self__.__hash));
}));
 ...
 */
frontend.fs.node.map__GT_Node = (function frontend$fs$node$map__GT_Node(G__100788){
var extmap__5342__auto__ = (function (){var G__100797 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$1(G__100788);
if(cljs.core.record_QMARK_(G__100788)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__100797);
} else {
return G__100797;
}
})();
