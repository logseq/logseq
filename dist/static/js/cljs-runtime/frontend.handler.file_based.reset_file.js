...
var temp__5804__auto____$1 = (function (){var G__292993 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("file","path","file/path",-191335748),current_file], null);
return (frontend.db.pull.cljs$core$IFn$_invoke$arity$1 ? frontend.db.pull.cljs$core$IFn$_invoke$arity$1(G__292993) : frontend.db.pull.call(null,G__292993));
})();
if(cljs.core.truth_(temp__5804__auto____$1)){
var file = temp__5804__auto____$1;
promesa.protocols._mcat(promesa.protocols._promise(null),(function (___41099__auto__){
 ...
 */
frontend.handler.file_based.reset_file.diff_merge_uuids_2ways = (function frontend$handler$file_based$reset_file$diff_merge_uuids_2ways(format,ast,content,p__292994){
var map__292995 = p__292994;
var map__292995__$1 = cljs.core.__destructure_map(map__292995);
var options = map__292995__$1;
var page_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__292995__$1,new cljs.core.Keyword(null,"page-name","page-name",974981762));
...
var new_uuids = (function (){var G__293003 = diff_ops;
var G__293004 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"uuid","uuid",-2145095719),base_diffblocks);
return (frontend.fs.diff_merge.attachUUID.cljs$core$IFn$_invoke$arity$2 ? frontend.fs.diff_merge.attachUUID.cljs$core$IFn$_invoke$arity$2(G__293003,G__293004) : frontend.fs.diff_merge.attachUUID.call(null,G__293003,G__293004));
})();
return cljs_bean.core.__GT_clj(new_uuids);
}catch (e292996){if((e292996 instanceof Error)){
var e = e292996;
 ...
 */
frontend.handler.file_based.reset_file.reset_file_BANG__STAR_ = (function frontend$handler$file_based$reset_file$reset_file_BANG__STAR_(repo_url,file_path,content,p__293005){
var map__293006 = p__293005;
var map__293006__$1 = cljs.core.__destructure_map(map__293006);
var options = map__293006__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__293006__$1,new cljs.core.Keyword("fs","event","fs/event",301434435));
...
var G__293010 = event;
var G__293010__$1 = (((G__293010 instanceof cljs.core.Keyword))?G__293010.fqn:null);
switch (G__293010__$1) {
...
var G__293027 = arguments.length;
switch (G__293027) {
case 3:
...
(frontend.handler.file_based.reset_file.reset_file_BANG_.cljs$core$IFn$_invoke$arity$4 = (function (repo_url,file_path,content,p__293029){
var map__293030 = p__293029;
var map__293030__$1 = cljs.core.__destructure_map(map__293030);
var options = map__293030__$1;
var verbose = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__293030__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060));
var extracted_block_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__293030__$1,new cljs.core.Keyword(null,"extracted-block-ids","extracted-block-ids",-1444219803));
var _ctime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__293030__$1,new cljs.core.Keyword(null,"_ctime","_ctime",851368378));
var _mtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__293030__$1,new cljs.core.Keyword(null,"_mtime","_mtime",-882459022));
