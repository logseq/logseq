...
return cljs.core.contains_QMARK_(cljs.core.set(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2((function (){var G__62964 = new cljs.core.Keyword("db","ident","db/ident",-737096).cljs$core$IFn$_invoke$arity$1(class_entity);
return (logseq.db.frontend.class$.built_in_classes.cljs$core$IFn$_invoke$arity$1 ? logseq.db.frontend.class$.built_in_classes.cljs$core$IFn$_invoke$arity$1(G__62964) : logseq.db.frontend.class$.built_in_classes.call(null,G__62964));
...
var G__62979 = db;
var G__62980 = new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(d);
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__62979,G__62980) : datascript.core.entity.call(null,G__62979,G__62980));
...
var len__5726__auto___63006 = arguments.length;
var i__5727__auto___63007 = (0);
while(true){
if((i__5727__auto___63007 < len__5726__auto___63006)){
args__5732__auto__.push((arguments[i__5727__auto___63007]));

var G__63008 = (i__5727__auto___63007 + (1));
i__5727__auto___63007 = G__63008;
continue;
} else {
}
break;
...
(logseq.db.frontend.db.get_page_parents.cljs$core$IFn$_invoke$arity$variadic = (function (node,p__62988){
var map__62990 = p__62988;
var map__62990__$1 = cljs.core.__destructure_map(map__62990);
var node_class_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62990__$1,new cljs.core.Keyword(null,"node-class?","node-class?",-430242441));
...
var G__63010 = new cljs.core.Keyword("logseq.property","parent","logseq.property/parent",177984509).cljs$core$IFn$_invoke$arity$1(current_parent);
var G__63011 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parents_SINGLEQUOTE_,current_parent);
current_parent = G__63010;
parents_SINGLEQUOTE_ = G__63011;
continue;
} else {
...
/** @this {Function} */
(logseq.db.frontend.db.get_page_parents.cljs$lang$applyTo = (function (seq62985){
var G__62986 = cljs.core.first(seq62985);
var seq62985__$1 = cljs.core.next(seq62985);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62986,seq62985__$1);
}));
...
var result = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__62998_SHARP_){
return logseq.db.frontend.db.get_page_parents.cljs$core$IFn$_invoke$arity$variadic(p1__62998_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"node-class?","node-class?",-430242441),true], null)], 0));
...
var G__63003 = class_ident;
var G__63003__$1 = (((G__63003 instanceof cljs.core.Keyword))?G__63003.fqn:null);
switch (G__63003__$1) {
