...
var vec__123394 = ((((typeof command === 'string') && (clojure.string.includes_QMARK_(command," "))))?logseq.common.util.split_first(" ",command):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [command,""], null));
var command__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123394,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__123394,(1),null);
...
return promesa.protocols._mcat(promesa.protocols._promise(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__123405_SHARP_){
return clojure.string.starts_with_QMARK_(p1__123405_SHARP_,"Commit: ");
...
var args = (function (){var G__123422 = command;
switch (G__123422) {
case "alda":
