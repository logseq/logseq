...
var map__33100 = top_item;
var map__33100__$1 = cljs.core.__destructure_map(map__33100);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33100__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33100__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33100__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e33098){var _e = e33098;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___33164 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___33164)){
var seen_errors_33165 = temp__5802__auto___33164;
if(cljs.core.truth_(seen_errors_33165.has(self))){
} else {
seen_errors_33165.add(self);

var temp__5804__auto___33166 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___33166)){
var sense_33168 = temp__5804__auto___33166;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_33168)].join(''));
} else {
}
}
} else {
