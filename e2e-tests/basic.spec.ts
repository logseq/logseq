...
test('block selection', async ({ page, block }) => {
  ...
  await expect(page.locator('.bullet >> nth=8')).toHaveCSS('border-style', 'double')
  await page.keyboard.press('ArrowUp')
  await block.waitForSelectedBlocks(2)
  await expect(page.locator('.bullet >> nth=7')).toHaveCSS('border-style', 'double')
  await page.keyboard.press('ArrowUp')
  await block.waitForSelectedBlocks(3)
  await expect(page.locator('.bullet >> nth=6')).toHaveCSS('border-style', 'double')
  await page.keyboard.press('ArrowDown')
  await block.waitForSelectedBlocks(2)
  await expect(page.locator('.bullet >> nth=6')).toHaveCSS('border-style', 'solid')
  ...
  await block.waitForSelectedBlocks(1)
  await expect(page.locator('.bullet >> nth=7')).toHaveCSS('border-style', 'solid')
  ...
  await block.waitForSelectedBlocks(3)
  await expect(page.locator('.bullet >> nth=4')).toHaveCSS('border-style', 'double')
  await page.keyboard.down('Shift')
  await page.click('.ls-block >> nth=1')
  await block.waitForSelectedBlocks(6)
  await expect(page.locator('.bullet >> nth=3')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=2')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=1')).toHaveCSS('border-style', 'double')
  await page.keyboard.up('Shift')
  ...
  await expect(page.locator('.bullet >> nth=0')).toHaveCSS('border-style', 'solid')
  await page.click('.block-main-container >> nth=3')
  await block.waitForSelectedBlocks(4)
  await expect(page.locator('.bullet >> nth=0')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=1')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=2')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=3')).toHaveCSS('border-style', 'double')
  ...
  await expect(page.locator('.bullet >> nth=4')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=5')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=6')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=7')).toHaveCSS('border-style', 'double')
  await expect(page.locator('.bullet >> nth=8')).toHaveCSS('border-style', 'double')
  ...
  await expect(page.locator('.bullet >> nth=6')).toHaveCSS('border-style', 'solid')
  await expect(page.locator('.bullet >> nth=7')).toHaveCSS('border-style', 'solid')
  await expect(page.locator('.bullet >> nth=8')).toHaveCSS('border-style', 'solid')
  await page.keyboard.up('Shift')
})
