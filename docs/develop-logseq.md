...
- [Node.js](https://nodejs.org/en/download/) (See [build.yml](https://github.com/logseq/og/blob/master/.github/workflows/build.yml) for allowed version)  & [Yarn](https://classic.yarnpkg.com/en/docs/install/)
