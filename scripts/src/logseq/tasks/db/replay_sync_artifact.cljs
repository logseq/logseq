(ns logseq.tasks.db.replay-sync-artifact
...
(defn usage []
  (str "Usage: pnpm exec nbb-logseq -cp src:../deps/db-sync/src src/logseq/tasks/db/replay_sync_artifact.cljs --artifact <path> [--client <n>] [--round <n>] [--pretty]\n"
       "Options:\n"
